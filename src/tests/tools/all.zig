...
test "test262 args parse --regression-baseline" {
    const config = try test262_runner.parseArgs(&.{
        "-c",                       "quickjs/test262.conf",
        "--regression-baseline", "docs/quickjs-redesign/baseline/2026-04-27/test262-by-dir.json",
        "quickjs/test262/test",
    });
    try std.testing.expectEqualStrings(
        "docs/quickjs-redesign/baseline/2026-04-27/test262-by-dir.json",
