...
//! and declaration table live side by side (QuickJS client model); dispatch
//! reaches `internal_entries` through `rt.internal_builtins` (see
//! `internal_table.zig`), and the install path consumes the same entries.
