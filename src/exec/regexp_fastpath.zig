...
// Helpers that remain in shared.zig (generic utilities and RegExp helpers
...
const latin1StringSlice = shared_vm.latin1StringSlice;
const nativeFunctionMatcherUnicodeClassAsciiResult = shared_vm.nativeFunctionMatcherUnicodeClassAsciiResult;
...
const qjsRegExpExecPropertyFallback = shared_vm.qjsRegExpExecPropertyFallback;
const qjsRegExpPrototypeMethodIsDefault = shared_vm.qjsRegExpPrototypeMethodIsDefault;
...
const qjsRegExpToString = shared_vm.qjsRegExpToString;
...
const regExpLegacyNoCaptureSliceValue = shared_vm.regExpLegacyNoCaptureSliceValue;
const regExpPrototypeFromGlobal = shared_vm.regExpPrototypeFromGlobal;
const regexpInternalStringValue = shared_vm.regexpInternalStringValue;
const regexpSourceUsesZigPropertyFallback = shared_vm.regexpSourceUsesZigPropertyFallback;
const replaceRegExpLegacySlot = shared_vm.replaceRegExpLegacySlot;
const sameObjectIdentity = shared_vm.sameObjectIdentity;
const setValuePropertyStrict = shared_vm.setValuePropertyStrict;
const simpleAsciiLiteralClassPlusLiteralMatchBytes = shared_vm.simpleAsciiLiteralClassPlusLiteralMatchBytes;
const simpleCaptureAtomsKnownDisjoint = shared_vm.simpleCaptureAtomsKnownDisjoint;
const simpleCaptureSequenceAtomMatches = shared_vm.simpleCaptureSequenceAtomMatches;
const simpleCaptureSequenceMatchPattern = shared_vm.simpleCaptureSequenceMatchPattern;
const simpleClassAlternationMatchPattern = shared_vm.simpleClassAlternationMatchPattern;
const simpleClassSequenceAtomMatches = shared_vm.simpleClassSequenceAtomMatches;
const simpleClassSequenceMatchPattern = shared_vm.simpleClassSequenceMatchPattern;
const simpleLatin1LiteralPlusLiteralMatch = shared_vm.simpleLatin1LiteralPlusLiteralMatch;
const simpleUnicodeLiteralMatch = shared_vm.simpleUnicodeLiteralMatch;
const simpleUnicodePropertyRunTestFast = shared_vm.simpleUnicodePropertyRunTestFast;
const stringAtomId = shared_vm.stringAtomId;
