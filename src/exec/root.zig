...
pub const native_legacy = @import("native_legacy.zig");
pub const vm_native = @import("vm_native.zig");
...
pub const host_invocation = @import("host_invocation.zig");
...
pub const iterator_slots = @import("iterator_slots.zig");
