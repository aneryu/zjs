...
//!
//! This file re-exports execution domains. Compatibility aliases keep retired
//! satellite names (`array_builtin_ops`, `exceptions`, `module_graph`, …)
//! pointing at the merged owner file. `Vm` owns its operand stack, borrows its
//! context/output/global view, and delegates compilation/evaluation to the same
//! public exec entry points.
...
pub const small_inline = @import("small_inline.zig");
pub const call = @import("call.zig");
pub const construct = @import("construct.zig");
pub const property_ops = @import("property_ops.zig");
pub const exceptions = @import("exception_ops.zig");
pub const exception_ops = @import("exception_ops.zig");
pub const builtin_dispatch = @import("builtin_dispatch.zig");
pub const native_legacy = @import("builtin_dispatch.zig");
pub const vm_native = @import("vm_opcodes.zig");
pub const iterator_builtin_ops = @import("iterator_ops.zig");
pub const eval_entry = @import("eval_entry.zig");
pub const module = @import("module.zig");
pub const module_graph = @import("module.zig");
pub const value_ops = @import("value_ops.zig");
pub const globals = core.global_slots;
pub const closure = @import("call.zig");
pub const collection_adapter = @import("collection_ops.zig");
pub const collection_ops = @import("collection_ops.zig");
pub const call_runtime = @import("call_runtime.zig");
pub const call_site = @import("call_site.zig");
pub const host_invocation = @import("call_site.zig");
pub const async_generator = @import("promise_ops.zig");
...
pub const primitive_ops = @import("value_ops.zig");
pub const function_ops = @import("function_ops.zig");
pub const error_ops = @import("exception_ops.zig");
pub const date_ops = @import("date_ops.zig");
pub const object_builtin_ops = @import("object_ops.zig");
pub const object_ops = @import("object_ops.zig");
pub const reflect_proxy_ops = @import("reflect_ops.zig");
pub const reflect_ops = @import("reflect_ops.zig");
pub const iterator_ops = @import("iterator_ops.zig");
pub const iterator_slots = @import("iterator_ops.zig");
pub const string_builtin_ops = @import("string_ops.zig");
pub const regexp_ops = @import("regexp_ops.zig");
pub const array_builtin_ops = @import("array_ops.zig");
pub const array_ops = @import("array_ops.zig");
pub const coercion_ops = @import("value_ops.zig");
pub const promise_ops = @import("promise_ops.zig");
pub const typed_array_construct = @import("buffer_ops.zig");
...
/// W1 property-site cache (`PropSiteCache`, capture and retire rules).
pub const vm_property = @import("vm_property.zig");
pub const vm_property_field = vm_property;
