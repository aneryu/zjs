...
// Helpers that remain in shared.zig (generic utilities outside the eval
// cluster).
const InlineCallRequest = shared_vm.InlineCallRequest;
...
const atomListToMemorySlice = shared_vm.atomListToMemorySlice;
