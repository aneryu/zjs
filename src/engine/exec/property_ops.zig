...
pub fn propertyKeyAtom(rt: *core.Runtime, value: core.Value) !core.Atom {
    ...
    return error.UnsupportedPropertyOp;
}

pub fn expectObject(value: core.Value) !*core.Object {
    const header = value.refHeader() orelse return error.UnsupportedPropertyOp;
    if (!value.isObject()) return error.UnsupportedPropertyOp;
