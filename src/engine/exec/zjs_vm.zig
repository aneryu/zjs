...
const isRuntimeSupportedBinaryPropertyName = shared_vm.isRuntimeSupportedBinaryPropertyName;
const binaryPropertyCodePointMatches = shared_vm.binaryPropertyCodePointMatches;
...
const codePointInUnicodeSet = shared_vm.codePointInUnicodeSet;
const codePointInSortedUnicodeRanges = shared_vm.codePointInSortedUnicodeRanges;
const codePointInSortedUnicodeSingles = shared_vm.codePointInSortedUnicodeSingles;
const isUnicodeAdlamScriptExtensionsCodePoint = shared_vm.isUnicodeAdlamScriptExtensionsCodePoint;
const isUnicodeArabicScriptExtensionsCodePoint = shared_vm.isUnicodeArabicScriptExtensionsCodePoint;
const isUnicodeArmenianScriptExtensionsCodePoint = shared_vm.isUnicodeArmenianScriptExtensionsCodePoint;
const isUnicodeAvestanScriptExtensionsCodePoint = shared_vm.isUnicodeAvestanScriptExtensionsCodePoint;
const isUnicodeBengaliScriptExtensionsCodePoint = shared_vm.isUnicodeBengaliScriptExtensionsCodePoint;
const isUnicodeBopomofoScriptExtensionsCodePoint = shared_vm.isUnicodeBopomofoScriptExtensionsCodePoint;
const isUnicodeBugineseScriptExtensionsCodePoint = shared_vm.isUnicodeBugineseScriptExtensionsCodePoint;
const isUnicodeCarianScriptExtensionsCodePoint = shared_vm.isUnicodeCarianScriptExtensionsCodePoint;
const isUnicodeCaucasianAlbanianScriptExtensionsCodePoint = shared_vm.isUnicodeCaucasianAlbanianScriptExtensionsCodePoint;
const isUnicodeChakmaScriptExtensionsCodePoint = shared_vm.isUnicodeChakmaScriptExtensionsCodePoint;
const isUnicodeCherokeeScriptExtensionsCodePoint = shared_vm.isUnicodeCherokeeScriptExtensionsCodePoint;
const isUnicodeCopticScriptCodePoint = shared_vm.isUnicodeCopticScriptCodePoint;
const isUnicodeInheritedScriptCodePoint = shared_vm.isUnicodeInheritedScriptCodePoint;
const isUnicodeNewaScriptCodePoint = shared_vm.isUnicodeNewaScriptCodePoint;
const isUnicodeNushuScriptCodePoint = shared_vm.isUnicodeNushuScriptCodePoint;
const isUnicodeOghamScriptCodePoint = shared_vm.isUnicodeOghamScriptCodePoint;
const isUnicodeOlChikiScriptCodePoint = shared_vm.isUnicodeOlChikiScriptCodePoint;
const isUnicodeMiaoScriptCodePoint = shared_vm.isUnicodeMiaoScriptCodePoint;
const isUnicodeNandinagariScriptCodePoint = shared_vm.isUnicodeNandinagariScriptCodePoint;
const isUnicodeNkoScriptCodePoint = shared_vm.isUnicodeNkoScriptCodePoint;
const isUnicodeNyiakengPuachueHmongScriptCodePoint = shared_vm.isUnicodeNyiakengPuachueHmongScriptCodePoint;
const isUnicodeOlOnalScriptCodePoint = shared_vm.isUnicodeOlOnalScriptCodePoint;
const isUnicodeOlOnalScriptExtensionsCodePoint = shared_vm.isUnicodeOlOnalScriptExtensionsCodePoint;
const isUnicodeOldHungarianScriptCodePoint = shared_vm.isUnicodeOldHungarianScriptCodePoint;
const isUnicodeOldPermicScriptCodePoint = shared_vm.isUnicodeOldPermicScriptCodePoint;
const isUnicodeOldPersianScriptCodePoint = shared_vm.isUnicodeOldPersianScriptCodePoint;
const isUnicodeOriyaScriptCodePoint = shared_vm.isUnicodeOriyaScriptCodePoint;
const isUnicodeOsageScriptCodePoint = shared_vm.isUnicodeOsageScriptCodePoint;
const isUnicodeOsmanyaScriptCodePoint = shared_vm.isUnicodeOsmanyaScriptCodePoint;
const isUnicodePahawhHmongScriptCodePoint = shared_vm.isUnicodePahawhHmongScriptCodePoint;
const isUnicodeKiratRaiScriptCodePoint = shared_vm.isUnicodeKiratRaiScriptCodePoint;
const isUnicodeOldItalicScriptCodePoint = shared_vm.isUnicodeOldItalicScriptCodePoint;
const isUnicodeOldNorthArabianScriptCodePoint = shared_vm.isUnicodeOldNorthArabianScriptCodePoint;
const isUnicodeOldSogdianScriptCodePoint = shared_vm.isUnicodeOldSogdianScriptCodePoint;
const isUnicodeOldSouthArabianScriptCodePoint = shared_vm.isUnicodeOldSouthArabianScriptCodePoint;
const isUnicodeOldTurkicScriptCodePoint = shared_vm.isUnicodeOldTurkicScriptCodePoint;
const isUnicodeOldUyghurScriptCodePoint = shared_vm.isUnicodeOldUyghurScriptCodePoint;
const isUnicodePalmyreneScriptCodePoint = shared_vm.isUnicodePalmyreneScriptCodePoint;
const isUnicodePauCinHauScriptCodePoint = shared_vm.isUnicodePauCinHauScriptCodePoint;
const isUnicodePhagsPaScriptCodePoint = shared_vm.isUnicodePhagsPaScriptCodePoint;
const isUnicodePhoenicianScriptCodePoint = shared_vm.isUnicodePhoenicianScriptCodePoint;
const isUnicodePsalterPahlaviScriptCodePoint = shared_vm.isUnicodePsalterPahlaviScriptCodePoint;
const isUnicodeRejangScriptCodePoint = shared_vm.isUnicodeRejangScriptCodePoint;
const isUnicodeRunicScriptCodePoint = shared_vm.isUnicodeRunicScriptCodePoint;
const isUnicodeNewTaiLueScriptCodePoint = shared_vm.isUnicodeNewTaiLueScriptCodePoint;
const isUnicodeSamaritanScriptCodePoint = shared_vm.isUnicodeSamaritanScriptCodePoint;
const isUnicodeSaurashtraScriptCodePoint = shared_vm.isUnicodeSaurashtraScriptCodePoint;
const isUnicodeSharadaScriptCodePoint = shared_vm.isUnicodeSharadaScriptCodePoint;
const isUnicodeShavianScriptCodePoint = shared_vm.isUnicodeShavianScriptCodePoint;
const isUnicodeSiddhamScriptCodePoint = shared_vm.isUnicodeSiddhamScriptCodePoint;
const isUnicodeSideticScriptCodePoint = shared_vm.isUnicodeSideticScriptCodePoint;
const isUnicodeSignWritingScriptCodePoint = shared_vm.isUnicodeSignWritingScriptCodePoint;
const isUnicodeSinhalaScriptCodePoint = shared_vm.isUnicodeSinhalaScriptCodePoint;
const isUnicodeSogdianScriptCodePoint = shared_vm.isUnicodeSogdianScriptCodePoint;
const isUnicodeSoraSompengScriptCodePoint = shared_vm.isUnicodeSoraSompengScriptCodePoint;
const isUnicodeSoyomboScriptCodePoint = shared_vm.isUnicodeSoyomboScriptCodePoint;
const isUnicodeSundaneseScriptCodePoint = shared_vm.isUnicodeSundaneseScriptCodePoint;
const isUnicodeSunuwarScriptCodePoint = shared_vm.isUnicodeSunuwarScriptCodePoint;
const isUnicodeSylotiNagriScriptCodePoint = shared_vm.isUnicodeSylotiNagriScriptCodePoint;
const isUnicodeSyriacScriptCodePoint = shared_vm.isUnicodeSyriacScriptCodePoint;
const isUnicodeTagalogScriptCodePoint = shared_vm.isUnicodeTagalogScriptCodePoint;
const isUnicodeTagbanwaScriptCodePoint = shared_vm.isUnicodeTagbanwaScriptCodePoint;
const isUnicodeTaiLeScriptCodePoint = shared_vm.isUnicodeTaiLeScriptCodePoint;
const isUnicodeTaiThamScriptCodePoint = shared_vm.isUnicodeTaiThamScriptCodePoint;
const isUnicodeTaiVietScriptCodePoint = shared_vm.isUnicodeTaiVietScriptCodePoint;
const isUnicodeTaiYoScriptCodePoint = shared_vm.isUnicodeTaiYoScriptCodePoint;
const isUnicodeTakriScriptCodePoint = shared_vm.isUnicodeTakriScriptCodePoint;
const isUnicodeTamilScriptCodePoint = shared_vm.isUnicodeTamilScriptCodePoint;
const isUnicodeTangsaScriptCodePoint = shared_vm.isUnicodeTangsaScriptCodePoint;
const isUnicodeTangutScriptCodePoint = shared_vm.isUnicodeTangutScriptCodePoint;
const isUnicodeTeluguScriptCodePoint = shared_vm.isUnicodeTeluguScriptCodePoint;
const isUnicodeThaanaScriptCodePoint = shared_vm.isUnicodeThaanaScriptCodePoint;
const isUnicodeThaiScriptCodePoint = shared_vm.isUnicodeThaiScriptCodePoint;
const isUnicodeTibetanScriptCodePoint = shared_vm.isUnicodeTibetanScriptCodePoint;
const isUnicodeTifinaghScriptCodePoint = shared_vm.isUnicodeTifinaghScriptCodePoint;
const isUnicodeTirhutaScriptCodePoint = shared_vm.isUnicodeTirhutaScriptCodePoint;
const isUnicodeTodhriScriptCodePoint = shared_vm.isUnicodeTodhriScriptCodePoint;
const isUnicodeTolongSikiScriptCodePoint = shared_vm.isUnicodeTolongSikiScriptCodePoint;
const isUnicodeTotoScriptCodePoint = shared_vm.isUnicodeTotoScriptCodePoint;
const isUnicodeTuluTigalariScriptCodePoint = shared_vm.isUnicodeTuluTigalariScriptCodePoint;
const isUnicodeUgariticScriptCodePoint = shared_vm.isUnicodeUgariticScriptCodePoint;
const isUnicodeVaiScriptCodePoint = shared_vm.isUnicodeVaiScriptCodePoint;
const isUnicodeUnknownScriptCodePoint = shared_vm.isUnicodeUnknownScriptCodePoint;
const isUnicodeVithkuqiScriptCodePoint = shared_vm.isUnicodeVithkuqiScriptCodePoint;
const isUnicodeWanchoScriptCodePoint = shared_vm.isUnicodeWanchoScriptCodePoint;
const isUnicodeWarangCitiScriptCodePoint = shared_vm.isUnicodeWarangCitiScriptCodePoint;
const isUnicodeYezidiScriptCodePoint = shared_vm.isUnicodeYezidiScriptCodePoint;
const isUnicodeYiScriptCodePoint = shared_vm.isUnicodeYiScriptCodePoint;
const isUnicodeZanabazarSquareScriptCodePoint = shared_vm.isUnicodeZanabazarSquareScriptCodePoint;
const isUnicodeCommonScriptExtensionsCodePoint = shared_vm.isUnicodeCommonScriptExtensionsCodePoint;
const isUnicodeCopticScriptExtensionsCodePoint = shared_vm.isUnicodeCopticScriptExtensionsCodePoint;
const isUnicodeNumberCategoryCodePoint = shared_vm.isUnicodeNumberCategoryCodePoint;
const isUnicodeIdContinueCodePoint = shared_vm.isUnicodeIdContinueCodePoint;
const isUnicodeXidContinueCodePoint = shared_vm.isUnicodeXidContinueCodePoint;
const isUnicodeTolongSikiScriptExtensionsCodePoint = shared_vm.isUnicodeTolongSikiScriptExtensionsCodePoint;
const isUnicodeWanchoScriptExtensionsCodePoint = shared_vm.isUnicodeWanchoScriptExtensionsCodePoint;
const isUnicodeWarangCitiScriptExtensionsCodePoint = shared_vm.isUnicodeWarangCitiScriptExtensionsCodePoint;
const isUnicodeZanabazarSquareScriptExtensionsCodePoint = shared_vm.isUnicodeZanabazarSquareScriptExtensionsCodePoint;
const isUnicodeCypriotScriptExtensionsCodePoint = shared_vm.isUnicodeCypriotScriptExtensionsCodePoint;
const isUnicodeCyrillicScriptExtensionsCodePoint = shared_vm.isUnicodeCyrillicScriptExtensionsCodePoint;
const isUnicodeDevanagariScriptExtensionsCodePoint = shared_vm.isUnicodeDevanagariScriptExtensionsCodePoint;
const isUnicodeDograScriptExtensionsCodePoint = shared_vm.isUnicodeDograScriptExtensionsCodePoint;
const isUnicodeDuployanScriptExtensionsCodePoint = shared_vm.isUnicodeDuployanScriptExtensionsCodePoint;
const isUnicodeElbasanScriptExtensionsCodePoint = shared_vm.isUnicodeElbasanScriptExtensionsCodePoint;
const isUnicodeEthiopicScriptExtensionsCodePoint = shared_vm.isUnicodeEthiopicScriptExtensionsCodePoint;
const isUnicodeGarayScriptExtensionsCodePoint = shared_vm.isUnicodeGarayScriptExtensionsCodePoint;
const isUnicodeGeorgianScriptExtensionsCodePoint = shared_vm.isUnicodeGeorgianScriptExtensionsCodePoint;
const isUnicodeGlagoliticScriptExtensionsCodePoint = shared_vm.isUnicodeGlagoliticScriptExtensionsCodePoint;
const isUnicodeUgariticScriptExtensionsCodePoint = shared_vm.isUnicodeUgariticScriptExtensionsCodePoint;
const isUnicodeVaiScriptExtensionsCodePoint = shared_vm.isUnicodeVaiScriptExtensionsCodePoint;
const isUnicodeVithkuqiScriptExtensionsCodePoint = shared_vm.isUnicodeVithkuqiScriptExtensionsCodePoint;
const isUnicodeSoraSompengScriptExtensionsCodePoint = shared_vm.isUnicodeSoraSompengScriptExtensionsCodePoint;
const isUnicodeTangsaScriptExtensionsCodePoint = shared_vm.isUnicodeTangsaScriptExtensionsCodePoint;
const isUnicodeGothicScriptExtensionsCodePoint = shared_vm.isUnicodeGothicScriptExtensionsCodePoint;
const isUnicodeGranthaScriptExtensionsCodePoint = shared_vm.isUnicodeGranthaScriptExtensionsCodePoint;
const isUnicodeGreekScriptExtensionsCodePoint = shared_vm.isUnicodeGreekScriptExtensionsCodePoint;
const isUnicodeGujaratiScriptExtensionsCodePoint = shared_vm.isUnicodeGujaratiScriptExtensionsCodePoint;
const isUnicodeGunjalaGondiScriptExtensionsCodePoint = shared_vm.isUnicodeGunjalaGondiScriptExtensionsCodePoint;
const isUnicodeGurmukhiScriptExtensionsCodePoint = shared_vm.isUnicodeGurmukhiScriptExtensionsCodePoint;
const isUnicodeHanScriptCodePoint = shared_vm.isUnicodeHanScriptCodePoint;
const isUnicodeHanScriptExtensionsCodePoint = shared_vm.isUnicodeHanScriptExtensionsCodePoint;
const isUnicodeHangulScriptExtensionsCodePoint = shared_vm.isUnicodeHangulScriptExtensionsCodePoint;
const isUnicodeHanifiRohingyaScriptExtensionsCodePoint = shared_vm.isUnicodeHanifiRohingyaScriptExtensionsCodePoint;
const isUnicodeHebrewScriptExtensionsCodePoint = shared_vm.isUnicodeHebrewScriptExtensionsCodePoint;
const isUnicodeHiraganaScriptExtensionsCodePoint = shared_vm.isUnicodeHiraganaScriptExtensionsCodePoint;
const isUnicodeInheritedScriptExtensionsCodePoint = shared_vm.isUnicodeInheritedScriptExtensionsCodePoint;
const isUnicodeJavaneseScriptExtensionsCodePoint = shared_vm.isUnicodeJavaneseScriptExtensionsCodePoint;
const isUnicodeKaithiScriptExtensionsCodePoint = shared_vm.isUnicodeKaithiScriptExtensionsCodePoint;
const isUnicodeKannadaScriptExtensionsCodePoint = shared_vm.isUnicodeKannadaScriptExtensionsCodePoint;
const isUnicodeKatakanaScriptExtensionsCodePoint = shared_vm.isUnicodeKatakanaScriptExtensionsCodePoint;
const isUnicodeKhojkiScriptExtensionsCodePoint = shared_vm.isUnicodeKhojkiScriptExtensionsCodePoint;
const isUnicodeKhudawadiScriptExtensionsCodePoint = shared_vm.isUnicodeKhudawadiScriptExtensionsCodePoint;
const isUnicodeLatinScriptExtensionsCodePoint = shared_vm.isUnicodeLatinScriptExtensionsCodePoint;
const isUnicodeLimbuScriptExtensionsCodePoint = shared_vm.isUnicodeLimbuScriptExtensionsCodePoint;
const isUnicodeMalayalamScriptExtensionsCodePoint = shared_vm.isUnicodeMalayalamScriptExtensionsCodePoint;
const isUnicodeMandaicScriptExtensionsCodePoint = shared_vm.isUnicodeMandaicScriptExtensionsCodePoint;
const isUnicodeModiScriptExtensionsCodePoint = shared_vm.isUnicodeModiScriptExtensionsCodePoint;
const isUnicodeMongolianScriptExtensionsCodePoint = shared_vm.isUnicodeMongolianScriptExtensionsCodePoint;
const isUnicodeMyanmarScriptExtensionsCodePoint = shared_vm.isUnicodeMyanmarScriptExtensionsCodePoint;
const isUnicodeNagMundariScriptExtensionsCodePoint = shared_vm.isUnicodeNagMundariScriptExtensionsCodePoint;
const isUnicodeNandinagariScriptExtensionsCodePoint = shared_vm.isUnicodeNandinagariScriptExtensionsCodePoint;
const isUnicodeNewaScriptExtensionsCodePoint = shared_vm.isUnicodeNewaScriptExtensionsCodePoint;
const isUnicodeNewTaiLueScriptExtensionsCodePoint = shared_vm.isUnicodeNewTaiLueScriptExtensionsCodePoint;
const isUnicodeNkoScriptExtensionsCodePoint = shared_vm.isUnicodeNkoScriptExtensionsCodePoint;
const isUnicodeOldHungarianScriptExtensionsCodePoint = shared_vm.isUnicodeOldHungarianScriptExtensionsCodePoint;
const isUnicodeOldPermicScriptExtensionsCodePoint = shared_vm.isUnicodeOldPermicScriptExtensionsCodePoint;
const isUnicodeOldPersianScriptExtensionsCodePoint = shared_vm.isUnicodeOldPersianScriptExtensionsCodePoint;
const isUnicodeOldSogdianScriptExtensionsCodePoint = shared_vm.isUnicodeOldSogdianScriptExtensionsCodePoint;
const isUnicodeOldTurkicScriptExtensionsCodePoint = shared_vm.isUnicodeOldTurkicScriptExtensionsCodePoint;
const isUnicodeOldUyghurScriptExtensionsCodePoint = shared_vm.isUnicodeOldUyghurScriptExtensionsCodePoint;
const isUnicodeOriyaScriptExtensionsCodePoint = shared_vm.isUnicodeOriyaScriptExtensionsCodePoint;
const isUnicodeOsageScriptExtensionsCodePoint = shared_vm.isUnicodeOsageScriptExtensionsCodePoint;
const isUnicodeOsmanyaScriptExtensionsCodePoint = shared_vm.isUnicodeOsmanyaScriptExtensionsCodePoint;
const isUnicodePahawhHmongScriptExtensionsCodePoint = shared_vm.isUnicodePahawhHmongScriptExtensionsCodePoint;
const isUnicodePauCinHauScriptExtensionsCodePoint = shared_vm.isUnicodePauCinHauScriptExtensionsCodePoint;
const isUnicodePhagsPaScriptExtensionsCodePoint = shared_vm.isUnicodePhagsPaScriptExtensionsCodePoint;
const isUnicodePhoenicianScriptExtensionsCodePoint = shared_vm.isUnicodePhoenicianScriptExtensionsCodePoint;
const isUnicodePsalterPahlaviScriptExtensionsCodePoint = shared_vm.isUnicodePsalterPahlaviScriptExtensionsCodePoint;
const isUnicodeRejangScriptExtensionsCodePoint = shared_vm.isUnicodeRejangScriptExtensionsCodePoint;
const isUnicodeRunicScriptExtensionsCodePoint = shared_vm.isUnicodeRunicScriptExtensionsCodePoint;
const isUnicodeSamaritanScriptExtensionsCodePoint = shared_vm.isUnicodeSamaritanScriptExtensionsCodePoint;
const isUnicodeSaurashtraScriptExtensionsCodePoint = shared_vm.isUnicodeSaurashtraScriptExtensionsCodePoint;
const isUnicodeSharadaScriptExtensionsCodePoint = shared_vm.isUnicodeSharadaScriptExtensionsCodePoint;
const isUnicodeShavianScriptExtensionsCodePoint = shared_vm.isUnicodeShavianScriptExtensionsCodePoint;
const isUnicodeSiddhamScriptExtensionsCodePoint = shared_vm.isUnicodeSiddhamScriptExtensionsCodePoint;
const isUnicodeSideticScriptExtensionsCodePoint = shared_vm.isUnicodeSideticScriptExtensionsCodePoint;
const isUnicodeSinhalaScriptExtensionsCodePoint = shared_vm.isUnicodeSinhalaScriptExtensionsCodePoint;
const isUnicodeSogdianScriptExtensionsCodePoint = shared_vm.isUnicodeSogdianScriptExtensionsCodePoint;
const isUnicodeSoyomboScriptExtensionsCodePoint = shared_vm.isUnicodeSoyomboScriptExtensionsCodePoint;
const isUnicodeSundaneseScriptExtensionsCodePoint = shared_vm.isUnicodeSundaneseScriptExtensionsCodePoint;
const isUnicodeSunuwarScriptExtensionsCodePoint = shared_vm.isUnicodeSunuwarScriptExtensionsCodePoint;
const isUnicodeSylotiNagriScriptExtensionsCodePoint = shared_vm.isUnicodeSylotiNagriScriptExtensionsCodePoint;
const isUnicodeSyriacScriptExtensionsCodePoint = shared_vm.isUnicodeSyriacScriptExtensionsCodePoint;
const isUnicodeTagalogScriptExtensionsCodePoint = shared_vm.isUnicodeTagalogScriptExtensionsCodePoint;
const isUnicodeTagbanwaScriptExtensionsCodePoint = shared_vm.isUnicodeTagbanwaScriptExtensionsCodePoint;
const isUnicodeTaiLeScriptExtensionsCodePoint = shared_vm.isUnicodeTaiLeScriptExtensionsCodePoint;
const isUnicodeTakriScriptExtensionsCodePoint = shared_vm.isUnicodeTakriScriptExtensionsCodePoint;
const isUnicodeTangutScriptExtensionsCodePoint = shared_vm.isUnicodeTangutScriptExtensionsCodePoint;
const isUnicodeTeluguScriptExtensionsCodePoint = shared_vm.isUnicodeTeluguScriptExtensionsCodePoint;
const isUnicodeThaanaScriptExtensionsCodePoint = shared_vm.isUnicodeThaanaScriptExtensionsCodePoint;
const isUnicodeThaiScriptExtensionsCodePoint = shared_vm.isUnicodeThaiScriptExtensionsCodePoint;
const isUnicodeTibetanScriptExtensionsCodePoint = shared_vm.isUnicodeTibetanScriptExtensionsCodePoint;
const isUnicodeTifinaghScriptExtensionsCodePoint = shared_vm.isUnicodeTifinaghScriptExtensionsCodePoint;
const isUnicodeTirhutaScriptExtensionsCodePoint = shared_vm.isUnicodeTirhutaScriptExtensionsCodePoint;
const isUnicodeTodhriScriptExtensionsCodePoint = shared_vm.isUnicodeTodhriScriptExtensionsCodePoint;
const isUnicodeTotoScriptExtensionsCodePoint = shared_vm.isUnicodeTotoScriptExtensionsCodePoint;
const isUnicodeTuluTigalariScriptExtensionsCodePoint = shared_vm.isUnicodeTuluTigalariScriptExtensionsCodePoint;
const isUnicodeTamilScriptExtensionsCodePoint = shared_vm.isUnicodeTamilScriptExtensionsCodePoint;
const isUnicodeHanunooScriptExtensionsCodePoint = shared_vm.isUnicodeHanunooScriptExtensionsCodePoint;
const isUnicodeImperialAramaicScriptExtensionsCodePoint = shared_vm.isUnicodeImperialAramaicScriptExtensionsCodePoint;
const isUnicodeKawiScriptExtensionsCodePoint = shared_vm.isUnicodeKawiScriptExtensionsCodePoint;
const isUnicodeKayahLiScriptExtensionsCodePoint = shared_vm.isUnicodeKayahLiScriptExtensionsCodePoint;
const isUnicodeLaoScriptExtensionsCodePoint = shared_vm.isUnicodeLaoScriptExtensionsCodePoint;
const isUnicodeLycianScriptExtensionsCodePoint = shared_vm.isUnicodeLycianScriptExtensionsCodePoint;
const isUnicodeMedefaidrinScriptExtensionsCodePoint = shared_vm.isUnicodeMedefaidrinScriptExtensionsCodePoint;
const isUnicodeMeeteiMayekScriptExtensionsCodePoint = shared_vm.isUnicodeMeeteiMayekScriptExtensionsCodePoint;
const isUnicodeMendeKikakuiScriptExtensionsCodePoint = shared_vm.isUnicodeMendeKikakuiScriptExtensionsCodePoint;
const isUnicodeMeroiticCursiveScriptExtensionsCodePoint = shared_vm.isUnicodeMeroiticCursiveScriptExtensionsCodePoint;
const isUnicodeMeroiticHieroglyphsScriptExtensionsCodePoint = shared_vm.isUnicodeMeroiticHieroglyphsScriptExtensionsCodePoint;
const isUnicodeMroScriptExtensionsCodePoint = shared_vm.isUnicodeMroScriptExtensionsCodePoint;
const isUnicodeNabataeanScriptExtensionsCodePoint = shared_vm.isUnicodeNabataeanScriptExtensionsCodePoint;
const isUnicodeNushuScriptExtensionsCodePoint = shared_vm.isUnicodeNushuScriptExtensionsCodePoint;
const isUnicodeLinearAScriptExtensionsCodePoint = shared_vm.isUnicodeLinearAScriptExtensionsCodePoint;
const isUnicodeLinearBScriptExtensionsCodePoint = shared_vm.isUnicodeLinearBScriptExtensionsCodePoint;
const isUnicodeLisuScriptExtensionsCodePoint = shared_vm.isUnicodeLisuScriptExtensionsCodePoint;
const isUnicodeLydianScriptExtensionsCodePoint = shared_vm.isUnicodeLydianScriptExtensionsCodePoint;
const isUnicodeMahajaniScriptExtensionsCodePoint = shared_vm.isUnicodeMahajaniScriptExtensionsCodePoint;
const isUnicodeManichaeanScriptExtensionsCodePoint = shared_vm.isUnicodeManichaeanScriptExtensionsCodePoint;
const isUnicodeMasaramGondiScriptExtensionsCodePoint = shared_vm.isUnicodeMasaramGondiScriptExtensionsCodePoint;
const isUnicodeMultaniScriptExtensionsCodePoint = shared_vm.isUnicodeMultaniScriptExtensionsCodePoint;
const isUnicodeYezidiScriptExtensionsCodePoint = shared_vm.isUnicodeYezidiScriptExtensionsCodePoint;
const isUnicodeYiScriptExtensionsCodePoint = shared_vm.isUnicodeYiScriptExtensionsCodePoint;
const isUnicodeTaiThamScriptExtensionsCodePoint = shared_vm.isUnicodeTaiThamScriptExtensionsCodePoint;
const isUnicodeTaiVietScriptExtensionsCodePoint = shared_vm.isUnicodeTaiVietScriptExtensionsCodePoint;
const isUnicodeTaiYoScriptExtensionsCodePoint = shared_vm.isUnicodeTaiYoScriptExtensionsCodePoint;
const isUnicodeSignWritingScriptExtensionsCodePoint = shared_vm.isUnicodeSignWritingScriptExtensionsCodePoint;
const isUnicodeUnassignedCodePoint = shared_vm.isUnicodeUnassignedCodePoint;
const isUnicodeLowercaseCodePoint = shared_vm.isUnicodeLowercaseCodePoint;
const isUnicodeUppercaseCodePoint = shared_vm.isUnicodeUppercaseCodePoint;
const isUnicodeAssignedCodePoint = shared_vm.isUnicodeAssignedCodePoint;
const isUnicodeOtherCategoryCodePoint = shared_vm.isUnicodeOtherCategoryCodePoint;
const isUnicodeControlCategoryCodePoint = shared_vm.isUnicodeControlCategoryCodePoint;
const isUnicodeFormatCategoryCodePoint = shared_vm.isUnicodeFormatCategoryCodePoint;
const isUnicodePrivateUseCategoryCodePoint = shared_vm.isUnicodePrivateUseCategoryCodePoint;
const isUnicodeSurrogateCategoryCodePoint = shared_vm.isUnicodeSurrogateCategoryCodePoint;
const isUnicodeDecimalNumberCategoryCodePoint = shared_vm.isUnicodeDecimalNumberCategoryCodePoint;
const isUnicodeMarkCategoryCodePoint = shared_vm.isUnicodeMarkCategoryCodePoint;
const isUnicodeLetterCategoryCodePoint = shared_vm.isUnicodeLetterCategoryCodePoint;
const isUnicodeOtherLetterCategoryCodePoint = shared_vm.isUnicodeOtherLetterCategoryCodePoint;
const isUnicodeUppercaseLetterCategoryCodePoint = shared_vm.isUnicodeUppercaseLetterCategoryCodePoint;
const isUnicodePunctuationCategoryCodePoint = shared_vm.isUnicodePunctuationCategoryCodePoint;
const isUnicodeSymbolCategoryCodePoint = shared_vm.isUnicodeSymbolCategoryCodePoint;
const isUnicodeGraphemeBaseCodePoint = shared_vm.isUnicodeGraphemeBaseCodePoint;
const isUnicodeHexDigitCodePoint = shared_vm.isUnicodeHexDigitCodePoint;
const isUnicodeCasedCodePoint = shared_vm.isUnicodeCasedCodePoint;
const isUnicodeDashCodePoint = shared_vm.isUnicodeDashCodePoint;
const isUnicodeBidiMirroredCodePoint = shared_vm.isUnicodeBidiMirroredCodePoint;
const isUnicodeBidiControlCodePoint = shared_vm.isUnicodeBidiControlCodePoint;
const isUnicodeDeprecatedCodePoint = shared_vm.isUnicodeDeprecatedCodePoint;
const isUnicodeDiacriticCodePoint = shared_vm.isUnicodeDiacriticCodePoint;
const isUnicodeIdsBinaryOperatorCodePoint = shared_vm.isUnicodeIdsBinaryOperatorCodePoint;
const isUnicodeIdsTrinaryOperatorCodePoint = shared_vm.isUnicodeIdsTrinaryOperatorCodePoint;
const isUnicodeRadicalCodePoint = shared_vm.isUnicodeRadicalCodePoint;
const isUnicodeVariationSelectorCodePoint = shared_vm.isUnicodeVariationSelectorCodePoint;
const isUnicodeQuotationMarkCodePoint = shared_vm.isUnicodeQuotationMarkCodePoint;
const isUnicodePatternWhiteSpaceCodePoint = shared_vm.isUnicodePatternWhiteSpaceCodePoint;
const isUnicodeWhiteSpaceCodePoint = shared_vm.isUnicodeWhiteSpaceCodePoint;
const isUnicodeLogicalOrderExceptionCodePoint = shared_vm.isUnicodeLogicalOrderExceptionCodePoint;
const isUnicodeNoncharacterCodePoint = shared_vm.isUnicodeNoncharacterCodePoint;
const isUnicodePatternSyntaxCodePoint = shared_vm.isUnicodePatternSyntaxCodePoint;
const isUnicodeDefaultIgnorableCodePoint = shared_vm.isUnicodeDefaultIgnorableCodePoint;
const isUnicodeEmojiComponentCodePoint = shared_vm.isUnicodeEmojiComponentCodePoint;
const isUnicodeEmojiCodePoint = shared_vm.isUnicodeEmojiCodePoint;
const isUnicodeExtendedPictographicCodePoint = shared_vm.isUnicodeExtendedPictographicCodePoint;
const isUnicodeAlphabeticCodePoint = shared_vm.isUnicodeAlphabeticCodePoint;
const isUnicodeCaseIgnorableCodePoint = shared_vm.isUnicodeCaseIgnorableCodePoint;
const isUnicodeChangesWhenCasemappedCodePoint = shared_vm.isUnicodeChangesWhenCasemappedCodePoint;
const isUnicodeChangesWhenCasefoldedCodePoint = shared_vm.isUnicodeChangesWhenCasefoldedCodePoint;
const isUnicodeChangesWhenLowercasedCodePoint = shared_vm.isUnicodeChangesWhenLowercasedCodePoint;
const isUnicodeChangesWhenTitlecasedCodePoint = shared_vm.isUnicodeChangesWhenTitlecasedCodePoint;
const isUnicodeChangesWhenUppercasedCodePoint = shared_vm.isUnicodeChangesWhenUppercasedCodePoint;
const isUnicodeChangesWhenNfkcCasefoldedCodePoint = shared_vm.isUnicodeChangesWhenNfkcCasefoldedCodePoint;
const isUnicodeGraphemeExtendCodePoint = shared_vm.isUnicodeGraphemeExtendCodePoint;
const isUnicodeEmojiModifierBaseCodePoint = shared_vm.isUnicodeEmojiModifierBaseCodePoint;
const isUnicodeEmojiPresentationCodePoint = shared_vm.isUnicodeEmojiPresentationCodePoint;
const isUnicodeExtenderCodePoint = shared_vm.isUnicodeExtenderCodePoint;
const isUnicodeMathCodePoint = shared_vm.isUnicodeMathCodePoint;
const isUnicodeIdeographicCodePoint = shared_vm.isUnicodeIdeographicCodePoint;
const isUnicodeUnifiedIdeographCodePoint = shared_vm.isUnicodeUnifiedIdeographCodePoint;
