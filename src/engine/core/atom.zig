...
pub const predefined_atoms = [_]PredefinedAtom{
    ...
    .{ .id = 594, .name = "Test262Error" },
    .{ .id = 595, .name = "verifyProperty" },
    .{ .id = 596, .name = "verifyCallableProperty" },
    .{ .id = 597, .name = "verifyNotWritable" },
    .{ .id = 598, .name = "verifyNotEnumerable" },
    .{ .id = 599, .name = "verifyConfigurable" },
    .{ .id = 600, .name = "isConstructor" },
    .{ .id = 601, .name = "trimLeft" },
    .{ .id = 602, .name = "trimRight" },
    .{ .id = 603, .name = "__primitive" },
    .{ .id = 604, .name = "toPrimitive" },
    .{ .id = 605, .name = "species" },
    .{ .id = 606, .name = "iterator" },
    .{ .id = 607, .name = "toStringTag" },
    .{ .id = 608, .name = "isConcatSpreadable" },
    .{ .id = 609, .name = "hasInstance" },
    .{ .id = 610, .name = "unscopables" },
    .{ .id = 611, .name = "asyncIterator" },
    .{ .id = 612, .name = "asyncDispose" },
    .{ .id = 613, .name = "dispose" },
    .{ .id = 614, .name = "toGMTString" },
    .{ .id = 615, .name = "ignoreCase" },
    .{ .id = 616, .name = "multiline" },
    .{ .id = 617, .name = "dotAll" },
    .{ .id = 618, .name = "sticky" },
    .{ .id = 619, .name = "hasIndices" },
    .{ .id = 620, .name = "unicodeSets" },
    .{ .id = 621, .name = "stackTraceLimit" },
    .{ .id = 622, .name = "__zjs_collection_method_owner" },
    .{ .id = 623, .name = "byteLength" },
    .{ .id = 624, .name = "detached" },
    .{ .id = 625, .name = "resizable" },
    .{ .id = 626, .name = "growable" },
    .{ .id = 627, .name = "BYTES_PER_ELEMENT" },
    .{ .id = 628, .name = "buffer" },
    .{ .id = 629, .name = "byteOffset" },
    .{ .id = 630, .name = "Infinity" },
    .{ .id = 631, .name = "$262" },
    .{ .id = 632, .name = "assert" },
