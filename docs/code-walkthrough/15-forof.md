...
### `forInIsArraySlot` (`src/exec/iterator_ops.zig:45`)
...
### `forInInProtoChainSlot` (`src/exec/iterator_ops.zig:50`)
...
### `createForInIterator` (`src/exec/iterator_ops.zig:58`)
...
### `forInFastArrayCount` (`src/exec/iterator_ops.zig:112`)
...
### `forInSnapshotOwnStringKeys` (`src/exec/iterator_ops.zig:143`)
...
### `forInOwnKeyIsEnumerable` (`src/exec/iterator_ops.zig:181`)
...
### `forInDefineVisited` (`src/exec/iterator_ops.zig:205`)
...
### `forInHasEnumerableStringKey` (`src/exec/iterator_ops.zig:218`)
...
### `iteratorCatchMarker` (`src/exec/iterator_ops.zig:262`)
...
### `iteratorCatchMarkerPreviousTarget` (`src/exec/iterator_ops.zig:272`)
...
### `asyncIteratorCatchMarker` (`src/exec/iterator_ops.zig:279`)
...
### `isAsyncIteratorCatchMarker` (`src/exec/iterator_ops.zig:283`)
...
### `isIteratorCatchMarker` (`src/exec/iterator_ops.zig:287`)
...
### `closeStackTopForOfIteratorForPendingError` (`src/exec/iterator_ops.zig:307`)
...
### `closeIteratorForAbruptCompletion` (`src/exec/iterator_ops.zig:347`)
...
### `findTopClosableForOfRecordIndexBefore` (`src/exec/iterator_ops.zig:364`)
...
### `isForOfRecordAt` (`src/exec/iterator_ops.zig:378`)
...
### `abandonForOfIteratorAtIndex` (`src/exec/iterator_ops.zig:387`)
...
### `abandonForOfIteratorAtDepth` (`src/exec/iterator_ops.zig:396`)
...
### `hasCatchMarkerAboveForOfRecord` (`src/exec/iterator_ops.zig:404`)
...
### `closeIteratorFromVm` (`src/exec/iterator_ops.zig:415`)
...
### `closeIteratorFromVmImpl` (`src/exec/iterator_ops.zig:424`)
