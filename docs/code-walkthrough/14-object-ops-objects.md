...
### `objectGetPrototypeOfStep` (`src/exec/object_ops.zig:1748`)
...
### `objectGetPrototypeOfValue` (`src/exec/object_ops.zig:1789`)
...
### `destructuringObjectRest` (`src/exec/object_ops.zig:1801`)
...
### `objectRestOwnKeys` (`src/exec/object_ops.zig:1869`)
...
### `objectRestOwnPropertyDescriptor` (`src/exec/object_ops.zig:1922`)
...
### `objectRestKeyExcluded` (`src/exec/object_ops.zig:1932`)
...
### `atomicsBufferObject` (`src/exec/object_ops.zig:1940`)
...
### `importMetaObject` (`src/exec/object_ops.zig:1945`)
...
### `createGeneratorObject` (`src/exec/object_ops.zig:1971`)
...
### `generatorObjectPrototype` (`src/exec/object_ops.zig:2112`)
...
### `iteratorPrototypeAccessor` (`src/exec/object_ops.zig:2121`)
...
### `iteratorPrototypeAccessorSet` (`src/exec/object_ops.zig:2136`)
...
### `iteratorPrototypeMethodCall` (`src/exec/object_ops.zig:2149`)
...
### `iteratorIsOnIteratorPrototypeChain` (`src/exec/object_ops.zig:2171`)
...
### `wrapForValidIteratorPrototype` (`src/exec/object_ops.zig:2182`)
...
### `tagIteratorWrapPrototypeMethod` (`src/exec/object_ops.zig:2198`)
...
### `iteratorPrototypeFromGlobal` (`src/exec/object_ops.zig:2207`)
...
### `iteratorPrototype` (`src/exec/object_ops.zig:2211`)
...
### `argumentsPropertyTemplate` (`src/exec/object_ops.zig:2215`)
...
### `createMappedArgumentsObject` (`src/exec/object_ops.zig:2232`)
...
### `argumentsIteratorValueOwned` (`src/exec/object_ops.zig:2277`)
...
### `createArgumentsObject` (`src/exec/object_ops.zig:2297`)
...
### `installFunctionPrototypeThrowTypeErrorAccessors` (`src/exec/object_ops.zig:2349`)
...
### `isThrowTypeErrorIntrinsicObject` (`src/exec/object_ops.zig:2356`)
...
### `frameArgumentsObjectForSpecialObject` (`src/exec/object_ops.zig:2360`)
...
### `functionObjectFromValue` (`src/exec/object_ops.zig:2372`)
...
### `plainBytecodeFunctionObjectFromValue` (`src/exec/object_ops.zig:2387`)
...
### `callableObjectFromValue` (`src/exec/object_ops.zig:2400`)
