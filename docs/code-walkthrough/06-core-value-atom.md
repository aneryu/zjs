...
### `DynamicAtom.isLive` (`src/core/atom.zig:1068`)
...
### `DynamicAtom.slotOccupied` (`src/core/atom.zig:1072`)
...
### `atomHashSeed` (`src/core/atom.zig:1118`)
...
### `spellingHash` (`src/core/atom.zig:1129`)
...
### `AtomTable.traceRoots` (`src/core/atom.zig:1296`)
...
### `AtomTable.traceYoungSymbolBodies` (`src/core/atom.zig:1305`)
...
### `AtomTable.youngListAllocator` (`src/core/atom.zig:1315`)
...
### `AtomTable.retireYoungSymbolBodies` (`src/core/atom.zig:1323`)
...
### `AtomTable.init` (`src/core/atom.zig:1327`)
...
### `AtomTable.deinit` (`src/core/atom.zig:1331`)
...
### `AtomTable.releaseCachedStrings` (`src/core/atom.zig:1359`)
...
### `AtomTable.releaseValueSymbolBodiesAfterGc` (`src/core/atom.zig:1387`)
...
### `AtomTable.hashNextPtr` (`src/core/atom.zig:1398`)
...
### `AtomTable.storedHash` (`src/core/atom.zig:1406`)
...
### `AtomTable.initAtomHash` (`src/core/atom.zig:1417`)
...
### `AtomTable.ensureAtomHash` (`src/core/atom.zig:1435`)
...
### `AtomTable.resizeAtomHash` (`src/core/atom.zig:1442`)
...
### `AtomTable.findAtom` (`src/core/atom.zig:1468`)
...
### `AtomTable.chainInsert` (`src/core/atom.zig:1498`)
...
### `AtomTable.chainUnlink` (`src/core/atom.zig:1514`)
...
### `AtomTable.internString` (`src/core/atom.zig:1537`)
...
### `AtomTable.internStringInner` (`src/core/atom.zig:1543`)
...
### `AtomTable.newSymbol` (`src/core/atom.zig:1560`)
...
### `AtomTable.newValueSymbol` (`src/core/atom.zig:1565`)
...
### `AtomTable.newValueSymbolNoDescription` (`src/core/atom.zig:1569`)
...
### `AtomTable.internSymbol` (`src/core/atom.zig:1573`)
...
### `AtomTable.internGlobalSymbol` (`src/core/atom.zig:1577`)
...
### `AtomTable.internGlobalSymbolInner` (`src/core/atom.zig:1583`)
...
### `AtomTable.internRegisteredValueSymbol` (`src/core/atom.zig:1595`)
...
### `AtomTable.internRegisteredValueSymbolInner` (`src/core/atom.zig:1601`)
...
### `AtomTable.isRegisteredSymbol` (`src/core/atom.zig:1617`)
...
### `AtomTable.traceEpoch` (`src/core/atom.zig:1634`)
...
### `AtomTable.markAtomAtEpoch` (`src/core/atom.zig:1648`)
...
### `AtomTable.atomEdgeBodyWithoutStamp` (`src/core/atom.zig:1662`)
...
### `AtomTable.atomEdge` (`src/core/atom.zig:1668`)
...
### `AtomTable.shadeAtomIfMarking` (`src/core/atom.zig:1710`)
...
### `AtomTable.shadeAtomBarrierSlow` (`src/core/atom.zig:1718`)
...
### `AtomTable.restampTraceEpoch` (`src/core/atom.zig:1739`)
...
### `AtomTable.stampBirthEpoch` (`src/core/atom.zig:1753`)
...
### `AtomTable.noteCompileScope` (`src/core/atom.zig:1764`)
...
### `AtomTable.pinForHost` (`src/core/atom.zig:1773`)
...
### `AtomTable.unpinForHost` (`src/core/atom.zig:1779`)
...
### `AtomTable.sweepDead` (`src/core/atom.zig:1796`)
...
### `AtomTable.noteHolderStore` (`src/core/atom.zig:1854`)
...
### `AtomTable.name` (`src/core/atom.zig:1860`)
...
### `AtomTable.atomIsArrayIndex` (`src/core/atom.zig:1886`)
...
### `AtomTable.kind` (`src/core/atom.zig:1907`)
...
### `AtomTable.isPublicSymbol` (`src/core/atom.zig:1917`)
...
### `AtomTable.cachedPushValue` (`src/core/atom.zig:1942`)
...
### `AtomTable.toStringValueForPush` (`src/core/atom.zig:1959`)
...
### `AtomTable.toStringValue` (`src/core/atom.zig:1964`)
...
### `AtomTable.cachedString` (`src/core/atom.zig:2031`)
...
### `AtomTable.cacheString` (`src/core/atom.zig:2046`)
...
### `AtomTable.symbolValue` (`src/core/atom.zig:2076`)
...
### `AtomTable.takeSymbolValue` (`src/core/atom.zig:2086`)
...
### `AtomTable.symbolValueIfLive` (`src/core/atom.zig:2091`)
...
### `AtomTable.retainSymbolWeakRef` (`src/core/atom.zig:2096`)
...
### `AtomTable.releaseSymbolWeakRef` (`src/core/atom.zig:2104`)
...
### `AtomTable.symbolDescription` (`src/core/atom.zig:2119`)
...
### `AtomTable.bodyLiveForCurrentPhase` (`src/core/atom.zig:2148`)
...
### `AtomTable.symbolBodyIfLive` (`src/core/atom.zig:2153`)
...
### `AtomTable.ensureSymbolBody` (`src/core/atom.zig:2175`)
...
### `AtomTable.internDynamic` (`src/core/atom.zig:2210`)
...
### `AtomTable.internDynamicInner` (`src/core/atom.zig:2216`)
...
### `AtomTable.mightBePrivate` (`src/core/atom.zig:2281`)
...
### `AtomTable.appendEntry` (`src/core/atom.zig:2286`)
...
### `AtomTable.indexEntry` (`src/core/atom.zig:2311`)
...
### `AtomTable.unindexEntry` (`src/core/atom.zig:2320`)
...
### `AtomTable.finalizeDeadEntry` (`src/core/atom.zig:2328`)
...
### `AtomTable.releaseQuarantinedSlots` (`src/core/atom.zig:2372`)
...
### `AtomTable.findDynamic` (`src/core/atom.zig:2386`)
...
### `AtomTable.findDynamicConst` (`src/core/atom.zig:2392`)
...
### `AtomTable.onSymbolBodyDead` (`src/core/atom.zig:2404`)
...
### `CompileAtomScope.init` (`src/core/atom.zig:2473`)
...
### `CompileAtomScope.traceRootsThunk` (`src/core/atom.zig:2482`)
...
### `CompileAtomScope.provider` (`src/core/atom.zig:2487`)
...
### `CompileAtomScope.activate` (`src/core/atom.zig:2493`)
...
### `CompileAtomScope.deinit` (`src/core/atom.zig:2506`)
...
### `CompileAtomScope.note` (`src/core/atom.zig:2527`)
...
### `CompileAtomScope.intern` (`src/core/atom.zig:2545`)
...
### `CompileAtomScope.noteExisting` (`src/core/atom.zig:2553`)
...
### `callVisitAtom` (`src/core/atom.zig:2563`)
...
### `dynamicEntryIndex` (`src/core/atom.zig:2576`)
...
### `isConst` (`src/core/atom.zig:2581`)
...
### `isTaggedInt` (`src/core/atom.zig:2585`)
...
### `atomFromUInt32` (`src/core/atom.zig:2589`)
...
### `atomToUInt32` (`src/core/atom.zig:2594`)
...
### `predefinedName` (`src/core/atom.zig:2604`)
...
### `predefinedById` (`src/core/atom.zig:2609`)
...
### `predefinedId` (`src/core/atom.zig:2614`)
...
### `parseArrayIndex` (`src/core/atom.zig:2624`)
...
### `parseHighArrayIndex` (`src/core/atom.zig:2647`)
...
### `atomListContains` (`src/core/atom.zig:2664`)
...
### `appendAtom` (`src/core/atom.zig:2671`)
...
- **所有权 / 错误 / 调用**：分配失败保留旧列表。旧存储须由该 runtime.memory 管理；不去重、不注册根或执行 atom store barrier，n 次逐项追加可能累计 O(n²) 复制。`appendOwnedAtom` 现在是本函数的别名（`pub const appendOwnedAtom = appendAtom;`），exec 侧的 owned 命名调用点行为完全相同。

### `freeAtomList` (`src/core/atom.zig:2681`)
...
- 清单函数数: 104（`src/core/atom.zig` 101 + `src/core/symbol.zig` 3）
- 本文标题覆盖: 104
- 未覆盖: 无
