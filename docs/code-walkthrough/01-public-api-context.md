...
### `createWithOptionsImpl` (`src/js_context.zig:105`)
...
### `createWithOptionsMeasured` (`src/js_context.zig:119`)
...
### `JSContext.createWithOptions` (`src/js_context.zig:142`)
...
### `JSContext.init` (`src/js_context.zig:146`)
...
### `JSContext.deinit` (`src/js_context.zig:150`)
...
### `JSContext.destroy` (`src/js_context.zig:155`)
...
### `JSContext.runtimePtr` (`src/js_context.zig:163`)
...
### `JSContext.createValueHandle` (`src/js_context.zig:167`)
...
### `JSContext.takeValueHandle` (`src/js_context.zig:171`)
...
### `JSContext.hasException` (`src/js_context.zig:175`)
...
### `JSContext.takeException` (`src/js_context.zig:179`)
...
### `JSContext.clearException` (`src/js_context.zig:183`)
...
### `JSContext.throwValue` (`src/js_context.zig:187`)
...
### `JSContext.recordUnhandledRejection` (`src/js_context.zig:191`)
...
### `JSContext.recordUnhandledPromiseRejection` (`src/js_context.zig:195`)
...
### `JSContext.hasUnhandledRejection` (`src/js_context.zig:199`)
...
### `JSContext.takeUnhandledRejection` (`src/js_context.zig:203`)
...
### `JSContext.clearUnhandledRejection` (`src/js_context.zig:207`)
...
### `JSContext.classPrototypeSlotCount` (`src/js_context.zig:211`)
...
### `JSContext.takePendingException` (`src/js_context.zig:215`)
...
### `JSContext.pushBacktraceFrame` (`src/js_context.zig:219`)
...
### `JSContext.pushBacktraceFrameWithResolver` (`src/js_context.zig:229`)
...
### `JSContext.popBacktraceFrame` (`src/js_context.zig:241`)
...
### `JSContext.updateBacktracePc` (`src/js_context.zig:245`)
...
### `JSContext.borrowBacktracePc` (`src/js_context.zig:249`)
...
### `JSContext.updateBacktraceLocation` (`src/js_context.zig:253`)
...
### `JSContext.defineDataProperty` (`src/js_context.zig:257`)
...
### `JSContext.arrayBuffer` (`src/js_context.zig:274`)
...
### `JSContext.setStackLimit` (`src/js_context.zig:278`)
...
### `JSContext.stackLimit` (`src/js_context.zig:282`)
...
### `JSContext.setTrackUnhandledRejections` (`src/js_context.zig:286`)
...
### `JSContext.tracksUnhandledRejections` (`src/js_context.zig:290`)
...
### `JSContext.setPreserveUncaughtException` (`src/js_context.zig:294`)
...
### `JSContext.preservesUncaughtException` (`src/js_context.zig:298`)
...
### `JSContext.setHostEventLoop` (`src/js_context.zig:302`)
...
### `JSContext.clearHostEventLoop` (`src/js_context.zig:306`)
...
### `JSContext.hostEventLoop` (`src/js_context.zig:310`)
...
### `JSContext.globalObject` (`src/js_context.zig:315`)
...
### `JSContext.createObject` (`src/js_context.zig:320`)
...
### `JSContext.createString` (`src/js_context.zig:325`)
...
### `JSContext.getPropertyAtom` (`src/js_context.zig:337`)
...
### `JSContext.getProperty` (`src/js_context.zig:342`)
...
### `JSContext.getPropertyKey` (`src/js_context.zig:351`)
...
### `JSContext.deleteProperty` (`src/js_context.zig:360`)
...
### `JSContext.deletePropertyKey` (`src/js_context.zig:369`)
...
### `JSContext.hasOwnProperty` (`src/js_context.zig:378`)
...
### `JSContext.hasOwnPropertyKey` (`src/js_context.zig:387`)
...
### `JSContext.ownPropertyDescriptor` (`src/js_context.zig:396`)
...
### `JSContext.toString` (`src/js_context.zig:405`)
...
### `JSContext.toOwnedUtf8` (`src/js_context.zig:410`)
...
### `JSContext.toNumber` (`src/js_context.zig:416`)
...
### `JSContext.toIntegerOrInfinity` (`src/js_context.zig:424`)
...
### `JSContext.isCallable` (`src/js_context.zig:431`)
...
### `JSContext.isConstructor` (`src/js_context.zig:436`)
...
### `JSContext.functionName` (`src/js_context.zig:443`)
...
### `JSContext.callFunction` (`src/js_context.zig:450`)
...
### `JSContext.createError` (`src/js_context.zig:472`)
...
### `JSContext.throwError` (`src/js_context.zig:478`)
...
### `JSContext.pendingExceptionMatchesErrorName` (`src/js_context.zig:484`)
...
### `JSContext.consumePendingExceptionIfErrorName` (`src/js_context.zig:489`)
...
### `JSContext.runtimeErrorMatchesErrorName` (`src/js_context.zig:496`)
...
### `JSContext.createRealm` (`src/js_context.zig:505`)
...
### `JSContext.realmGlobal` (`src/js_context.zig:509`)
...
### `JSContext.realmGlobalObject` (`src/js_context.zig:513`)
...
### `JSContext.isArray` (`src/js_context.zig:518`)
...
### `JSContext.arrayLength` (`src/js_context.zig:524`)
...
### `JSContext.getIndex` (`src/js_context.zig:530`)
...
### `JSContext.hasOwnPropertyAtom` (`src/js_context.zig:534`)
...
### `JSContext.deletePropertyAtom` (`src/js_context.zig:538`)
...
### `JSContext.ownPropertyDescriptorAtom` (`src/js_context.zig:544`)
...
### `JSContext.retainSharedArrayBuffer` (`src/js_context.zig:557`)
...
### `JSContext.sharedArrayBufferFromRef` (`src/js_context.zig:569`)
...
### `JSContext.functionRealmGlobal` (`src/js_context.zig:583`)
...
### `JSContext.restoreUncaughtOutOfMemory` (`src/js_context.zig:601`)
...
### `JSContext.evalScriptSource` (`src/js_context.zig:608`)
...
### `JSContext.evalScriptValue` (`src/js_context.zig:618`)
...
### `JSContext.eval` (`src/js_context.zig:628`)
...
### `JSContext.runJobs` (`src/js_context.zig:634`)
...
### `JSContext.defineFunction` (`src/js_context.zig:644`)
...
### `JSContext.createFunction` (`src/js_context.zig:660`)
...
### `JSContext.formatException` (`src/js_context.zig:787`)
...
### `JSContext.formatExceptionStack` (`src/js_context.zig:820`)
...
### `getPropertyString` (`src/js_context.zig:833`)
...
### `arrayObjectFromValue` (`src/js_context.zig:843`)
...
### `CallSite.init` (`src/js_context.zig:891`)
...
### `CallSite.deinit` (`src/js_context.zig:900`)
