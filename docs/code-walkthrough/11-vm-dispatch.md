...
### `evIsEval` (`src/exec/tailcall_dispatch.zig:643`)

- **签名**：`inline fn evIsEval(vm: *Vm) bool`。
- **作用**：`isEvalCode` 别名。
- **实现**：单条 `return isEvalCode(vm)`，`inline` 别名，展开后不产生额外代码。
- **所有权 / 错误 / 调用**：错误：无。所有权：无——私有 `inline` 别名，原样转调 `isEvalCode`。调用：**没有真实调用方**：全仓唯一引用是本文件 `:7566` 的 `_ = &evIsEval;`（保活占位，防未使用私有声明报错）。

### `op_invalid` (`src/exec/tailcall_dispatch.zig:651`)
...
### `callSetupRecover` (`src/exec/tailcall_dispatch.zig:678`)
...
### `constructorSetupRecover` (`src/exec/tailcall_dispatch.zig:698`)
...
### `constructorRegionRecover` (`src/exec/tailcall_dispatch.zig:722`)
...
### `iteratorNextCallSetupRecover` (`src/exec/tailcall_dispatch.zig:731`)
...
### `attachApplyForwardNativeCaller` (`src/exec/tailcall_dispatch.zig:757`)
...
### `enterEntry` (`src/exec/tailcall_dispatch.zig:767`)
...
### `pollRetreatedCallRegion` (`src/exec/tailcall_dispatch.zig:822`)
...
### `pollRetreatedCallRegionCold` (`src/exec/tailcall_dispatch.zig:836`)
...
### `pushAndEnter` (`src/exec/tailcall_dispatch.zig:851`)
...
### `pushApplyForwardEntry` (`src/exec/tailcall_dispatch.zig:874`)
...
### `applyForwardCallMethod` (`src/exec/tailcall_dispatch.zig:895`)
...
### `pushWarmEmptyLeafAndEnter` (`src/exec/tailcall_dispatch.zig:938`)
...
### `pushWarmExactArgsLeafAndEnter` (`src/exec/tailcall_dispatch.zig:955`)
...
### `pushEmptyLeafMiss` (`src/exec/tailcall_dispatch.zig:979`)
...
### `pushWarmOutlineExactArgsLeafAndEnter` (`src/exec/tailcall_dispatch.zig:988`)
...
### `pushEmptyLeafAndEnter` (`src/exec/tailcall_dispatch.zig:1004`)
...
### `pushExactArgsLeafAndEnter` (`src/exec/tailcall_dispatch.zig:1020`)
...
### `pushWarmCaptureLeafAndEnter` (`src/exec/tailcall_dispatch.zig:1036`)
...
### `pushWarmOutlineCaptureLeafAndEnter` (`src/exec/tailcall_dispatch.zig:1049`)
...
### `pushCaptureLeafAndEnter` (`src/exec/tailcall_dispatch.zig:1065`)
...
### `pollCallEntryCold` (`src/exec/tailcall_dispatch.zig:1083`)
...
### `pushMovedAndEnter` (`src/exec/tailcall_dispatch.zig:1095`)
...
### `pushBorrowedIteratorAndEnter` (`src/exec/tailcall_dispatch.zig:1127`)
...
### `pushForwardedCallEntry` (`src/exec/tailcall_dispatch.zig:1183`)
...
### `pushForwardedApplyEntry` (`src/exec/tailcall_dispatch.zig:1201`)
...
### `resolveForwardedTarget` (`src/exec/tailcall_dispatch.zig:1229`)
...
### `growForwardedWindow` (`src/exec/tailcall_dispatch.zig:1240`)
...
### `finishForwardedEntry` (`src/exec/tailcall_dispatch.zig:1248`)
...
### `completeProxyGetContinuation` (`src/exec/tailcall_dispatch.zig:1309`)
...
### `op_post_call_continuation` (`src/exec/tailcall_dispatch.zig:1375`)
...
### `completeForOfNextContinuation` (`src/exec/tailcall_dispatch.zig:1445`)
...
### `loadValueAsIntPair` (`src/exec/tailcall_dispatch.zig:1480`)
...
### `loadValueAsSplitPair` (`src/exec/tailcall_dispatch.zig:1498`)
...
### `storeValueAsIntPair` (`src/exec/tailcall_dispatch.zig:1521`)
...
### `popAndResume` (`src/exec/tailcall_dispatch.zig:1531`)
...
### `op_return_slow` (`src/exec/tailcall_dispatch.zig:1750`)
...
### `returnLeanTail` (`src/exec/tailcall_dispatch.zig:1867`)
...
### `op_return_general` (`src/exec/tailcall_dispatch.zig:1877`)
...
### `op_return_undef_general` (`src/exec/tailcall_dispatch.zig:1885`)
...
### `op_return` (`src/exec/tailcall_dispatch.zig:1891`)
...
### `op_return_depth0` (`src/exec/tailcall_dispatch.zig:1921`)
...
### `op_return_undef` (`src/exec/tailcall_dispatch.zig:1930`)
...
### `op_return_undef_depth0` (`src/exec/tailcall_dispatch.zig:1946`)
...
### `opCall` (`src/exec/tailcall_dispatch.zig:1961`)
...
### `opCall.h` (`src/exec/tailcall_dispatch.zig:1967`)
...
### `enterNoSuspendAsync` (`src/exec/tailcall_dispatch.zig:2162`)
...
### `opAsyncCall` (`src/exec/tailcall_dispatch.zig:2194`)
...
### `h` (`src/exec/tailcall_dispatch.zig:2196`)
...
### `op_async_call_method` (`src/exec/tailcall_dispatch.zig:2220`)
...
### `op_apply` (`src/exec/tailcall_dispatch.zig:2253`)
...
### `op_call_method` (`src/exec/tailcall_dispatch.zig:2322`)
...
### `pushDerivedConstructorEntry` (`src/exec/tailcall_dispatch.zig:2536`)
...
### `pushSpreadDerivedConstructorEntry` (`src/exec/tailcall_dispatch.zig:2575`)
...
### `enterSameMachineSpreadConstructor` (`src/exec/tailcall_dispatch.zig:2617`)
...
### `op_call_constructor` (`src/exec/tailcall_dispatch.zig:2691`)
...
### `op_for_of_next` (`src/exec/tailcall_dispatch.zig:2870`)
...
### `op_tail_call` (`src/exec/tailcall_dispatch.zig:2970`)
...
### `op_eval` (`src/exec/tailcall_dispatch.zig:2994`)
...
### `op_drop_fast` (`src/exec/tailcall_dispatch.zig:3033`)
...
### `op_drop` (`src/exec/tailcall_dispatch.zig:3049`)
...
### `op_throw` (`src/exec/tailcall_dispatch.zig:3059`)
...
### `op_throw_error` (`src/exec/tailcall_dispatch.zig:3065`)
...
### `h_initial_yield.b` (`src/exec/tailcall_dispatch.zig:3073`)
...
### `h_yield.b` (`src/exec/tailcall_dispatch.zig:3082`)
...
### `h_yield_star.b` (`src/exec/tailcall_dispatch.zig:3091`)
...
### `h_await.b` (`src/exec/tailcall_dispatch.zig:3100`)
...
### `opBinary` (`src/exec/tailcall_dispatch.zig:3147`)
...
### `opBinary.hnd` (`src/exec/tailcall_dispatch.zig:3150`)
...
### `opBinaryFloat` (`src/exec/tailcall_dispatch.zig:3247`)
...
### `hnd` (`src/exec/tailcall_dispatch.zig:3249`)
...
### `op_add_strings` (`src/exec/tailcall_dispatch.zig:3285`)
...
### `cont` (`src/exec/tailcall_dispatch.zig:3309`)
...
### `opLoc` (`src/exec/tailcall_dispatch.zig:3321`)
...
### `opLoc.h` (`src/exec/tailcall_dispatch.zig:3324`)
...
### `opLocCheck` (`src/exec/tailcall_dispatch.zig:3375`)
...
### `h` (`src/exec/tailcall_dispatch.zig:3378`)
...
### `op_set_loc_uninitialized` (`src/exec/tailcall_dispatch.zig:3412`)
...
### `op_put_loc_check_init` (`src/exec/tailcall_dispatch.zig:3423`)
...
### `opGetVarRef` (`src/exec/tailcall_dispatch.zig:3436`)
...
### `opGetVarRef.h` (`src/exec/tailcall_dispatch.zig:3442`)
...
### `opPutVarRef` (`src/exec/tailcall_dispatch.zig:3495`)
...
### `op_put_var_ref_check` (`src/exec/tailcall_dispatch.zig:3534`)
...
### `opSetVarRef` (`src/exec/tailcall_dispatch.zig:3561`)
...
### `op_push_i32` (`src/exec/tailcall_dispatch.zig:3588`)
...
### `op_push_const` (`src/exec/tailcall_dispatch.zig:3598`)
...
### `op_push_const8` (`src/exec/tailcall_dispatch.zig:3605`)
...
### `opFclosure` (`src/exec/tailcall_dispatch.zig:3620`)
...
### `op_push_atom_value` (`src/exec/tailcall_dispatch.zig:3652`)
...
### `op_special_object` (`src/exec/tailcall_dispatch.zig:3676`)
...
### `op_special_arguments` (`src/exec/tailcall_dispatch.zig:3690`)
...
### `op_push_this` (`src/exec/tailcall_dispatch.zig:3725`)
...
### `op_undefined_fast` (`src/exec/tailcall_dispatch.zig:3757`)
...
### `op_null_fast` (`src/exec/tailcall_dispatch.zig:3762`)
...
### `op_push_false_fast` (`src/exec/tailcall_dispatch.zig:3767`)
...
### `op_push_true_fast` (`src/exec/tailcall_dispatch.zig:3772`)
...
### `op_push_i16` (`src/exec/tailcall_dispatch.zig:3777`)
...
### `op_push_i8` (`src/exec/tailcall_dispatch.zig:3781`)
...
### `op_push_small` (`src/exec/tailcall_dispatch.zig:3787`)
...
### `op_get_arg` (`src/exec/tailcall_dispatch.zig:3813`)
...
### `getArgShort` (`src/exec/tailcall_dispatch.zig:3821`)
...
### `op_get_arg0_fast` (`src/exec/tailcall_dispatch.zig:3833`)
...
### `op_get_arg1_fast` (`src/exec/tailcall_dispatch.zig:3837`)
...
### `op_get_arg2_fast` (`src/exec/tailcall_dispatch.zig:3841`)
...
### `op_get_arg3_fast` (`src/exec/tailcall_dispatch.zig:3845`)
...
### `opArgStore` (`src/exec/tailcall_dispatch.zig:3857`)
...
### `opArgStore.h` (`src/exec/tailcall_dispatch.zig:3859`)
...
### `op_get_field_primitive` (`src/exec/tailcall_dispatch.zig:3913`)
...
### `op_get_loc0_field` (`src/exec/tailcall_dispatch.zig:3927`)
...
### `op_get_loc0_field_cold` (`src/exec/tailcall_dispatch.zig:3934`)
...
### `op_get_loc2_field` (`src/exec/tailcall_dispatch.zig:3941`)
...
### `op_get_loc2_field_cold` (`src/exec/tailcall_dispatch.zig:3946`)
...
### `op_get_field2_call_method` (`src/exec/tailcall_dispatch.zig:3955`)
...
### `op_get_field2_call_method_cold` (`src/exec/tailcall_dispatch.zig:3996`)
...
### `op_get_field_property_tail` (`src/exec/tailcall_dispatch.zig:4002`)
...
### `op_get_field_after_own_miss_tail` (`src/exec/tailcall_dispatch.zig:4048`)
...
### `op_get_field_absent_tail` (`src/exec/tailcall_dispatch.zig:4098`)
...
### `op_get_field_native_getter_tail` (`src/exec/tailcall_dispatch.zig:4112`)
...
### `op_prop_site_indirect_tail` (`src/exec/tailcall_dispatch.zig:4172`)
...
### `op_prop_site_capture_tail` (`src/exec/tailcall_dispatch.zig:4225`)
...
### `op_get_field_typed_property_tail` (`src/exec/tailcall_dispatch.zig:4247`)
...
### `op_get_field` (`src/exec/tailcall_dispatch.zig:4272`)
...
### `op_get_field2_primitive` (`src/exec/tailcall_dispatch.zig:4350`)
...
### `op_get_field2` (`src/exec/tailcall_dispatch.zig:4377`)
...
### `op_put_array_el_ta` (`src/exec/tailcall_dispatch.zig:4459`)
...
### `op_put_array_el` (`src/exec/tailcall_dispatch.zig:4497`)
...
### `op_put_array_el_cold` (`src/exec/tailcall_dispatch.zig:4570`)
...
### `op_put_field` (`src/exec/tailcall_dispatch.zig:4663`)
...
### `op_put_field_add_tail` (`src/exec/tailcall_dispatch.zig:4737`)
...
### `op_get_array_el_atom_key` (`src/exec/tailcall_dispatch.zig:4756`)
...
### `op_get_property_cached_getter` (`src/exec/tailcall_dispatch.zig:4782`)
...
### `op_get_array_el_atom_key_getter` (`src/exec/tailcall_dispatch.zig:4833`)
...
### `op_get_field_cached_getter` (`src/exec/tailcall_dispatch.zig:4837`)
...
### `op_get_static_cached_proxy` (`src/exec/tailcall_dispatch.zig:4841`)
...
### `tryInlineProxyTrap` (`src/exec/tailcall_dispatch.zig:4876`)
...
### `op_get_array_el_atom_key_proxy` (`src/exec/tailcall_dispatch.zig:4920`)
...
### `op_get_array_el_ta` (`src/exec/tailcall_dispatch.zig:4962`)
...
### `op_get_array_el` (`src/exec/tailcall_dispatch.zig:4993`)
...
### `op_get_array_el2` (`src/exec/tailcall_dispatch.zig:5065`)
...
### `op_get_length` (`src/exec/tailcall_dispatch.zig:5086`)
...
### `op_get_length_property_tail` (`src/exec/tailcall_dispatch.zig:5135`)
...
### `op_object` (`src/exec/tailcall_dispatch.zig:5173`)
...
### `op_object_slots2` (`src/exec/tailcall_dispatch.zig:5185`)
...
### `op_define_field` (`src/exec/tailcall_dispatch.zig:5206`)
...
### `op_array_from` (`src/exec/tailcall_dispatch.zig:5230`)
...
### `opCompare` (`src/exec/tailcall_dispatch.zig:5266`)
...
### `opCompare.h` (`src/exec/tailcall_dispatch.zig:5269`)
...
### `opCompareEq` (`src/exec/tailcall_dispatch.zig:5332`)
...
### `hnd` (`src/exec/tailcall_dispatch.zig:5334`)
...
### `opCompareEqFast` (`src/exec/tailcall_dispatch.zig:5429`)
...
### `hnd` (`src/exec/tailcall_dispatch.zig:5431`)
...
### `compareEqExport` (`src/exec/tailcall_dispatch.zig:5507`)
...
### `compareEqFramedExport` (`src/exec/tailcall_dispatch.zig:5517`)
...
### `zjs_cmp_eq_mixed` (`src/exec/tailcall_dispatch.zig:5527`)
...
### `zjs_cmp_neq_mixed` (`src/exec/tailcall_dispatch.zig:5530`)
...
### `zjs_cmp_strict_eq_mixed` (`src/exec/tailcall_dispatch.zig:5533`)
...
### `zjs_cmp_strict_neq_mixed` (`src/exec/tailcall_dispatch.zig:5536`)
...
### `zjs_cmp_eq_framed` (`src/exec/tailcall_dispatch.zig:5540`)
...
### `zjs_cmp_neq_framed` (`src/exec/tailcall_dispatch.zig:5543`)
...
### `zjs_cmp_strict_eq_framed` (`src/exec/tailcall_dispatch.zig:5546`)
...
### `zjs_cmp_strict_neq_framed` (`src/exec/tailcall_dispatch.zig:5549`)
...
### `op_mod_cold` (`src/exec/tailcall_dispatch.zig:5558`)
...
### `op_div_cold` (`src/exec/tailcall_dispatch.zig:5581`)
...
### `logicOperandInt32` (`src/exec/tailcall_dispatch.zig:5605`)
...
### `opLogicCold` (`src/exec/tailcall_dispatch.zig:5638`)
...
### `opCompareCold` (`src/exec/tailcall_dispatch.zig:5689`)
...
### `hnd` (`src/exec/tailcall_dispatch.zig:5691`)
...
### `op_instanceof_lookup_error` (`src/exec/tailcall_dispatch.zig:5725`)
...
### `transformInternalCallResult` (`src/exec/tailcall_dispatch.zig:5742`)
...
### `recoverOwnedInternalCallRegion` (`src/exec/tailcall_dispatch.zig:5755`)
...
### `dispatchInternalNativeMethod` (`src/exec/tailcall_dispatch.zig:5779`)
...
### `dispatchInternalNativeMethodSlow` (`src/exec/tailcall_dispatch.zig:5805`)
...
### `pushInternalMethodAndEnter` (`src/exec/tailcall_dispatch.zig:5838`)
...
### `internalMethodRemainderHandler` (`src/exec/tailcall_dispatch.zig:5861`)
...
### `hnd` (`src/exec/tailcall_dispatch.zig:5867`)
...
### `InternalMethodBoundary.toBooleanOne` (`src/exec/tailcall_dispatch.zig:5918`)
...
### `completeOrdinaryInstanceof` (`src/exec/tailcall_dispatch.zig:5929`)
...
### `completeInstanceofSlow` (`src/exec/tailcall_dispatch.zig:5951`)
...
### `tryFastDefaultInstanceof` (`src/exec/tailcall_dispatch.zig:5973`)
...
### `op_instanceof_published` (`src/exec/tailcall_dispatch.zig:6019`)
...
### `op_instanceof` (`src/exec/tailcall_dispatch.zig:6084`)
...
### `op_neg` (`src/exec/tailcall_dispatch.zig:6110`)
...
### `op_inc_dec` (`src/exec/tailcall_dispatch.zig:6139`)
...
### `op_post_inc_dec` (`src/exec/tailcall_dispatch.zig:6156`)
...
### `op_dup` (`src/exec/tailcall_dispatch.zig:6168`)
...
### `op_insert2` (`src/exec/tailcall_dispatch.zig:6182`)
...
### `op_insert3` (`src/exec/tailcall_dispatch.zig:6193`)
...
### `op_perm3` (`src/exec/tailcall_dispatch.zig:6205`)
...
### `op_swap` (`src/exec/tailcall_dispatch.zig:6218`)
...
### `jump8Target` (`src/exec/tailcall_dispatch.zig:6232`)
...
### `op_goto8` (`src/exec/tailcall_dispatch.zig:6239`)
...
### `jump16Target` (`src/exec/tailcall_dispatch.zig:6254`)
...
### `op_goto16` (`src/exec/tailcall_dispatch.zig:6264`)
...
### `op_goto` (`src/exec/tailcall_dispatch.zig:6273`)
...
### `op_if_false8` (`src/exec/tailcall_dispatch.zig:6288`)
...
### `op_if_false8_complex` (`src/exec/tailcall_dispatch.zig:6323`)
...
### `op_if_true8` (`src/exec/tailcall_dispatch.zig:6334`)
...
### `jump32Target` (`src/exec/tailcall_dispatch.zig:6359`)
...
### `op_if_false` (`src/exec/tailcall_dispatch.zig:6373`)
...
### `op_cmp_if_false8` (`src/exec/tailcall_dispatch.zig:6397`)
...
### `op_eq_if_false8` (`src/exec/tailcall_dispatch.zig:6418`)
...
### `op_eq_if_false8_cold` (`src/exec/tailcall_dispatch.zig:6425`)
...
### `op_cmp_if_false8_cold` (`src/exec/tailcall_dispatch.zig:6447`)
...
### `op_is_null` (`src/exec/tailcall_dispatch.zig:6481`)
...
### `op_lnot` (`src/exec/tailcall_dispatch.zig:6520`)
...
### `op_update_loc` (`src/exec/tailcall_dispatch.zig:6541`)
...
### `op_put_loc8_get_loc8` (`src/exec/tailcall_dispatch.zig:6565`)
...
### `op_put_loc8_get_loc8_cold` (`src/exec/tailcall_dispatch.zig:6572`)
...
### `op_push_this_put_loc0` (`src/exec/tailcall_dispatch.zig:6580`)
...
### `storeThisInLoc0` (`src/exec/tailcall_dispatch.zig:6587`)
...
### `op_push_this_put_loc0_cold` (`src/exec/tailcall_dispatch.zig:6605`)
...
### `op_update_loc_cold` (`src/exec/tailcall_dispatch.zig:6619`)
...
### `op_add_loc` (`src/exec/tailcall_dispatch.zig:6639`)
...
### `op_add_loc_cold` (`src/exec/tailcall_dispatch.zig:6681`)
...
### `getVarGlobalOwnDataInline` (`src/exec/tailcall_dispatch.zig:6748`)
...
### `op_get_var` (`src/exec/tailcall_dispatch.zig:6781`)
...
### `op_put_var` (`src/exec/tailcall_dispatch.zig:6845`)
...
### `pushExactArgsLeafMiss` (`src/exec/tailcall_dispatch.zig:6925`)
...
### `warmExactArgsLeafOutline` (`src/exec/tailcall_dispatch.zig:6941`)
...
### `pushCaptureLeafMiss` (`src/exec/tailcall_dispatch.zig:6956`)
...
### `warmCaptureLeafOutline` (`src/exec/tailcall_dispatch.zig:6971`)
...
### `pushBorrowedIteratorMiss` (`src/exec/tailcall_dispatch.zig:6991`)
...
### `reloadTop` (`src/exec/tailcall_dispatch.zig:7045`)
...
### `reloadAfterPop` (`src/exec/tailcall_dispatch.zig:7063`)
...
### `runDispatchLoop` (`src/exec/tailcall_dispatch.zig:7105`)
...
### `runDispatchLoopPublished` (`src/exec/tailcall_dispatch.zig:7116`)
...
### `driveReturnedContinuation` (`src/exec/tailcall_dispatch.zig:7147`)
...
### `driveTailRequest` (`src/exec/tailcall_dispatch.zig:7189`)
...
### `op_using` (`src/exec/tailcall_dispatch.zig:7251`)
...
### `op_using_is_undefined` (`src/exec/tailcall_dispatch.zig:7262`)
...
### `op_using_typeof_is_undefined` (`src/exec/tailcall_dispatch.zig:7272`)
...
### `op_using_typeof_is_function` (`src/exec/tailcall_dispatch.zig:7279`)
...
### `op_get_field_field2` (`src/exec/tailcall_dispatch.zig:7289`)
...
### `op_get_field_field2_cold` (`src/exec/tailcall_dispatch.zig:7348`)
...
### `op_get_var_field` (`src/exec/tailcall_dispatch.zig:7355`)
...
### `op_get_var_field_cold` (`src/exec/tailcall_dispatch.zig:7372`)
...
### `op_get_loc2_field2` (`src/exec/tailcall_dispatch.zig:7384`)
...
### `op_get_loc2_field2_cold` (`src/exec/tailcall_dispatch.zig:7389`)
...
### `op_push_0_or` (`src/exec/tailcall_dispatch.zig:7396`)
...
### `op_push_0_or_cold` (`src/exec/tailcall_dispatch.zig:7401`)
...
- **所有权 / 错误 / 调用**：错误：本体不产生错误——它 `publish` 后自己压 int32 `0`、`setTopPtr(sp+1)`、`frame.pc += 1`，然后 `coldNext`（唯一的错误边是 `coldNext` 自己的 `InvalidBytecode`）。 所有权：立即数是非引用计数裸值。⚠️注意这条 `frame.pc += 1`：`push_0_or` 是 1 字节、残留的 `or` 就在 `pc+1`，而 `publish` 写回的 `frame.pc` 已经等于 `pc+1`（它写的是「操作数游标」），再 `+1` 会让 `coldNext` 落到 `or` 之后——同族的 `op_push_0_shr_cold` 就没有这一步。两者不可能都对，见报告的源码侧疑点。 调用：只装在 `cold_table`——`tailcall_dispatch_colds.zig:809` 在 `if (!fast) return`（:818）之前赋值，`dispatch_table` 的同一格随后被 `op_push_0_or` 覆盖（:960）。进入路径是快臂 miss 的 `cold_table[pc[0]]` 间接尾调用，以及 L0 停机 seam 下 `next`/`coldNext` 直接选中。

### `op_sar_get_array_el` (`src/exec/tailcall_dispatch.zig:7410`)
...
### `op_sar_get_array_el_cold` (`src/exec/tailcall_dispatch.zig:7417`)
...
### `op_push_2_sar` (`src/exec/tailcall_dispatch.zig:7426`)
...
### `op_push_2_sar_cold` (`src/exec/tailcall_dispatch.zig:7433`)
...
- **实现**：先 `publish(pc,sp)` 把寄存器写回 Frame/Stack，outlined helper 才能看见活窗口。 关键调用：`publish`、`coldNext`。 栈效应：+1。 下一跳：冷续跑：`coldNext`（`maybeStop` 后走 `active_dispatch_tbl`）。
- **所有权 / 错误 / 调用**：错误：本体不产生错误（publish + 压 int32 `2` + `coldNext`）。所有权：同 `op_push_0_or_cold`。 调用：只装在 `cold_table`——`tailcall_dispatch_colds.zig:811` 在 `if (!fast) return`（:818）之前赋值，`dispatch_table` 的同一格随后被 `op_push_2_sar` 覆盖（:962）。进入路径是快臂 miss 的 `cold_table[pc[0]]` 间接尾调用，以及 L0 停机 seam 下 `next`/`coldNext` 直接选中。

### `tailPush2` (`src/exec/tailcall_dispatch.zig:7449`)
...
### `op_get_loc8_push_2` (`src/exec/tailcall_dispatch.zig:7462`)
...
### `op_get_loc8_push_2_cold` (`src/exec/tailcall_dispatch.zig:7467`)
...
### `op_push_0_shr` (`src/exec/tailcall_dispatch.zig:7474`)
...
### `op_push_0_shr_cold` (`src/exec/tailcall_dispatch.zig:7479`)
...
### `op_get_loc8_push_1` (`src/exec/tailcall_dispatch.zig:7487`)
...
### `op_get_loc8_push_1_cold` (`src/exec/tailcall_dispatch.zig:7492`)
...
### `tailGetLoc8` (`src/exec/tailcall_dispatch.zig:7501`)
...
### `op_get_var_ref0_get_loc8` (`src/exec/tailcall_dispatch.zig:7515`)
...
### `op_get_var_ref0_get_loc8_cold` (`src/exec/tailcall_dispatch.zig:7525`)
...
### `op_push_i8_add` (`src/exec/tailcall_dispatch.zig:7532`)
...
### `op_push_i8_add_cold` (`src/exec/tailcall_dispatch.zig:7537`)
...
### `op_get_loc8_push_i8` (`src/exec/tailcall_dispatch.zig:7546`)
...
### `op_get_loc8_push_i8_cold` (`src/exec/tailcall_dispatch.zig:7553`)
