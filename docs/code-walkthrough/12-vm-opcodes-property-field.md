...
### `fastArrayLengthValue` (`src/exec/vm_property_field.zig:278`)
...
### `debugAssertNonPrivateFieldOperandAtom` (`src/exec/vm_property_field.zig:300`)
...
### `getFieldFastSlotWithExoticOrder` (`src/exec/vm_property_field.zig:307`)
...
### `namedAtomUsesOrdinaryWalkOnIndexExotic` (`src/exec/vm_property_field.zig:440`)
...
### `getFieldFastSlotOrAbsent` (`src/exec/vm_property_field.zig:457`)
...
### `ordinaryAccessorGetterAfterOwnMiss` (`src/exec/vm_property_field.zig:482`)
...
### `getFieldFastSlotOrAbsentAfterOwnMiss` (`src/exec/vm_property_field.zig:495`)
...
### `getFieldFastSlotAfterNonAuthoritativeLink` (`src/exec/vm_property_field.zig:551`)
...
### `getFieldFast` (`src/exec/vm_property_field.zig:569`)
...
### `getLengthFieldFast` (`src/exec/vm_property_field.zig:580`)
...
### `primitivePrototypeDataPropertyValueForFastPath` (`src/exec/vm_property_field.zig:592`)
...
### `primitivePrototypeObjectForFastPath` (`src/exec/vm_property_field.zig:609`)
...
### `typedArrayAccessorMethodId` (`src/exec/vm_property_field.zig:640`)
...
### `isTypedArrayPayloadAtomForFastPath` (`src/exec/vm_property_field.zig:648`)
...
### `typedArrayNativeAccessorIdMatches` (`src/exec/vm_property_field.zig:652`)
...
### `typedArrayIntrinsicNamedValue` (`src/exec/vm_property_field.zig:657`)
...
### `typedArrayShapePropertyForFastPath` (`src/exec/vm_property_field.zig:677`)
...
### `typedArrayPrototypeNamedPropertyForFastPath` (`src/exec/vm_property_field.zig:701`)
...
### `typedArrayNamedPropertyForFastPath` (`src/exec/vm_property_field.zig:726`)
...
### `typedArrayReceiverForFastPath` (`src/exec/vm_property_field.zig:746`)
...
### `typedArrayPropertyValueForFastPath` (`src/exec/vm_property_field.zig:756`)
...
### `getLengthActionForFastPath` (`src/exec/vm_property_field.zig:771`)
...
### `primitivePrototypePropertyForFastPath` (`src/exec/vm_property_field.zig:799`)
...
### `atomPropertyValueForFastPath` (`src/exec/vm_property_field.zig:826`)
...
### `existingPropertyKeyValueForFastPath` (`src/exec/vm_property_field.zig:855`)
...
### `existingPropertyKeyAtomForFastPath` (`src/exec/vm_property_field.zig:879`)
...
### `putFieldFastSlot` (`src/exec/vm_property_field.zig:906`)
...
### `replaceTopBorrowed` (`src/exec/vm_property_field.zig:921`)
...
### `replaceTopOwned` (`src/exec/vm_property_field.zig:931`)
...
### `setArrayLengthForPutFieldFastPath` (`src/exec/vm_property_field.zig:941`)
...
### `putArrayElementAfterFastMiss` (`src/exec/vm_property_field.zig:974`)
...
### `getArrayElement` (`src/exec/vm_property_field.zig:1052`)
...
### `readTypedArrayIndexFast` (`src/exec/vm_property_field.zig:1195`)
...
### `fastTypedArrayElementValue` (`src/exec/vm_property_field.zig:1210`)
...
### `putTypedArrayElementFast` (`src/exec/vm_property_field.zig:1236`)
...
### `storeElementBytes` (`src/exec/vm_property_field.zig:1302`)
...
### `fastPrototypeMethodValue` (`src/exec/vm_property_field.zig:1318`)
...
### `fastRegExpPrototypeMethodValue` (`src/exec/vm_property_field.zig:1354`)
...
### `fastCollectionPrototypeMethodValue` (`src/exec/vm_property_field.zig:1358`)
...
### `fastStringIndexValue` (`src/exec/vm_property_field.zig:1362`)
...
### `stackValueFromTop` (`src/exec/vm_property_field.zig:1376`)
...
### `noPropSite` (`src/exec/vm_property_field.zig:1415`)
...
### `noPropSiteBase` (`src/exec/vm_property_field.zig:1419`)
...
### `siteCapturable` (`src/exec/vm_property_field.zig:1429`)
...
### `retireSite` (`src/exec/vm_property_field.zig:1433`)
...
### `noteSiteMiss` (`src/exec/vm_property_field.zig:1442`)
...
### `slotIndexOf` (`src/exec/vm_property_field.zig:1454`)
...
### `siteCacheableReceiverClass` (`src/exec/vm_property_field.zig:1471`)
...
### `isNativeGetterValue` (`src/exec/vm_property_field.zig:1501`)
...
### `captureFieldSite` (`src/exec/vm_property_field.zig:1520`)
...
### `capturePutSite` (`src/exec/vm_property_field.zig:1596`)
