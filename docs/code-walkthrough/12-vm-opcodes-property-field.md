...
### `PoppedWindow` (`src/exec/vm_property_field.zig:24`)
...
### `PoppedWindow.activate` (`src/exec/vm_property_field.zig:30`)
...
### `PoppedWindow.deactivate` (`src/exec/vm_property_field.zig:38`)
...
### `toPropKey` (`src/exec/vm_property_field.zig:59`)
...
### `toPropKeyVm` (`src/exec/vm_property_field.zig:72`)
...
### `setName` (`src/exec/vm_property_field.zig:88`)
...
### `inOrInstanceof` (`src/exec/vm_property_field.zig:124`)
...
### `field` (`src/exec/vm_property_field.zig:145`)
...
### `fastArrayLengthValue` (`src/exec/vm_property_field.zig:282`)
...
### `debugAssertNonPrivateFieldOperandAtom` (`src/exec/vm_property_field.zig:304`)
...
### `getFieldFastSlotWithExoticOrder` (`src/exec/vm_property_field.zig:311`)
...
### `namedAtomUsesOrdinaryWalkOnIndexExotic` (`src/exec/vm_property_field.zig:444`)
...
### `getFieldFastSlotOrAbsent` (`src/exec/vm_property_field.zig:461`)
...
### `ordinaryAccessorGetterAfterOwnMiss` (`src/exec/vm_property_field.zig:486`)
...
### `getFieldFastSlotOrAbsentAfterOwnMiss` (`src/exec/vm_property_field.zig:499`)
...
### `getFieldFastSlotAfterNonAuthoritativeLink` (`src/exec/vm_property_field.zig:555`)
...
### `getFieldFast` (`src/exec/vm_property_field.zig:573`)
...
### `getLengthFieldFast` (`src/exec/vm_property_field.zig:584`)
...
### `primitivePrototypeDataPropertyValueForFastPath` (`src/exec/vm_property_field.zig:596`)
...
### `primitivePrototypeObjectForFastPath` (`src/exec/vm_property_field.zig:613`)
...
- **所有权 / 错误 / 调用**：只做 tag 判读 + 读 realm 缓存槽，不分配、不建根、无 error set；返回的 `*core.Object` 是**借用**的 realm intrinsic prototype，其存活由 `global` 持有，调用方不 retain 也不释放。文件私有，两处调用：`src/exec/vm_property_field.zig:603`（数据属性快路径）与 `:810`（带 getter/proxy 分类的快路径），两处都先过 `rt.atoms.mightBePrivate` 才进来。

### `typedArrayAccessorMethodId` (`src/exec/vm_property_field.zig:644`)
...
### `isTypedArrayPayloadAtomForFastPath` (`src/exec/vm_property_field.zig:652`)
...
### `typedArrayNativeAccessorIdMatches` (`src/exec/vm_property_field.zig:656`)
...
### `typedArrayIntrinsicNamedValue` (`src/exec/vm_property_field.zig:661`)
...
### `typedArrayShapePropertyForFastPath` (`src/exec/vm_property_field.zig:681`)
...
### `typedArrayNamedPropertyForFastPath` (`src/exec/vm_property_field.zig:730`)
...
### `typedArrayReceiverForFastPath` (`src/exec/vm_property_field.zig:750`)
...
### `typedArrayPropertyValueForFastPath` (`src/exec/vm_property_field.zig:760`)
...
### `getLengthActionForFastPath` (`src/exec/vm_property_field.zig:775`)
...
### `primitivePrototypePropertyForFastPath` (`src/exec/vm_property_field.zig:803`)
...
### `atomPropertyValueForFastPath` (`src/exec/vm_property_field.zig:830`)
...
### `existingPropertyKeyValueForFastPath` (`src/exec/vm_property_field.zig:859`)
...
### `existingPropertyKeyAtomForFastPath` (`src/exec/vm_property_field.zig:883`)
...
### `putFieldFastSlot` (`src/exec/vm_property_field.zig:910`)
...
### `replaceTopBorrowed` (`src/exec/vm_property_field.zig:925`)
...
### `replaceTopOwned` (`src/exec/vm_property_field.zig:935`)
...
### `setArrayLengthForPutFieldFastPath` (`src/exec/vm_property_field.zig:945`)
...
### `putArrayElementAfterFastMiss` (`src/exec/vm_property_field.zig:978`)
...
### `getArrayElement` (`src/exec/vm_property_field.zig:1056`)
...
### `readTypedArrayIndexFast` (`src/exec/vm_property_field.zig:1199`)
...
### `fastTypedArrayElementValue` (`src/exec/vm_property_field.zig:1214`)
...
### `putTypedArrayElementFast` (`src/exec/vm_property_field.zig:1240`)
...
### `storeElementBytes` (`src/exec/vm_property_field.zig:1306`)
...
### `fastPrototypeMethodValue` (`src/exec/vm_property_field.zig:1322`)
...
### `fastRegExpPrototypeMethodValue` (`src/exec/vm_property_field.zig:1358`)
...
### `fastCollectionPrototypeMethodValue` (`src/exec/vm_property_field.zig:1362`)
...
### `fastStringIndexValue` (`src/exec/vm_property_field.zig:1366`)
...
### `stackValueFromTop` (`src/exec/vm_property_field.zig:1380`)
...
### `noPropSite` (`src/exec/vm_property_field.zig:1419`)
...
### `noPropSiteBase` (`src/exec/vm_property_field.zig:1423`)
...
### `siteCapturable` (`src/exec/vm_property_field.zig:1433`)
...
### `retireSite` (`src/exec/vm_property_field.zig:1437`)
...
### `noteSiteMiss` (`src/exec/vm_property_field.zig:1446`)
...
### `slotIndexOf` (`src/exec/vm_property_field.zig:1458`)
...
### `siteCacheableReceiverClass` (`src/exec/vm_property_field.zig:1475`)
...
### `isNativeGetterValue` (`src/exec/vm_property_field.zig:1505`)
...
### `captureFieldSite` (`src/exec/vm_property_field.zig:1524`)
...
### `capturePutSite` (`src/exec/vm_property_field.zig:1600`)
