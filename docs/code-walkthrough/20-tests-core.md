...
`tests/core.zig` 覆盖 shape/属性、tracing GC、FinalizationRegistry、弱集合与跨模块运行时合同。叶子合同（atom 表、string 布局、MemoryAccount、VmStackArena、array_list_erased、heap/kernel BigInt、Object handle/payload、shape 注册表、Runtime init-deinit）已回到对应生产文件。多数用例直接操 Runtime，而不是 `eval` 一整段脚本。 源文件 `tests/core.zig`（16294 行，447 个 `test` 块）。

## `tests/core.zig`

`tests/core.zig` 覆盖 shape/属性、tracing GC、FinalizationRegistry、弱集合与跨模块运行时合同。叶子合同（atom 表、string 布局、MemoryAccount、VmStackArena、array_list_erased、heap/kernel BigInt、Object handle/payload、shape 注册表、Runtime init-deinit）已回到对应生产文件。多数用例直接操 Runtime，而不是 `eval` 一整段脚本。
...
### `Probe.trigger` (`tests/core.zig:15`)
...
### `ModuleAutoInitFixture.resolve` (`tests/core.zig:155`)
...
### `publishFreshModule` (`tests/core.zig:184`)
...
### `publishEmptyModule` (`tests/core.zig:194`)
...
### `pointerPayload.get` (`tests/core.zig:283`)
...
### `Counter.visitValue` (`tests/core.zig:855`)
...
### `Counter.visitObject` (`tests/core.zig:860`)
...
### `TestJob.run` (`tests/core.zig:1228`)
...
### `Attempt.run` (`tests/core.zig:1318`)
...
### `Worker.run` (`tests/core.zig:1394`)
...
### `liveRealmCount` (`tests/core.zig:1551`)
...
### `testBacktraceLocationResolver` (`tests/core.zig:1757`)
...
### `appendFinalizationRegistryCell` (`tests/core.zig:1763`)
...
### `borrowedHolderInitialAllocationBytes` (`tests/core.zig:1773`)
...
### `TailBufferForceGcProbe.trigger` (`tests/core.zig:2490`)
...
### `tailBufferText` (`tests/core.zig:2498`)
...
### `countFinalizer` (`tests/core.zig:2904`)
...
### `countNativeCleanup` (`tests/core.zig:2908`)
...
### `countPayloadFinalizer` (`tests/core.zig:2913`)
...
### `countPayloadMark` (`tests/core.zig:2918`)
...
### `countVisitedValue` (`tests/core.zig:2928`)
...
### `ClassConstructionUnregisterProbe.trigger` (`tests/core.zig:2946`)
...
### `ClassConstructionGrowthProbe.trigger` (`tests/core.zig:2962`)
...
### `accountedPlainObjectBytes` (`tests/core.zig:2974`)
...
### `emptyRootShapeAllocationBytes` (`tests/core.zig:2982`)
...
### `ObjectConstructionOrderProbe.trigger` (`tests/core.zig:2997`)
...
### `InlineClassFinalizerReentry.reset` (`tests/core.zig:3031`)
...
### `InlineClassFinalizerReentry.finalize` (`tests/core.zig:3046`)
...
### `InlineObjectLifecycleProbe.reset` (`tests/core.zig:3078`)
...
### `InlineObjectLifecycleProbe.finalize` (`tests/core.zig:3089`)
...
### `SideAuthorityDestroyProbe.reset` (`tests/core.zig:3108`)
...
### `SideAuthorityDestroyProbe.finalize` (`tests/core.zig:3114`)
...
### `registerStandaloneInlineObjectTestClass` (`tests/core.zig:3128`)
...
### `expectPublishedStandaloneInlineObject` (`tests/core.zig:3148`)
...
### `countYoungHeader` (`tests/core.zig:3181`)
...
### `ExternalObjectLifecycleProbe.reset` (`tests/core.zig:3204`)
...
### `ExternalObjectLifecycleProbe.finalize` (`tests/core.zig:3213`)
...
### `ExternalClassFinalizerReentry.reset` (`tests/core.zig:3242`)
...
### `ExternalClassFinalizerReentry.finalize` (`tests/core.zig:3251`)
...
### `createExternalObjectLifecycleProbe` (`tests/core.zig:3268`)
...
### `finalizeTestExternalPayload` (`tests/core.zig:3280`)
...
### `finalizeTestExternalObjectPayload` (`tests/core.zig:3289`)
...
### `reentrantCollectionClearFinalizer` (`tests/core.zig:3298`)
...
### `reentrantArrayDeleteFinalizer` (`tests/core.zig:3308`)
...
### `reentrantPropertyDeleteFinalizer` (`tests/core.zig:3318`)
...
### `reentrantRegExpLastIndexFinalizer` (`tests/core.zig:3328`)
...
### `reentrantMappedArgumentsFinalizer` (`tests/core.zig:3338`)
...
### `reentrantCachedIteratorNextFinalizer` (`tests/core.zig:3352`)
...
### `reentrantExceptionSlotFinalizer` (`tests/core.zig:3362`)
...
### `reentrantArrayIteratorFinalizer` (`tests/core.zig:3372`)
...
### `markTestExternalPayload` (`tests/core.zig:3382`)
...
### `markTestExternalObjectPayload` (`tests/core.zig:3394`)
...
### `registryResolveOne` (`tests/core.zig:3770`)
...
### `Probe.visit` (`tests/core.zig:3773`)
...
### `Probe.visit` (`tests/core.zig:3840`)
...
### `TestJob.run` (`tests/core.zig:5037`)
...
### `Counter.visitValue` (`tests/core.zig:5047`)
...
### `Counter.visitObject` (`tests/core.zig:5054`)
...
### `Rewriter.visitValue` (`tests/core.zig:5089`)
...
### `Rewriter.visitObject` (`tests/core.zig:5096`)
...
### `Rewriter.visitValue` (`tests/core.zig:5132`)
...
### `Rewriter.visitObject` (`tests/core.zig:5139`)
...
### `DefineFieldForceGcProbe.trigger` (`tests/core.zig:6458`)
...
### `Rewriter.visitValue` (`tests/core.zig:7462`)
...
### `Rewriter.visitObject` (`tests/core.zig:7475`)
...
### `Local.storeYoungChild` (`tests/core.zig:7936`)
...
### `Probe.visitArena` (`tests/core.zig:8345`)
...
### `Probe.visitBlock` (`tests/core.zig:8349`)
...
### `Visitor.visitValue` (`tests/core.zig:8482`)
...
### `Visitor.visitValue` (`tests/core.zig:8514`)
...
### `Visitor.visitValue` (`tests/core.zig:8552`)
...
### `createDeepOwnedPropertyChain` (`tests/core.zig:8580`)
...
### `externalPropertyStorageBytes` (`tests/core.zig:8652`)
...
### `expectNoLiveGc` (`tests/core.zig:8659`)
...
### `expectCycleReclaimedIncludingShapes` (`tests/core.zig:8664`)
...
### `expectAllLiveGcReclaimed` (`tests/core.zig:8674`)
...
### `expectClosedPropertyCycleReclaimed` (`tests/core.zig:8686`)
...
### `TraceEdges.recordHeader` (`tests/core.zig:8735`)
...
### `TraceEdges.Visitor.visitValue` (`tests/core.zig:8742`)
...
### `TraceEdges.Visitor.visitObject` (`tests/core.zig:8746`)
...
### `TraceEdges.Visitor.visitShape` (`tests/core.zig:8753`)
...
### `TraceEdges.Visitor.visitRealm` (`tests/core.zig:8757`)
...
### `TraceEdges.Visitor.visitModule` (`tests/core.zig:8761`)
...
### `TraceEdges.Visitor.storageCell` (`tests/core.zig:8765`)
...
### `TraceEdges.Visitor.visitWeakCollectionEntry` (`tests/core.zig:8769`)
...
### `TraceEdges.Visitor.visitFinalizationCell` (`tests/core.zig:8771`)
...
### `TraceEdges.collect` (`tests/core.zig:8776`)
...
### `TraceEdges.expectContains` (`tests/core.zig:8827`)
...
### `Shade.shade` (`tests/core.zig:9438`)
...
### `Probe.visit` (`tests/core.zig:9468`)
...
### `weakPersistentCounterCallback` (`tests/core.zig:10399`)
...
### `ForceCollectionProbe.trigger` (`tests/core.zig:11422`)
...
### `interruptOnce` (`tests/core.zig:13509`)
...
### `exoticGet` (`tests/core.zig:13766`)
...
### `exoticDefine` (`tests/core.zig:13770`)
...
### `exoticDelete` (`tests/core.zig:13775`)
...
### `exoticOwnKeys` (`tests/core.zig:13780`)
...
### `referenceSubMul` (`src/libs/bigint.zig:1925`)

- **签名**：`fn referenceSubMul(numerator: []Limb, divisor: []const Limb, qhat: Limb) bool`。
...
- **实现**：每 limb 用 `i128` 显式借位算 `numerator[i] - (limb * qhat) - borrow`，与内核的 fused wrapping 链形状不同。返回下溢旗。
- **所有权 / 错误 / 调用**：无独立 error set；由 `fused multiply-subtract matches the reference limb for limb` 对照 `subMulAt`。
...
### `countExtentStringHeaders` (`tests/core.zig:15883`)
...
### `Probe.visit` (`tests/core.zig:15933`)
...
### `Probe.visit` (`tests/core.zig:15984`)
...
### `atomMarkEpochForTest` (`tests/core.zig:16145`)
...
### `driveOneIncrementalMajorForCensusTest` (`tests/core.zig:17404`)
...
### `s3AtomEntry` (`tests/core.zig:17907`)
...
### `s3MarkEpoch` (`tests/core.zig:17911`)
...
### `s3RunMajor` (`tests/core.zig:17915`)
...
### `s3OccupiedEntryCount` (`tests/core.zig:18076`)
...
### `defineS4bNamedProperties` (`tests/core.zig:18399`)
...
### `expectS4bNamedProperties` (`tests/core.zig:18414`)
...
### `fillS4bDenseArray` (`tests/core.zig:18426`)
...
### `installMintedStringBufferBody` (`tests/core.zig:18473`)
...
### `registerS4cPayloadClass` (`tests/core.zig:18716`)
...
### `lessThan.lessThan` (`tests/core.zig:19222`)
...
### `expectAuditPrintMatchesFmt` (`tests/core.zig:19231`)
...
### `test "dense parameter arrays borrowed construction roots output during storage allocation"` (`tests/core.zig:10`)
...
### `test "dense parameter arrays borrowed construction propagates OOM and recovers"` (`tests/core.zig:51`)
...
### `test "host transports and core operation errors keep independent narrow sets"` (`tests/core.zig:96`)
...
### `test "over-reserved property storage is freed by prop_size not prop_count"` (`tests/core.zig:204`)
...
### `test "M-cut slots2 payload-spill deletion mutant is rejected"` (`tests/core.zig:497`)
...
### `test "plain object destroy slim frees two data slots and the value buffer"` (`tests/core.zig:528`)
...
### `test "proven object release preserves generic JSValue ownership semantics"` (`tests/core.zig:548`)
...
### `test "active bytecode release preserves generic ownership"` (`tests/core.zig:577`)
...
### `test "RealmContext is header-first and RealmRef owns independently of runtime list membership"` (`tests/core.zig:810`)
...
### `test "RealmContext construction stays unpublished and untraced until the live commit"` (`tests/core.zig:839`)
...
### `test "RealmContext owns the five QuickJS initial layouts as Shapes"` (`tests/core.zig:879`)
...
### `test "array target barrier: known append immediately shades the new target"` (`tests/core.zig:915`)
...
### `test "array target barrier: three append routes cover grey and black owners"` (`tests/core.zig:961`)
...
### `test "array target barrier: capacity growth shades only storage and preserves copied edges"` (`tests/core.zig:1018`)
...
### `test "array target barrier: public uninitialized slot still queues its owner"` (`tests/core.zig:1062`)
...
### `test "array target barrier: old array remembers first storage and appended target"` (`tests/core.zig:1088`)
...
### `test "array target barrier: failed capacity allocation leaves count and value unchanged"` (`tests/core.zig:1116`)
...
### `test "array target barrier: frontier OOM fails closed after a committed store"` (`tests/core.zig:1141`)
...
### `test "array target barrier: literal fill marks new edges after owner scanning"` (`tests/core.zig:1183`)
...
### `test "Runtime queues retain their originating Realm until owned jobs are released"` (`tests/core.zig:1220`)
...
### `test "caller-owned ClassIdSlot is process-stable while definitions stay per Runtime"` (`tests/core.zig:1258`)
...
### `test "Runtime owner thread rejects foreign structural mutation before publication"` (`tests/core.zig:1286`)
...
### `test "process-global ClassId allocation is atomic across owner-thread Runtimes"` (`tests/core.zig:1383`)
...
### `test "RealmContext participates in cycle collection through typed RealmRef edges"` (`tests/core.zig:1440`)
...
### `test "FunctionBytecode RealmRef edge participates in realm-global cycle collection"` (`tests/core.zig:1466`)
...
### `test "FinalizationRegistry RealmRef edge participates in realm-global cycle collection"` (`tests/core.zig:1521`)
...
### `test "auto_init slot to another realm retains it across JSContext.destroy and cycle GC"` (`tests/core.zig:1558`)
...
### `test "FinalizationRegistry RealmRef retains and releases its construction realm exactly once"` (`tests/core.zig:1595`)
...
### `test "dynamic class registration reserves slots in live and future realms"` (`tests/core.zig:1614`)
...
### `test "dynamic class prototype capacity and clearing include constructing realms"` (`tests/core.zig:1634`)
...
### `test "runtime-resident indexes outlive a temporary allocator"` (`tests/core.zig:1656`)
...
### `test "context backtrace can borrow VM frame pc lazily"` (`tests/core.zig:1777`)
...
### `test "private brand property owns exactly one stored symbol value across replacement"` (`tests/core.zig:1840`)
...
### `test "ownership audit quarantines every atom slot the last sweep retired"` (`tests/core.zig:1971`)
...
### `test "GC leaves atom-owned unique symbol atoms until release"` (`tests/core.zig:2023`)
...
### `test "GC leaves manually owned unique symbol atoms alone"` (`tests/core.zig:2041`)
...
### `test "GC keeps rooted unique symbol atoms until the root is gone"` (`tests/core.zig:2053`)
...
### `test "GC keeps atom-owned unique symbol atoms until the atom owner releases"` (`tests/core.zig:2070`)
...
### `test "GC keeps runtime exception and realm value slot unique symbol atoms"` (`tests/core.zig:2089`)
...
### `test "GC keeps context lexical object unique symbol atoms"` (`tests/core.zig:2133`)
...
### `test "GC keeps context pending promise job unique symbol atoms until release"` (`tests/core.zig:2156`)
...
### `test "GC keeps finalization job unique symbol atoms after dequeue until release"` (`tests/core.zig:2177`)
...
### `test "GC keeps dequeued finalization job function bytecode symbol constants until release"` (`tests/core.zig:2223`)
...
### `test "GC keeps module registry unique symbol atoms until release"` (`tests/core.zig:2264`)
...
### `test "GC sweeps unique symbol atoms after description string cache"` (`tests/core.zig:2297`)
...
### `test "GC keeps rooted function bytecode symbol constants"` (`tests/core.zig:2315`)
...
### `test "GC keeps object-held and registered symbol atoms"` (`tests/core.zig:2339`)
...
### `test "runtime teardown keeps unique symbol property keys live through shape destruction"` (`tests/core.zig:2369`)
...
### `test "S2-i append chain survives a forced collection at every allocation"` (`tests/core.zig:2615`)
...
### `test "S2-i the concat operator seeds a tail buffer and keeps forks independent"` (`tests/core.zig:2666`)
...
### `test "class table registers QuickJS standard classes and dynamic classes"` (`tests/core.zig:2796`)
...
### `test "class Record default fill matches Record{} without a template"` (`tests/core.zig:2849`)
...
### `test "class prototype inline slots start as JSValue.nullValue"` (`tests/core.zig:2861`)
...
### `test "class standard_plans match standardPayloadKind before and after register"` (`tests/core.zig:2873`)
...
### `test "class registration growth OOM does not publish a partial definition and retry succeeds"` (`tests/core.zig:3406`)
...
### `test "object creation rejects an unregistered dynamic class generation"` (`tests/core.zig:3423`)
...
### `test "class construction pins its definition across reentrant unregister"` (`tests/core.zig:3437`)
...
### `test "class construction scalar plan survives record table growth"` (`tests/core.zig:3472`)
...
### `test "inline class finalizer reentry keeps definition pinned while growing the table"` (`tests/core.zig:3510`)
...
### `test "inline class finalizer observes the live object allocation until callback return"` (`tests/core.zig:3548`)
...
### `test "standalone inline object publication is visible to collector enumeration"` (`tests/core.zig:3593`)
...
### `test "side authority swap-remove condemnation drains every non-block object exactly once"` (`tests/core.zig:3612`)
...
### `test "standalone inline object survives a rooted minor and retires young"` (`tests/core.zig:3673`)
...
### `test "standalone inline object survives a rooted major mark"` (`tests/core.zig:3705`)
...
### `test "single-code-unit string table survives a declared-roots collection"` (`tests/core.zig:3736`)
...
### `test "standalone inline object resolves from a conservative interior candidate"` (`tests/core.zig:3783`)
...
### `test "standalone inline object teardown parks its struct free until the drain"` (`tests/core.zig:3853`)
...
### `test "external class finalizers run synchronously with original object identity in zero-ref FIFO order"` (`tests/core.zig:3880`)
...
### `test "array teardown releases its unique prototype before its unique dense element"` (`tests/core.zig:3915`)
...
### `test "weak husk keeps its class definition after one synchronous finalizer"` (`tests/core.zig:3945`)
...
### `test "class finalizers and context prototype slots are wired"` (`tests/core.zig:3987`)
...
### `test "object destruction runs class payload finalizers synchronously without allocation"` (`tests/core.zig:4036`)
...
### `test "strong collection clear publishes empty state before synchronous finalizer reentry"` (`tests/core.zig:4085`)
...
### `test "dense array delete publishes sparse state before synchronous finalizer reentry"` (`tests/core.zig:4124`)
...
### `test "ordinary property delete publishes absence before synchronous finalizer reentry"` (`tests/core.zig:4163`)
...
### `test "IC-R1: in-place delete mutates the shape Property word"` (`tests/core.zig:4204`)
...
### `test "regexp lastIndex set publishes replacement before synchronous finalizer reentry"` (`tests/core.zig:4239`)
...
### `test "regexp lastIndex define publishes replacement before synchronous finalizer reentry"` (`tests/core.zig:4278`)
...
### `test "mapped arguments binding update publishes value before synchronous finalizer reentry"` (`tests/core.zig:4321`)
...
### `test "mapped arguments var-ref update publishes value before synchronous finalizer reentry"` (`tests/core.zig:4366`)
...
### `test "mapped arguments binding delete publishes disconnection before synchronous finalizer reentry"` (`tests/core.zig:4410`)
...
### `test "cached iterator next clear publishes null before synchronous finalizer reentry"` (`tests/core.zig:4459`)
...
### `test "exception slot clear publishes empty state before synchronous finalizer reentry"` (`tests/core.zig:4499`)
...
### `test "array iterator target clear publishes null before synchronous finalizer reentry"` (`tests/core.zig:4531`)
...
### `test "runtime cycle removal follows class payload mark hooks"` (`tests/core.zig:4576`)
...
### `test "synchronous class payload finalizer drains payload-owned zero-ref children before free returns"` (`tests/core.zig:4629`)
...
### `test "synchronous external payload callback pins its generation through reentrant unregister"` (`tests/core.zig:4663`)
...
### `test "runtime cycle removal synchronously finalizes class payload object slots once"` (`tests/core.zig:4704`)
...
### `test "array buffer view list republishes cached typed array count and data"` (`tests/core.zig:4811`)
...
### `test "shared array buffer grow refreshes length-tracking typed array state"` (`tests/core.zig:4856`)
...
### `test "shared buffer store can back wrappers in separate runtimes"` (`tests/core.zig:4871`)
...
### `test "array buffer backing stores report external memory"` (`tests/core.zig:4893`)
...
### `test "ordinary array buffer backing overlaps account and external ledgers"` (`tests/core.zig:4913`)
...
### `test "large shared buffers request a major through external pressure"` (`tests/core.zig:4956`)
...
### `test "runtime root tracer visits async roots"` (`tests/core.zig:5026`)
...
### `test "runtime root frame slots are mutable"` (`tests/core.zig:5070`)
...
### `test "value root buffer exposes mutable copied slice"` (`tests/core.zig:5118`)
...
### `test "generator completion eagerly releases the resident execution owners"` (`tests/core.zig:5425`)
...
### `test "suspended execution preserves and closes open frame var refs"` (`tests/core.zig:5478`)
...
### `test "suspended execution republishes running aliases without a second owner"` (`tests/core.zig:5514`)
...
### `test "native function state uses payload storage"` (`tests/core.zig:5548`)
...
### `test "true C functions own their construction realm while data functions do not"` (`tests/core.zig:5579`)
...
### `test "bytecode function state uses the inline qjs function arm"` (`tests/core.zig:5628`)
...
### `test "module namespace uses shape-only live-binding storage"` (`tests/core.zig:5661`)
...
### `test "trace object shape summary follows append kind delete and compaction"` (`tests/core.zig:5867`)
...
### `test "trace object shape summary base-5 payload decodes all two-slot states"` (`tests/core.zig:5983`)
...
### `test "pure property value replacement preserves a shared shape until flags change"` (`tests/core.zig:6008`)
...
### `test "unique transition shape appends in place across FAM relocation"` (`tests/core.zig:6040`)
...
### `test "first property append OOM restores the no-storage sentinel"` (`tests/core.zig:6083`)
...
### `test "failed new property definition rolls back retained entry"` (`tests/core.zig:6118`)
...
### `test "unique shape append OOM rolls back shape and value storage together"` (`tests/core.zig:6152`)
...
### `test "property compaction removes tombstones without mutating shared sibling shapes"` (`tests/core.zig:6207`)
...
### `test "context lexicals property alias releases context strong reference"` (`tests/core.zig:6265`)
...
### `test "failed auto-init property definition rolls back retained entry"` (`tests/core.zig:6283`)
...
### `test "failed realm auto-init property definition rolls back borrowed holder registration"` (`tests/core.zig:6322`)
...
### `test "property replacement preserves references under memory cap"` (`tests/core.zig:6361`)
...
### `test "definePlainDataPropertyKnownFast refcounted append and duplicate-key replace balance refs"` (`tests/core.zig:6391`)
...
### `test "definePlainDataPropertyKnownFast barriers follow committed slot and shape writes"` (`tests/core.zig:6426`)
...
### `test "definePlainDataPropertyKnownFast refcounted define survives forced GC at every allocation"` (`tests/core.zig:6469`)
...
### `test "definePlainDataPropertyKnownFast OOM sweep leaves refcounted value owned by caller"` (`tests/core.zig:6532`)
...
### `test "object data property self-assignment keeps stored object alive"` (`tests/core.zig:6591`)
...
### `test "json parse data property self-assignment keeps stored object alive"` (`tests/core.zig:6614`)
...
### `test "dense array element self-assignment keeps stored object alive"` (`tests/core.zig:6630`)
...
### `test "owned dense array writes consume values only on success"` (`tests/core.zig:6646`)
...
### `test "prototype replacement clones shared transition shape"` (`tests/core.zig:6667`)
...
### `test "failed prototype replacement preserves prototype and refcounts"` (`tests/core.zig:6689`)
...
### `test "failed object registration destroys initialized object once"` (`tests/core.zig:6717`)
...
### `test "shape transition cache releases chained shapes"` (`tests/core.zig:6742`)
...
### `test "large object property lookup uses shape hash across delete and re-add"` (`tests/core.zig:6768`)
...
### `test "exception slot transfers owned value and clears context slot"` (`tests/core.zig:6796`)
...
### `test "reference dup and free retain until final release"` (`tests/core.zig:6813`)
...
### `test "gc registry tracks live objects and intrusive list state"` (`tests/core.zig:7023`)
...
### `test "runtime exposes stable gc stats snapshot"` (`tests/core.zig:7232`)
...
### `test "gc live heap stats drop when object is released"` (`tests/core.zig:7286`)
...
### `test "external memory token registry audits duplicate releases and leaks"` (`tests/core.zig:7313`)
...
### `test "runtime runs deferred native cleanup jobs with a budget"` (`tests/core.zig:7344`)
...
### `test "std file object destruction defers native close cleanup"` (`tests/core.zig:7373`)
...
### `test "gc callback boundary defers non-urgent major work until idle"` (`tests/core.zig:7406`)
...
### `test "gc callback boundary runs urgent major work"` (`tests/core.zig:7425`)
...
### `test "runtime force major gc runs an urgent major poll"` (`tests/core.zig:7437`)
...
### `test "object child edge tracing exposes mutable value slots"` (`tests/core.zig:7448`)
...
### `test "gc registry debug verifier accepts linked and unlinked list states"` (`tests/core.zig:7490`)
...
### `test "gc heap accounting derives live bytes"` (`tests/core.zig:7504`)
...
### `test "gc heap accounting rejects an orphaned accounted standalone header"` (`tests/core.zig:7520`)
...
### `test "gc heap accounting verifier catches missing allocation entries"` (`tests/core.zig:7558`)
...
### `test "gc heap accounting verifier catches pinned header flag drift"` (`tests/core.zig:7574`)
...
### `test "gc invariant negative: block candidate index audit rejects bloom and exact-set drift"` (`tests/core.zig:7593`)
...
### `test "gc invariant negative: block heap rejects geometry free-chain and doomed-list corruption"` (`tests/core.zig:7620`)
...
### `test "gc invariant negative: block cell publication audit rejects hidden allocations"` (`tests/core.zig:7679`)
...
### `test "gc invariant negative: metadata semantics reject kind carrier and field misuse"` (`tests/core.zig:7710`)
...
### `test "compact trace retained-RC backlinks are authoritative and audited"` (`tests/core.zig:7771`)
...
### `test "trace shape summary: incremental writers track the Shape projection"` (`tests/core.zig:7819`)
...
### `test "trace shape summary: appends preserve the leased remembered bit"` (`tests/core.zig:7913`)
...
### `test "gc invariant negative: representation audit rejects physical carrier and cell index drift"` (`tests/core.zig:7968`)
...
### `test "representation audit cross-checks the remembered object cache and map"` (`tests/core.zig:8027`)
...
### `test "representation audit cross-checks the remembered cache on a non-object carrier"` (`tests/core.zig:8085`)
...
### `test "forget fuses the remembered map removal with its own cache bit"` (`tests/core.zig:8169`)
...
### `test "gc invariant negative: construction root audit rejects published shell state"` (`tests/core.zig:8234`)
...
### `test "gc: a remembered detached generator shell is still a construction root"` (`tests/core.zig:8283`)
...
### `test "gc invariant negative: arena audit rejects an accounted free slab block"` (`tests/core.zig:8335`)
...
### `test "gc invariant negative: address index audit rejects canonical page drift"` (`tests/core.zig:8372`)
...
### `test "gc invariant negative: heap accounting audit rejects a pin without an entry"` (`tests/core.zig:8411`)
...
### `test "gc invariant negative: generation audit rejects census and stale remembered drift"` (`tests/core.zig:8425`)
...
### `test "gc invariant negative: retirement audit rejects a marked young survivor"` (`tests/core.zig:8450`)
...
### `test "object traceChildEdgesFallible propagates visitor errors"` (`tests/core.zig:8471`)
...
### `test "ordinary object trace visits data slots and TMASK accessor edges"` (`tests/core.zig:8491`)
...
### `test "object traceChildEdgesFallible propagates class payload visitor errors"` (`tests/core.zig:8531`)
...
### `test "gc object release paths do not allocate"` (`tests/core.zig:8561`)
...
### `test "zero-ref release drains a deep acyclic object chain iteratively"` (`tests/core.zig:8601`)
...
### `test "cycle scan preserves a deeply rooted object chain without recursion"` (`tests/core.zig:8614`)
...
### `test "closed object property cycle is released by runtime cycle removal"` (`tests/core.zig:8695`)
...
### `test "fast array iterator-next cache cycle is released by runtime cycle removal"` (`tests/core.zig:8712`)
...
### `test "function_bytecode trace edges visit realm and cpool"` (`tests/core.zig:8836`)
...
### `test "var_ref trace edges visit the closed binding value"` (`tests/core.zig:8859`)
...
### `test "realm_context trace edges visit the global object"` (`tests/core.zig:8871`)
...
### `test "module trace edges visit function, namespace, meta and thrown values"` (`tests/core.zig:8885`)
...
### `test "strong Map and Set entry cycles are released by runtime cycle removal"` (`tests/core.zig:8910`)
...
### `test "ordinary error stack and callsite cycles are released by runtime cycle removal"` (`tests/core.zig:8937`)
...
### `test "accessor getter and setter self-cycle is released by runtime cycle removal"` (`tests/core.zig:8957`)
...
### `test "bound function payload self-cycle is released by runtime cycle removal"` (`tests/core.zig:8972`)
...
### `test "arguments payload value-slice cycle is released by runtime cycle removal"` (`tests/core.zig:8991`)
...
### `test "object data self-cycle is released by runtime cycle removal"` (`tests/core.zig:9014`)
...
### `test "fallible GC API reports reclaimed objects and no failure"` (`tests/core.zig:9028`)
...
### `test "trace_stw collects a closed property cycle"` (`tests/core.zig:9049`)
...
### `test "trace_stw ephemeron keeps value only when table and key are live"` (`tests/core.zig:9062`)
...
### `test "trace_stw ephemeron value does not keep its key alive"` (`tests/core.zig:9092`)
...
### `test "trace_stw WeakRef deref keep-alive lasts until job end"` (`tests/core.zig:9117`)
...
### `test "trace_stw WeakRef symbol target dies with its body"` (`tests/core.zig:9151`)
...
### `test "trace_stw FinalizationRegistry symbol target enqueues its cleanup"` (`tests/core.zig:9181`)
...
### `test "trace_stw WeakMap symbol key entry disappears with the symbol"` (`tests/core.zig:9219`)
...
### `test "trace_stw symbol liveness queries follow the mark inside the sweep phase"` (`tests/core.zig:9246`)
...
### `test "trace_stw WeakRef symbol deref keep-alive survives the same job"` (`tests/core.zig:9301`)
...
### `test "trace_stw survivor classes on a known graph"` (`tests/core.zig:9334`)
...
### `test "address registry tracks published objects and interior pointers"` (`tests/core.zig:9380`)
...
### `test "conservative scan shades a stack-held object header word"` (`tests/core.zig:9422`)
...
### `test "carrier protocols keep adjacent one-past roots multi-hit and diagnostics explicit"` (`tests/core.zig:9453`)
...
### `test "address registry page radix covers a multi-page allocation"` (`tests/core.zig:9485`)
...
### `test "address registry lookup cost stays with page occupants not live N"` (`tests/core.zig:9504`)
...
### `test "size-class table pins the measured §4.2 allocation policy"` (`tests/core.zig:9573`)
...
### `test "size-class table matches measured publication histogram"` (`tests/core.zig:9618`)
...
### `test "block heap splits a 2MiB superblock into 64KiB classed blocks"` (`tests/core.zig:9694`)
...
### `test "block heap reserve OOM is visible and not swallowed"` (`tests/core.zig:9739`)
...
### `test "block heap rolls a superblock back when its exact index cannot reserve"` (`tests/core.zig:9748`)
...
### `test "block heap mark epoch lazily clears the mark bitmap"` (`tests/core.zig:9772`)
...
### `test "minor doomed snapshot preserves the active block lifecycle"` (`tests/core.zig:9791`)
...
### `test "trace carrier mark epoch keeps zero unmarked and scrubs before wrap"` (`tests/core.zig:9815`)
...
### `test "block heap nonempty index follows zero-one population transitions"` (`tests/core.zig:9852`)
...
### `test "block heap reopens a swept partial block before reserving a fresh block"` (`tests/core.zig:9881`)
...
### `test "block heap aged decommit reports scans release and recommit"` (`tests/core.zig:9961`)
...
### `test "block heap returns wholly empty medium superblocks and keeps one spare"` (`tests/core.zig:10018`)
...
### `test "process heap trim fires only when a contraction crosses its threshold"` (`tests/core.zig:10084`)
...
### `test "pollGC runs pending collection and clears pending flag"` (`tests/core.zig:10095`)
...
### `test "object allocation drops a stale threshold request after a transient live-byte peak"` (`tests/core.zig:10117`)
...
### `test "object allocation keeps a threshold request while prospective bytes remain over threshold"` (`tests/core.zig:10140`)
...
### `test "stale threshold request cannot mask explicit or pressure major requests"` (`tests/core.zig:10162`)
...
### `test "a pure string loop reaches the allocation-threshold boundary"` (`tests/core.zig:10200`)
...
### `test "a pure rope-concat loop reaches the allocation-threshold boundary"` (`tests/core.zig:10221`)
...
### `test "an unrequested threshold crossing is still serviced at the object boundary"` (`tests/core.zig:10248`)
...
### `test "an unrequested threshold crossing is still serviced at a scheduler poll"` (`tests/core.zig:10269`)
...
### `test "persistent value handle keeps object and nested symbols alive"` (`tests/core.zig:10299`)
...
### `test "handle scope local keeps object alive until scope exits"` (`tests/core.zig:10319`)
...
### `test "handle scope locals do not clear persistent handles created inside scope"` (`tests/core.zig:10343`)
...
### `test "native pin retains direct object and counts nested pins"` (`tests/core.zig:10372`)
...
### `test "weak persistent value rejects non-weak targets"` (`tests/core.zig:10404`)
...
### `test "weak persistent value does not retain direct object target"` (`tests/core.zig:10414`)
...
### `test "weak persistent value clears object cycle target during gc"` (`tests/core.zig:10446`)
...
### `test "weak persistent value clears unrooted symbol target during gc"` (`tests/core.zig:10466`)
...
### `test "function home object cycle is released by runtime cycle removal"` (`tests/core.zig:10492`)
...
### `test "async continuation function cycle is released by runtime cycle removal"` (`tests/core.zig:10506`)
...
### `test "async generator promise cycle is released by runtime cycle removal"` (`tests/core.zig:10524`)
...
### `test "materialized native function cycle is released by runtime cycle removal"` (`tests/core.zig:10542`)
...
### `test "function bytecode constant object cycle is released by runtime cycle removal"` (`tests/core.zig:10580`)
...
### `test "runtime destroy releases callback bytecode before object registries"` (`tests/core.zig:10602`)
...
### `test "runtime destroy releases nested callback bytecode in owner order"` (`tests/core.zig:10614`)
...
### `test "runtime destroy revisits callback bytecode after parent release"` (`tests/core.zig:10633`)
...
### `test "runtime destroy releases cyclic callback bytecode constants"` (`tests/core.zig:10652`)
...
### `test "runtime destroy releases callback bytecode constants with transferred ownership"` (`tests/core.zig:10672`)
...
### `test "bytecode-only callback constant cycle is released by runtime cycle removal"` (`tests/core.zig:10692`)
...
### `test "shared function bytecode constant object cycle is released by runtime cycle removal"` (`tests/core.zig:10714`)
...
### `test "cycle teardown frees bytecode function captures before FB metadata"` (`tests/core.zig:10741`)
...
### `test "nested function bytecode constant object cycle is released by runtime cycle removal"` (`tests/core.zig:10766`)
...
### `test "cyclic internal function bytecode references are released by runtime cycle removal"` (`tests/core.zig:10802`)
...
### `test "class payload function bytecode constant object cycle is released by runtime cycle removal"` (`tests/core.zig:10839`)
...
### `test "realm context owns cached prototype references"` (`tests/core.zig:10880`)
...
### `test "auto-init slot owns its Realm until the property is deleted"` (`tests/core.zig:10906`)
...
### `test "typed MODULE_NS auto-init publishes a normal value or the same VarRef cell"` (`tests/core.zig:10951`)
...
### `test "MODULE_NS auto-init failure retains its slot Realm and retries once per read"` (`tests/core.zig:10992`)
...
### `test "MODULE_NS auto-init reentry cannot overwrite the replacement property"` (`tests/core.zig:11017`)
...
### `test "auto-init slot exposes the typed Realm and module owner edges"` (`tests/core.zig:11045`)
...
### `test "unmaterialized MODULE_NS slot participates in Realm cycle marking"` (`tests/core.zig:11065`)
...
### `test "ordinary and object-data payloads ignore generic realm assignment"` (`tests/core.zig:11091`)
...
### `test "native call carriers do not enter borrowed realm bookkeeping"` (`tests/core.zig:11110`)
...
### `test "generator noncarriers never enter borrowed realm bookkeeping"` (`tests/core.zig:11135`)
...
### `test "leaf payload noncarriers ignore generic realm assignment"` (`tests/core.zig:11157`)
...
### `test "promise weak-ref regexp and typed-array payloads ignore generic realm assignment"` (`tests/core.zig:11196`)
...
### `test "iterator collection and disposable payloads ignore generic realm assignment"` (`tests/core.zig:11225`)
...
### `test "collection iterator prototype follows explicit active realm, never receiver"` (`tests/core.zig:11246`)
...
### `test "weak reference holders use a lifetime intrusive list"` (`tests/core.zig:11305`)
...
### `test "weak collection borrowed holder cache supports reverse teardown"` (`tests/core.zig:11351`)
...
### `test "fresh object prototype rebinding reuses the shared empty root shape"` (`tests/core.zig:11399`)
...
### `test "data to auto-init replacement stays traceable across allocation GC"` (`tests/core.zig:11416`)
...
### `test "data to auto-init replacement rolls back descriptor OOM and retries in same runtime"` (`tests/core.zig:11480`)
...
### `test "replacing auto-init transfers the owned Realm edge"` (`tests/core.zig:11529`)
...
### `test "replacing auto-init rolls back descriptor OOM and retries in same runtime"` (`tests/core.zig:11570`)
...
### `test "deleting auto-init releases its owned Realm edge"` (`tests/core.zig:11621`)
...
### `test "ordinary auto-init replacement releases each owned Realm edge"` (`tests/core.zig:11638`)
...
### `test "specialized auto-init producers retain the same typed Realm owner"` (`tests/core.zig:11687`)
...
### `test "auto-init descriptor interning reuses value-identical metadata"` (`tests/core.zig:11731`)
...
### `test "materialized auto-init true C function owns its construction realm"` (`tests/core.zig:11756`)
...
### `test "dead weak collection key entry is swept when target is destroyed"` (`tests/core.zig:11794`)
...
### `test "dead weak collection key entry is swept without freeing live value"` (`tests/core.zig:11820`)
...
### `test "live weak collection key preserves stored value"` (`tests/core.zig:11841`)
...
### `test "weak ref target identity does not retain object target"` (`tests/core.zig:11865`)
...
### `test "weak ref target registration roots direct symbol target"` (`tests/core.zig:11891`)
...
### `test "weak ref target registration failure leaves target unset"` (`tests/core.zig:11920`)
...
### `test "weak collection capacity failure leaves empty holder unregistered"` (`tests/core.zig:11934`)
...
### `test "weak collection append failure rolls back borrowed holder registration"` (`tests/core.zig:11949`)
...
### `test "weak collection capacity reservation keeps empty holder unregistered"` (`tests/core.zig:11966`)
...
### `test "finalization registry capacity failure leaves empty holder unregistered"` (`tests/core.zig:11978`)
...
### `test "finalization registry append failure rolls back borrowed holder registration"` (`tests/core.zig:11993`)
...
### `test "finalization registry job-queue reserve OOM rolls back the cell"` (`tests/core.zig:12012`)
...
### `test "finalization registry capacity reservation keeps empty holder unregistered"` (`tests/core.zig:12040`)
...
### `test "weak collection delete and clear unregister empty borrowed holder"` (`tests/core.zig:12052`)
...
### `test "finalization registry unregister unregisters empty borrowed holder"` (`tests/core.zig:12079`)
...
### `test "finalization registry unregister handles token equal to target"` (`tests/core.zig:12096`)
...
### `test "finalization registry dead target cleanup tolerates held value reentry"` (`tests/core.zig:12117`)
...
### `test "weak collection delete tolerates value cleanup reentry"` (`tests/core.zig:12158`)
...
### `test "weak collection clear tolerates value cleanup reentry"` (`tests/core.zig:12174`)
...
### `test "weak map deep value chain releases without recursive destruction"` (`tests/core.zig:12193`)
...
### `test "weak map cycle sweep clears index after removing dead keys"` (`tests/core.zig:12220`)
...
### `test "finalization registry dead target releases held value when target is destroyed"` (`tests/core.zig:12277`)
...
### `test "finalization registry live target preserves held value"` (`tests/core.zig:12303`)
...
### `test "finalization registry unregister cannot remove queued cleanup cell"` (`tests/core.zig:12330`)
...
### `test "finalization registry cleanup enqueue does not allocate after registration"` (`tests/core.zig:12382`)
...
### `test "object allocation threshold triggers runtime cycle removal"` (`tests/core.zig:12449`)
...
### `test "object allocation collects reclaimable cycles before memory-limit rejection"` (`tests/core.zig:12478`)
...
### `test "cache-miss root shape is owned before the object allocation GC boundary"` (`tests/core.zig:12515`)
...
### `test "post-shape object OOM rolls back construction owners and retries in the same runtime"` (`tests/core.zig:12556`)
...
### `test "shape reserve OOM does not publish or retain proto"` (`tests/core.zig:12629`)
...
### `test "gc threshold API resets after scheduled collection and survives force-GC instrumentation"` (`tests/core.zig:12655`)
...
### `test "proxy target handler cycle is released by runtime cycle removal"` (`tests/core.zig:12691`)
...
### `test "runtime cycle removal preserves externally rooted outgoing objects"` (`tests/core.zig:12706`)
...
### `test "module namespace shape VarRef cycle is released by runtime cycle removal"` (`tests/core.zig:12734`)
...
### `test "mapped arguments var-ref cycle is released by runtime cycle removal"` (`tests/core.zig:12751`)
...
### `test "array element self-cycle is released by runtime cycle removal"` (`tests/core.zig:12767`)
...
### `test "typed-array buffer self-cycle is released by runtime cycle removal"` (`tests/core.zig:12778`)
...
### `test "array buffer and linked typed array cycle survives arbitrary finalizer order"` (`tests/core.zig:12789`)
...
### `test "regexp lastIndex self-cycle is released by runtime cycle removal"` (`tests/core.zig:12811`)
...
### `test "realm module registry keeps published record addresses stable"` (`tests/core.zig:12825`)
...
### `test "module registries isolate records between realms"` (`tests/core.zig:12845`)
...
### `test "module registry trace keeps a linked record alive"` (`tests/core.zig:12872`)
...
### `test "explicitly rooted module outlives realm registry teardown"` (`tests/core.zig:12890`)
...
### `test "module namespace strong edge participates in realm object cycle collection"` (`tests/core.zig:12920`)
...
### `test "Nth module allocation OOM leaves registry and Atom ownership recoverable"` (`tests/core.zig:12948`)
...
### `test "runtime memory usage counts linked and explicitly rooted unlinked modules"` (`tests/core.zig:12989`)
...
### `test "module publication retains indexed metadata and all strong value edges"` (`tests/core.zig:13033`)
...
### `test "pending module metadata and publication OOM are atomic"` (`tests/core.zig:13100`)
...
### `test "module registry resolves local indirect star and ambiguous exports"` (`tests/core.zig:13142`)
...
### `test "existing published module generation is not overwritten by pending definition"` (`tests/core.zig:13210`)
...
### `test "indexed module resolution is pure across not-found ambiguous and cyclic graphs"` (`tests/core.zig:13244`)
...
### `test "module resolution follows local exports of ordinary imports"` (`tests/core.zig:13338`)
...
### `test "module resolution normalizes namespace re-export bindings"` (`tests/core.zig:13399`)
...
### `test "runtime stack and interrupt state are stored"` (`tests/core.zig:13515`)
...
### `test "realm interrupt cadence advances without a handler and is realm-local"` (`tests/core.zig:13536`)
...
### `test "ordinary objects define own data properties and descriptors"` (`tests/core.zig:13578`)
...
### `test "define property enforces non-configurable and non-writable invariants"` (`tests/core.zig:13598`)
...
### `test "accessor descriptors store getter setter placeholders"` (`tests/core.zig:13618`)
...
### `test "prototype traversal and cycle checks are enforced"` (`tests/core.zig:13640`)
...
### `test "own keys follow index string symbol ordering"` (`tests/core.zig:13656`)
...
### `test "extensibility seal and freeze update descriptor flags"` (`tests/core.zig:13682`)
...
### `test "array length tracks sparse indices and truncation"` (`tests/core.zig:13710`)
...
### `test "array indexed delete does not let dense holes mask ordinary properties"` (`tests/core.zig:13731`)
...
### `test "array element storage mode moves between dense and sparse"` (`tests/core.zig:13746`)
...
### `test "exotic dispatch hooks are called without builtin shortcuts"` (`tests/core.zig:13786`)
...
### `test "explicit value root preserves and releases a symbol across GC"` (`tests/core.zig:13856`)
...
### `test "finalization registry pending jobs preserve callback and held symbols"` (`tests/core.zig:13874`)
...
### `test "fused multiply-subtract matches the reference limb for limb"` (`src/libs/bigint.zig:1947`)

- **签名**：无参数测试块，返回 `!void`。
- **作用**：钉住 `subMulAt` 与定义性 `referenceSubMul` 在宽度 2..32、七种 limb 花样、七个 qhat 上逐 limb 一致。
- **实现**：模式扫；不再做 50 万次随机。
- **所有权 / 错误 / 调用**：无跨测试状态；失败即测试失败。

### `test "minor collection reclaims young garbage and promotes survivors"` (`tests/core.zig:14905`)
...
### `test "minor block mark clearing preserves old sticky marks"` (`tests/core.zig:14927`)
...
### `test "the minor reclaims young cycles and parks no deferred frees"` (`tests/core.zig:14949`)
...
### `test "minor pause distribution retains the complete diagnostic run"` (`tests/core.zig:14995`)
...
### `test "old-to-young edge survives a minor only because the barrier remembered it"` (`tests/core.zig:15021`)
...
### `test "object remembered bit is consumed and rebuilt across consecutive minors"` (`tests/core.zig:15076`)
...
### `test "incremental retirement clears remembered cache before the next generation"` (`tests/core.zig:15123`)
...
### `test "non-object remembered owners use the byte-6 cache and re-arm across consecutive minors"` (`tests/core.zig:15194`)
...
### `test "minor full-trace verifier owns its reachability set per runtime"` (`tests/core.zig:15243`)
...
### `test "the generational barrier ignores edges a minor would find anyway"` (`tests/core.zig:15271`)
...
### `test "the folded barrier gate skips exactly the two owner facts"` (`tests/core.zig:15286`)
...
### `test "the barrier gate closes on every phase that needs a richer arm"` (`tests/core.zig:15361`)
...
### `test "the barrier shades exact targets while marking and remembers owners otherwise"` (`tests/core.zig:15413`)
...
### `test "the barrier shades a target the marker had already passed"` (`tests/core.zig:15436`)
...
### `test "segmented shared mark frontier grows without dropping work"` (`tests/core.zig:15471`)
...
### `test "mark frontier whitelist encodes the epoch exemption"` (`tests/core.zig:15497`)
...
### `test "checked frontier admission requires a published marked header"` (`tests/core.zig:15518`)
...
### `test "frontier requeue admission checks a prior claim without executing one"` (`tests/core.zig:15536`)
...
### `test "G-Shape indexed adoption shades the Shape once without requeueing the array"` (`tests/core.zig:15571`)
...
### `test "G-Shape adoption traces prototype children and symbol keys but skips white owners"` (`tests/core.zig:15592`)
...
### `test "G-Shape prototype frontier OOM fails before tracing or sweeping"` (`tests/core.zig:15639`)
...
### `test "G-Shape relocation leaves no raw Shape queued and survives declared major GC"` (`tests/core.zig:15662`)
...
### `test "G-Shape unpublished adoption does not publish a pending owner or target"` (`tests/core.zig:15699`)
...
### `test "Shape barrier requeues only an owner with a prior mark claim"` (`tests/core.zig:15728`)
...
### `test "incremental abort disables marking before draining every frontier segment"` (`tests/core.zig:15763`)
...
### `test "the barrier queue hands whole segments to a private mark stack"` (`tests/core.zig:15789`)
...
### `test "an abandoned retirement transaction closes minors until a major repairs it"` (`tests/core.zig:15815`)
...
### `test "a major retires every block-cell survivor it traces"` (`tests/core.zig:15851`)
...
### `test "a conservative candidate on a shared extent boundary visits both extents"` (`tests/core.zig:15899`)
...
### `test "a published string extent takes no occupant entry and still resolves conservatively"` (`tests/core.zig:15958`)
...
### `test "minor collection reclaims an unreachable young string extent"` (`tests/core.zig:16011`)
...
### `test "a rooted or remembered young string extent survives the minor"` (`tests/core.zig:16043`)
...
### `test "the whole-heap iterator enumerates string extents and a major removes the unreachable one"` (`tests/core.zig:16088`)
...
### `test "the full-reachable verifier restores extent marks and atom epoch stamps"` (`tests/core.zig:16153`)
...
### `test "incremental begin preserves list-young suffix until finish retirement"` (`tests/core.zig:16216`)
...
### `test "representation audit guards block-cell marker direct dispatch"` (`tests/core.zig:16269`)
...
### `test "independent runtimes collect without touching each other"` (`tests/core.zig:16288`)
...
### `test "a crossing a minor cannot answer is still answered by a major"` (`tests/core.zig:16332`)
...
### `test "a minor-only workload still returns free block pages to the OS"` (`tests/core.zig:16391`)
...
### `test "ten thousand plain object deaths reach no destructor"` (`tests/core.zig:16432`)
...
### `test "young churn that crosses the threshold is paid by the minor, not by a major"` (`tests/core.zig:16479`)
...
### `test "an old generation that keeps growing keeps triggering majors"` (`tests/core.zig:16517`)
...
### `test "a dense buffer adopted by an aged array is remembered for the next minor"` (`tests/core.zig:16570`)
...
### `test "regexp capture strings survive a minor taken inside the match-array fill"` (`tests/core.zig:16623`)
...
### `test "a minor does not move the major's threshold"` (`tests/core.zig:16672`)
...
### `test "minor detailed stats decompose the outer STW envelope"` (`tests/core.zig:16701`)
...
### `test "cell resolution stops at the block header and at unallocated cells"` (`tests/core.zig:16742`)
...
### `test "carrier exact handles reject stale block-cell generations"` (`tests/core.zig:16763`)
...
### `test "production current-membership API cannot carry generation or lifecycle state"` (`tests/core.zig:16825`)
...
### `test "carrier generation authorities reject wrap in both extent and block schemes"` (`tests/core.zig:16833`)
...
### `test "a minor that keeps reclaiming nothing stops being offered"` (`tests/core.zig:16850`)
...
### `test "marking barrier shades grey, not black: the stored object's children survive the remark"` (`tests/core.zig:16885`)
...
### `test "mark frontier allocation failure invalidates rather than rescans"` (`tests/core.zig:16928`)
...
### `test "runtime recovers a frontier OOM through allocation-boundary full GC"` (`tests/core.zig:16942`)
...
### `test "incremental marking preserves a frontier beyond both former 65K bounds"` (`tests/core.zig:17004`)
...
### `test "incremental settled account excludes storage bytes already debited at condemnation"` (`tests/core.zig:17052`)
...
### `test "incremental settled account retains finalizer and list corpse charges"` (`tests/core.zig:17085`)
...
### `test "incremental destruction credit reconciles each reclaimed byte once"` (`tests/core.zig:17126`)
...
### `test "incremental destruction credit funds safe assists from actual native backing release"` (`tests/core.zig:17162`)
...
### `test "incremental destruction credit rejects growth without sufficient deferred charges"` (`tests/core.zig:17219`)
...
### `test "incremental marking retains requested-byte pacing across storage growth"` (`tests/core.zig:17267`)
...
### `test "incremental scheduler slices consume existing allocation assist debt"` (`tests/core.zig:17296`)
...
### `test "an incremental cycle frees threshold garbage across bounded polls"` (`tests/core.zig:17315`)
...
### `test "object allocation boundaries pace incremental assists by allocation debt"` (`tests/core.zig:17373`)
...
### `test "condemning many shapes leaves the transition table exactly consistent"` (`tests/core.zig:17423`)
...
### `test "the marked-set census is its own opt-in, not a rider on the stats panel"` (`tests/core.zig:17489`)
...
### `test "the incremental finish reports a remark segment net of its census walk"` (`tests/core.zig:17520`)
...
### `test "incremental cycle envelope keeps one exact MemoryAccount S T P domain"` (`tests/core.zig:17557`)
...
### `test "synchronous incremental destruction drains more than one parked-free budget"` (`tests/core.zig:17607`)
...
### `test "terminal pending stats count accounted block and standalone corpses"` (`tests/core.zig:17648`)
...
### `test "pending class finalizer keeps the incremental morgue open"` (`tests/core.zig:17701`)
...
### `test "incremental block finalizer observes its object without sweep publication"` (`tests/core.zig:17756`)
...
### `test "a store during an incremental cycle keeps the stored subgraph alive to the remark"` (`tests/core.zig:17792`)
...
### `test "an explicit collection supersedes an open incremental cycle with full precision"` (`tests/core.zig:17836`)
...
### `test "an urgent poll aborts the open cycle and collects fully"` (`tests/core.zig:17868`)
...
### `test "runtime teardown owns a detached generator shell"` (`tests/core.zig:17892`)
...
### `test "TGC S3: a shape property key is an atom trace edge"` (`tests/core.zig:17920`)
...
### `test "TGC S3: an inline bytecode atom operand is an atom trace edge"` (`tests/core.zig:17939`)
...
### `test "TGC S3: a module record name is an atom trace edge"` (`tests/core.zig:17957`)
...
### `test "TGC S3: an id-held value symbol keeps its body marked"` (`tests/core.zig:17977`)
...
### `test "TGC S3-c: an atom no edge and no root reaches is retired by the major"` (`tests/core.zig:18000`)
...
### `test "TGC S3-b: a compile scope roots an atom no holder edge names"` (`tests/core.zig:18022`)
...
### `test "TGC S3-b: a compile scope on a runtime-less table records without registering"` (`tests/core.zig:18056`)
...
### `test "TGC S3-c: the atom entry census falls back after a major"` (`tests/core.zig:18082`)
...
### `test "TGC S3-c: a young symbol body a shape names by id survives a minor"` (`tests/core.zig:18113`)
...
### `test "TGC S3-c: a thousand fresh symbol keys survive the minors taken while they accumulate"` (`tests/core.zig:18161`)
...
### `test "TGC S3-c: a symbol interned inside a marking window keeps its body"` (`tests/core.zig:18190`)
...
### `test "TGC S3-c: a shape key keeps its atom, and the next major after the shape dies retires it"` (`tests/core.zig:18221`)
...
### `test "TGC S3-c: a WeakRef'd symbol still leaves a weak shell instead of a recycled slot"` (`tests/core.zig:18248`)
...
### `test "TGC S3: the insertion barrier shades an atom stored during marking"` (`tests/core.zig:18286`)
...
### `test "TGC S3-c: the atom verdict is applied in the pause that took it, not after the morgue drains"` (`tests/core.zig:18312`)
...
### `test "needs_finalizer is recorded in both the header and the block bitmap"` (`tests/core.zig:18358`)
...
### `test "storage-cell mint writes runtime kind tags on block and extent paths"` (`tests/core.zig:18444`)
...
### `test "TGC S4-b: an external property buffer survives with its owner and dies one major later"` (`tests/core.zig:18482`)
...
### `test "TGC S4-b: an aged owner remembers a property buffer minted after its promotion"` (`tests/core.zig:18510`)
...
### `test "Q22: a bitmap-reclaimed storage cell leaves the byte ledger exactly once"` (`tests/core.zig:18537`)
...
### `test "TGC S4-b: a growing dense array leaves every superseded element cell to the sweep"` (`tests/core.zig:18584`)
...
### `test "Q21: the element cell is kept alive by the arm, not by flags.fast_array"` (`tests/core.zig:18611`)
...
### `test "TGC S4-b: a mapped-arguments var-ref table is an array storage cell"` (`tests/core.zig:18647`)
...
### `test "TGC S4-b: storage over the block-cell ceiling takes the extent route and is swept"` (`tests/core.zig:18677`)
...
### `test "promise coallocation: state and reactions survive through the sole owner"` (`tests/core.zig:18726`)
...
### `test "promise coallocation: accounting and allocation failure share the object cell"` (`tests/core.zig:18774`)
...
### `test "TGC S4-c: every a-class payload is a cell that dies one major after its owner"` (`tests/core.zig:18802`)
...
### `test "TGC S4-c: a bytecode function's rare/aux record is a payload cell"` (`tests/core.zig:18883`)
...
### `test "TGC S4-c: an aged promise remembers a reaction cell minted after its promotion"` (`tests/core.zig:18912`)
...
### `test "TGC S4-c: bound arguments, disposable resources and arguments var-refs cross a major"` (`tests/core.zig:18947`)
...
### `test "TGC S4-c: a payload slice over the block-cell ceiling takes the extent route"` (`tests/core.zig:19012`)
