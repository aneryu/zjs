...
### `dummyExternalHostCall` (`src/tests/core.zig:2913`)

- **签名**：`fn dummyExternalHostCall(_: *anyopaque, _: core.host_function.ExternalCall) anyerror!core.JSValue`。
- **作用**：测试夹具/探针 `dummyExternalHostCall`，给周围 `test` 块提供可注入行为或断言助手。
- **实现**：关键调用：`core.JSValue.undefinedValue`。
- **所有权 / 错误 / 调用**：返回 `anyerror!core.JSValue`，由测试 `try`/`expectError` 消费。

### `countPayloadFinalizer` (`src/tests/core.zig:2917`)
...
### `countPayloadMark` (`src/tests/core.zig:2922`)
...
### `countVisitedValue` (`src/tests/core.zig:2932`)
...
### `ClassConstructionUnregisterProbe.trigger` (`src/tests/core.zig:2950`)
...
### `ClassConstructionGrowthProbe.trigger` (`src/tests/core.zig:2966`)
...
### `accountedPlainObjectBytes` (`src/tests/core.zig:2978`)
...
### `emptyRootShapeAllocationBytes` (`src/tests/core.zig:2986`)
...
### `ObjectConstructionOrderProbe.trigger` (`src/tests/core.zig:3001`)
...
### `InlineClassFinalizerReentry.reset` (`src/tests/core.zig:3035`)
...
### `InlineClassFinalizerReentry.finalize` (`src/tests/core.zig:3050`)
...
### `InlineObjectLifecycleProbe.reset` (`src/tests/core.zig:3082`)
...
### `InlineObjectLifecycleProbe.finalize` (`src/tests/core.zig:3093`)
...
### `SideAuthorityDestroyProbe.reset` (`src/tests/core.zig:3112`)
...
### `SideAuthorityDestroyProbe.finalize` (`src/tests/core.zig:3118`)
...
### `registerStandaloneInlineObjectTestClass` (`src/tests/core.zig:3132`)
...
### `expectPublishedStandaloneInlineObject` (`src/tests/core.zig:3152`)
...
### `countYoungHeader` (`src/tests/core.zig:3185`)
...
### `ExternalObjectLifecycleProbe.reset` (`src/tests/core.zig:3208`)
...
### `ExternalObjectLifecycleProbe.finalize` (`src/tests/core.zig:3217`)
...
### `ExternalClassFinalizerReentry.reset` (`src/tests/core.zig:3246`)
...
### `ExternalClassFinalizerReentry.finalize` (`src/tests/core.zig:3255`)
...
### `createExternalObjectLifecycleProbe` (`src/tests/core.zig:3272`)
...
### `finalizeTestExternalPayload` (`src/tests/core.zig:3284`)
...
### `finalizeTestExternalObjectPayload` (`src/tests/core.zig:3293`)
...
### `reentrantCollectionClearFinalizer` (`src/tests/core.zig:3302`)
...
### `reentrantArrayDeleteFinalizer` (`src/tests/core.zig:3312`)
...
### `reentrantPropertyDeleteFinalizer` (`src/tests/core.zig:3322`)
...
### `reentrantRegExpLastIndexFinalizer` (`src/tests/core.zig:3332`)
...
### `reentrantMappedArgumentsFinalizer` (`src/tests/core.zig:3342`)
...
### `reentrantCachedIteratorNextFinalizer` (`src/tests/core.zig:3356`)
...
### `reentrantExceptionSlotFinalizer` (`src/tests/core.zig:3366`)
...
### `reentrantArrayIteratorFinalizer` (`src/tests/core.zig:3376`)
...
### `markTestExternalPayload` (`src/tests/core.zig:3386`)
...
### `markTestExternalObjectPayload` (`src/tests/core.zig:3398`)
...
### `registryResolveOne` (`src/tests/core.zig:3774`)
...
### `Probe.visit` (`src/tests/core.zig:3777`)
...
### `Probe.visit` (`src/tests/core.zig:3844`)
...
### `TestJob.run` (`src/tests/core.zig:5041`)
...
### `Counter.visitValue` (`src/tests/core.zig:5051`)
...
### `Counter.visitObject` (`src/tests/core.zig:5058`)
...
### `Rewriter.visitValue` (`src/tests/core.zig:5093`)
...
### `Rewriter.visitObject` (`src/tests/core.zig:5100`)
...
### `Rewriter.visitValue` (`src/tests/core.zig:5136`)
...
### `Rewriter.visitObject` (`src/tests/core.zig:5143`)
...
### `DefineFieldForceGcProbe.trigger` (`src/tests/core.zig:6463`)
...
### `Rewriter.visitValue` (`src/tests/core.zig:7467`)
...
### `Rewriter.visitObject` (`src/tests/core.zig:7480`)
...
### `Local.storeYoungChild` (`src/tests/core.zig:7941`)
...
### `Probe.visitArena` (`src/tests/core.zig:8350`)
...
### `Probe.visitBlock` (`src/tests/core.zig:8354`)
...
### `Visitor.visitValue` (`src/tests/core.zig:8487`)
...
### `Visitor.visitValue` (`src/tests/core.zig:8519`)
...
### `Visitor.visitValue` (`src/tests/core.zig:8557`)
...
### `createDeepOwnedPropertyChain` (`src/tests/core.zig:8585`)
...
### `externalPropertyStorageBytes` (`src/tests/core.zig:8657`)
...
### `expectNoLiveGc` (`src/tests/core.zig:8664`)
...
### `expectCycleReclaimedIncludingShapes` (`src/tests/core.zig:8669`)
...
### `expectAllLiveGcReclaimed` (`src/tests/core.zig:8679`)
...
### `dropGcPtr` (`src/tests/core.zig:8687`)
...
### `expectClosedPropertyCycleReclaimed` (`src/tests/core.zig:8691`)
...
### `TraceEdges.recordHeader` (`src/tests/core.zig:8740`)
...
### `TraceEdges.Visitor.visitValue` (`src/tests/core.zig:8747`)
...
### `TraceEdges.Visitor.visitObject` (`src/tests/core.zig:8751`)
...
### `TraceEdges.Visitor.visitShape` (`src/tests/core.zig:8758`)
...
### `TraceEdges.Visitor.visitRealm` (`src/tests/core.zig:8762`)
...
### `TraceEdges.Visitor.visitModule` (`src/tests/core.zig:8766`)
...
### `TraceEdges.Visitor.storageCell` (`src/tests/core.zig:8770`)
...
### `TraceEdges.Visitor.visitWeakCollectionEntry` (`src/tests/core.zig:8774`)
...
### `TraceEdges.Visitor.visitFinalizationCell` (`src/tests/core.zig:8776`)
...
### `TraceEdges.collect` (`src/tests/core.zig:8781`)
...
### `TraceEdges.expectContains` (`src/tests/core.zig:8832`)
...
### `Shade.shade` (`src/tests/core.zig:9443`)
...
### `Probe.visit` (`src/tests/core.zig:9473`)
...
### `weakPersistentCounterCallback` (`src/tests/core.zig:10404`)
...
### `ForceCollectionProbe.trigger` (`src/tests/core.zig:11427`)
...
### `interruptOnce` (`src/tests/core.zig:13514`)
...
### `exoticGet` (`src/tests/core.zig:13771`)
...
### `exoticDefine` (`src/tests/core.zig:13775`)
...
### `exoticDelete` (`src/tests/core.zig:13780`)
...
### `exoticOwnKeys` (`src/tests/core.zig:13785`)
...
### `PoisonAllocator.alloc` (`src/tests/core.zig:13946`)
...
### `PoisonAllocator.resize` (`src/tests/core.zig:13952`)
...
### `PoisonAllocator.remap` (`src/tests/core.zig:13956`)
...
### `PoisonAllocator.free` (`src/tests/core.zig:13960`)
...
### `PoisonAllocator.allocator` (`src/tests/core.zig:13964`)
...
### `referenceMul` (`src/tests/core.zig:13973`)
...
### `lockstepLimb` (`src/tests/core.zig:14032`)
...
### `expectLockstepMul` (`src/tests/core.zig:14118`)
...
### `makeLockstepOperand` (`src/tests/core.zig:14166`)
...
### `DivFailAllocator.allocator` (`src/tests/core.zig:14463`)
...
### `DivFailAllocator.alloc` (`src/tests/core.zig:14472`)
...
### `DivFailAllocator.resize` (`src/tests/core.zig:14492`)
...
### `DivFailAllocator.remap` (`src/tests/core.zig:14498`)
...
### `DivFailAllocator.free` (`src/tests/core.zig:14509`)
...
### `expectDivisionUnderInjection` (`src/tests/core.zig:14516`)
...
### `expectDivisionIdentity` (`src/tests/core.zig:14623`)
...
### `Case.check` (`src/tests/core.zig:14860`)
...
### `countExtentStringHeaders` (`src/tests/core.zig:15888`)
...
### `Probe.visit` (`src/tests/core.zig:15938`)
...
### `Probe.visit` (`src/tests/core.zig:15989`)
...
### `atomMarkEpochForTest` (`src/tests/core.zig:16150`)
...
### `driveOneIncrementalMajorForCensusTest` (`src/tests/core.zig:17410`)
...
### `s3AtomEntry` (`src/tests/core.zig:17913`)
...
### `s3MarkEpoch` (`src/tests/core.zig:17917`)
...
### `s3RunMajor` (`src/tests/core.zig:17921`)
...
### `s3OccupiedEntryCount` (`src/tests/core.zig:18082`)
...
### `defineS4bNamedProperties` (`src/tests/core.zig:18405`)
...
### `expectS4bNamedProperties` (`src/tests/core.zig:18420`)
...
### `fillS4bDenseArray` (`src/tests/core.zig:18432`)
...
### `installMintedStringBufferBody` (`src/tests/core.zig:18479`)
...
### `registerS4cPayloadClass` (`src/tests/core.zig:18722`)
...
### `lessThan.lessThan` (`src/tests/core.zig:19228`)
...
### `expectAuditPrintMatchesFmt` (`src/tests/core.zig:19237`)
...
### `test "class registration growth OOM does not publish a partial definition and retry succeeds"` (`src/tests/core.zig:3410`)
...
### `test "object creation rejects an unregistered dynamic class generation"` (`src/tests/core.zig:3427`)
...
### `test "class construction pins its definition across reentrant unregister"` (`src/tests/core.zig:3441`)
...
### `test "class construction scalar plan survives record table growth"` (`src/tests/core.zig:3476`)
...
### `test "inline class finalizer reentry keeps definition pinned while growing the table"` (`src/tests/core.zig:3514`)
...
### `test "inline class finalizer observes the live object allocation until callback return"` (`src/tests/core.zig:3552`)
...
### `test "standalone inline object publication is visible to collector enumeration"` (`src/tests/core.zig:3597`)
...
### `test "side authority swap-remove condemnation drains every non-block object exactly once"` (`src/tests/core.zig:3616`)
...
### `test "standalone inline object survives a rooted minor and retires young"` (`src/tests/core.zig:3677`)
...
### `test "standalone inline object survives a rooted major mark"` (`src/tests/core.zig:3709`)
...
### `test "single-code-unit string table survives a declared-roots collection"` (`src/tests/core.zig:3740`)
...
### `test "standalone inline object resolves from a conservative interior candidate"` (`src/tests/core.zig:3787`)
...
### `test "standalone inline object teardown parks its struct free until the drain"` (`src/tests/core.zig:3857`)
...
### `test "external class finalizers run synchronously with original object identity in zero-ref FIFO order"` (`src/tests/core.zig:3884`)
...
### `test "array teardown releases its unique prototype before its unique dense element"` (`src/tests/core.zig:3919`)
...
### `test "weak husk keeps its class definition after one synchronous finalizer"` (`src/tests/core.zig:3949`)
...
### `test "class finalizers and context prototype slots are wired"` (`src/tests/core.zig:3991`)
...
### `test "object destruction runs class payload finalizers synchronously without allocation"` (`src/tests/core.zig:4040`)
...
### `test "strong collection clear publishes empty state before synchronous finalizer reentry"` (`src/tests/core.zig:4089`)
...
### `test "dense array delete publishes sparse state before synchronous finalizer reentry"` (`src/tests/core.zig:4128`)
...
### `test "ordinary property delete publishes absence before synchronous finalizer reentry"` (`src/tests/core.zig:4167`)
...
### `test "IC-R1: in-place delete mutates the shape Property word"` (`src/tests/core.zig:4208`)
...
### `test "regexp lastIndex set publishes replacement before synchronous finalizer reentry"` (`src/tests/core.zig:4243`)
...
### `test "regexp lastIndex define publishes replacement before synchronous finalizer reentry"` (`src/tests/core.zig:4282`)
...
### `test "mapped arguments binding update publishes value before synchronous finalizer reentry"` (`src/tests/core.zig:4325`)
...
### `test "mapped arguments var-ref update publishes value before synchronous finalizer reentry"` (`src/tests/core.zig:4370`)
...
### `test "mapped arguments binding delete publishes disconnection before synchronous finalizer reentry"` (`src/tests/core.zig:4414`)
...
### `test "cached iterator next clear publishes null before synchronous finalizer reentry"` (`src/tests/core.zig:4463`)
...
### `test "exception slot clear publishes empty state before synchronous finalizer reentry"` (`src/tests/core.zig:4503`)
...
### `test "array iterator target clear publishes null before synchronous finalizer reentry"` (`src/tests/core.zig:4535`)
...
### `test "runtime cycle removal follows class payload mark hooks"` (`src/tests/core.zig:4580`)
...
### `test "synchronous class payload finalizer drains payload-owned zero-ref children before free returns"` (`src/tests/core.zig:4633`)
...
### `test "synchronous external payload callback pins its generation through reentrant unregister"` (`src/tests/core.zig:4667`)
...
### `test "runtime cycle removal synchronously finalizes class payload object slots once"` (`src/tests/core.zig:4708`)
...
### `test "plain objects do not allocate class payload storage"` (`src/tests/core.zig:4750`)
...
### `test "iterator classes store iterator state in class payload"` (`src/tests/core.zig:4761`)
...
### `test "collection classes store entries in class payload"` (`src/tests/core.zig:4774`)
...
### `test "buffer and typed array state use payload storage"` (`src/tests/core.zig:4789`)
...
### `test "array buffer view list republishes cached typed array count and data"` (`src/tests/core.zig:4815`)
...
### `test "shared array buffer grow refreshes length-tracking typed array state"` (`src/tests/core.zig:4860`)
...
### `test "shared buffer store can back wrappers in separate runtimes"` (`src/tests/core.zig:4875`)
...
### `test "array buffer backing stores report external memory"` (`src/tests/core.zig:4897`)
...
### `test "ordinary array buffer backing overlaps account and external ledgers"` (`src/tests/core.zig:4917`)
...
### `test "shared buffer store reports external memory for its owner runtime"` (`src/tests/core.zig:4936`)
...
### `test "large shared buffers request a major through external pressure"` (`src/tests/core.zig:4960`)
...
### `test "runtime root tracer visits async roots"` (`src/tests/core.zig:5030`)
...
### `test "runtime root frame slots are mutable"` (`src/tests/core.zig:5074`)
...
### `test "value root buffer exposes mutable copied slice"` (`src/tests/core.zig:5122`)
...
### `test "regexp internals use inline storage and lastIndex uses first shape slot"` (`src/tests/core.zig:5161`)
...
### `test "bound function state uses payload storage"` (`src/tests/core.zig:5186`)
...
### `test "proxy state uses payload storage"` (`src/tests/core.zig:5211`)
...
### `test "mapped arguments state uses inline var-ref storage"` (`src/tests/core.zig:5227`)
...
### `test "unmapped arguments share a prepared shape and use dense element storage"` (`src/tests/core.zig:5245`)
...
### `test "object data state uses payload storage"` (`src/tests/core.zig:5300`)
...
### `test "array element state uses inline fast-array storage"` (`src/tests/core.zig:5314`)
...
### `test "promise state uses payload storage"` (`src/tests/core.zig:5330`)
...
### `test "generator state uses payload storage"` (`src/tests/core.zig:5349`)
...
### `test "generator bound and proxy payloads carry no realm compensation"` (`src/tests/core.zig:5391`)
...
### `test "leaf noncarrier payloads carry no borrowed realm compensation"` (`src/tests/core.zig:5401`)
...
### `test "object payloads carry no private-name remap side tables"` (`src/tests/core.zig:5421`)
...
### `test "generator completion eagerly releases the resident execution owners"` (`src/tests/core.zig:5429`)
...
### `test "suspended execution preserves and closes open frame var refs"` (`src/tests/core.zig:5482`)
...
### `test "suspended execution republishes running aliases without a second owner"` (`src/tests/core.zig:5518`)
...
### `test "native function state uses payload storage"` (`src/tests/core.zig:5552`)
...
### `test "true C functions own their construction realm while data functions do not"` (`src/tests/core.zig:5583`)
...
### `test "bytecode function state uses the inline qjs function arm"` (`src/tests/core.zig:5632`)
...
### `test "module namespace uses shape-only live-binding storage"` (`src/tests/core.zig:5665`)
...
### `test "shapes retain property atoms and compare transitions"` (`src/tests/core.zig:5698`)

- **签名**：无参数测试块，返回 `!void`。
- **作用**：钉住场景「shapes retain property atoms and compare transitions」。
- **实现**：直接 `JSRuntime.create` 建裸 Runtime（不经 TestEngine）。断言 5 处 `std.testing.expect*`。约 5 个 Zig expect、0 个 JS `assert.*`。
- **所有权 / 错误 / 调用**：测试持有 Runtime/Context 所有权，`defer destroy/deinit`；GC 对象靠 root frame 或精确扫描。

### `test "shape shared bit and prototype transitions are tracked"` (`src/tests/core.zig:5718`)
...
### `test "restorePropertyLayout rebuilds a baseline layout after FAM relocation"` (`src/tests/core.zig:5740`)
...
### `test "shape registry create publishes hashed live shapes"` (`src/tests/core.zig:5776`)
...
### `test "shape registry hash grows and reuses object root shapes"` (`src/tests/core.zig:5794`)
...
### `test "createObjectRoot leftover reserved flag shares hashed proto roots"` (`src/tests/core.zig:5811`)
...
### `test "reserved object root shapes reuse only an exact property capacity"` (`src/tests/core.zig:5832`)
...
### `test "ordinary object additions reuse transition shapes"` (`src/tests/core.zig:5851`)
...
### `test "trace object shape summary follows append kind delete and compaction"` (`src/tests/core.zig:5872`)
...
### `test "trace object shape summary base-5 payload decodes all two-slot states"` (`src/tests/core.zig:5988`)
...
### `test "pure property value replacement preserves a shared shape until flags change"` (`src/tests/core.zig:6013`)
...
### `test "unique transition shape appends in place across FAM relocation"` (`src/tests/core.zig:6045`)
...
### `test "first property append OOM restores the no-storage sentinel"` (`src/tests/core.zig:6088`)
...
### `test "failed new property definition rolls back retained entry"` (`src/tests/core.zig:6123`)
...
### `test "unique shape append OOM rolls back shape and value storage together"` (`src/tests/core.zig:6157`)
...
### `test "property compaction removes tombstones without mutating shared sibling shapes"` (`src/tests/core.zig:6212`)
...
### `test "context lexicals property alias releases context strong reference"` (`src/tests/core.zig:6270`)
...
### `test "failed auto-init property definition rolls back retained entry"` (`src/tests/core.zig:6288`)
...
### `test "failed realm auto-init property definition rolls back borrowed holder registration"` (`src/tests/core.zig:6327`)
...
### `test "property replacement preserves references under memory cap"` (`src/tests/core.zig:6366`)
...
### `test "definePlainDataPropertyKnownFast refcounted append and duplicate-key replace balance refs"` (`src/tests/core.zig:6396`)
...
### `test "definePlainDataPropertyKnownFast barriers follow committed slot and shape writes"` (`src/tests/core.zig:6431`)
...
### `test "definePlainDataPropertyKnownFast refcounted define survives forced GC at every allocation"` (`src/tests/core.zig:6474`)
...
### `test "definePlainDataPropertyKnownFast OOM sweep leaves refcounted value owned by caller"` (`src/tests/core.zig:6537`)
...
### `test "object data property self-assignment keeps stored object alive"` (`src/tests/core.zig:6596`)
...
### `test "json parse data property self-assignment keeps stored object alive"` (`src/tests/core.zig:6619`)
...
### `test "dense array element self-assignment keeps stored object alive"` (`src/tests/core.zig:6635`)
...
### `test "owned dense array writes consume values only on success"` (`src/tests/core.zig:6651`)
...
### `test "prototype replacement clones shared transition shape"` (`src/tests/core.zig:6672`)
...
### `test "failed prototype replacement preserves prototype and refcounts"` (`src/tests/core.zig:6694`)
...
### `test "failed object registration destroys initialized object once"` (`src/tests/core.zig:6722`)
...
### `test "shape transition cache releases chained shapes"` (`src/tests/core.zig:6747`)
...
### `test "large object property lookup uses shape hash across delete and re-add"` (`src/tests/core.zig:6773`)
...
### `test "exception slot transfers owned value and clears context slot"` (`src/tests/core.zig:6801`)
...
### `test "reference dup and free retain until final release"` (`src/tests/core.zig:6818`)
...
### `test "memory account tracks same-allocator allocation and free"` (`src/tests/core.zig:6827`)
...
### `test "memory account treats zero-length allocations as inert"` (`src/tests/core.zig:6835`)
...
### `test "VM stack arena default fill matches VmStackArena{}"` (`src/tests/core.zig:6849`)
...
### `test "VM stack arena allocates and reuses a compact first chunk"` (`src/tests/core.zig:6864`)
...
### `test "VM stack arena active miss is pure before authoritative second chunk carve"` (`src/tests/core.zig:6891`)
...
### `test "VM stack arena large first carve retains the maximum chunk size"` (`src/tests/core.zig:6922`)
...
### `test "VM stack arena oversized carve is rejected without state or accounting changes"` (`src/tests/core.zig:6939`)
...
### `test "VM stack arena allocation failure is retryable and keeps accounting balanced"` (`src/tests/core.zig:6952`)
...
### `test "runtime allocator facades share memory accounting"` (`src/tests/core.zig:7005`)
...
### `test "gc registry tracks live objects and intrusive list state"` (`src/tests/core.zig:7028`)
...
### `test "process memory snapshot is needed exactly when a policy field consumes it"` (`src/tests/core.zig:7042`)
...
### `test "process memory gate preserves external accounting and still fires when consumed"` (`src/tests/core.zig:7096`)
...
### `test "gc process memory pressure policy maps rss and cgroup usage to major requests"` (`src/tests/core.zig:7128`)
...
### `test "function bytecode registration is old-space accounted"` (`src/tests/core.zig:7154`)
...
### `test "runtime exposes stable gc stats snapshot"` (`src/tests/core.zig:7237`)
...
### `test "gc live heap stats drop when object is released"` (`src/tests/core.zig:7291`)
...
### `test "external memory token registry audits duplicate releases and leaks"` (`src/tests/core.zig:7318`)
...
### `test "runtime runs deferred native cleanup jobs with a budget"` (`src/tests/core.zig:7349`)
...
### `test "std file object destruction defers native close cleanup"` (`src/tests/core.zig:7378`)
...
### `test "gc callback boundary defers non-urgent major work until idle"` (`src/tests/core.zig:7411`)
...
### `test "gc callback boundary runs urgent major work"` (`src/tests/core.zig:7430`)
...
### `test "runtime force major gc runs an urgent major poll"` (`src/tests/core.zig:7442`)
...
### `test "object child edge tracing exposes mutable value slots"` (`src/tests/core.zig:7453`)
...
### `test "gc registry debug verifier accepts linked and unlinked list states"` (`src/tests/core.zig:7495`)
...
### `test "gc heap accounting derives live bytes"` (`src/tests/core.zig:7509`)
...
### `test "gc heap accounting rejects an orphaned accounted standalone header"` (`src/tests/core.zig:7525`)
...
### `test "gc heap accounting verifier catches missing allocation entries"` (`src/tests/core.zig:7563`)
...
### `test "gc heap accounting verifier catches pinned header flag drift"` (`src/tests/core.zig:7579`)
...
### `test "gc invariant negative: block candidate index audit rejects bloom and exact-set drift"` (`src/tests/core.zig:7598`)
...
### `test "gc invariant negative: block heap rejects geometry free-chain and doomed-list corruption"` (`src/tests/core.zig:7625`)
...
### `test "gc invariant negative: block cell publication audit rejects hidden allocations"` (`src/tests/core.zig:7684`)
...
### `test "gc invariant negative: metadata semantics reject kind carrier and field misuse"` (`src/tests/core.zig:7715`)
...
### `test "compact trace retained-RC backlinks are authoritative and audited"` (`src/tests/core.zig:7776`)
...
### `test "trace shape summary: incremental writers track the Shape projection"` (`src/tests/core.zig:7824`)
...
### `test "trace shape summary: appends preserve the leased remembered bit"` (`src/tests/core.zig:7918`)
...
### `test "gc invariant negative: representation audit rejects physical carrier and cell index drift"` (`src/tests/core.zig:7973`)
...
### `test "representation audit cross-checks the remembered object cache and map"` (`src/tests/core.zig:8032`)
...
### `test "representation audit cross-checks the remembered cache on a non-object carrier"` (`src/tests/core.zig:8090`)
...
### `test "forget fuses the remembered map removal with its own cache bit"` (`src/tests/core.zig:8174`)
...
### `test "gc invariant negative: construction root audit rejects published shell state"` (`src/tests/core.zig:8239`)
...
### `test "gc: a remembered detached generator shell is still a construction root"` (`src/tests/core.zig:8288`)
...
### `test "gc invariant negative: arena audit rejects an accounted free slab block"` (`src/tests/core.zig:8340`)
...
### `test "gc invariant negative: address index audit rejects canonical page drift"` (`src/tests/core.zig:8377`)
...
### `test "gc invariant negative: heap accounting audit rejects a pin without an entry"` (`src/tests/core.zig:8416`)
...
### `test "gc invariant negative: generation audit rejects census and stale remembered drift"` (`src/tests/core.zig:8430`)
...
### `test "gc invariant negative: retirement audit rejects a marked young survivor"` (`src/tests/core.zig:8455`)
...
### `test "object traceChildEdgesFallible propagates visitor errors"` (`src/tests/core.zig:8476`)
...
### `test "ordinary object trace visits data slots and TMASK accessor edges"` (`src/tests/core.zig:8496`)
...
### `test "object traceChildEdgesFallible propagates class payload visitor errors"` (`src/tests/core.zig:8536`)
...
### `test "gc object release paths do not allocate"` (`src/tests/core.zig:8566`)
...
### `test "zero-ref release drains a deep acyclic object chain iteratively"` (`src/tests/core.zig:8606`)
...
### `test "cycle scan preserves a deeply rooted object chain without recursion"` (`src/tests/core.zig:8619`)
...
### `test "closed object property cycle is released by runtime cycle removal"` (`src/tests/core.zig:8700`)
...
### `test "fast array iterator-next cache cycle is released by runtime cycle removal"` (`src/tests/core.zig:8717`)
...
### `test "function_bytecode trace edges visit realm and cpool"` (`src/tests/core.zig:8841`)
...
### `test "var_ref trace edges visit the closed binding value"` (`src/tests/core.zig:8864`)
...
### `test "realm_context trace edges visit the global object"` (`src/tests/core.zig:8876`)
...
### `test "module trace edges visit function, namespace, meta and thrown values"` (`src/tests/core.zig:8890`)
...
### `test "strong Map and Set entry cycles are released by runtime cycle removal"` (`src/tests/core.zig:8915`)
...
### `test "ordinary error stack and callsite cycles are released by runtime cycle removal"` (`src/tests/core.zig:8942`)
...
### `test "accessor getter and setter self-cycle is released by runtime cycle removal"` (`src/tests/core.zig:8962`)
...
### `test "bound function payload self-cycle is released by runtime cycle removal"` (`src/tests/core.zig:8977`)
...
### `test "arguments payload value-slice cycle is released by runtime cycle removal"` (`src/tests/core.zig:8996`)
...
### `test "object data self-cycle is released by runtime cycle removal"` (`src/tests/core.zig:9019`)
...
### `test "fallible GC API reports reclaimed objects and no failure"` (`src/tests/core.zig:9033`)
...
### `test "trace_stw collects a closed property cycle"` (`src/tests/core.zig:9054`)
...
### `test "trace_stw ephemeron keeps value only when table and key are live"` (`src/tests/core.zig:9067`)
...
### `test "trace_stw ephemeron value does not keep its key alive"` (`src/tests/core.zig:9097`)
...
### `test "trace_stw WeakRef deref keep-alive lasts until job end"` (`src/tests/core.zig:9122`)
...
### `test "trace_stw WeakRef symbol target dies with its body"` (`src/tests/core.zig:9156`)
...
### `test "trace_stw FinalizationRegistry symbol target enqueues its cleanup"` (`src/tests/core.zig:9186`)
...
### `test "trace_stw WeakMap symbol key entry disappears with the symbol"` (`src/tests/core.zig:9224`)
...
### `test "trace_stw symbol liveness queries follow the mark inside the sweep phase"` (`src/tests/core.zig:9251`)
...
### `test "trace_stw WeakRef symbol deref keep-alive survives the same job"` (`src/tests/core.zig:9306`)
...
### `test "trace_stw survivor classes on a known graph"` (`src/tests/core.zig:9339`)
...
### `test "address registry tracks published objects and interior pointers"` (`src/tests/core.zig:9385`)
...
### `test "conservative scan shades a stack-held object header word"` (`src/tests/core.zig:9427`)
...
### `test "carrier protocols keep adjacent one-past roots multi-hit and diagnostics explicit"` (`src/tests/core.zig:9458`)
...
### `test "address registry page radix covers a multi-page allocation"` (`src/tests/core.zig:9490`)
...
### `test "address registry lookup cost stays with page occupants not live N"` (`src/tests/core.zig:9509`)
...
### `test "size-class table pins the measured §4.2 allocation policy"` (`src/tests/core.zig:9578`)
...
### `test "size-class table matches measured publication histogram"` (`src/tests/core.zig:9623`)
...
### `test "block heap splits a 2MiB superblock into 64KiB classed blocks"` (`src/tests/core.zig:9699`)
...
### `test "block heap reserve OOM is visible and not swallowed"` (`src/tests/core.zig:9744`)
...
### `test "block heap rolls a superblock back when its exact index cannot reserve"` (`src/tests/core.zig:9753`)
...
### `test "block heap mark epoch lazily clears the mark bitmap"` (`src/tests/core.zig:9777`)
...
### `test "minor doomed snapshot preserves the active block lifecycle"` (`src/tests/core.zig:9796`)
...
### `test "trace carrier mark epoch keeps zero unmarked and scrubs before wrap"` (`src/tests/core.zig:9820`)
...
### `test "block heap nonempty index follows zero-one population transitions"` (`src/tests/core.zig:9857`)
...
### `test "block heap reopens a swept partial block before reserving a fresh block"` (`src/tests/core.zig:9886`)
...
### `test "block heap aged decommit reports scans release and recommit"` (`src/tests/core.zig:9966`)
...
### `test "block heap returns wholly empty medium superblocks and keeps one spare"` (`src/tests/core.zig:10023`)
...
### `test "process heap trim fires only when a contraction crosses its threshold"` (`src/tests/core.zig:10089`)
...
### `test "pollGC runs pending collection and clears pending flag"` (`src/tests/core.zig:10100`)
...
### `test "object allocation drops a stale threshold request after a transient live-byte peak"` (`src/tests/core.zig:10122`)
...
### `test "object allocation keeps a threshold request while prospective bytes remain over threshold"` (`src/tests/core.zig:10145`)
...
### `test "stale threshold request cannot mask explicit or pressure major requests"` (`src/tests/core.zig:10167`)
...
### `test "a pure string loop reaches the allocation-threshold boundary"` (`src/tests/core.zig:10205`)
...
### `test "a pure rope-concat loop reaches the allocation-threshold boundary"` (`src/tests/core.zig:10226`)
...
### `test "an unrequested threshold crossing is still serviced at the object boundary"` (`src/tests/core.zig:10253`)
...
### `test "an unrequested threshold crossing is still serviced at a scheduler poll"` (`src/tests/core.zig:10274`)
...
### `test "persistent value handle keeps object and nested symbols alive"` (`src/tests/core.zig:10304`)
...
### `test "handle scope local keeps object alive until scope exits"` (`src/tests/core.zig:10324`)
...
### `test "handle scope locals do not clear persistent handles created inside scope"` (`src/tests/core.zig:10348`)
...
### `test "native pin retains direct object and counts nested pins"` (`src/tests/core.zig:10377`)
...
### `test "weak persistent value rejects non-weak targets"` (`src/tests/core.zig:10409`)
...
### `test "weak persistent value does not retain direct object target"` (`src/tests/core.zig:10419`)
...
### `test "weak persistent value clears object cycle target during gc"` (`src/tests/core.zig:10451`)
...
### `test "weak persistent value clears unrooted symbol target during gc"` (`src/tests/core.zig:10471`)
...
### `test "function home object cycle is released by runtime cycle removal"` (`src/tests/core.zig:10497`)
...
### `test "async continuation function cycle is released by runtime cycle removal"` (`src/tests/core.zig:10511`)
...
### `test "async generator promise cycle is released by runtime cycle removal"` (`src/tests/core.zig:10529`)
...
### `test "materialized native function cycle is released by runtime cycle removal"` (`src/tests/core.zig:10547`)
...
### `test "function bytecode constant object cycle is released by runtime cycle removal"` (`src/tests/core.zig:10585`)
...
### `test "runtime destroy releases callback bytecode before object registries"` (`src/tests/core.zig:10607`)
...
### `test "runtime destroy releases nested callback bytecode in owner order"` (`src/tests/core.zig:10619`)
...
### `test "runtime destroy revisits callback bytecode after parent release"` (`src/tests/core.zig:10638`)
...
### `test "runtime destroy releases cyclic callback bytecode constants"` (`src/tests/core.zig:10657`)
...
### `test "runtime destroy releases callback bytecode constants with transferred ownership"` (`src/tests/core.zig:10677`)
...
### `test "bytecode-only callback constant cycle is released by runtime cycle removal"` (`src/tests/core.zig:10697`)
...
### `test "shared function bytecode constant object cycle is released by runtime cycle removal"` (`src/tests/core.zig:10719`)
...
### `test "cycle teardown frees bytecode function captures before FB metadata"` (`src/tests/core.zig:10746`)
...
### `test "nested function bytecode constant object cycle is released by runtime cycle removal"` (`src/tests/core.zig:10771`)
...
### `test "cyclic internal function bytecode references are released by runtime cycle removal"` (`src/tests/core.zig:10807`)
...
### `test "class payload function bytecode constant object cycle is released by runtime cycle removal"` (`src/tests/core.zig:10844`)
...
### `test "realm context owns cached prototype references"` (`src/tests/core.zig:10885`)
...
### `test "auto-init slot owns its Realm until the property is deleted"` (`src/tests/core.zig:10911`)
...
### `test "typed MODULE_NS auto-init publishes a normal value or the same VarRef cell"` (`src/tests/core.zig:10956`)
...
### `test "MODULE_NS auto-init failure retains its slot Realm and retries once per read"` (`src/tests/core.zig:10997`)
...
### `test "MODULE_NS auto-init reentry cannot overwrite the replacement property"` (`src/tests/core.zig:11022`)
...
### `test "auto-init slot exposes the typed Realm and module owner edges"` (`src/tests/core.zig:11050`)
...
### `test "unmaterialized MODULE_NS slot participates in Realm cycle marking"` (`src/tests/core.zig:11070`)
...
### `test "ordinary and object-data payloads ignore generic realm assignment"` (`src/tests/core.zig:11096`)
...
### `test "native call carriers do not enter borrowed realm bookkeeping"` (`src/tests/core.zig:11115`)
...
### `test "generator noncarriers never enter borrowed realm bookkeeping"` (`src/tests/core.zig:11140`)
...
### `test "leaf payload noncarriers ignore generic realm assignment"` (`src/tests/core.zig:11162`)
...
### `test "promise weak-ref regexp and typed-array payloads ignore generic realm assignment"` (`src/tests/core.zig:11201`)
...
### `test "iterator collection and disposable payloads ignore generic realm assignment"` (`src/tests/core.zig:11230`)
...
### `test "collection iterator prototype follows explicit active realm, never receiver"` (`src/tests/core.zig:11251`)
...
### `test "weak reference holders use a lifetime intrusive list"` (`src/tests/core.zig:11310`)
...
### `test "weak collection borrowed holder cache supports reverse teardown"` (`src/tests/core.zig:11356`)
...
### `test "fresh object prototype rebinding reuses the shared empty root shape"` (`src/tests/core.zig:11404`)
...
### `test "data to auto-init replacement stays traceable across allocation GC"` (`src/tests/core.zig:11421`)
...
### `test "data to auto-init replacement rolls back descriptor OOM and retries in same runtime"` (`src/tests/core.zig:11485`)
...
### `test "replacing auto-init transfers the owned Realm edge"` (`src/tests/core.zig:11534`)
...
### `test "replacing auto-init rolls back descriptor OOM and retries in same runtime"` (`src/tests/core.zig:11575`)
...
### `test "deleting auto-init releases its owned Realm edge"` (`src/tests/core.zig:11626`)
...
### `test "ordinary auto-init replacement releases each owned Realm edge"` (`src/tests/core.zig:11643`)
...
### `test "specialized auto-init producers retain the same typed Realm owner"` (`src/tests/core.zig:11692`)
...
### `test "auto-init descriptor interning reuses value-identical metadata"` (`src/tests/core.zig:11736`)
...
### `test "materialized auto-init true C function owns its construction realm"` (`src/tests/core.zig:11761`)
...
### `test "dead weak collection key entry is swept when target is destroyed"` (`src/tests/core.zig:11799`)
...
### `test "dead weak collection key entry is swept without freeing live value"` (`src/tests/core.zig:11825`)
...
### `test "live weak collection key preserves stored value"` (`src/tests/core.zig:11846`)
...
### `test "weak ref target identity does not retain object target"` (`src/tests/core.zig:11870`)
...
### `test "weak ref target registration roots direct symbol target"` (`src/tests/core.zig:11896`)
...
### `test "weak ref target registration failure leaves target unset"` (`src/tests/core.zig:11925`)
...
### `test "weak collection capacity failure leaves empty holder unregistered"` (`src/tests/core.zig:11939`)
...
### `test "weak collection append failure rolls back borrowed holder registration"` (`src/tests/core.zig:11954`)
...
### `test "weak collection capacity reservation keeps empty holder unregistered"` (`src/tests/core.zig:11971`)
...
### `test "finalization registry capacity failure leaves empty holder unregistered"` (`src/tests/core.zig:11983`)
...
### `test "finalization registry append failure rolls back borrowed holder registration"` (`src/tests/core.zig:11998`)
...
### `test "finalization registry job-queue reserve OOM rolls back the cell"` (`src/tests/core.zig:12017`)
...
### `test "finalization registry capacity reservation keeps empty holder unregistered"` (`src/tests/core.zig:12045`)
...
### `test "weak collection delete and clear unregister empty borrowed holder"` (`src/tests/core.zig:12057`)
...
### `test "finalization registry unregister unregisters empty borrowed holder"` (`src/tests/core.zig:12084`)
...
### `test "finalization registry unregister handles token equal to target"` (`src/tests/core.zig:12101`)
...
### `test "finalization registry dead target cleanup tolerates held value reentry"` (`src/tests/core.zig:12122`)
...
### `test "weak collection delete tolerates value cleanup reentry"` (`src/tests/core.zig:12163`)
...
### `test "weak collection clear tolerates value cleanup reentry"` (`src/tests/core.zig:12179`)
...
### `test "weak map deep value chain releases without recursive destruction"` (`src/tests/core.zig:12198`)
...
### `test "weak map cycle sweep clears index after removing dead keys"` (`src/tests/core.zig:12225`)
...
### `test "finalization registry dead target releases held value when target is destroyed"` (`src/tests/core.zig:12282`)
...
### `test "finalization registry live target preserves held value"` (`src/tests/core.zig:12308`)
...
### `test "finalization registry unregister cannot remove queued cleanup cell"` (`src/tests/core.zig:12335`)
...
### `test "finalization registry cleanup enqueue does not allocate after registration"` (`src/tests/core.zig:12387`)
...
### `test "object allocation threshold triggers runtime cycle removal"` (`src/tests/core.zig:12454`)
...
### `test "object allocation collects reclaimable cycles before memory-limit rejection"` (`src/tests/core.zig:12483`)
...
### `test "cache-miss root shape is owned before the object allocation GC boundary"` (`src/tests/core.zig:12520`)
...
### `test "post-shape object OOM rolls back construction owners and retries in the same runtime"` (`src/tests/core.zig:12561`)
...
### `test "shape reserve OOM does not publish or retain proto"` (`src/tests/core.zig:12634`)
...
### `test "gc threshold API resets after scheduled collection and survives force-GC instrumentation"` (`src/tests/core.zig:12660`)
...
### `test "proxy target handler cycle is released by runtime cycle removal"` (`src/tests/core.zig:12696`)
...
### `test "runtime cycle removal preserves externally rooted outgoing objects"` (`src/tests/core.zig:12711`)
...
### `test "module namespace shape VarRef cycle is released by runtime cycle removal"` (`src/tests/core.zig:12739`)
...
### `test "mapped arguments var-ref cycle is released by runtime cycle removal"` (`src/tests/core.zig:12756`)
...
### `test "array element self-cycle is released by runtime cycle removal"` (`src/tests/core.zig:12772`)
...
### `test "typed-array buffer self-cycle is released by runtime cycle removal"` (`src/tests/core.zig:12783`)
...
### `test "array buffer and linked typed array cycle survives arbitrary finalizer order"` (`src/tests/core.zig:12794`)
...
### `test "regexp lastIndex self-cycle is released by runtime cycle removal"` (`src/tests/core.zig:12816`)
...
### `test "realm module registry keeps published record addresses stable"` (`src/tests/core.zig:12830`)
...
### `test "module registries isolate records between realms"` (`src/tests/core.zig:12850`)
...
### `test "module registry trace keeps a linked record alive"` (`src/tests/core.zig:12877`)
...
### `test "explicitly rooted module outlives realm registry teardown"` (`src/tests/core.zig:12895`)
...
### `test "module namespace strong edge participates in realm object cycle collection"` (`src/tests/core.zig:12925`)
...
### `test "Nth module allocation OOM leaves registry and Atom ownership recoverable"` (`src/tests/core.zig:12953`)
...
### `test "runtime memory usage counts linked and explicitly rooted unlinked modules"` (`src/tests/core.zig:12994`)
...
### `test "module publication retains indexed metadata and all strong value edges"` (`src/tests/core.zig:13038`)
...
### `test "pending module metadata and publication OOM are atomic"` (`src/tests/core.zig:13105`)
...
### `test "module registry resolves local indirect star and ambiguous exports"` (`src/tests/core.zig:13147`)
...
### `test "existing published module generation is not overwritten by pending definition"` (`src/tests/core.zig:13215`)
...
### `test "indexed module resolution is pure across not-found ambiguous and cyclic graphs"` (`src/tests/core.zig:13249`)
...
### `test "module resolution follows local exports of ordinary imports"` (`src/tests/core.zig:13343`)
...
### `test "module resolution normalizes namespace re-export bindings"` (`src/tests/core.zig:13404`)
...
### `test "runtime stack and interrupt state are stored"` (`src/tests/core.zig:13520`)
...
### `test "realm interrupt cadence advances without a handler and is realm-local"` (`src/tests/core.zig:13541`)
...
### `test "ordinary objects define own data properties and descriptors"` (`src/tests/core.zig:13583`)
...
### `test "define property enforces non-configurable and non-writable invariants"` (`src/tests/core.zig:13603`)
...
### `test "accessor descriptors store getter setter placeholders"` (`src/tests/core.zig:13623`)
...
### `test "prototype traversal and cycle checks are enforced"` (`src/tests/core.zig:13645`)
...
### `test "own keys follow index string symbol ordering"` (`src/tests/core.zig:13661`)
...
### `test "extensibility seal and freeze update descriptor flags"` (`src/tests/core.zig:13687`)
...
### `test "array index detection handles QuickJS boundaries"` (`src/tests/core.zig:13706`)
...
### `test "array length tracks sparse indices and truncation"` (`src/tests/core.zig:13715`)
...
### `test "array indexed delete does not let dense holes mask ordinary properties"` (`src/tests/core.zig:13736`)
...
### `test "array element storage mode moves between dense and sparse"` (`src/tests/core.zig:13751`)
...
### `test "exotic dispatch hooks are called without builtin shortcuts"` (`src/tests/core.zig:13791`)
...
### `test "intrusive list supports empty insert and remove"` (`src/tests/core.zig:13839`)
...
### `test "explicit value root preserves and releases a symbol across GC"` (`src/tests/core.zig:13861`)
...
### `test "finalization registry pending jobs preserve callback and held symbols"` (`src/tests/core.zig:13879`)
...
### `test "basecase multiplication never reads an uninitialized result limb"` (`src/tests/core.zig:13994`)
...
### `test "inline FAM multiplication matches the external kernel limb for limb"` (`src/tests/core.zig:14051`)
...
### `test "heap multiplication costs one allocation and one block"` (`src/tests/core.zig:14187`)
...
### `test "heap multiplication crosses the slab boundary into standalone blocks"` (`src/tests/core.zig:14221`)
...
### `test "heap multiplication reports its single allocation failure cleanly"` (`src/tests/core.zig:14268`)
...
### `test "heap multiplication rejects an oversize product before allocating"` (`src/tests/core.zig:14312`)
...
### `test "repeated heap multiplication retains nothing as the count grows"` (`src/tests/core.zig:14335`)
...
### `test "single-limb division is exact and allocation-bounded"` (`src/tests/core.zig:14372`)
...
### `test "multi-limb division survives a failure at every allocation point"` (`src/tests/core.zig:14548`)
...
### `test "normalized long division handles every quotient-estimate correction"` (`src/tests/core.zig:14657`)
...
### `test "normalized long division covers every normalization shift"` (`src/tests/core.zig:14730`)
...
### `test "normalized long division covers the operand relations"` (`src/tests/core.zig:14759`)
...
### `test "normalized long division skips a known-zero leading digit"` (`src/tests/core.zig:14791`)
...
### `test "reciprocal two-by-one division is exactly the wide division"` (`src/tests/core.zig:14849`)
...
### `test "minor collection reclaims young garbage and promotes survivors"` (`src/tests/core.zig:14910`)
...
### `test "minor block mark clearing preserves old sticky marks"` (`src/tests/core.zig:14932`)
...
### `test "the minor reclaims young cycles and parks no deferred frees"` (`src/tests/core.zig:14954`)
...
### `test "minor pause distribution retains the complete diagnostic run"` (`src/tests/core.zig:15000`)
...
### `test "old-to-young edge survives a minor only because the barrier remembered it"` (`src/tests/core.zig:15026`)
...
### `test "object remembered bit is consumed and rebuilt across consecutive minors"` (`src/tests/core.zig:15081`)
...
### `test "incremental retirement clears remembered cache before the next generation"` (`src/tests/core.zig:15128`)
...
### `test "non-object remembered owners use the byte-6 cache and re-arm across consecutive minors"` (`src/tests/core.zig:15199`)
...
### `test "minor full-trace verifier owns its reachability set per runtime"` (`src/tests/core.zig:15248`)
...
### `test "the generational barrier ignores edges a minor would find anyway"` (`src/tests/core.zig:15276`)
...
### `test "the folded barrier gate skips exactly the two owner facts"` (`src/tests/core.zig:15291`)
...
### `test "the barrier gate closes on every phase that needs a richer arm"` (`src/tests/core.zig:15366`)
...
### `test "the barrier shades exact targets while marking and remembers owners otherwise"` (`src/tests/core.zig:15418`)
...
### `test "the barrier shades a target the marker had already passed"` (`src/tests/core.zig:15441`)
...
### `test "segmented shared mark frontier grows without dropping work"` (`src/tests/core.zig:15476`)
...
### `test "mark frontier whitelist encodes the epoch exemption"` (`src/tests/core.zig:15502`)
...
### `test "checked frontier admission requires a published marked header"` (`src/tests/core.zig:15523`)
...
### `test "frontier requeue admission checks a prior claim without executing one"` (`src/tests/core.zig:15541`)
...
### `test "G-Shape indexed adoption shades the Shape once without requeueing the array"` (`src/tests/core.zig:15576`)
...
### `test "G-Shape adoption traces prototype children and symbol keys but skips white owners"` (`src/tests/core.zig:15597`)
...
### `test "G-Shape prototype frontier OOM fails before tracing or sweeping"` (`src/tests/core.zig:15644`)
...
### `test "G-Shape relocation leaves no raw Shape queued and survives declared major GC"` (`src/tests/core.zig:15667`)
...
### `test "G-Shape unpublished adoption does not publish a pending owner or target"` (`src/tests/core.zig:15704`)
...
### `test "Shape barrier requeues only an owner with a prior mark claim"` (`src/tests/core.zig:15733`)
...
### `test "incremental abort disables marking before draining every frontier segment"` (`src/tests/core.zig:15768`)
...
### `test "the barrier queue hands whole segments to a private mark stack"` (`src/tests/core.zig:15794`)
...
### `test "an abandoned retirement transaction closes minors until a major repairs it"` (`src/tests/core.zig:15820`)
...
### `test "a major retires every block-cell survivor it traces"` (`src/tests/core.zig:15856`)
...
### `test "a conservative candidate on a shared extent boundary visits both extents"` (`src/tests/core.zig:15904`)
...
### `test "a published string extent takes no occupant entry and still resolves conservatively"` (`src/tests/core.zig:15963`)
...
### `test "minor collection reclaims an unreachable young string extent"` (`src/tests/core.zig:16016`)
...
### `test "a rooted or remembered young string extent survives the minor"` (`src/tests/core.zig:16048`)
...
### `test "the whole-heap iterator enumerates string extents and a major removes the unreachable one"` (`src/tests/core.zig:16093`)
...
### `test "the full-reachable verifier restores extent marks and atom epoch stamps"` (`src/tests/core.zig:16158`)
...
### `test "incremental begin preserves list-young suffix until finish retirement"` (`src/tests/core.zig:16221`)
...
### `test "representation audit guards block-cell marker direct dispatch"` (`src/tests/core.zig:16274`)
...
### `test "independent runtimes collect without touching each other"` (`src/tests/core.zig:16293`)
...
### `test "a crossing a minor cannot answer is still answered by a major"` (`src/tests/core.zig:16337`)
...
### `test "a minor-only workload still returns free block pages to the OS"` (`src/tests/core.zig:16396`)
...
### `test "ten thousand plain object deaths reach no destructor"` (`src/tests/core.zig:16437`)
...
### `test "young churn that crosses the threshold is paid by the minor, not by a major"` (`src/tests/core.zig:16484`)
...
### `test "an old generation that keeps growing keeps triggering majors"` (`src/tests/core.zig:16522`)
...
### `test "a dense buffer adopted by an aged array is remembered for the next minor"` (`src/tests/core.zig:16575`)
...
### `test "regexp capture strings survive a minor taken inside the match-array fill"` (`src/tests/core.zig:16628`)
...
### `test "a minor does not move the major's threshold"` (`src/tests/core.zig:16677`)
...
### `test "minor detailed stats decompose the outer STW envelope"` (`src/tests/core.zig:16706`)
...
### `test "cell resolution stops at the block header and at unallocated cells"` (`src/tests/core.zig:16747`)
...
### `test "carrier exact handles reject stale block-cell generations"` (`src/tests/core.zig:16768`)
...
### `test "production current-membership API cannot carry generation or lifecycle state"` (`src/tests/core.zig:16830`)
...
### `test "carrier generation authorities reject wrap in both extent and block schemes"` (`src/tests/core.zig:16838`)
...
### `test "a minor that keeps reclaiming nothing stops being offered"` (`src/tests/core.zig:16855`)
...
### `test "marking barrier shades grey, not black: the stored object's children survive the remark"` (`src/tests/core.zig:16890`)
...
### `test "mark frontier allocation failure invalidates rather than rescans"` (`src/tests/core.zig:16933`)
...
### `test "runtime recovers a frontier OOM through allocation-boundary full GC"` (`src/tests/core.zig:16947`)
...
### `test "incremental marking preserves a frontier beyond both former 65K bounds"` (`src/tests/core.zig:17009`)
...
### `test "incremental settled account excludes storage bytes already debited at condemnation"` (`src/tests/core.zig:17057`)
...
### `test "incremental settled account retains finalizer and list corpse charges"` (`src/tests/core.zig:17090`)
...
### `test "incremental destruction credit reconciles each reclaimed byte once"` (`src/tests/core.zig:17131`)
...
### `test "incremental destruction credit funds safe assists from actual native backing release"` (`src/tests/core.zig:17167`)
...
### `test "incremental destruction credit rejects growth without sufficient deferred charges"` (`src/tests/core.zig:17224`)
...
### `test "incremental marking retains requested-byte pacing across storage growth"` (`src/tests/core.zig:17272`)
...
### `test "incremental scheduler slices consume existing allocation assist debt"` (`src/tests/core.zig:17301`)
...
### `test "an incremental cycle frees threshold garbage across bounded polls"` (`src/tests/core.zig:17320`)
...
### `test "object allocation boundaries pace incremental assists by allocation debt"` (`src/tests/core.zig:17379`)
...
### `test "condemning many shapes leaves the transition table exactly consistent"` (`src/tests/core.zig:17429`)
...
### `test "the marked-set census is its own opt-in, not a rider on the stats panel"` (`src/tests/core.zig:17495`)
...
### `test "the incremental finish reports a remark segment net of its census walk"` (`src/tests/core.zig:17526`)
...
### `test "incremental cycle envelope keeps one exact MemoryAccount S T P domain"` (`src/tests/core.zig:17563`)
...
### `test "synchronous incremental destruction drains more than one parked-free budget"` (`src/tests/core.zig:17613`)
...
### `test "terminal pending stats count accounted block and standalone corpses"` (`src/tests/core.zig:17654`)
...
### `test "pending class finalizer keeps the incremental morgue open"` (`src/tests/core.zig:17707`)
...
### `test "incremental block finalizer observes its object without sweep publication"` (`src/tests/core.zig:17762`)
...
### `test "a store during an incremental cycle keeps the stored subgraph alive to the remark"` (`src/tests/core.zig:17798`)
...
### `test "an explicit collection supersedes an open incremental cycle with full precision"` (`src/tests/core.zig:17842`)
...
### `test "an urgent poll aborts the open cycle and collects fully"` (`src/tests/core.zig:17874`)
...
### `test "runtime teardown owns a detached generator shell"` (`src/tests/core.zig:17898`)
...
### `test "TGC S3: a shape property key is an atom trace edge"` (`src/tests/core.zig:17926`)
...
### `test "TGC S3: an inline bytecode atom operand is an atom trace edge"` (`src/tests/core.zig:17945`)
...
### `test "TGC S3: a module record name is an atom trace edge"` (`src/tests/core.zig:17963`)
...
### `test "TGC S3: an id-held value symbol keeps its body marked"` (`src/tests/core.zig:17983`)
...
### `test "TGC S3-c: an atom no edge and no root reaches is retired by the major"` (`src/tests/core.zig:18006`)
...
### `test "TGC S3-b: a compile scope roots an atom no holder edge names"` (`src/tests/core.zig:18028`)
...
### `test "TGC S3-b: a compile scope on a runtime-less table records without registering"` (`src/tests/core.zig:18062`)
...
### `test "TGC S3-c: the atom entry census falls back after a major"` (`src/tests/core.zig:18088`)
...
### `test "TGC S3-c: a young symbol body a shape names by id survives a minor"` (`src/tests/core.zig:18119`)
...
### `test "TGC S3-c: a thousand fresh symbol keys survive the minors taken while they accumulate"` (`src/tests/core.zig:18167`)
...
### `test "TGC S3-c: a symbol interned inside a marking window keeps its body"` (`src/tests/core.zig:18196`)
...
### `test "TGC S3-c: a shape key keeps its atom, and the next major after the shape dies retires it"` (`src/tests/core.zig:18227`)
...
### `test "TGC S3-c: a WeakRef'd symbol still leaves a weak shell instead of a recycled slot"` (`src/tests/core.zig:18254`)
...
### `test "TGC S3: the insertion barrier shades an atom stored during marking"` (`src/tests/core.zig:18292`)
...
### `test "TGC S3-c: the atom verdict is applied in the pause that took it, not after the morgue drains"` (`src/tests/core.zig:18318`)
...
### `test "needs_finalizer is recorded in both the header and the block bitmap"` (`src/tests/core.zig:18364`)
...
### `test "storage-cell mint writes runtime kind tags on block and extent paths"` (`src/tests/core.zig:18450`)
...
### `test "TGC S4-b: an external property buffer survives with its owner and dies one major later"` (`src/tests/core.zig:18488`)
...
### `test "TGC S4-b: an aged owner remembers a property buffer minted after its promotion"` (`src/tests/core.zig:18516`)
...
### `test "Q22: a bitmap-reclaimed storage cell leaves the byte ledger exactly once"` (`src/tests/core.zig:18543`)
...
### `test "TGC S4-b: a growing dense array leaves every superseded element cell to the sweep"` (`src/tests/core.zig:18590`)
...
### `test "Q21: the element cell is kept alive by the arm, not by flags.fast_array"` (`src/tests/core.zig:18617`)
...
### `test "TGC S4-b: a mapped-arguments var-ref table is an array storage cell"` (`src/tests/core.zig:18653`)
...
### `test "TGC S4-b: storage over the block-cell ceiling takes the extent route and is swept"` (`src/tests/core.zig:18683`)
...
### `test "promise coallocation: state and reactions survive through the sole owner"` (`src/tests/core.zig:18732`)
...
### `test "promise coallocation: accounting and allocation failure share the object cell"` (`src/tests/core.zig:18780`)
...
### `test "TGC S4-c: every a-class payload is a cell that dies one major after its owner"` (`src/tests/core.zig:18808`)
...
### `test "TGC S4-c: a bytecode function's rare/aux record is a payload cell"` (`src/tests/core.zig:18889`)
...
### `test "TGC S4-c: an aged promise remembers a reaction cell minted after its promotion"` (`src/tests/core.zig:18918`)
...
### `test "TGC S4-c: bound arguments, disposable resources and arguments var-refs cross a major"` (`src/tests/core.zig:18953`)
...
### `test "TGC S4-c: a payload slice over the block-cell ceiling takes the extent route"` (`src/tests/core.zig:19018`)
...
### `test "array_list_erased append matches std ArrayList growth"` (`src/tests/core.zig:19052`)
...
### `test "array_list_erased append matches MemoryAccount allocator ledger"` (`src/tests/core.zig:19087`)
...
### `test "array_list_erased toOwnedSlice matches std ArrayList shrink-to-fit"` (`src/tests/core.zig:19119`)
...
### `test "array_list_erased toOwnedSlice matches MemoryAccount allocator ledger"` (`src/tests/core.zig:19162`)
...
### `test "sort_erased heap matches std.sort.heap"` (`src/tests/core.zig:19201`)
...
### `test "gc_audit_print leftover formats match debug.print digits"` (`src/tests/core.zig:19250`)
...
### `test "gc_audit_print hexPad matches zero-padded hex widths"` (`src/tests/core.zig:19586`)
...
### `test "json leftover unicode escapes match hexPad min-width"` (`src/tests/core.zig:19613`)
...
### `test "gc_audit_print handles full unsigned range and writer errors"` (`src/tests/core.zig:19622`)
