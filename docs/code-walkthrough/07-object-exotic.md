...
### `Object.getPrototype` (`src/core/object.zig:7506`)
...
### `Object.setPrototype` (`src/core/object.zig:7510`)
...
### `Object.setFreshObjectPrototype` (`src/core/object.zig:7534`)
...
### `Object.preventExtensions` (`src/core/object.zig:7550`)
...
### `Object.isExtensible` (`src/core/object.zig:7554`)
...
### `Object.markImmutablePrototype` (`src/core/object.zig:7558`)
...
### `Object.hasImmutablePrototype` (`src/core/object.zig:7562`)
...
### `Object.getOwnProperty` (`src/core/object.zig:7566`)
...
### `Object.descriptorFromOwnPropertySlot` (`src/core/object.zig:7610`)
...
### `Object.isModuleNamespaceExportProperty` (`src/core/object.zig:7625`)
...
### `Object.ownPropertyEnumerableKind` (`src/core/object.zig:7648`)
...
### `Object.hasOwnProperty` (`src/core/object.zig:7673`)
...
### `Object.existsOwnProperty` (`src/core/object.zig:7691`)
...
### `Object.ownPropertyEnumerable` (`src/core/object.zig:7728`)
...
### `Object.hasProperty` (`src/core/object.zig:7743`)
...
### `Object.getProperty` (`src/core/object.zig:7753`)
...
### `Object.getOwnDataPropertyValue` (`src/core/object.zig:8253`)
...
### `Object.getOwnDataObjectBorrowed` (`src/core/object.zig:8258`)
...
### `Object.getOwnConstructorPrototypeObject` (`src/core/object.zig:8275`)
...
### `Object.getOwnDataPropertyLookup` (`src/core/object.zig:8291`)
...
### `Object.getOwnDataPropertyValueAt` (`src/core/object.zig:8300`)
...
### `Object.getDenseArrayElementValue` (`src/core/object.zig:8308`)
...
### `Object.defineOwnProperty` (`src/core/object.zig:8312`)
...
### `Object.defineOwnPropertyAssumingNew` (`src/core/object.zig:8384`)
...
### `Object.defineOwnDataPropertyAssumingNewFromRootedAtom` (`src/core/object.zig:8410`)
...
### `Object.defineOwnNonIndexPropertyAssumingNew` (`src/core/object.zig:8435`)
...
### `Object.defineJsonParseDataProperty` (`src/core/object.zig:8444`)
...
### `Object.setProperty` (`src/core/object.zig:9206`)
...
### `Object.setOwnWritableDataProperty` (`src/core/object.zig:9303`)
...
### `Object.setOwnDataPropertyAtForLexicalSyncOwned` (`src/core/object.zig:9348`)
...
### `Object.setOrDefineOwnDataPropertyForSimpleSet` (`src/core/object.zig:9362`)
...
### `Object.defineOwnDataPropertyForSetKnownNoOwn` (`src/core/object.zig:9416`)
...
### `Object.defineNewOwnDataPropertyForSimpleSetKnownNoOwn` (`src/core/object.zig:9447`)
...
### `Object.setOrDefineOwnDataPropertyForPutFieldOwned` (`src/core/object.zig:9536`)
...
### `Object.defineModuleNamespaceProperty` (`src/core/object.zig:9668`)
...
### `Object.deleteOrdinaryPropertyAt` (`src/core/object.zig:9697`)
...
### `Object.deleteProperty` (`src/core/object.zig:9745`)
...
### `Object.ownKeys` (`src/core/object.zig:9780`)
...
### `Object.freeKeys` (`src/core/object.zig:9860`)
...
### `Object.seal` (`src/core/object.zig:9864`)
...
### `Object.freeze` (`src/core/object.zig:9883`)
...
### `Object.defineOrdinaryOwnProperty` (`src/core/object.zig:9904`)
...
### `Object.defineOrdinaryOwnPropertyKnownNoOwn` (`src/core/object.zig:9939`)
...
### `Object.defineArrayLength` (`src/core/object.zig:9951`)
...
### `Object.updateMappedArgumentsBinding` (`src/core/object.zig:10924`)
...
### `Object.prepareMappedArgumentsDescriptorForDefine` (`src/core/object.zig:10945`)
...
### `Object.setMappedArgumentsBindingValue` (`src/core/object.zig:10955`)
...
### `Object.deleteMappedArgumentsBinding` (`src/core/object.zig:10962`)
...
### `Object.mappedArgumentsBindingValue` (`src/core/object.zig:10969`)
...
### `Object.mappedArgumentsBindingIndexFromAtom` (`src/core/object.zig:10977`)
...
### `Object.mappedArgumentsTaggedBindingIndex` (`src/core/object.zig:10983`)
...
### `Object.hasMappedArgumentsBinding` (`src/core/object.zig:10989`)
...
### `Object.detachAllMappedArgumentsBindings` (`src/core/object.zig:11010`)
...
### `isTypedArrayObjectForSetFastPath` (`src/core/object.zig:11066`)
...
### `isTypedArrayObject` (`src/core/object.zig:11083`)
...
### `typedArrayOutOfBounds` (`src/core/object.zig:11088`)
...
### `typedArrayDetached` (`src/core/object.zig:11099`)
...
### `typedArrayLength` (`src/core/object.zig:11105`)
...
### `typedArrayByteLength` (`src/core/object.zig:11112`)
...
### `typedArrayEffectiveByteOffset` (`src/core/object.zig:11117`)
...
### `typedArrayIndexValid` (`src/core/object.zig:11123`)
...
### `typedArrayCanonicalNumericIndex` (`src/core/object.zig:11136`)
...
### `typedArrayBackedByResizableBuffer` (`src/core/object.zig:11166`)
...
### `arrayBufferIsImmutable` (`src/core/object.zig:11173`)
...
### `markArrayBufferImmutable` (`src/core/object.zig:11178`)
...
### `typedArrayImmutableBuffer` (`src/core/object.zig:11183`)
...
### `typedArrayRejectImmutableBuffer` (`src/core/object.zig:11190`)
...
### `isCompatible` (`src/core/object.zig:11194`)
...
### `mergeDescriptor` (`src/core/object.zig:11222`)
...
- 清单函数数（本文件分到）: 69（`src/core/object.zig` 全文件 879）
- 本文标题覆盖: 69
- 未覆盖: 无
