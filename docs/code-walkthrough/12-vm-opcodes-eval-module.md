...
### `directEval` (`src/exec/vm_eval_module.zig:29`)
...
### `applyEval` (`src/exec/vm_eval_module.zig:64`)
...
### `dynamicImport` (`src/exec/vm_eval_module.zig:95`)
...
### `readInt` (`src/exec/vm_eval_module.zig:133`)
