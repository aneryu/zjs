...
### `Object.value` (`src/core/object.zig:2198`)
...
### `Object.cachedIteratorNextSlot` (`src/core/object.zig:2202`)
...
### `Object.cachedIteratorNext` (`src/core/object.zig:2227`)
...
### `Object.clearCachedIteratorNext` (`src/core/object.zig:2233`)
...
### `Object.clearCachedIteratorNextWithoutFree` (`src/core/object.zig:2240`)

- **签名**：`fn clearCachedIteratorNextWithoutFree(rt: *JSRuntime, self: *Object) void`。
- **作用**：在清理路径移除next缓存entry。
- **实现**：与clearCachedIteratorNext当前实现相同：找到后value=null并swap-remove。
- **所有权 / 错误 / 调用**：名称保留历史差异，不能描述为普通版本会做RC free而本版本不做；不释放侧表backing。
...
- **实现**：bytecode已有aux返回rare字段；否则createPayloadCell(BytecodeFunctionAux)，将旧未tag的home指针复制为aux.home_object，写tagged aux并bulk barrier。非bytecode取得functionPayload，无则断言kind后TypeError；已有rare返回，否则createRuntime默认FunctionRarePayload并安装。
- **所有权 / 错误 / 调用**：两条路线分配与生命周期不同，native rare不是此处mint的GC cell。bytecode迁移保留home引用，成功后才替换原槽；不初始化具体rare业务状态。

### `Object.functionRarePayload` (`src/core/object.zig:2470`)
...
### `Object.functionRarePayloadConst` (`src/core/object.zig:2476`)
...
### `Object.installExternalClassPayload` (`src/core/object.zig:2482`)
...
### `Object.assertOnlyPayloadWordIsLive` (`src/core/object.zig:2501`)
...
### `Object.nativeSelf` (`src/core/object.zig:2511`)
...
### `Object.nativeSelfAssumeClass` (`src/core/object.zig:2519`)
...
### `Object.installNativeSelf` (`src/core/object.zig:2527`)
...
### `Object.takeNativeSelf` (`src/core/object.zig:2535`)
...
### `Object.externalClassPayload` (`src/core/object.zig:2543`)
...
### `Object.externalClassPayloadConst` (`src/core/object.zig:2554`)
...
### `Object.setCachedFunctionProto` (`src/core/object.zig:2562`)
...
### `Object.cachedFunctionProto` (`src/core/object.zig:2573`)
...
### `Object.setCachedPromiseProto` (`src/core/object.zig:2578`)
...
### `Object.cachedPromiseProto` (`src/core/object.zig:2589`)
...
### `Object.setCachedRealmValue` (`src/core/object.zig:2599`)
...
### `Object.setRealmRegExpLegacySlot` (`src/core/object.zig:2618`)
...
### `Object.cachedRealmValue` (`src/core/object.zig:2626`)
...
### `Object.cachedThrowTypeErrorIntrinsic` (`src/core/object.zig:2631`)
...
### `Object.iteratorTargetSlot` (`src/core/object.zig:3110`)
...
### `Object.iteratorLengthSlot` (`src/core/object.zig:3116`)
...
### `Object.iteratorLength` (`src/core/object.zig:3122`)
...
### `Object.setIteratorLength` (`src/core/object.zig:3127`)
...
### `Object.arrayLength` (`src/core/object.zig:3131`)
...
### `Object.setArrayLength` (`src/core/object.zig:3140`)
...
### `Object.hasExoticMethods` (`src/core/object.zig:3145`)
...
### `Object.isArray` (`src/core/object.zig:3149`)
...
### `Object.supportsPlainNamedPropertyStorage` (`src/core/object.zig:3153`)
...
### `Object.isProxy` (`src/core/object.zig:3163`)
...
### `Object.isGlobal` (`src/core/object.zig:3169`)
...
### `Object.hasPropertyStorage` (`src/core/object.zig:3173`)
...
### `Object.hasSlots2Layout` (`src/core/object.zig:3177`)
...
### `Object.propertyStorageIsInline` (`src/core/object.zig:3181`)
...
### `Object.needsSlowPropertyAccess` (`src/core/object.zig:3185`)
...
### `Object.exoticMethods` (`src/core/object.zig:3189`)
...
### `Object.installClassExoticMethods` (`src/core/object.zig:3198`)
...
### `Object.iteratorTarget` (`src/core/object.zig:3210`)
...
### `Object.iteratorDataSlot` (`src/core/object.zig:3215`)
...
### `Object.iteratorData` (`src/core/object.zig:3221`)
...
### `Object.iteratorNextSlot` (`src/core/object.zig:3226`)
...
### `Object.iteratorNext` (`src/core/object.zig:3232`)
...
### `Object.iteratorCallbackSlot` (`src/core/object.zig:3237`)
...
### `Object.iteratorCallback` (`src/core/object.zig:3243`)
...
### `Object.iteratorInnerNextSlot` (`src/core/object.zig:3248`)
...
### `Object.iteratorInnerNext` (`src/core/object.zig:3254`)
...
### `Object.iteratorZipNextsSlot` (`src/core/object.zig:3259`)
...
### `Object.iteratorZipNexts` (`src/core/object.zig:3265`)
...
### `Object.iteratorZipPadsSlot` (`src/core/object.zig:3270`)
...
### `Object.iteratorZipPads` (`src/core/object.zig:3276`)
...
### `Object.iteratorZipKeysSlot` (`src/core/object.zig:3281`)
...
### `Object.iteratorZipKeys` (`src/core/object.zig:3287`)
...
### `Object.iteratorAtomKeysSlot` (`src/core/object.zig:3292`)
...
### `Object.iteratorAtomKeys` (`src/core/object.zig:3298`)
...
### `Object.iteratorIndexSlot` (`src/core/object.zig:3303`)
...
### `Object.iteratorKindSlot` (`src/core/object.zig:3309`)
...
### `Object.iteratorZipAliveSlot` (`src/core/object.zig:3315`)
...
### `Object.iteratorZipModeSlot` (`src/core/object.zig:3321`)
...
### `Object.iteratorZipStateSlot` (`src/core/object.zig:3327`)
...
### `Object.collectionEntriesSlot` (`src/core/object.zig:3334`)
...
### `Object.collectionEntries` (`src/core/object.zig:3340`)
...
### `Object.collectionEntriesCapacitySlot` (`src/core/object.zig:3345`)
...
### `Object.collectionEntriesCapacity` (`src/core/object.zig:3351`)
...
### `Object.collectionBucketHeadsSlot` (`src/core/object.zig:3356`)
...
### `Object.collectionBucketHeads` (`src/core/object.zig:3362`)
...
### `Object.collectionActiveCountSlot` (`src/core/object.zig:3367`)
...
### `Object.collectionActiveCount` (`src/core/object.zig:3373`)
...
### `Object.retainCollectionCursor` (`src/core/object.zig:3381`)
...
### `Object.releaseCollectionCursor` (`src/core/object.zig:3392`)
...
### `Object.collectionLiveCursors` (`src/core/object.zig:3397`)
...
### `Object.retainCollectionIteratorCursor` (`src/core/object.zig:3406`)
...
### `Object.detachCollectionIteratorTarget` (`src/core/object.zig:3420`)
...
### `Object.ensureCollectionEntryCapacity` (`src/core/object.zig:3427`)
...
### `Object.appendCollectionEntryUnindexed` (`src/core/object.zig:3450`)
...
### `Object.clearCollectionIndex` (`src/core/object.zig:3466`)
...
### `Object.weakCollectionEntriesSlot` (`src/core/object.zig:3473`)
...
### `Object.weakCollectionEntries` (`src/core/object.zig:3479`)
...
### `Object.ensureWeakCollectionEntryCapacity` (`src/core/object.zig:3484`)
...
### `Object.finalizationRegistryCleanupCallbackSlot` (`src/core/object.zig:3510`)
...
### `Object.finalizationRegistryCleanupCallback` (`src/core/object.zig:3516`)
...
### `Object.finalizationRegistryRealmContext` (`src/core/object.zig:3521`)
...
### `Object.finalizationRegistryCellsSlot` (`src/core/object.zig:3526`)
...
### `Object.finalizationRegistryCells` (`src/core/object.zig:3532`)
...
### `Object.pendingFinalizationCellCountForTest` (`src/core/object.zig:3537`)
...
### `Object.unregisterFinalizationRegistryCells` (`src/core/object.zig:3547`)
...
### `Object.ensureFinalizationRegistryCellCapacity` (`src/core/object.zig:3575`)
...
### `Object.appendFinalizationRegistryCell` (`src/core/object.zig:3600`)
...
- **实现**：断言 FR class，以 ValueRootFrame 包住三个输入值；取得 target/token identity 后登记 borrowed holder，确保 cells 容量，再扩有效长度、retain 两个非空 identity，并预留一个 cleanup job 槽。安装 cell 后对 held_value 做 owner 屏障，最后再次登记 holder。
...
### `Object.stdFileSlot` (`src/core/object.zig:3656`)
...
### `Object.stdFileIsPopenSlot` (`src/core/object.zig:3662`)
...
### `Object.stdFileIsStdioSlot` (`src/core/object.zig:3668`)
...
### `Object.disposableStackDisposedSlot` (`src/core/object.zig:3674`)
...
### `Object.disposableStackDisposed` (`src/core/object.zig:3680`)
...
### `Object.appendDisposableResource` (`src/core/object.zig:3685`)
...
### `Object.disposableStackHasAsyncHint` (`src/core/object.zig:3727`)
...
### `Object.disposableStackAsyncResolveSlot` (`src/core/object.zig:3735`)
...
### `Object.disposableStackAsyncRejectSlot` (`src/core/object.zig:3741`)
...
### `Object.disposableStackAsyncErrorSlot` (`src/core/object.zig:3747`)
...
### `Object.clearDisposableStackAsyncCapability` (`src/core/object.zig:3753`)
...
### `Object.popDisposableResource` (`src/core/object.zig:3761`)
...
### `Object.moveDisposableResourcesTo` (`src/core/object.zig:3770`)
...
### `Object.setVarRefValue` (`src/core/object.zig:3790`)
...
### `Object.setOptionalValueSlot` (`src/core/object.zig:3799`)
...
### `Object.clearOptionalValueSlot` (`src/core/object.zig:3808`)
...
### `Object.takeOptionalValueSlot` (`src/core/object.zig:3813`)
...
### `Object.setPromiseResult` (`src/core/object.zig:3820`)
...
### `Object.setPromiseReactionCallback` (`src/core/object.zig:3824`)
...
### `Object.setPromiseReactionArg` (`src/core/object.zig:3828`)
...
### `Object.setFunctionPromiseCapabilitySlot` (`src/core/object.zig:3832`)
...
### `Object.setFunctionPromiseResolvingTarget` (`src/core/object.zig:3836`)
...
### `Object.setFunctionPromiseResolvingState` (`src/core/object.zig:3840`)
...
### `Object.setFunctionPromiseCombinatorState` (`src/core/object.zig:3844`)
...
### `Object.setFunctionPromiseFinallyPayload` (`src/core/object.zig:3848`)
...
### `Object.setFunctionPromiseFinallyCallback` (`src/core/object.zig:3852`)
...
### `Object.setFunctionPromiseFinallyConstructor` (`src/core/object.zig:3856`)
...
### `Object.varRefValueSlot` (`src/core/object.zig:3860`)
...
### `Object.varRefValue` (`src/core/object.zig:3866`)
...
### `Object.varRefIsConstSlot` (`src/core/object.zig:3871`)
...
### `Object.varRefIsFunctionNameSlot` (`src/core/object.zig:3877`)
...
### `Object.varRefIsDeletableSlot` (`src/core/object.zig:3883`)
...
### `Object.ensureTypedArrayPayload` (`src/core/object.zig:3890`)
...
### `Object.initTypedArrayView` (`src/core/object.zig:3906`)
...
### `Object.byteStorage` (`src/core/object.zig:3939`)
...
### `Object.installByteStorage` (`src/core/object.zig:3944`)
...
### `Object.installInlineByteStorage` (`src/core/object.zig:3960`)
...
### `Object.installExternalByteStorage` (`src/core/object.zig:3979`)
...
### `Object.detachByteStorage` (`src/core/object.zig:4002`)
...
### `Object.sharedByteStorageStore` (`src/core/object.zig:4013`)
...
### `Object.installSharedByteStorage` (`src/core/object.zig:4018`)
...
### `Object.setSharedByteStorageLength` (`src/core/object.zig:4036`)
...
### `Object.arrayBufferDetached` (`src/core/object.zig:4044`)
...
### `Object.arrayBufferImmutableSlot` (`src/core/object.zig:4049`)
...
### `Object.arrayBufferImmutable` (`src/core/object.zig:4055`)
...
### `Object.arrayBufferMaxByteLengthSlot` (`src/core/object.zig:4060`)
...
### `Object.arrayBufferMaxByteLength` (`src/core/object.zig:4066`)
...
### `Object.typedArrayBufferSlot` (`src/core/object.zig:4071`)
...
### `Object.typedArrayBuffer` (`src/core/object.zig:4077`)
...
### `Object.typedArrayByteOffset` (`src/core/object.zig:4082`)
...
### `Object.typedArrayElementSizeSlot` (`src/core/object.zig:4087`)
...
### `Object.typedArrayElementSize` (`src/core/object.zig:4095`)
...
### `Object.typedArrayFixedLength` (`src/core/object.zig:4102`)
...
### `Object.typedArrayPayloadFast` (`src/core/object.zig:4112`)
...
### `Object.collectionPayloadBorrowed` (`src/core/object.zig:4118`)
...
### `Object.typedArrayKindSlot` (`src/core/object.zig:4122`)
...
### `Object.typedArrayKind` (`src/core/object.zig:4130`)
...
### `Object.regexpSource` (`src/core/object.zig:4137`)
...
### `Object.setRegexpSource` (`src/core/object.zig:4148`)
...
### `Object.regexpLastIndexSlot` (`src/core/object.zig:4160`)
...
### `Object.regexpLastIndex` (`src/core/object.zig:4170`)
...
### `Object.regexpLastIndexWritable` (`src/core/object.zig:4176`)
...
### `Object.initializeRegExpLastIndex` (`src/core/object.zig:4185`)
...
### `Object.regexpCompiledBytecode` (`src/core/object.zig:4197`)
...
### `Object.clearRegexpCompiledBytecode` (`src/core/object.zig:4208`)
...
### `Object.setRegexpCompiledBytecode` (`src/core/object.zig:4217`)
...
### `Object.setRegexpCompiledBytecodeString` (`src/core/object.zig:4239`)
...
### `Object.boundTargetSlot` (`src/core/object.zig:4250`)
...
### `Object.boundTarget` (`src/core/object.zig:4256`)
...
### `Object.boundThisSlot` (`src/core/object.zig:4261`)
...
### `Object.boundThis` (`src/core/object.zig:4267`)
...
### `Object.boundArgsSlot` (`src/core/object.zig:4272`)
...
### `Object.boundArgs` (`src/core/object.zig:4278`)
...
### `Object.ensureProxyPayload` (`src/core/object.zig:4283`)
...
### `Object.proxyTargetSlot` (`src/core/object.zig:4292`)
...
### `Object.proxyTarget` (`src/core/object.zig:4298`)
...
### `Object.proxyHandlerSlot` (`src/core/object.zig:4303`)
...
### `Object.proxyHandler` (`src/core/object.zig:4309`)
...
### `Object.allocateMappedArgumentsVarRefsAssumingEmpty` (`src/core/object.zig:4320`)
...
### `Object.unmappedArgumentsDenseValues` (`src/core/object.zig:4350`)
...
### `Object.fullyBoundMappedArgumentsVarRefs` (`src/core/object.zig:4366`)
...
### `Object.argumentsVarRefs` (`src/core/object.zig:4376`)
...
### `Object.argumentsVarRefsMut` (`src/core/object.zig:4384`)
...
### `Object.objectDataSlot` (`src/core/object.zig:4392`)
...
### `Object.objectData` (`src/core/object.zig:4398`)
...
### `Object.setWeakRefTarget` (`src/core/object.zig:4403`)

- **签名**：`pub fn setWeakRefTarget(self: *Object, rt: *JSRuntime, target: JSValue) !void`。
- **作用**：安装 WeakRef 的弱 target identity。
- **实现**：断言 weak_ref class；仅 target 放入 rootValues 帧，取得 identity 并登记 holder。取得 payload 后保存旧 identity，retain 新非空 identity、替换字段，再登记 holder，release 旧 identity，最后 prune 空 holder。
- **所有权 / 错误 / 调用**：不把 target 变成强边，也不在这里执行 CanBeHeldWeakly 校验。retain/releaseWeakIdentity 对 object identity 无操作，仅 symbol atom 做弱引用计数；新 identity 登记等已发生的副作用没有整体事务回滚。self 的存活由调用方负责。

### `Object.weakRefDeref` (`src/core/object.zig:4424`)
...
### `Object.arrayElementStorageMode` (`src/core/object.zig:4447`)
...
### `Object.denseArmNamesStorageCell` (`src/core/object.zig:4463`)
...
### `Object.arrayElements` (`src/core/object.zig:4471`)
...
### `Object.arrayElementsMut` (`src/core/object.zig:4478`)
...
### `Object.createArrayStorageCell` (`src/core/object.zig:4496`)
...
### `Object.createArrayStorageSlice` (`src/core/object.zig:4514`)
...
### `Object.arrayStorageCellHeader` (`src/core/object.zig:4522`)
...
### `Object.arrayElementsCapacity` (`src/core/object.zig:4526`)
...
### `Object.isFastArray` (`src/core/object.zig:4530`)
...
### `Object.isFastArrayIndexInBounds` (`src/core/object.zig:4534`)
...
### `Object.fastArrayElementAt` (`src/core/object.zig:4538`)
...
### `Object.fastArrayElementDup` (`src/core/object.zig:4543`)
...
### `Object.mappedArgumentsElementDup` (`src/core/object.zig:4564`)
...
### `Object.mappedArgumentsIntElementDup` (`src/core/object.zig:4571`)
...
### `Object.setFastArrayElementDup` (`src/core/object.zig:4579`)
...
### `Object.setFastArrayElementOwned` (`src/core/object.zig:4590`)
...
### `Object.setFastArrayElementOwnedDuringActiveBytecode` (`src/core/object.zig:4598`)
...
### `Object.adoptDenseArrayElementsAssumingEmpty` (`src/core/object.zig:4617`)
...
### `Object.adoptDenseUnmappedArgumentsElementsAssumingEmpty` (`src/core/object.zig:4634`)
...
### `Object.takeLastFullyDenseFastArrayElement` (`src/core/object.zig:4656`)
...
### `Object.freeArrayElementBufferAfterMove` (`src/core/object.zig:4667`)
...
### `Object.ensureArrayBufferCapacity` (`src/core/object.zig:4673`)
...
### `Object.appendInitializedFastArrayValue` (`src/core/object.zig:4711`)
...
### `Object.appendUninitializedFastArraySlot` (`src/core/object.zig:4720`)
...
### `Object.fastArrayEnsureCapacity` (`src/core/object.zig:4732`)
...
### `Object.fastArrayCount` (`src/core/object.zig:4736`)
...
### `Object.fastArrayCapacity` (`src/core/object.zig:4740`)
...
### `Object.fastArrayValues` (`src/core/object.zig:4744`)
...
### `Object.fastArrayValuesMut` (`src/core/object.zig:4748`)
...
### `Object.setFastArrayCountAssumeCapacity` (`src/core/object.zig:4752`)
...
### `Object.fastArraySlotAssumeCapacity` (`src/core/object.zig:4758`)
...
### `Object.promiseResultSlot` (`src/core/object.zig:4764`)
...
### `Object.promiseResult` (`src/core/object.zig:4770`)
...
### `Object.promiseReactionCallbackSlot` (`src/core/object.zig:4775`)
...
### `Object.promiseReactionCallback` (`src/core/object.zig:4781`)
...
### `Object.promiseReactionArgSlot` (`src/core/object.zig:4786`)
...
### `Object.promiseReactionArg` (`src/core/object.zig:4792`)
...
### `Object.promiseReactionsSlot` (`src/core/object.zig:4797`)
...
### `Object.promiseReactions` (`src/core/object.zig:4803`)
...
### `Object.promiseReactionsCapacitySlot` (`src/core/object.zig:4808`)
...
### `Object.promiseIsRejectedSlot` (`src/core/object.zig:4814`)
...
### `Object.promiseIsRejected` (`src/core/object.zig:4820`)
...
### `Object.promiseAtomicsWaitAsyncSlot` (`src/core/object.zig:4825`)
...
### `Object.promiseAtomicsWaitAsync` (`src/core/object.zig:4831`)
...
### `Object.initGeneratorExecutionWithStorage` (`src/core/object.zig:4839`)
...
### `Object.generatorLiveExecution` (`src/core/object.zig:4848`)
...
### `Object.generatorPayloadPtr` (`src/core/object.zig:4862`)
...
### `Object.attachGeneratorOpenVarRefOwners` (`src/core/object.zig:4870`)
...
### `Object.generatorThisSlot` (`src/core/object.zig:4880`)
...
### `Object.setGeneratorThis` (`src/core/object.zig:4884`)
...
### `Object.generatorThis` (`src/core/object.zig:4888`)
...
### `Object.generatorArgs` (`src/core/object.zig:4896`)
...
### `Object.generatorCaptures` (`src/core/object.zig:4904`)
...
### `Object.generatorActualArgCountSlot` (`src/core/object.zig:4912`)
...
### `Object.generatorActualArgCount` (`src/core/object.zig:4916`)
...
### `Object.generatorExecutionStateSlot` (`src/core/object.zig:4924`)
...
### `Object.generatorExecutionState` (`src/core/object.zig:4928`)
...
### `Object.generatorStackUsesCombinedStorage` (`src/core/object.zig:4937`)
...
### `Object.generatorCombinedFrameStorage` (`src/core/object.zig:4943`)
...
### `Object.generatorFrameUsesCombinedStorage` (`src/core/object.zig:4949`)
...
### `Object.finalizeGeneratorExecutionCompletion` (`src/core/object.zig:4958`)
...
### `Object.setGeneratorCurrentFunction` (`src/core/object.zig:4967`)
...
### `Object.generatorCurrentFunction` (`src/core/object.zig:4971`)
...
### `Object.generatorYieldStarIteratorSlot` (`src/core/object.zig:4980`)
...
### `Object.setGeneratorYieldStarIterator` (`src/core/object.zig:4984`)
...
### `Object.clearGeneratorYieldStarIterator` (`src/core/object.zig:4988`)
...
### `Object.generatorYieldStarIterator` (`src/core/object.zig:4992`)
...
### `Object.generatorAsyncPromiseSlot` (`src/core/object.zig:5001`)
...
### `Object.generatorAsyncPromise` (`src/core/object.zig:5007`)
...
### `Object.generatorPcSlot` (`src/core/object.zig:5012`)
...
### `Object.generatorPc` (`src/core/object.zig:5016`)
...
### `Object.generatorResumeCompletionTypeSlot` (`src/core/object.zig:5024`)
...
### `Object.generatorResumeCompletionType` (`src/core/object.zig:5030`)
...
### `Object.generatorDoneSlot` (`src/core/object.zig:5035`)
...
### `Object.completeGeneratorExecution` (`src/core/object.zig:5058`)
...
### `Object.generatorDone` (`src/core/object.zig:5041`)
...
### `Object.generatorExecutingSlot` (`src/core/object.zig:5081`)
...
### `Object.generatorExecuting` (`src/core/object.zig:5088`)
...
### `Object.generatorStartedSlot` (`src/core/object.zig:5094`)
...
### `Object.generatorStarted` (`src/core/object.zig:5100`)
...
### `Object.generatorJustYieldedSlot` (`src/core/object.zig:5105`)
...
### `Object.generatorJustYielded` (`src/core/object.zig:5111`)
...
### `Object.generatorYieldStarSuspendedSlot` (`src/core/object.zig:5116`)
...
### `Object.generatorYieldStarSuspended` (`src/core/object.zig:5122`)
...
### `Object.generatorSuspendKindSlot` (`src/core/object.zig:5127`)
...
### `Object.generatorSuspendKind` (`src/core/object.zig:5133`)
...
### `Object.asyncGeneratorStateSlot` (`src/core/object.zig:5138`)
...
### `Object.asyncGeneratorQueueSlot` (`src/core/object.zig:5144`)
...
### `Object.asyncGeneratorQueue` (`src/core/object.zig:5150`)
...
### `Object.asyncGeneratorQueueCapacitySlot` (`src/core/object.zig:5155`)
...
### `Object.payloadSlot` (`src/core/object.zig:6306`)
...
### `Object.injectSlots2PayloadArmMutationForTest` (`src/core/object.zig:6314`)
...
### `Object.ordinaryPayloadForAudit` (`src/core/object.zig:6320`)
...
### `Object.promiseReactionRecordPayload` (`src/core/object.zig:6324`)
...
### `Object.promiseReactionRecordPayloadConst` (`src/core/object.zig:6329`)
...
### `Object.ordinaryPayload` (`src/core/object.zig:6334`)
...
### `Object.ordinaryPayloadConst` (`src/core/object.zig:6339`)
...
### `Object.iteratorPayload` (`src/core/object.zig:6344`)
...
### `Object.iteratorPayloadConst` (`src/core/object.zig:6350`)
...
### `Object.releaseIteratorCollectionCursor` (`src/core/object.zig:6361`)
...
### `Object.destroyIteratorPayload` (`src/core/object.zig:6370`)
...
### `Object.collectionPayload` (`src/core/object.zig:6379`)
...
### `Object.collectionPayloadForCycleGc` (`src/core/object.zig:6386`)
...
### `Object.collectionPayloadConst` (`src/core/object.zig:6390`)
...
### `Object.destroyCollectionPayload` (`src/core/object.zig:6396`)
...
### `Object.finalizationRegistryPayload` (`src/core/object.zig:6404`)
...
### `Object.finalizationRegistryPayloadForCycleGc` (`src/core/object.zig:6411`)
...
### `Object.finalizationRegistryPayloadConst` (`src/core/object.zig:6415`)
...
### `Object.destroyFinalizationRegistryPayload` (`src/core/object.zig:6421`)
...
### `Object.weakRefPayload` (`src/core/object.zig:6429`)
...
### `Object.weakRefPayloadForCycleGc` (`src/core/object.zig:6436`)
...
### `Object.weakRefPayloadConst` (`src/core/object.zig:6440`)
...
### `Object.destroyWeakRefPayload` (`src/core/object.zig:6446`)
...
### `Object.isWeakReferenceHolderClass` (`src/core/object.zig:6454`)
...
### `Object.weakReferenceHolderLink` (`src/core/object.zig:6461`)
...
### `Object.weakReferenceHolderLinkConst` (`src/core/object.zig:6468`)
...
### `Object.weakReferenceHolderPrevious` (`src/core/object.zig:6475`)
...
### `Object.weakReferenceHolderNext` (`src/core/object.zig:6480`)
...
### `Object.stdFilePayload` (`src/core/object.zig:6485`)
...
### `Object.destroyStdFilePayload` (`src/core/object.zig:6491`)
...
### `Object.disposableStackPayload` (`src/core/object.zig:6499`)
...
### `Object.disposableStackPayloadConst` (`src/core/object.zig:6505`)
...
### `Object.globalPayload` (`src/core/object.zig:6511`)
...
### `Object.globalPayloadConst` (`src/core/object.zig:6517`)
...
### `Object.destroyRealmRecordPayload` (`src/core/object.zig:6523`)
...
### `Object.bufferPayload` (`src/core/object.zig:6533`)
...
### `Object.bufferPayloadConst` (`src/core/object.zig:6539`)
...
### `Object.destroyBufferPayload` (`src/core/object.zig:6545`)
...
### `Object.typedArrayPayload` (`src/core/object.zig:6553`)
...
### `Object.typedArrayPayloadConst` (`src/core/object.zig:6558`)
...
### `Object.destroyTypedArrayPayload` (`src/core/object.zig:6563`)
...
### `Object.regExpPayload` (`src/core/object.zig:6571`)
...
### `Object.regExpPayloadConst` (`src/core/object.zig:6578`)
...
### `Object.boundFunctionPayload` (`src/core/object.zig:6585`)
...
### `Object.boundFunctionPayloadConst` (`src/core/object.zig:6591`)
...
### `Object.proxyPayload` (`src/core/object.zig:6597`)
...
### `Object.proxyPayloadConst` (`src/core/object.zig:6603`)
...
### `Object.argumentsPayload` (`src/core/object.zig:6609`)
...
### `Object.argumentsPayloadConst` (`src/core/object.zig:6615`)
...
### `Object.objectDataPayload` (`src/core/object.zig:6621`)
...
### `Object.objectDataPayloadConst` (`src/core/object.zig:6627`)
...
### `Object.varRefPayload` (`src/core/object.zig:6633`)
...
### `Object.varRefPayloadConst` (`src/core/object.zig:6638`)
...
### `Object.promisePayload` (`src/core/object.zig:6643`)
...
### `Object.promisePayloadConst` (`src/core/object.zig:6648`)
...
### `Object.generatorPayload` (`src/core/object.zig:6653`)
...
### `Object.generatorPayloadConst` (`src/core/object.zig:6659`)
...
### `Object.destroyGeneratorPayload` (`src/core/object.zig:6665`)
...
### `Object.functionPayload` (`src/core/object.zig:6673`)
...
### `Object.functionPayloadConst` (`src/core/object.zig:6679`)
...
### `Object.destroyFunctionPayload` (`src/core/object.zig:6685`)
...
- 清单函数数（本文件分到）: 348（`src/core/object.zig` 全文件 879）
- 本文标题覆盖: 348
- 未覆盖: 无
