...
### `returnTop` (`src/exec/vm_control.zig:25`)
...
### `returnUndefined` (`src/exec/vm_control.zig:41`)
...
### `finishFunctionReturn` (`src/exec/vm_control.zig:48`)
...
### `jump32` (`src/exec/vm_control.zig:56`)
...
### `jump16` (`src/exec/vm_control.zig:62`)
...
### `jump8` (`src/exec/vm_control.zig:68`)
...
### `branch32` (`src/exec/vm_control.zig:74`)
...
### `branch8` (`src/exec/vm_control.zig:85`)
...
### `throwTop` (`src/exec/vm_control.zig:96`)
...
### `createAtomError` (`src/exec/vm_control.zig:123`)
...
### `createThrowErrorValue` (`src/exec/vm_control.zig:142`)
...
### `deliverPendingThrow` (`src/exec/vm_control.zig:158`)
...
### `throwErrorVm` (`src/exec/vm_control.zig:171`)
...
### `catchTarget` (`src/exec/vm_control.zig:196`)
...
### `gosub` (`src/exec/vm_control.zig:205`)
...
### `ret` (`src/exec/vm_control.zig:214`)
...
### `relativePc` (`src/exec/vm_control.zig:223`)
...
### `adapterValueBorrow` (`src/exec/vm_control.zig:227`)
...
### `varRefCellFromValue` (`src/exec/vm_control.zig:236`)
...
### `readInt` (`src/exec/vm_control.zig:240`)
