...
### `JSRuntime.init` (`src/core/runtime.zig:1529`)
...
### `JSRuntime.create` (`src/core/runtime.zig:1538`)

- **签名**：`pub fn create(allocator: std.mem.Allocator, options: RuntimeOptions) !*JSRuntime`。
- **作用**：通过新账户分配runtime并初始化。默认写 `create(allocator, .{})`。
- **实现**：按trace_writer创建account，account.create(JSRuntime)，失败清理该分配；initWithAccount传owns_self_allocation=true。
- **所有权 / 错误 / 调用**：返回拥有self分配的runtime，最终由destroy释放。self分配发生在initWithAccount应用memory_limit之前，不能宣称构造最初分配已受该limit检查。初始化错误传播，外层errdefer只负责self存储，不代替各子系统自己的失败清理。

### `JSRuntime.initWithAccount` (`src/core/runtime.zig:1549`)
...
### `JSRuntime.setOpcodeProfile` (`src/core/runtime.zig:1679`)
...
### `JSRuntime.isOwnerThread` (`src/core/runtime.zig:1684`)
...
### `JSRuntime.requireOwnerThread` (`src/core/runtime.zig:1688`)
...
### `JSRuntime.assertOwnerThread` (`src/core/runtime.zig:1692`)
...
### `JSRuntime.deinit` (`src/core/runtime.zig:1696`)
...
### `JSRuntime.destroy` (`src/core/runtime.zig:1815`)
...
- **所有权 / 错误 / 调用**：必须用于create返回的自有分配；不会按owns_self_allocation跳过free。调用方栈上或外部分配后init的runtime应使用deinit，不得调用destroy。

### `JSRuntime.tryDestroy` (`src/core/runtime.zig:1825`)
...
### `JSRuntime.allocRuntime` (`src/core/runtime.zig:1839`)
...
### `JSRuntime.freeRuntime` (`src/core/runtime.zig:1849`)
...
### `JSRuntime.remapRuntime` (`src/core/runtime.zig:1853`)
...
### `JSRuntime.createRuntime` (`src/core/runtime.zig:1864`)
...
### `JSRuntime.destroyRuntime` (`src/core/runtime.zig:1869`)
...
### `JSRuntime.allocRuntimeAlignedBytes` (`src/core/runtime.zig:1873`)
...
### `JSRuntime.freeRuntimeAlignedBytes` (`src/core/runtime.zig:1880`)
...
### `JSRuntime.registerObject` (`src/core/runtime.zig:1884`)
...
### `JSRuntime.registerObjectWithBytes` (`src/core/runtime.zig:1911`)
...
### `JSRuntime.unregisterObjectWithBytes` (`src/core/runtime.zig:1936`)
...
### `JSRuntime.registerWeakReferenceHolder` (`src/core/runtime.zig:1965`)
...
### `JSRuntime.unregisterWeakReferenceHolder` (`src/core/runtime.zig:1987`)
...
### `JSRuntime.registerBorrowedReferenceHolder` (`src/core/runtime.zig:2013`)
...
### `JSRuntime.borrowedReferenceHolderRegistered` (`src/core/runtime.zig:2028`)
...
### `JSRuntime.unregisterBorrowedReferenceHolder` (`src/core/runtime.zig:2033`)
...
### `JSRuntime.removeBorrowedReferenceHolderAt` (`src/core/runtime.zig:2052`)
...
### `JSRuntime.linkContext` (`src/core/runtime.zig:2061`)
...
### `JSRuntime.linkConstructingContext` (`src/core/runtime.zig:2074`)
...
### `JSRuntime.unlinkConstructingContext` (`src/core/runtime.zig:2087`)
...
### `JSRuntime.unlinkContext` (`src/core/runtime.zig:2106`)
...
### `JSRuntime.firstContext` (`src/core/runtime.zig:2125`)
...
### `JSRuntime.assertNoHostRealmRefsForTeardown` (`src/core/runtime.zig:2129`)
...
### `JSRuntime.contextForGlobal` (`src/core/runtime.zig:2141`)
...
### `JSRuntime.contextForGlobalIncludingConstructing` (`src/core/runtime.zig:2151`)
...
### `JSRuntime.invalidateStandardArrayPrototypeForObjectPrototype` (`src/core/runtime.zig:2164`)
...
### `JSRuntime.invalidateContextStandardArrayPrototype` (`src/core/runtime.zig:2176`)
...
### `JSRuntime.initialArrayShapeForPrototype` (`src/core/runtime.zig:2188`)
...
### `JSRuntime.ensureContextClassPrototypeCapacity` (`src/core/runtime.zig:2205`)
...
### `JSRuntime.nextRetainableClassPrototypeContext` (`src/core/runtime.zig:2235`)
...
### `JSRuntime.clearContextClassPrototype` (`src/core/runtime.zig:2264`)
...
### `JSRuntime.registerRootProvider` (`src/core/runtime.zig:2287`)
...
### `JSRuntime.registerRootProviderChecked` (`src/core/runtime.zig:2295`)
...
### `JSRuntime.rootProvidersUsingInline` (`src/core/runtime.zig:2300`)
...
### `JSRuntime.appendRootProvider` (`src/core/runtime.zig:2304`)
...
### `JSRuntime.unregisterRootProvider` (`src/core/runtime.zig:2322`)
...
### `JSRuntime.traceRoots` (`src/core/runtime.zig:2349`)
...
### `JSRuntime.traceAtomRoots` (`src/core/runtime.zig:2379`)
...
### `JSRuntime.traceStringCacheRoots` (`src/core/runtime.zig:2393`)
...
### `JSRuntime.traceActiveRoots` (`src/core/runtime.zig:2411`)
...
### `JSRuntime.verifyDeferredClassPayloadRootLiveness` (`src/core/runtime.zig:2437`)
...
### `JSRuntime.Audit.checkHeader` (`src/core/runtime.zig:2442`)
...
### `JSRuntime.Audit.visitValue` (`src/core/runtime.zig:2466`)
...
### `JSRuntime.Audit.visitObject` (`src/core/runtime.zig:2471`)
...
### `JSRuntime.Audit.visitHeader` (`src/core/runtime.zig:2476`)
...
### `JSRuntime.traceValueRootFrameChain` (`src/core/runtime.zig:2504`)
...
### `JSRuntime.traceValueRootFrames` (`src/core/runtime.zig:2512`)
...
### `JSRuntime.createPersistentRootSlot` (`src/core/runtime.zig:2557`)
...
### `JSRuntime.createLocalRootSlot` (`src/core/runtime.zig:2561`)
...
### `JSRuntime.createWeakRootSlot` (`src/core/runtime.zig:2565`)
...
### `JSRuntime.createRootSlot` (`src/core/runtime.zig:2591`)
...
### `JSRuntime.destroyWeakRootSlot` (`src/core/runtime.zig:2609`)
...
### `JSRuntime.removeWeakRootSlot` (`src/core/runtime.zig:2616`)
...
### `JSRuntime.takePersistentRootSlot` (`src/core/runtime.zig:2629`)
...
### `JSRuntime.removePersistentRootSlot` (`src/core/runtime.zig:2637`)
...
### `JSRuntime.assertNoOutstandingValueHandles` (`src/core/runtime.zig:2653`)
...
### `JSRuntime.assertIdleForTeardown` (`src/core/runtime.zig:2665`)
...
### `JSRuntime.clearWeakRootSlot` (`src/core/runtime.zig:2687`)
...
### `JSRuntime.sweepDeadWeakPersistentSlots` (`src/core/runtime.zig:2695`)
...
### `JSRuntime.clearWeakPersistentIdentity` (`src/core/runtime.zig:2704`)
...
### `JSRuntime.keepAliveWeakRefTarget` (`src/core/runtime.zig:2713`)
...
### `JSRuntime.clearWeakRefKeptAlive` (`src/core/runtime.zig:2719`)
...
### `JSRuntime.retainWeakIdentity` (`src/core/runtime.zig:2728`)
...
### `JSRuntime.releaseWeakIdentity` (`src/core/runtime.zig:2737`)
...
### `JSRuntime.clearWeakIdentitySlot` (`src/core/runtime.zig:2744`)
...
### `JSRuntime.weakIdentityIsCurrentlyLive` (`src/core/runtime.zig:2750`)
...
### `JSRuntime.valueFromWeakIdentity` (`src/core/runtime.zig:2759`)
...
### `JSRuntime.liveObjectFromWeakIdentity` (`src/core/runtime.zig:2780`)
...
### `JSRuntime.objectFromWeakIdentity` (`src/core/runtime.zig:2784`)
...
### `JSRuntime.registerWeakObjectIdentity` (`src/core/runtime.zig:2791`)
...
### `JSRuntime.peekWeakObjectIdentity` (`src/core/runtime.zig:2822`)
...
### `JSRuntime.takeWeakObjectIdentity` (`src/core/runtime.zig:2831`)
...
### `JSRuntime.clearLocalRootSlotsFrom` (`src/core/runtime.zig:2841`)
...
### `JSRuntime.enterHandleScope` (`src/core/runtime.zig:2854`)
...
### `JSRuntime.localRootCountForTest` (`src/core/runtime.zig:2858`)
...
### `JSRuntime.weakRootCountForTest` (`src/core/runtime.zig:2863`)
...
### `JSRuntime.persistentRootCountForTest` (`src/core/runtime.zig:2868`)
...
### `JSRuntime.symbolValue` (`src/core/runtime.zig:2873`)
...
### `JSRuntime.takeSymbolValue` (`src/core/runtime.zig:2877`)
...
### `JSRuntime.newSymbolValue` (`src/core/runtime.zig:2881`)
...
### `JSRuntime.globalSymbolValue` (`src/core/runtime.zig:2890`)
...
### `JSRuntime.createValueHandle` (`src/core/runtime.zig:2895`)
...
### `JSRuntime.takeValueHandle` (`src/core/runtime.zig:2899`)
...
### `JSRuntime.createPersistentValue` (`src/core/runtime.zig:2903`)
...
### `JSRuntime.createWeakPersistentValue` (`src/core/runtime.zig:2907`)
...
### `JSRuntime.allocNativeEntry` (`src/core/runtime.zig:2918`)
...
### `JSRuntime.registerNativeEntryFinalizer` (`src/core/runtime.zig:2926`)
...
### `JSRuntime.retireNativeEntry` (`src/core/runtime.zig:2932`)
...
### `JSRuntime.internalBuiltinRecord` (`src/core/runtime.zig:2943`)
...
### `JSRuntime.clearExternalHostFunctions` (`src/core/runtime.zig:2948`)
...
### `JSRuntime.runObjectCycleRemoval` (`src/core/runtime.zig:2966`)
...
### `JSRuntime.runObjectCycleRemovalWithValueRoots` (`src/core/runtime.zig:2971`)
...
### `JSRuntime.tryRunObjectCycleRemoval` (`src/core/runtime.zig:2981`)
...
### `JSRuntime.tryRunObjectCycleRemovalWithValueRoots` (`src/core/runtime.zig:2985`)
...
### `JSRuntime.pollGC` (`src/core/runtime.zig:3066`)
...
### `JSRuntime.incrementalMarkPoll` (`src/core/runtime.zig:3333`)
...
### `JSRuntime.resetGCThresholdExcludingDoomed` (`src/core/runtime.zig:3454`)
...
### `JSRuntime.destroySlicePoll` (`src/core/runtime.zig:3466`)
...
### `JSRuntime.finishDoomedCompletion` (`src/core/runtime.zig:3491`)
...
### `JSRuntime.pollGCChecked` (`src/core/runtime.zig:3509`)
...
### `JSRuntime.gcSafepoint` (`src/core/runtime.zig:3518`)
...
### `JSRuntime.afterCallbackBoundaryGC` (`src/core/runtime.zig:3522`)
...
### `JSRuntime.beforeEventLoopIdleGC` (`src/core/runtime.zig:3529`)
...
### `JSRuntime.forceGC` (`src/core/runtime.zig:3536`)
...
### `JSRuntime.forceMajorGC` (`src/core/runtime.zig:3542`)
...
### `JSRuntime.requestGCForTest` (`src/core/runtime.zig:3546`)
...
### `JSRuntime.pollScansConservatively` (`src/core/runtime.zig:3565`)
...
### `JSRuntime.forcePreciseRootScanForTest` (`src/core/runtime.zig:3576`)
...
### `JSRuntime.restoreDefaultRootScanForTest` (`src/core/runtime.zig:3586`)
...
### `JSRuntime.gcPendingForTest` (`src/core/runtime.zig:3591`)
...
### `JSRuntime.gcLastRequestReasonForTest` (`src/core/runtime.zig:3596`)
...
### `JSRuntime.setGCThreshold` (`src/core/runtime.zig:3601`)
...
### `JSRuntime.gcThreshold` (`src/core/runtime.zig:3606`)
...
### `JSRuntime.setMemoryLimit` (`src/core/runtime.zig:3610`)
...
### `JSRuntime.suppressLimitCollectionForTest` (`src/core/runtime.zig:3625`)
...
### `JSRuntime.memoryLimit` (`src/core/runtime.zig:3630`)
...
### `JSRuntime.memoryUsage` (`src/core/runtime.zig:3634`)
...
### `JSRuntime.reportExternalAlloc` (`src/core/runtime.zig:3678`)
...
### `JSRuntime.reportExternalAllocUntracked` (`src/core/runtime.zig:3690`)
...
### `JSRuntime.reportExternalFreeUntracked` (`src/core/runtime.zig:3694`)
...
### `JSRuntime.externalMemoryBytes` (`src/core/runtime.zig:3698`)
...
### `JSRuntime.allocationDebtBytes` (`src/core/runtime.zig:3702`)
...
### `JSRuntime.gcPauseDistribution` (`src/core/runtime.zig:3713`)
...
### `JSRuntime.requestGCForAllocationTotal` (`src/core/runtime.zig:3830`)
...
### `JSRuntime.requestGCForAllocation` (`src/core/runtime.zig:3864`)
...
### `JSRuntime.collectBeforeObjectAllocation` (`src/core/runtime.zig:3873`)
...
### `JSRuntime.collectBeforeObjectAllocationAfterDeferredDrain` (`src/core/runtime.zig:3893`)
...
### `JSRuntime.collectBeforeObjectAllocationAfterFinalizerCheck` (`src/core/runtime.zig:3905`)
...
### `JSRuntime.pollGCBeforeObjectAllocation` (`src/core/runtime.zig:3901`)
...
### `JSRuntime.triggerGCOnAllocation` (`src/core/runtime.zig:3950`)
...
### `JSRuntime.collectBeforeLimitRejection` (`src/core/runtime.zig:3962`)
...
### `JSRuntime.resetGCThreshold` (`src/core/runtime.zig:3967`)
...
### `JSRuntime.singleByteString` (`src/core/runtime.zig:4027`)
...
### `JSRuntime.createSingleByteString` (`src/core/runtime.zig:4033`)
...
### `JSRuntime.cachedSingleByteString` (`src/core/runtime.zig:4040`)
...
### `JSRuntime.emptyString` (`src/core/runtime.zig:4044`)
...
### `JSRuntime.recentTwoUnitString` (`src/core/runtime.zig:4054`)
...
### `JSRuntime.recentAtomString` (`src/core/runtime.zig:4070`)
...
### `JSRuntime.smallIntString` (`src/core/runtime.zig:4092`)
...
### `JSRuntime.percentHexString` (`src/core/runtime.zig:4103`)
...
### `JSRuntime.setStackSize` (`src/core/runtime.zig:4115`)
...
### `JSRuntime.stackSize` (`src/core/runtime.zig:4120`)
...
### `JSRuntime.setNativeStackSize` (`src/core/runtime.zig:4124`)
...
### `JSRuntime.updateNativeStackTop` (`src/core/runtime.zig:4135`)
...
### `JSRuntime.checkNativeStackOverflow` (`src/core/runtime.zig:4157`)
...
### `JSRuntime.internAtom` (`src/core/runtime.zig:4162`)
...
### `JSRuntime.newClassId` (`src/core/runtime.zig:4166`)
...
### `JSRuntime.setInterruptHandler` (`src/core/runtime.zig:4172`)
...
### `JSRuntime.getDynamicImportLoader` (`src/core/runtime.zig:4177`)
...
### `JSRuntime.installDynamicImportLoader` (`src/core/runtime.zig:4181`)
...
### `JSRuntime.standardGlobalOwnPropertyCapacity` (`src/core/runtime.zig:4195`)
...
### `JSRuntime.installStandardGlobals` (`src/core/runtime.zig:4208`)
...
### `JSRuntime.hasInterruptHandler` (`src/core/runtime.zig:4236`)
...
### `JSRuntime.runInterruptHandler` (`src/core/runtime.zig:4240`)
...
### `JSRuntime.setCanBlock` (`src/core/runtime.zig:4245`)
...
### `JSRuntime.canBlock` (`src/core/runtime.zig:4249`)
...
### `JSRuntime.signalHostCompletion` (`src/core/runtime.zig:4253`)
...
### `JSRuntime.resetHostCompletionSignal` (`src/core/runtime.zig:4257`)
...
### `JSRuntime.waitForHostCompletion` (`src/core/runtime.zig:4261`)
...
### `JSRuntime.waitForHostCompletionUntil` (`src/core/runtime.zig:4265`)
...
### `JSRuntime.enqueueFinalizationJobForRealm` (`src/core/runtime.zig:4272`)
...
### `JSRuntime.enqueueFinalizationJobReserved` (`src/core/runtime.zig:4279`)
...
### `JSRuntime.clearPendingFinalizationJobs` (`src/core/runtime.zig:4289`)
...
### `JSRuntime.pendingFinalizationJobCountForTest` (`src/core/runtime.zig:4296`)
...
### `JSRuntime.enqueueDeferredNativeCleanup` (`src/core/runtime.zig:4301`)
...
### `JSRuntime.enqueueDeferredClassPayloadFinalizer` (`src/core/runtime.zig:4308`)
...
### `JSRuntime.reserveDeferredClassPayloadFinalizerSlot` (`src/core/runtime.zig:4324`)
...
### `JSRuntime.releaseDeferredClassPayloadFinalizerSlot` (`src/core/runtime.zig:4336`)
...
### `JSRuntime.registerReservedDeferredClassPayloadRoot` (`src/core/runtime.zig:4346`)
...
### `JSRuntime.unregisterDeferredClassPayloadRoot` (`src/core/runtime.zig:4354`)
...
### `JSRuntime.enqueueReservedDeferredClassPayloadFinalizer` (`src/core/runtime.zig:4367`)
...
### `JSRuntime.hasDeferredNativeCleanups` (`src/core/runtime.zig:4387`)
...
### `JSRuntime.hasPendingDeferredClassPayloadFinalizers` (`src/core/runtime.zig:4391`)
...
### `JSRuntime.isActiveDeferredClassPayloadFinalizerCallback` (`src/core/runtime.zig:4396`)
...
### `JSRuntime.runDeferredNativeCleanupBudgeted` (`src/core/runtime.zig:4401`)
...
### `JSRuntime.runDeferredClassPayloadFinalizerBudgeted` (`src/core/runtime.zig:4418`)
...
### `JSRuntime.drainDeferredNativeCleanups` (`src/core/runtime.zig:4435`)
...
### `JSRuntime.drainDeferredClassPayloadFinalizers` (`src/core/runtime.zig:4440`)
...
### `JSRuntime.drainDeferredClassPayloadFinalizersAtSafeBoundary` (`src/core/runtime.zig:4450`)
...
### `JSRuntime.runDeferredClassPayloadFinalizerJob` (`src/core/runtime.zig:4457`)
...
### `JSRuntime.pendingDeferredNativeCleanupCountForTest` (`src/core/runtime.zig:4464`)
...
### `JSRuntime.pendingDeferredClassPayloadFinalizerCountForTest` (`src/core/runtime.zig:4469`)
...
### `JSRuntime.releaseEmptyDeferredNativeCleanupBuffer` (`src/core/runtime.zig:4474`)
...
### `JSRuntime.ensureDeferredClassPayloadFinalizerCapacity` (`src/core/runtime.zig:4479`)
...
### `JSRuntime.ensureDeferredClassPayloadRootCapacity` (`src/core/runtime.zig:4483`)
...
### `JSRuntime.releaseEmptyDeferredClassPayloadFinalizerBuffer` (`src/core/runtime.zig:4489`)
...
### `JSRuntime.releaseEmptyDeferredClassPayloadRootBuffer` (`src/core/runtime.zig:4495`)
...
### `JSRuntime.beginBorrowedWeakCleanup` (`src/core/runtime.zig:4501`)
...
### `JSRuntime.endBorrowedWeakCleanup` (`src/core/runtime.zig:4508`)
...
### `JSRuntime.borrowedWeakCleanupActive` (`src/core/runtime.zig:4514`)
...
### `JSRuntime.borrowedWeakCleanupIdentityCount` (`src/core/runtime.zig:4518`)
...
### `JSRuntime.enqueueBorrowedWeakCleanupIdentity` (`src/core/runtime.zig:4522`)
...
### `JSRuntime.borrowedWeakCleanupIdentityMatches` (`src/core/runtime.zig:4530`)
...
### `JSRuntime.borrowedWeakCleanupIdentityMatchesSlice` (`src/core/runtime.zig:4543`)
...
### `JSRuntime.clearBorrowedWeakCleanupIdentities` (`src/core/runtime.zig:4556`)
...
### `settlePendingDestructionForGateStats` (`src/core/runtime.zig:4569`)
...
### `newRealmRandomSeed` (`src/core/runtime.zig:4886`)
