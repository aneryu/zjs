...
### `binding_rules.decodeScopeOperand` (`src/bytecode.zig:6342`)
...
### `binding_rules.markEvalCapturedVariables` (`src/bytecode.zig:6362`)
...
### `binding_rules.encodeEvalScopeHead` (`src/bytecode.zig:6381`)
...
### `binding_rules.validateFunctionDefParentChain` (`src/bytecode.zig:6393`)
...
### `binding_rules.JSContext.initWithFunctionDef` (`src/bytecode.zig:6424`)
...
### `binding_rules.JSContext.proveScopeLinksForResolution` (`src/bytecode.zig:6441`)
...
### `binding_rules.JSContext.proveParentScopeLinksForResolution` (`src/bytecode.zig:6448`)
...
### `binding_rules.fclosureEncodingSize` (`src/bytecode.zig:6462`)
...
### `binding_rules.emitFClosure` (`src/bytecode.zig:6467`)
...
### `binding_rules.lowerScopeVarOpGlobal` (`src/bytecode.zig:6488`)
...
### `binding_rules.lowerScopeVarOpLocal` (`src/bytecode.zig:6504`)
...
### `binding_rules.selectShortLoc` (`src/bytecode.zig:6531`)
...
### `binding_rules.shortOpcodesEnabled` (`src/bytecode.zig:6557`)
...
### `binding_rules.selectLocForm` (`src/bytecode.zig:6562`)
...
### `binding_rules.closureVarIsRuntimeVarRef` (`src/bytecode.zig:6567`)
...
### `binding_rules.closureVarSourceIsDynamicGlobal` (`src/bytecode.zig:6578`)
...
### `binding_rules.lookupClosureVar` (`src/bytecode.zig:6598`)
...
### `binding_rules.lookupGlobalClosureVar` (`src/bytecode.zig:6614`)
...
### `binding_rules.addOrFindClosureSource` (`src/bytecode.zig:6626`)
...
### `binding_rules.threadClosureSource` (`src/bytecode.zig:6653`)
...
### `binding_rules.ensureGlobalClosureVar` (`src/bytecode.zig:6679`)
...
### `binding_rules.emitGlobalVarOp` (`src/bytecode.zig:6720`)
...
### `binding_rules.lookupTopLevelModuleLexicalClosureVar` (`src/bytecode.zig:6728`)
...
### `binding_rules.preferTopLevelModuleClassBinding` (`src/bytecode.zig:6737`)
...
### `binding_rules.closureVarKind` (`src/bytecode.zig:6748`)
...
### `binding_rules.closureVarWriteThrowsReadOnly` (`src/bytecode.zig:6768`)
...
### `binding_rules.closureVarConstWriteThrows` (`src/bytecode.zig:6774`)
...
### `binding_rules.writeThrowVarReadOnly` (`src/bytecode.zig:6801`)
...
### `binding_rules.writeThrowVarError` (`src/bytecode.zig:6805`)
...
### `binding_rules.writeThrowVarRedeclaration` (`src/bytecode.zig:6822`)
...
### `binding_rules.lowerScopeVarOpForClosure` (`src/bytecode.zig:6831`)
...
### `binding_rules.resolvePrivateField` (`src/bytecode.zig:6913`)
...
### `binding_rules.isPrivateVarKind` (`src/bytecode.zig:6939`)
...
### `binding_rules.isPrivateSetterCompanionName` (`src/bytecode.zig:6951`)
...
### `binding_rules.resolvePrivateSetter` (`src/bytecode.zig:6960`)
...
### `binding_rules.privateAccessorSize` (`src/bytecode.zig:6985`)
...
### `binding_rules.writePrivateAccessor` (`src/bytecode.zig:6989`)
...
### `binding_rules.loweredPrivateFieldSize` (`src/bytecode.zig:7013`)
...
### `binding_rules.loweredPrivateFieldAtomCount` (`src/bytecode.zig:7037`)
...
### `binding_rules.writePrivateCallMethodZero` (`src/bytecode.zig:7046`)
...
### `binding_rules.writePrivateCallMethod` (`src/bytecode.zig:7052`)
...
### `binding_rules.writeLoweredPrivateField` (`src/bytecode.zig:7059`)
...
### `binding_rules.varNeedsTdzRearm` (`src/bytecode.zig:7140`)
...
### `binding_rules.varNeedsScopeFunctionInit` (`src/bytecode.zig:7144`)
...
### `binding_rules.enterScopeRefreshSize` (`src/bytecode.zig:7153`)
...
### `binding_rules.writeEnterScopeRefresh` (`src/bytecode.zig:7175`)
...
### `binding_rules.leaveScopeCloseSize` (`src/bytecode.zig:7201`)
...
### `binding_rules.writeLeaveScopeClose` (`src/bytecode.zig:7215`)
...
### `binding_rules.lowerScopeVarOpClosure` (`src/bytecode.zig:7232`)
...
### `binding_rules.selectShortVarRef` (`src/bytecode.zig:7244`)
...
### `binding_rules.selectVarRefForm` (`src/bytecode.zig:7261`)
...
### `binding_rules.selectShortArg` (`src/bytecode.zig:7266`)
...
### `binding_rules.selectArgForm` (`src/bytecode.zig:7282`)
...
### `binding_rules.lookupArg` (`src/bytecode.zig:7287`)
...
### `binding_rules.lookupCurrentFunctionName` (`src/bytecode.zig:7299`)
...
### `binding_rules.lookupCurrentPseudoBinding` (`src/bytecode.zig:7309`)
...
### `binding_rules.lowerScopeVarOpArg` (`src/bytecode.zig:7328`)
...
### `binding_rules.resolveScopeVarLookupImpl` (`src/bytecode.zig:7349`)
...
### `binding_rules.resolveScopeVarImpl` (`src/bytecode.zig:7383`)
...
### `binding_rules.resolveScopeVar` (`src/bytecode.zig:7397`)
...
### `binding_rules.resolveLocalOrArgImpl` (`src/bytecode.zig:7417`)
...
### `binding_rules.resolveLocalOrArg` (`src/bytecode.zig:7446`)
...
### `binding_rules.isEvalVarObjectAtom` (`src/bytecode.zig:7457`)
...
### `binding_rules.isDynamicEnvObjectAtom` (`src/bytecode.zig:7461`)
...
### `binding_rules.closureVarRangeHasDynamicEnvObjects` (`src/bytecode.zig:7465`)
...
### `binding_rules.functionHasDynamicEnvObjects` (`src/bytecode.zig:7478`)
...
### `binding_rules.scopeUsesArgumentEnvironmentOnly` (`src/bytecode.zig:7487`)
...
### `binding_rules.ClosureDynamicEnvProbeIterator.init` (`src/bytecode.zig:7505`)
...
### `binding_rules.ClosureDynamicEnvProbeIterator.next` (`src/bytecode.zig:7532`)
...
### `binding_rules.LocalWithProbeIterator.init` (`src/bytecode.zig:7550`)
...
### `binding_rules.LocalWithProbeIterator.next` (`src/bytecode.zig:7562`)
...
### `binding_rules.staticBindingStopsDynamicEnvProbes` (`src/bytecode.zig:7581`)
...
### `binding_rules.scopeVarDynamicProbeEligible` (`src/bytecode.zig:7608`)
...
### `binding_rules.resolvedBindingStopsDynamicEnvProbes` (`src/bytecode.zig:7617`)
...
### `binding_rules.closureDynamicEnvProbeIteratorInitResolved` (`src/bytecode.zig:7652`)
...
### `binding_rules.scopeContainsBinding` (`src/bytecode.zig:7673`)
...
### `binding_rules.EvalVarObjectProbeKind.matches` (`src/bytecode.zig:7695`)
...
### `binding_rules.EvalVarObjectProbeKind.wireKind` (`src/bytecode.zig:7705`)
...
### `binding_rules.evalVarObjectProbePlan` (`src/bytecode.zig:7721`)
...
### `binding_rules.ScopeVarAction.size` (`src/bytecode.zig:7770`)
...
### `binding_rules.ScopeVarAction.atomCount` (`src/bytecode.zig:7774`)
...
### `binding_rules.ScopeVarAction.form` (`src/bytecode.zig:7778`)
...
### `binding_rules.ScopeVarAction.throwReadonly` (`src/bytecode.zig:7782`)
...
### `binding_rules.ScopeVarAction.dropAction` (`src/bytecode.zig:7790`)
...
### `binding_rules.ScopeVarProbePlan.from` (`src/bytecode.zig:7803`)
...
### `binding_rules.scopeVarProbeKind` (`src/bytecode.zig:7825`)
...
### `binding_rules.globalScopeVarAction` (`src/bytecode.zig:7835`)
...
### `binding_rules.closureScopeVarAction` (`src/bytecode.zig:7847`)
...
### `binding_rules.planScopeVarAction` (`src/bytecode.zig:7866`)
...
### `binding_rules.planResolvedScopeVarAction` (`src/bytecode.zig:7918`)
...
### `binding_rules.planScopeVarLowering` (`src/bytecode.zig:7961`)
...
### `binding_rules.writeScopeVarAction` (`src/bytecode.zig:7984`)
...
### `binding_rules.evalVarObjectProbeAccessorSize` (`src/bytecode.zig:8005`)
...
### `binding_rules.evalVarObjectProbeIsWith` (`src/bytecode.zig:8012`)
...
### `binding_rules.evalVarObjectClosureProbe` (`src/bytecode.zig:8019`)
...
### `binding_rules.loweredScopeDeleteVarSize` (`src/bytecode.zig:8026`)
...
### `binding_rules.loweredScopeGetRefSize` (`src/bytecode.zig:8036`)
...
### `binding_rules.loweredScopeMakeRefSize` (`src/bytecode.zig:8052`)
...
### `binding_rules.loweredScopeMakeRefAtomCount` (`src/bytecode.zig:8074`)
...
### `binding_rules.writeEvalVarObjectProbeAccessor` (`src/bytecode.zig:8094`)
...
### `binding_rules.writeLoweredScopeDeleteVar` (`src/bytecode.zig:8122`)
...
### `binding_rules.writeLoweredScopeGetRef` (`src/bytecode.zig:8158`)
...
### `binding_rules.writeFunctionNameDummyRef` (`src/bytecode.zig:8215`)
...
### `binding_rules.writeLoweredScopeMakeRef` (`src/bytecode.zig:8242`)
...
### `binding_rules.isLexicalLocal` (`src/bytecode.zig:8324`)
...
### `binding_rules.isEvalNonLexicalLocal` (`src/bytecode.zig:8330`)
...
### `binding_rules.bytecodeFunctionIsEval` (`src/bytecode.zig:8354`)
...
### `binding_rules.localIsFunctionName` (`src/bytecode.zig:8364`)
...
### `binding_rules.localWriteThrowsReadOnly` (`src/bytecode.zig:8373`)
...
### `binding_rules.lowerScopeVarOpLexical` (`src/bytecode.zig:8390`)
...
### `binding_rules.localLexicalAccessNeedsCheck` (`src/bytecode.zig:8405`)
...
### `binding_rules.writeSelectedLocForm` (`src/bytecode.zig:8410`)
...
### `binding_rules.markReferenceTakenBinding` (`src/bytecode.zig:8421`)
...
### `binding_rules.functionIsStrict` (`src/bytecode.zig:8438`)
...
### `binding_rules.functionDeclaresGlobalVar` (`src/bytecode.zig:8443`)
...
### `binding_rules.canOptimizeGlobalRefPutTail` (`src/bytecode.zig:8451`)
...
### `binding_rules.closureVarIsGlobalFamily` (`src/bytecode.zig:8455`)
...
### `binding_rules.resolveEvalGlobalVarTargets` (`src/bytecode.zig:8465`)
...
### `binding_rules.hasDirectEvalLexicalRedeclaration` (`src/bytecode.zig:8496`)
...
### `binding_rules.isPseudoBindingAtom` (`src/bytecode.zig:8517`)
...
### `binding_rules.threadParentLocalSource` (`src/bytecode.zig:8524`)
...
### `binding_rules.threadParentArgSource` (`src/bytecode.zig:8542`)
...
### `binding_rules.discoverParentScopedSource` (`src/bytecode.zig:8568`)
...
### `binding_rules.threadParentEvalObject` (`src/bytecode.zig:8597`)
...
### `binding_rules.ensureParentArgumentsBinding` (`src/bytecode.zig:8606`)
...
### `binding_rules.ensureCurrentPseudoBinding` (`src/bytecode.zig:8614`)
...
### `binding_rules.findResolvedClosureBinding` (`src/bytecode.zig:8637`)
...
### `binding_rules.resolveBindingTopologyAfterCurrentMiss` (`src/bytecode.zig:8662`)
...
### `binding_rules.resolveBindingTopologyResultImpl` (`src/bytecode.zig:8835`)
...
### `binding_rules.resolveBindingTopologyResult` (`src/bytecode.zig:8857`)
...
### `binding_rules.resolveScopeVarBindingTopologyImpl` (`src/bytecode.zig:8868`)
...
### `binding_rules.ResolvedScopeVarPlan.init` (`src/bytecode.zig:8931`)
...
### `binding_rules.ResolvedScopeVarPlan.withBinding` (`src/bytecode.zig:8951`)
...
### `binding_rules.ResolvedScopeVarPlan.binding` (`src/bytecode.zig:8962`)
...
### `binding_rules.ResolvedScopeVarPlan.action` (`src/bytecode.zig:8971`)
...
### `binding_rules.resolveScopeVarPlanImpl` (`src/bytecode.zig:8983`)
...
### `binding_rules.resolveScopeVarPlanV2` (`src/bytecode.zig:9019`)
...
### `binding_rules.resolveBindingTopology` (`src/bytecode.zig:9028`)
...
### `binding_rules.resolveScopeVarBindingTopologyV2` (`src/bytecode.zig:9032`)
...
### `binding_rules.privateBindingOwner` (`src/bytecode.zig:9045`)
...
### `binding_rules.findPrivateSetterOwnerBinding` (`src/bytecode.zig:9073`)
...
### `binding_rules.resolvePrivateBindingTopology` (`src/bytecode.zig:9087`)
