...
### `Program.phase1Code` (`src/compiler/test_entry.zig:25`)
...
### `Program.deinit` (`src/compiler/test_entry.zig:29`)
...
### `configureScriptRoot` (`src/compiler/test_entry.zig:40`)
...
### `configureModuleRoot` (`src/compiler/test_entry.zig:46`)
...
### `parseAndCompileV2TestProgram` (`src/compiler/test_entry.zig:55`)
...
### `ParseHarness.init` (`src/compiler/tests.zig:33`)
...
### `ParseHarness.builder` (`src/compiler/tests.zig:45`)
...
### `ParseHarness.childBuilder` (`src/compiler/tests.zig:49`)
...
### `ParseHarness.grandchildBuilder` (`src/compiler/tests.zig:53`)
...
### `ParseHarness.deinit` (`src/compiler/tests.zig:57`)
...
### `ExecHarness.init` (`src/compiler/tests.zig:75`)
...
### `ExecHarness.deinit` (`src/compiler/tests.zig:95`)
...
### `expectV2Stream` (`src/compiler/tests.zig:111`)
...
### `expectResolvedStream` (`src/compiler/tests.zig:125`)
...
### `expectLabel` (`src/compiler/tests.zig:148`)
...
### `expectResolvedLabel` (`src/compiler/tests.zig:156`)
...
### `installedFunctionHasShortOpcode` (`src/compiler/tests.zig:170`)
...
### `compileAndRun` (`src/compiler/tests.zig:193`)
...
### `compileAndRunWithHook` (`src/compiler/tests.zig:200`)
...
### `expectFunctionDefInertAfterEscape` (`src/compiler/tests.zig:249`)
...
### `expectPublishedAtomResolves` (`src/compiler/tests.zig:273`)
...
### `expectPublishedFunctionBytecodeOwnersResolve` (`src/compiler/tests.zig:278`)
...
### `expectRelocIntegrity` (`src/compiler/tests.zig:315`)
...
### `expectSourceOrder` (`src/compiler/tests.zig:364`)
...
### `expectSourceOffsets` (`src/compiler/tests.zig:373`)
...
### `oomScript` (`src/compiler/tests.zig:493`)
...
### `countInstalledOpcode` (`src/compiler/tests.zig:3132`)
...
### `compileRunAndCount` (`src/compiler/tests.zig:3152`)
...
### `s3bDrainGc` (`src/compiler/tests.zig:3527`)
...
### `s3bExpectDefTreeMarked` (`src/compiler/tests.zig:3540`)
...
### `s3bMajorBeforeFinalize` (`src/compiler/tests.zig:3560`)
...
### `s3bExpectTemplateArraysMarked` (`src/compiler/tests.zig:3612`)
