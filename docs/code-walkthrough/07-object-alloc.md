...
### `Object.expect` (`src/core/object.zig:866`)
...
### `Object.create` (`src/core/object.zig:872`)
...
### `Object.createFinalizationRegistry` (`src/core/object.zig:885`)
...
### `Object.createWithOwnPropertyCapacity` (`src/core/object.zig:898`)
...
### `Object.reserveOwnPropertyCapacity` (`src/core/object.zig:905`)
...
### `Object.createGeneratorShell` (`src/core/object.zig:919`)
...
### `Object.finishGeneratorShell` (`src/core/object.zig:978`)
...
### `Object.destroyGeneratorShell` (`src/core/object.zig:1006`)
...
### `Object.createFromPropertyTemplate` (`src/core/object.zig:1027`)
...
### `Object.createFromShape` (`src/core/object.zig:1036`)
...
### `Object.createArrayFromShape` (`src/core/object.zig:1049`)
...
### `Object.createArrayFromInitialShape` (`src/core/object.zig:1074`)
...
### `Object.collectBeforeObjectAllocationPublishingShape` (`src/core/object.zig:1147`)
...
### `Object.createPlainObject` (`src/core/object.zig:1184`)
...
### `Object.createPlainObjectReserved2` (`src/core/object.zig:1238`)
...
### `Object.createRegExpFromShape` (`src/core/object.zig:1304`)
...
### `Object.createRegExpMatchArrayFromShape` (`src/core/object.zig:1311`)
...
### `Object.createArgumentsFromShape` (`src/core/object.zig:1343`)
...
### `createPreparedPropertyTemplate` (`src/core/object.zig:1426`)
...
### `Object.createInternal` (`src/core/object.zig:1501`)
...
### `Object.payloadKindAllocates` (`src/core/object.zig:1758`)
...
### `Object.payloadKindIsTracerOwnedCell` (`src/core/object.zig:1777`)
...
### `Object.payloadKindIsTracerOwnedCellOrNone` (`src/core/object.zig:1811`)
...
### `Object.payloadKindNeedsFinalizer` (`src/core/object.zig:1823`)
...
### `Object.markNeedsFinalizer` (`src/core/object.zig:1833`)
...
### `Object.hasTracerOwnedPayloadCell` (`src/core/object.zig:1837`)
...
### `Object.mintPayloadCell` (`src/core/object.zig:1849`)
...
### `Object.createPayloadCell` (`src/core/object.zig:1863`)
...
### `Object.payloadCellHeader` (`src/core/object.zig:1869`)
...
### `Object.createPayloadSliceCell` (`src/core/object.zig:1881`)
...
### `allocClassPayloadCell` (`src/core/object.zig:1901`)
...
### `Object.classPayloadCellBytes` (`src/core/object.zig:1920`)
...
### `allocFunctionPayload` (`src/core/object.zig:1941`)
...
### `allocClassPayload` (`src/core/object.zig:1961`)
...
### `freeClassPayloadAllocation` (`src/core/object.zig:2040`)
...
### `Object.inlineClassPayloadLayout` (`src/core/object.zig:2077`)
...
### `Object.inlineClassPayloadLayoutForDefinition` (`src/core/object.zig:2082`)
...
### `Object.inlineClassPayloadLayoutFromScalars` (`src/core/object.zig:2093`)
...
### `Object.initInlineClassPayloadGcPrefix` (`src/core/object.zig:2111`)
...
### `Object.inlineClassPayloadPtr` (`src/core/object.zig:2120`)
...
### `Object.freeObjectAllocation` (`src/core/object.zig:2134`)
...
### `Object.inlineClassObjectSize` (`src/core/object.zig:2167`)
...
### `freeInlinePayloadObjectAllocation` (`src/core/object.zig:2152`)
...
### `Object.allocationSize` (`src/core/object.zig:2175`)
...
### `Object.createArray` (`src/core/object.zig:2183`)
...
### `Object.createArrayWithOwnPropertyCapacity` (`src/core/object.zig:2192`)
...
- 清单函数数（本文件分到）: 46（`src/core/object.zig` 全文件 879）
- 本文标题覆盖: 46
- 未覆盖: 无
