...
### `leaf` (`src/binding/native.zig:167`)
...
### `leafWithState` (`src/binding/native.zig:173`)
...
### `leafSpec` (`src/binding/native.zig:177`)
...
### `native.t` (`src/binding/native.zig:191`)
...
### `native.stateOf` (`src/binding/native.zig:198`)
...
### `native.void_to_void` (`src/binding/native.zig:201`)
...
### `native.i32_to_i32` (`src/binding/native.zig:204`)
...
### `native.i32_i32_to_i32` (`src/binding/native.zig:207`)
...
### `native.f64_to_f64` (`src/binding/native.zig:210`)
...
### `native.f64_f64_to_f64` (`src/binding/native.zig:213`)
...
### `native.f64_to_void` (`src/binding/native.zig:216`)
...
### `native.bool_to_bool` (`src/binding/native.zig:219`)
...
### `native.state_f64_to_void` (`src/binding/native.zig:222`)
...
### `native.state_i32_to_i32` (`src/binding/native.zig:225`)
...
### `P.add` (`src/binding/native.zig:255`)
...
### `P.half` (`src/binding/native.zig:258`)
...
### `Probe.f` (`src/binding/native.zig:270`)
...
### `Class` (`src/binding/native.zig:320`)
...
### `Class.classId` (`src/binding/native.zig:337`)
...
### `Class.unwrap` (`src/binding/native.zig:343`)
...
### `native.thunk` (`src/binding/native.zig:349`)
...
### `Class.constructThunk` (`src/binding/native.zig:371`)
...
### `Class.memberTable` (`src/binding/native.zig:404`)
...
### `Handle.classId` (`src/binding/native.zig:427`)
...
### `Handle.create` (`src/binding/native.zig:434`)
...
### `Handle.unwrap` (`src/binding/native.zig:440`)
...
### `Handle.dispose` (`src/binding/native.zig:446`)
...
### `Handle.prototype` (`src/binding/native.zig:453`)
...
### `selfParamCheck` (`src/binding/native.zig:460`)
...
### `selfOf` (`src/binding/native.zig:467`)
...
### `methodSpec` (`src/binding/native.zig:473`)
...
### `native.thunk` (`src/binding/native.zig:482`)
...
### `native.t` (`src/binding/native.zig:501`)
...
### `native.self_to_f64` (`src/binding/native.zig:506`)
...
### `native.self_f64_to_void` (`src/binding/native.zig:509`)
...
### `native.self_f64_f64_to_void` (`src/binding/native.zig:512`)
...
### `native.self_i32_to_i32` (`src/binding/native.zig:515`)
...
### `native.self_to_i32` (`src/binding/native.zig:518`)
...
### `native.self_i32_to_void` (`src/binding/native.zig:521`)
...
### `native.self_to_void` (`src/binding/native.zig:524`)
...
### `getterSpec` (`src/binding/native.zig:549`)
...
### `native.self_to_f64` (`src/binding/native.zig:561`)
...
### `native.self_to_i32` (`src/binding/native.zig:564`)
...
### `native.thunk` (`src/binding/native.zig:577`)
...
### `setterSpec` (`src/binding/native.zig:611`)
...
### `native.self_f64_to_void` (`src/binding/native.zig:622`)
...
### `native.self_i32_to_void` (`src/binding/native.zig:625`)
...
### `native.thunk` (`src/binding/native.zig:639`)
...
### `State.step` (`src/binding/native.zig:683`)
...
### `State.query` (`src/binding/native.zig:687`)
...
### `State.time` (`src/binding/native.zig:691`)
...
### `State.setTime` (`src/binding/native.zig:694`)
