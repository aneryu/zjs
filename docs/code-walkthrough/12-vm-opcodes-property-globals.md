...
### `putVar` (`src/exec/vm_property_globals.zig:204`)
...
### `globalOwnRejectedNonStrictSet` (`src/exec/vm_property_globals.zig:319`)
...
### `canUseFastGlobalVarWrite` (`src/exec/vm_property_globals.zig:335`)
...
### `canUseFastGlobalUndefinedLookup` (`src/exec/vm_property_globals.zig:346`)
...
### `evalFunctionDeclaresGlobalVar` (`src/exec/vm_property_globals.zig:354`)
...
### `globalOwnAccessorWithoutSetter` (`src/exec/vm_property_globals.zig:362`)
...
### `globalDeclIsFunction` (`src/exec/vm_property_globals.zig:367`)
...
### `validateGlobalVarDeclaration` (`src/exec/vm_property_globals.zig:371`)
...
### `validateGlobalVarDeclarations` (`src/exec/vm_property_globals.zig:406`)
...
### `QuickJS global declaration validation does not materialize auto-init properties` (`src/exec/vm_property_globals.zig:418`)
