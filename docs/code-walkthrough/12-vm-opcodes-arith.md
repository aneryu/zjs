...
### `binary` (`src/exec/vm_arith.zig:23`)
...
### `binaryVm` (`src/exec/vm_arith.zig:73`)
...
### `compare` (`src/exec/vm_arith.zig:89`)
...
### `compareVm` (`src/exec/vm_arith.zig:140`)
...
### `compareAt` (`src/exec/vm_arith.zig:172`)
...
### `unary` (`src/exec/vm_arith.zig:235`)
...
### `unaryVm` (`src/exec/vm_arith.zig:267`)
...
### `bitNot` (`src/exec/vm_arith.zig:283`)
...
### `bitNotVm` (`src/exec/vm_arith.zig:295`)
...
### `postUpdate` (`src/exec/vm_arith.zig:310`)
...
### `postUpdateVm` (`src/exec/vm_arith.zig:343`)
...
### `updateLocal` (`src/exec/vm_arith.zig:359`)
...
### `updateLocalVm` (`src/exec/vm_arith.zig:404`)
...
### `updateLocalAt` (`src/exec/vm_arith.zig:428`)
...
### `addLocal` (`src/exec/vm_arith.zig:486`)
...
### `addLocalString` (`src/exec/vm_arith.zig:570`)
...
### `addLocalVm` (`src/exec/vm_arith.zig:594`)
...
### `addLocalAt` (`src/exec/vm_arith.zig:627`)
...
### `addLocalStringAt` (`src/exec/vm_arith.zig:676`)
...
### `fastBinaryInt32` (`src/exec/vm_arith.zig:698`)
...
### `fastInt32Add` (`src/exec/vm_arith.zig:715`)
...
### `fastInt32Sub` (`src/exec/vm_arith.zig:725`)
...
### `fastInt32Mul` (`src/exec/vm_arith.zig:732`)
...
### `fastInt32Mod` (`src/exec/vm_arith.zig:739`)
...
### `fastCompareShortBigInt` (`src/exec/vm_arith.zig:747`)
...
### `isBitwiseBinaryOp` (`src/exec/vm_arith.zig:759`)
...
### `isNumericBinaryOp` (`src/exec/vm_arith.zig:764`)
...
### `looseEqualOp` (`src/exec/vm_arith.zig:769`)
...
### `sameLooseEqualityType` (`src/exec/vm_arith.zig:831`)
...
### `isLoosePrimitiveForObject` (`src/exec/vm_arith.zig:842`)
...
### `looseEqualSameNumberTypes` (`src/exec/vm_arith.zig:846`)
