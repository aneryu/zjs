...
### `execCall` (`src/exec/call_runtime.zig:77`)
...
### `popOwnedStackRegion` (`src/exec/call_runtime.zig:130`)
...
### `handleCatchableRuntimeError` (`src/exec/call_runtime.zig:139`)
...
### `tryCatchInFrame` (`src/exec/call_runtime.zig:157`)
...
### `callValueOrBytecodeRoot` (`src/exec/call_runtime.zig:206`)
...
### `coerceCallThis` (`src/exec/call_runtime.zig:263`)
...
### `callNativeBuiltinRecordForVm` (`src/exec/call_runtime.zig:280`)
...
### `throwRuntimeErrorForGlobal` (`src/exec/call_runtime.zig:323`)
...
### `callValueOrBytecodeRootPreRooted` (`src/exec/call_runtime.zig:335`)
...
### `callValueOrBytecodeRootPreRootedInternal` (`src/exec/call_runtime.zig:351`)
...
### `callValueOrBytecodeRootPreRootedAfterInterruptPoll` (`src/exec/call_runtime.zig:366`)
...
### `OwnedArgList.init` (`src/exec/call_runtime.zig:394`)
...
### `OwnedArgList.initTakeArgs` (`src/exec/call_runtime.zig:424`)
...
### `OwnedArgList.deinit` (`src/exec/call_runtime.zig:453`)
...
### `resolveSyncInlineRoute` (`src/exec/call_runtime.zig:474`)
