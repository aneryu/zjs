...
### `dynEnvProbe` (`src/exec/vm_property.zig:29`)
...
### `dynEnvProbeAccess` (`src/exec/vm_property.zig:46`)
...
### `makeSlotRef` (`src/exec/vm_property.zig:149`)
...
### `makeVarRef` (`src/exec/vm_property.zig:181`)
...
### `makeVarRefVm` (`src/exec/vm_property.zig:222`)
...
### `getRefValue` (`src/exec/vm_property.zig:238`)
...
### `getRefValueVm` (`src/exec/vm_property.zig:277`)
...
### `putRefValue` (`src/exec/vm_property.zig:293`)
...
### `putRefValueVm` (`src/exec/vm_property.zig:342`)
...
### `dynEnvProbeStore` (`src/exec/vm_property.zig:358`)
...
### `deleteVar` (`src/exec/vm_property.zig:408`)
...
### `deletePropertyVm` (`src/exec/vm_property.zig:429`)
