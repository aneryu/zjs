...
### `Object.functionSourceSlot` (`src/core/object.zig:5162`)
...
### `Object.functionSource` (`src/core/object.zig:5166`)

- **签名**：`pub fn functionSource(self: *const Object) ?JSValue`。
- **作用**：取回挂在函数对象上的源码文本，`Function.prototype.toString` 对「native 函数但带源码」这一类（`function_ops.sourceFunction` 造出来的）就靠它返回真正的源文本而不是 `[native code]`。
...
### `Object.hostFunctionKindSlot` (`src/core/object.zig:5171`)
...
### `Object.hostFunctionKind` (`src/core/object.zig:5178`)
...
### `Object.nativeFunctionIdSlot` (`src/core/object.zig:5184`)
...
### `Object.nativeFunctionId` (`src/core/object.zig:5191`)
...
### `Object.setNativeBuiltinIdAndRecord` (`src/core/object.zig:5197`)
...
### `Object.nativeEntrySlot` (`src/core/object.zig:5211`)
...
### `Object.nativeEntry` (`src/core/object.zig:5218`)
...
### `Object.nativeEntryAssumeCFunction` (`src/core/object.zig:5224`)
...
### `Object.nativeCallTarget` (`src/core/object.zig:5239`)
...
### `Object.nativeCallTargetAssumeCFunction` (`src/core/object.zig:5251`)
...
### `Object.isHostEntryFunction` (`src/core/object.zig:5260`)
...
### `Object.installNativeEntry` (`src/core/object.zig:5268`)
...
### `Object.functionIteratorWrapMethodSlot` (`src/core/object.zig:5273`)
...
### `Object.functionIteratorWrapMethod` (`src/core/object.zig:5277`)
...
### `Object.nativeDispatchNameSlot` (`src/core/object.zig:5282`)
...
### `Object.nativeDispatchName` (`src/core/object.zig:5289`)
...
### `Object.installedRealmRegExpLegacyStatics` (`src/core/object.zig:5298`)
...
### `Object.ensureInstalledRealmRegExpLegacyStatics` (`src/core/object.zig:5304`)
...
### `Object.arrayBuiltinMarkerSlot` (`src/core/object.zig:5314`)
...
### `Object.arrayBuiltinMarker` (`src/core/object.zig:5318`)
...
### `Object.typedArrayBuiltinMarker` (`src/core/object.zig:5323`)
...
### `Object.internalCallableTag` (`src/core/object.zig:5328`)
...
### `Object.setInternalCallableTag` (`src/core/object.zig:5333`)
...
### `Object.arrayIteratorKind` (`src/core/object.zig:5341`)
...
### `Object.isIteratorIdentityFunction` (`src/core/object.zig:5346`)
...
### `Object.isArrayIteratorNextFunction` (`src/core/object.zig:5351`)
...
### `Object.isGeneratorNextFunction` (`src/core/object.zig:5356`)
...
### `Object.addGeneratorNextFunction` (`src/core/object.zig:5361`)
...
### `Object.isThrowTypeErrorIntrinsicFunction` (`src/core/object.zig:5366`)
...
### `Object.isAsyncIteratorAsyncDisposeFunction` (`src/core/object.zig:5371`)
...
### `Object.isAsyncGeneratorPrototypeMethod` (`src/core/object.zig:5376`)
...
### `Object.iteratorHelperMethod` (`src/core/object.zig:5381`)
...
### `Object.asyncFromSyncIteratorMethod` (`src/core/object.zig:5386`)
...
### `Object.disposableStackMethod` (`src/core/object.zig:5391`)
...
### `Object.asyncDisposableStackMethod` (`src/core/object.zig:5396`)
...
### `Object.addArrayBuiltinMarker` (`src/core/object.zig:5401`)
...
### `Object.addTypedArrayBuiltinMarker` (`src/core/object.zig:5407`)
...
### `Object.addIteratorIdentityFunction` (`src/core/object.zig:5413`)
...
### `Object.addArrayIteratorNextFunction` (`src/core/object.zig:5419`)
...
### `Object.addThrowTypeErrorIntrinsicFunction` (`src/core/object.zig:5425`)
...
### `Object.addAsyncIteratorAsyncDisposeFunction` (`src/core/object.zig:5431`)
...
### `Object.addAsyncGeneratorPrototypeMethod` (`src/core/object.zig:5437`)
...
### `Object.addIteratorHelperMethod` (`src/core/object.zig:5443`)
...
### `Object.addAsyncFromSyncIteratorMethod` (`src/core/object.zig:5451`)
...
### `Object.addDisposableStackMethod` (`src/core/object.zig:5459`)
...
### `Object.addAsyncDisposableStackMethod` (`src/core/object.zig:5465`)
...
### `Object.addCollectionMethodOwnerClass` (`src/core/object.zig:5471`)
...
### `Object.setArrayBuiltinMarker` (`src/core/object.zig:5477`)
...
### `Object.setTypedArrayBuiltinMarker` (`src/core/object.zig:5483`)
...
### `Object.setArrayIteratorKind` (`src/core/object.zig:5489`)
...
### `Object.setDisposableStackMethod` (`src/core/object.zig:5495`)
...
### `Object.setAsyncDisposableStackMethod` (`src/core/object.zig:5501`)
...
### `Object.setCollectionMethodOwnerClass` (`src/core/object.zig:5507`)
...
### `Object.collectionMethodOwnerClass` (`src/core/object.zig:5513`)
...
### `Object.setFunctionBytecodeValue` (`src/core/object.zig:5518`)
...
### `Object.bytecodeFunctionStoragePtr` (`src/core/object.zig:5537`)
...
### `Object.bytecodeFunctionStoragePtrConst` (`src/core/object.zig:5543`)
...
### `Object.functionBytecode` (`src/core/object.zig:5549`)
...
### `Object.generatorFunctionBytecode` (`src/core/object.zig:5559`)
...
### `Object.generatorFunctionRealmGlobalPtr` (`src/core/object.zig:5572`)
...
### `Object.functionProxyRevokeTargetSlot` (`src/core/object.zig:5579`)
...
### `Object.functionPromiseCapabilitySlot` (`src/core/object.zig:5583`)
...
### `Object.functionPromiseResolvingTarget` (`src/core/object.zig:5588`)
...
### `Object.functionPromiseResolvingState` (`src/core/object.zig:5593`)
...
### `Object.functionPromiseResolvingRejectSlot` (`src/core/object.zig:5598`)
...
### `Object.functionPromiseResolvingReject` (`src/core/object.zig:5602`)
...
### `Object.functionPromiseCombinatorState` (`src/core/object.zig:5607`)
...
### `Object.functionPromiseCombinatorModeSlot` (`src/core/object.zig:5612`)
...
### `Object.functionPromiseCombinatorMode` (`src/core/object.zig:5616`)
...
### `Object.functionPromiseCombinatorIndexSlot` (`src/core/object.zig:5621`)
...
### `Object.functionPromiseCombinatorIndex` (`src/core/object.zig:5625`)
...
### `Object.functionPromiseCombinatorCalledSlot` (`src/core/object.zig:5630`)
...
### `Object.functionPromiseCombinatorCalled` (`src/core/object.zig:5634`)
...
### `Object.functionPromiseFinallyPayload` (`src/core/object.zig:5639`)
...
### `Object.functionPromiseFinallyCallback` (`src/core/object.zig:5644`)
...
### `Object.functionPromiseFinallyConstructor` (`src/core/object.zig:5649`)
...
### `Object.functionPromiseFinallyModeSlot` (`src/core/object.zig:5654`)
...
### `Object.functionPromiseFinallyMode` (`src/core/object.zig:5658`)
...
### `Object.functionAsyncDisposeStackSlot` (`src/core/object.zig:5663`)
...
### `Object.functionAsyncDisposeStack` (`src/core/object.zig:5667`)
...
### `Object.functionAsyncDisposeRejectedSlot` (`src/core/object.zig:5672`)
...
### `Object.functionAsyncDisposeRejected` (`src/core/object.zig:5676`)
...
### `Object.functionAsyncContinuationSlot` (`src/core/object.zig:5681`)
...
### `Object.functionAsyncContinuation` (`src/core/object.zig:5685`)
...
### `Object.functionAsyncContinuationRejectedSlot` (`src/core/object.zig:5690`)
...
### `Object.functionAsyncContinuationRejected` (`src/core/object.zig:5694`)
...
### `Object.functionAsyncGeneratorActionSlot` (`src/core/object.zig:5699`)
...
### `Object.functionAsyncGeneratorAction` (`src/core/object.zig:5703`)
...
### `Object.functionAsyncFromSyncUnwrapDoneSlot` (`src/core/object.zig:5708`)
...
### `Object.functionAsyncFromSyncUnwrapDone` (`src/core/object.zig:5712`)
...
### `Object.functionCaptures` (`src/core/object.zig:5717`)
...
### `Object.moduleCaptureSlots` (`src/core/object.zig:5725`)
...
### `Object.allocateNullCaptureSlots` (`src/core/object.zig:5739`)
...
### `Object.allocateNullModuleCaptureSlots` (`src/core/object.zig:5756`)
...
### `Object.mutableCaptureSlots` (`src/core/object.zig:5761`)
...
### `Object.replaceModuleCaptureSlotOwned` (`src/core/object.zig:5768`)
...
### `Object.clearModuleImportCaptureSlot` (`src/core/object.zig:5783`)
...
### `Object.sealModuleCaptures` (`src/core/object.zig:5794`)
...
### `Object.functionHomeObject` (`src/core/object.zig:5804`)
...
### `Object.setFunctionHomeObject` (`src/core/object.zig:5813`)
...
### `Object.setCallSiteMetadata` (`src/core/object.zig:5824`)
...
### `Object.isCallSite` (`src/core/object.zig:5855`)
...
### `Object.callSiteFile` (`src/core/object.zig:5860`)
...
### `Object.callSiteFunctionName` (`src/core/object.zig:5865`)
...
### `Object.callSiteLine` (`src/core/object.zig:5870`)
...
### `Object.callSiteColumn` (`src/core/object.zig:5875`)
...
### `Object.callSiteIsNative` (`src/core/object.zig:5880`)
...
### `Object.setErrorStack` (`src/core/object.zig:5885`)
...
### `Object.errorStack` (`src/core/object.zig:5901`)
...
### `Object.setErrorStackSites` (`src/core/object.zig:5906`)
...
### `Object.errorStackSites` (`src/core/object.zig:5918`)
...
### `Object.errorStackSiteCount` (`src/core/object.zig:5923`)
...
### `Object.capturedStackSiteCount` (`src/core/object.zig:5928`)
...
### `Object.promiseReactionOnFulfilledSlot` (`src/core/object.zig:5933`)
...
### `Object.promiseReactionOnFulfilled` (`src/core/object.zig:5939`)
...
### `Object.setPromiseReactionOnFulfilled` (`src/core/object.zig:5945`)
...
### `Object.promiseReactionOnRejectedSlot` (`src/core/object.zig:5949`)
...
### `Object.promiseReactionOnRejected` (`src/core/object.zig:5955`)
...
### `Object.setPromiseReactionOnRejected` (`src/core/object.zig:5961`)
...
### `Object.promiseReactionResolveSlot` (`src/core/object.zig:5965`)
...
### `Object.promiseReactionResolve` (`src/core/object.zig:5975`)
...
### `Object.setPromiseReactionResolve` (`src/core/object.zig:5987`)
...
### `Object.promiseReactionRejectSlot` (`src/core/object.zig:5991`)
...
### `Object.promiseReactionReject` (`src/core/object.zig:6001`)
...
### `Object.setPromiseReactionReject` (`src/core/object.zig:6013`)
...
### `Object.promiseReactionIntrinsicCapability` (`src/core/object.zig:6017`)
...
### `Object.setPromiseReactionIntrinsicCapability` (`src/core/object.zig:6032`)
...
### `Object.clearPromiseReactionIntrinsicCapability` (`src/core/object.zig:6041`)
...
### `Object.promiseReactionCapabilityPtr` (`src/core/object.zig:6047`)
...
### `Object.promiseAlreadyResolvedSlot` (`src/core/object.zig:6053`)
...
### `Object.promiseAlreadyResolved` (`src/core/object.zig:6058`)
...
### `Object.promiseCapabilityResolveSlot` (`src/core/object.zig:6063`)
...
### `Object.promiseCapabilityResolve` (`src/core/object.zig:6068`)
...
### `Object.promiseCapabilityRejectSlot` (`src/core/object.zig:6073`)
...
### `Object.promiseCapabilityReject` (`src/core/object.zig:6078`)
...
### `Object.setPromiseCapability` (`src/core/object.zig:6083`)
...
### `Object.promiseCombinatorResolveSlot` (`src/core/object.zig:6097`)
...
### `Object.promiseCombinatorResolve` (`src/core/object.zig:6102`)
...
### `Object.setPromiseCombinatorResolve` (`src/core/object.zig:6107`)
...
### `Object.promiseCombinatorRejectSlot` (`src/core/object.zig:6111`)
...
### `Object.promiseCombinatorReject` (`src/core/object.zig:6116`)
...
### `Object.setPromiseCombinatorReject` (`src/core/object.zig:6121`)
...
### `Object.promiseCombinatorValuesSlot` (`src/core/object.zig:6125`)
...
### `Object.promiseCombinatorValues` (`src/core/object.zig:6130`)
...
### `Object.setPromiseCombinatorValues` (`src/core/object.zig:6135`)
...
### `Object.promiseCombinatorKeysSlot` (`src/core/object.zig:6139`)
...
### `Object.promiseCombinatorKeys` (`src/core/object.zig:6144`)
...
### `Object.setPromiseCombinatorKeys` (`src/core/object.zig:6149`)
...
### `Object.promiseCombinatorRemainingSlot` (`src/core/object.zig:6153`)
...
### `Object.promiseCombinatorRemaining` (`src/core/object.zig:6158`)
...
### `Object.functionRealmGlobalSlot` (`src/core/object.zig:6163`)
...
### `Object.functionRealmGlobal` (`src/core/object.zig:6168`)
...
### `Object.setFunctionRealmGlobalPtr` (`src/core/object.zig:6173`)
...
### `Object.setFunctionRealmGlobalPtrIfNull` (`src/core/object.zig:6189`)
...
### `Object.borrowedReferenceHolderIndex` (`src/core/object.zig:6199`)
...
### `Object.setBorrowedReferenceHolderIndex` (`src/core/object.zig:6211`)
...
### `Object.bytecodeFunctionRealmGlobalPtr` (`src/core/object.zig:6232`)
...
### `Object.bytecodeFunctionRealmContext` (`src/core/object.zig:6237`)
...
### `Object.setNativeFunctionRealm` (`src/core/object.zig:6246`)
...
### `Object.forgetNativeFunctionRealmForTest` (`src/core/object.zig:6261`)
...
### `Object.nativeFunctionRealm` (`src/core/object.zig:6271`)
...
### `Object.nativeFunctionRealmAssumeCFunction` (`src/core/object.zig:6277`)
...
### `Object.nativeFunctionRealmGlobalPtr` (`src/core/object.zig:6282`)
...
### `Object.functionRealmGlobalPtr` (`src/core/object.zig:6287`)
...
- 清单函数数（本文件分到）: 166（`src/core/object.zig` 全文件 879）
- 本文标题覆盖: 166
- 未覆盖: 无
