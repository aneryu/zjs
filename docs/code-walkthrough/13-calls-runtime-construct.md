...
### `constructValueOrBytecode` (`src/exec/call_runtime.zig:1694`)
...
### `constructArrayNativeRecordVm` (`src/exec/call_runtime.zig:1742`)
...
### `constructBuiltinNativeRecordVm` (`src/exec/call_runtime.zig:1764`)
...
### `constructStringBuiltinNativeVm` (`src/exec/call_runtime.zig:1778`)
...
### `constructStringBuiltinNativeInScope` (`src/exec/call_runtime.zig:1800`)
...
### `constructDateBuiltinNativeVm` (`src/exec/call_runtime.zig:1820`)
...
### `constructPromiseNativeVm` (`src/exec/call_runtime.zig:1846`)
...
### `constructDateBuiltinNativeInScope` (`src/exec/call_runtime.zig:1870`)
...
### `constructValueOrBytecodeWithNewTarget` (`src/exec/call_runtime.zig:1918`)
...
### `constructValueOrBytecodeWithNewTargetInternal` (`src/exec/call_runtime.zig:1944`)
...
### `ownConstructorPrototypeData` (`src/exec/call_runtime.zig:1987`)
...
### `resolveSameMachineConstructor` (`src/exec/call_runtime.zig:1996`)
...
### `resolveSameMachineSpreadConstructor` (`src/exec/call_runtime.zig:2021`)
...
### `prepareSameMachineConstructorAfterFirstPoll` (`src/exec/call_runtime.zig:2061`)
...
### `constructOrdinaryBytecodeFunctionObject` (`src/exec/call_runtime.zig:2121`)
...
### `constructValueOrBytecodeWithNewTargetMode` (`src/exec/call_runtime.zig:2148`)
...
### `constructValueOrBytecodeWithNewTargetAfterInterruptPoll` (`src/exec/call_runtime.zig:2167`)
...
### `constructExternalHostFunction` (`src/exec/call_runtime.zig:2406`)
...
### `isBuiltinConstructorName` (`src/exec/call_runtime.zig:2526`)
...
### `createConstructorInstance` (`src/exec/call_runtime.zig:2560`)
...
### `createBytecodeConstructorInstance` (`src/exec/call_runtime.zig:2575`)
...
### `createProfiledConstructorInstance` (`src/exec/call_runtime.zig:2605`)
...
### `noteConstructorAllocation` (`src/exec/call_runtime.zig:2623`)
...
### `functionRealmContext` (`src/exec/call_runtime.zig:2639`)
...
### `functionRealmGlobal` (`src/exec/call_runtime.zig:2667`)
...
### `isConstructibleFunctionBytecode` (`src/exec/call_runtime.zig:4498`)
...
### `isConstructibleBytecodeFunctionObject` (`src/exec/call_runtime.zig:4503`)
...
### `Fixture.create` (`src/exec/call_runtime.zig:4527`)
...
### `isConstructorLike` (`src/exec/call_runtime.zig:4557`)
