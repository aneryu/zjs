...
### `isBuiltinConstructorName` (`src/exec/call_runtime.zig:2527`)
...
### `createConstructorInstance` (`src/exec/call_runtime.zig:2561`)
...
### `createBytecodeConstructorInstance` (`src/exec/call_runtime.zig:2576`)
...
### `createProfiledConstructorInstance` (`src/exec/call_runtime.zig:2606`)
...
### `noteConstructorAllocation` (`src/exec/call_runtime.zig:2624`)
...
### `functionRealmContext` (`src/exec/call_runtime.zig:2640`)
...
### `functionRealmGlobal` (`src/exec/call_runtime.zig:2668`)
...
### `isConstructibleFunctionBytecode` (`src/exec/call_runtime.zig:4500`)
...
### `isConstructibleBytecodeFunctionObject` (`src/exec/call_runtime.zig:4505`)
...
### `Fixture.create` (`src/exec/call_runtime.zig:4529`)
...
### `isConstructorLike` (`src/exec/call_runtime.zig:4559`)
