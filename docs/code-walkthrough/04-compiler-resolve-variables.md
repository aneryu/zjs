...
### `ResolvedProduct.releaseConsumedStreams` (`src/compiler/resolve_variables.zig:63`)
...
### `ResolvedProduct.deinitUncommitted` (`src/compiler/resolve_variables.zig:82`)
...
### `updateLabel` (`src/compiler/resolve_variables.zig:113`)
...
### `Resolver.deinitScratch` (`src/compiler/resolve_variables.zig:170`)
...
### `Resolver.hasDynamicEnvObjects` (`src/compiler/resolve_variables.zig:185`)
...
### `Resolver.dynamicEnvProbesPossible` (`src/compiler/resolve_variables.zig:212`)
...
### `Resolver.streamHasCapacity` (`src/compiler/resolve_variables.zig:220`)
...
### `Resolver.growProductStreams` (`src/compiler/resolve_variables.zig:229`)
...
### `Resolver.ensureProductStreams` (`src/compiler/resolve_variables.zig:283`)
...
### `Resolver.prepareLegacyWrite` (`src/compiler/resolve_variables.zig:304`)
...
### `Resolver.finishLegacyWrite` (`src/compiler/resolve_variables.zig:327`)
...
### `Resolver.newProductLabel` (`src/compiler/resolve_variables.zig:338`)
...
### `Resolver.bindProductLabel` (`src/compiler/resolve_variables.zig:356`)
...
### `Resolver.writeScopeVarAction` (`src/compiler/resolve_variables.zig:365`)
...
### `Resolver.writeResolvedScopeVarPlan` (`src/compiler/resolve_variables.zig:396`)
...
### `Resolver.emitDynamicEnvProbe` (`src/compiler/resolve_variables.zig:429`)
...
### `Resolver.ensureDynamicEnvLabel` (`src/compiler/resolve_variables.zig:468`)
...
### `Resolver.needsDynamicEnvProbes` (`src/compiler/resolve_variables.zig:483`)

- **签名**：`inline fn needsDynamicEnvProbes( self: *Resolver, atom_id: core.atom.Atom, scope_level: i32, ) Error!bool`。
- **作用**：热路径否定测试：无资格或无动态对象则 false。
- **实现**：`scopeVarDynamicProbeEligible` 与 `hasDynamicEnvObjects` 两个闸门都过才为真。
- **所有权 / 错误 / 调用**：大多数函数永不进入 outlined emitter。

### `Resolver.emitDynamicEnvProbes` (`src/compiler/resolve_variables.zig:501`)

- **签名**：`fn emitDynamicEnvProbes( self: *Resolver, atom_id: core.atom.Atom, scope_level: i32, kind: opcode.dyn_env.ProbeKind, binding: rules.ScopeVarBindingAlias, ) Error!?u32`。
- **作用**：qjs 边走绑定链边发探针。本地 with、var_object、arg_var_object、闭包动态环境。
- **实现**：`resolvedBindingStopsDynamicEnvProbes` 为真则跳过后续。返回 done 标签或 null。
- **所有权 / 错误 / 调用**：调用方随后 `bindProductLabel`。

### `Resolver.emitThrowVarRedeclaration` (`src/compiler/resolve_variables.zig:559`)
...
### `Resolver.writeLoweredScopeDeleteVar` (`src/compiler/resolve_variables.zig:582`)
...
### `Resolver.writeLoweredScopeGetRef` (`src/compiler/resolve_variables.zig:609`)
...
### `Resolver.writeLoweredScopeMakeRef` (`src/compiler/resolve_variables.zig:629`)
...
### `Resolver.writeLoweredPrivateField` (`src/compiler/resolve_variables.zig:656`)
...
### `Resolver.writeEnterScopeRefresh` (`src/compiler/resolve_variables.zig:692`)
...
### `Resolver.writeLeaveScopeClose` (`src/compiler/resolve_variables.zig:708`)
...
### `Resolver.emitWideU16` (`src/compiler/resolve_variables.zig:724`)
...
### `Resolver.emitWideU32` (`src/compiler/resolve_variables.zig:731`)
...
### `Resolver.emitAtomWide` (`src/compiler/resolve_variables.zig:738`)
...
### `Resolver.emitProductJump` (`src/compiler/resolve_variables.zig:752`)
...
### `Resolver.emitBodyHoists` (`src/compiler/resolve_variables.zig:762`)
...
### `Resolver.registerPendingTailRewrite` (`src/compiler/resolve_variables.zig:826`)
...
### `Resolver.pendingTailRewriteAt` (`src/compiler/resolve_variables.zig:855`)
...
### `Resolver.emitPendingTailRewrite` (`src/compiler/resolve_variables.zig:864`)
...
### `Resolver.ensureAllPendingTailsConsumed` (`src/compiler/resolve_variables.zig:888`)
...
### `Resolver.incrementJumpSize` (`src/compiler/resolve_variables.zig:894`)
...
### `Resolver.refreshSourceFrontier` (`src/compiler/resolve_variables.zig:899`)
...
### `Resolver.absorbSourcesThrough` (`src/compiler/resolve_variables.zig:907`)
...
### `Resolver.pendingSourceUpperBound` (`src/compiler/resolve_variables.zig:916`)
...
### `Resolver.attachPendingSourcesAssumeCapacity` (`src/compiler/resolve_variables.zig:928`)
...
### `Resolver.attachPendingSourcesSlowAssumeCapacity` (`src/compiler/resolve_variables.zig:943`)
...
### `Resolver.emitInstruction` (`src/compiler/resolve_variables.zig:961`)
...
### `Resolver.consumeInputAtom` (`src/compiler/resolve_variables.zig:1001`)
...
### `Resolver.emitValidatedCopyNoAtom` (`src/compiler/resolve_variables.zig:1025`)
...
### `Resolver.emitValidatedCopyAtom` (`src/compiler/resolve_variables.zig:1049`)
...
### `Resolver.copyInputInstruction` (`src/compiler/resolve_variables.zig:1071`)
...
### `Resolver.validateLabelIndex` (`src/compiler/resolve_variables.zig:1085`)
...
### `Resolver.labelAt` (`src/compiler/resolve_variables.zig:1089`)
...
### `Resolver.passBindsAt` (`src/compiler/resolve_variables.zig:1099`)
...
### `Resolver.refreshBindFrontier` (`src/compiler/resolve_variables.zig:1118`)
...
### `Resolver.refreshSideFrontier` (`src/compiler/resolve_variables.zig:1126`)
...
### `Resolver.passSideEventsThrough` (`src/compiler/resolve_variables.zig:1130`)
...
### `Resolver.hasLiveMatchBarrierAt` (`src/compiler/resolve_variables.zig:1136`)
...
### `Resolver.deadBoundaryAt` (`src/compiler/resolve_variables.zig:1154`)
...
### `Resolver.firstBindAtOrAfter` (`src/compiler/resolve_variables.zig:1186`)
...
### `Resolver.hasBindInRange` (`src/compiler/resolve_variables.zig:1199`)
...
### `Resolver.planMakeRefFold` (`src/compiler/resolve_variables.zig:1215`)
...
### `Resolver.matchBranchDrop` (`src/compiler/resolve_variables.zig:1296`)
...
### `Resolver.matchDupBranchDrop` (`src/compiler/resolve_variables.zig:1322`)
...
### `Resolver.matchBareBranch` (`src/compiler/resolve_variables.zig:1341`)
...
### `Resolver.hasSourceTransitionAt` (`src/compiler/resolve_variables.zig:1369`)
...
### `Resolver.matchInsertTail` (`src/compiler/resolve_variables.zig:1405`)
...
### `Resolver.getLabelPos` (`src/compiler/resolve_variables.zig:1422`)
...
### `Resolver.skipDeadCode` (`src/compiler/resolve_variables.zig:1446`)
...
### `Resolver.lowerScopeVar` (`src/compiler/resolve_variables.zig:1492`)
...
- **实现**：`resolveScopeVarPlan`。闸门 `dynamicEnvProbesPossible`；需要则 `emitDynamicEnvProbes` 后绑 done。
- **所有权 / 错误 / 调用**：qjs:34263-34269。

### `Resolver.lowerScopeRef` (`src/compiler/resolve_variables.zig:1525`)
...
### `Resolver.lowerScopeMakeRef` (`src/compiler/resolve_variables.zig:1568`)
...
### `Resolver.lowerPrivateField` (`src/compiler/resolve_variables.zig:1628`)
...
### `Resolver.run` (`src/compiler/resolve_variables.zig:2113`)
...
### `validateInput` (`src/compiler/resolve_variables.zig:1987`)
...
### `initializeLabels` (`src/compiler/resolve_variables.zig:2016`)
...
### `preallocateProductStreams` (`src/compiler/resolve_variables.zig:2045`)
...
### `buildBindIndex` (`src/compiler/resolve_variables.zig:2084`)
...
### `run` (`src/compiler/resolve_variables.zig:2113`)

- **签名**：`pub fn run( function: *bytecode.Bytecode, fd: *bytecode.function_def.FunctionDef, ) Error!ResolvedProduct`。
- **作用**：对 `fd.builder` 做变量解析与死代码删除。入口公共 API。
- **实现**：无 builder / memory/atoms 不一致 → 失败。`validateInput`；`JSContext.initWithFunctionDef` + `proveScopeLinksForResolution` + `resolveEvalGlobalVarTargets`。bind 索引。初始化产物与 Resolver（含 `functionHasDynamicEnvObjects`）。`resolver.run`。
...
### `ResolveTestHarness.init` (`src/compiler/resolve_variables.zig:2248`)
...
### `ResolveTestHarness.deinit` (`src/compiler/resolve_variables.zig:2286`)
...
### `ResolveTestHarness.deinitInput` (`src/compiler/resolve_variables.zig:2200`)
...
### `ResolveTestHarness.input` (`src/compiler/resolve_variables.zig:2208`)
...
### `ResolveTestHarness.resolve` (`src/compiler/resolve_variables.zig:2212`)
...
### `expectProductCode` (`src/compiler/resolve_variables.zig:2217`)
...
### `expectProductLabel` (`src/compiler/resolve_variables.zig:2222`)
...
### `TestInputSnapshot.init` (`src/compiler/resolve_variables.zig:2248`)
...
### `TestInputSnapshot.deinit` (`src/compiler/resolve_variables.zig:2286`)
...
### `TestInputSnapshot.expectUnchanged` (`src/compiler/resolve_variables.zig:2295`)
...
### `expectOwnedAtomRelease` (`src/compiler/resolve_variables.zig:2323`)
...
### `expectOomInputUnchanged` (`src/compiler/resolve_variables.zig:3332`)
...
### `resolveVariablesOomScript` (`src/compiler/resolve_variables.zig:3347`)
