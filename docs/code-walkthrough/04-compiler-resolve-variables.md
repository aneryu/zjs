...
### `Resolver.deinitScratch` (`src/compiler/resolve_variables.zig:183`)
...
### `Resolver.hasDynamicEnvObjects` (`src/compiler/resolve_variables.zig:206`)
...
### `Resolver.dynamicEnvProbesPossible` (`src/compiler/resolve_variables.zig:233`)
...
### `Resolver.recordOptimizationBoundary` (`src/compiler/resolve_variables.zig:247`)
...
### `Resolver.resolveDeferredFoldProduct` (`src/compiler/resolve_variables.zig:280`)
...
### `Resolver.streamHasCapacity` (`src/compiler/resolve_variables.zig:297`)
...
### `Resolver.growProductStreams` (`src/compiler/resolve_variables.zig:306`)
...
### `Resolver.ensureProductStreams` (`src/compiler/resolve_variables.zig:360`)
...
### `Resolver.prepareLegacyWrite` (`src/compiler/resolve_variables.zig:381`)
...
### `Resolver.finishLegacyWrite` (`src/compiler/resolve_variables.zig:404`)
...
### `Resolver.newProductLabel` (`src/compiler/resolve_variables.zig:415`)
...
### `Resolver.bindProductLabel` (`src/compiler/resolve_variables.zig:433`)
...
### `Resolver.writeScopeVarAction` (`src/compiler/resolve_variables.zig:442`)
...
### `Resolver.writeResolvedScopeVarPlan` (`src/compiler/resolve_variables.zig:473`)
...
### `Resolver.emitDynamicEnvProbe` (`src/compiler/resolve_variables.zig:506`)
...
### `Resolver.ensureDynamicEnvLabel` (`src/compiler/resolve_variables.zig:545`)
...
### `Resolver.needsDynamicEnvProbes` (`src/compiler/resolve_variables.zig:560`)
...
### `Resolver.emitDynamicEnvProbes` (`src/compiler/resolve_variables.zig:582`)
...
### `Resolver.emitThrowVarRedeclaration` (`src/compiler/resolve_variables.zig:654`)
...
### `Resolver.writeLoweredScopeDeleteVar` (`src/compiler/resolve_variables.zig:677`)
...
### `Resolver.writeLoweredScopeGetRef` (`src/compiler/resolve_variables.zig:704`)
...
### `Resolver.writeLoweredScopeMakeRef` (`src/compiler/resolve_variables.zig:724`)
...
### `Resolver.writeLoweredPrivateField` (`src/compiler/resolve_variables.zig:751`)
...
### `Resolver.writeEnterScopeRefresh` (`src/compiler/resolve_variables.zig:787`)
...
### `Resolver.writeLeaveScopeClose` (`src/compiler/resolve_variables.zig:803`)
...
### `Resolver.emitWideU16` (`src/compiler/resolve_variables.zig:819`)
...
### `Resolver.emitWideU32` (`src/compiler/resolve_variables.zig:826`)
...
### `Resolver.emitAtomWide` (`src/compiler/resolve_variables.zig:833`)
...
### `Resolver.emitProductJump` (`src/compiler/resolve_variables.zig:847`)
...
### `Resolver.emitBodyHoists` (`src/compiler/resolve_variables.zig:857`)
...
### `Resolver.registerPendingTailRewrite` (`src/compiler/resolve_variables.zig:920`)
...
### `Resolver.pendingTailRewriteAt` (`src/compiler/resolve_variables.zig:949`)
...
### `Resolver.emitPendingTailRewrite` (`src/compiler/resolve_variables.zig:958`)
...
### `Resolver.ensureAllPendingTailsConsumed` (`src/compiler/resolve_variables.zig:987`)
...
### `Resolver.incrementJumpSize` (`src/compiler/resolve_variables.zig:993`)
...
### `Resolver.refreshSourceFrontier` (`src/compiler/resolve_variables.zig:998`)
...
### `Resolver.absorbSourcesThrough` (`src/compiler/resolve_variables.zig:1006`)
...
### `Resolver.pendingSourceUpperBound` (`src/compiler/resolve_variables.zig:1015`)
...
### `Resolver.attachPendingSourcesAssumeCapacity` (`src/compiler/resolve_variables.zig:1027`)
...
### `Resolver.attachPendingSourcesSlowAssumeCapacity` (`src/compiler/resolve_variables.zig:1042`)
...
### `Resolver.emitInstruction` (`src/compiler/resolve_variables.zig:1060`)
...
### `Resolver.consumeInputAtom` (`src/compiler/resolve_variables.zig:1100`)
...
### `Resolver.emitValidatedCopyNoAtom` (`src/compiler/resolve_variables.zig:1124`)
...
### `Resolver.emitValidatedCopyAtom` (`src/compiler/resolve_variables.zig:1148`)
...
### `Resolver.copyInputInstruction` (`src/compiler/resolve_variables.zig:1170`)
...
### `Resolver.validateLabelIndex` (`src/compiler/resolve_variables.zig:1184`)
...
### `Resolver.labelAt` (`src/compiler/resolve_variables.zig:1188`)
...
### `Resolver.passBindsAt` (`src/compiler/resolve_variables.zig:1198`)
...
### `Resolver.refreshBindFrontier` (`src/compiler/resolve_variables.zig:1217`)
...
### `Resolver.refreshSideFrontier` (`src/compiler/resolve_variables.zig:1225`)
...
### `Resolver.passSideEventsThrough` (`src/compiler/resolve_variables.zig:1229`)
...
### `Resolver.hasLiveMatchBarrierAt` (`src/compiler/resolve_variables.zig:1235`)
...
### `Resolver.blockAt` (`src/compiler/resolve_variables.zig:1248`)
...
### `Resolver.deadBoundaryAt` (`src/compiler/resolve_variables.zig:1268`)
...
### `Resolver.firstBindAtOrAfter` (`src/compiler/resolve_variables.zig:1329`)
...
### `Resolver.hasBindInRange` (`src/compiler/resolve_variables.zig:1342`)
...
### `Resolver.planMakeRefFold` (`src/compiler/resolve_variables.zig:1358`)
...
### `Resolver.matchBranchDrop` (`src/compiler/resolve_variables.zig:1439`)
...
### `Resolver.matchDupBranchDrop` (`src/compiler/resolve_variables.zig:1465`)
...
### `Resolver.matchBareBranch` (`src/compiler/resolve_variables.zig:1484`)
...
### `Resolver.hasSourceTransitionAt` (`src/compiler/resolve_variables.zig:1512`)
...
### `Resolver.matchInsertTail` (`src/compiler/resolve_variables.zig:1548`)
...
### `Resolver.getLabelPos` (`src/compiler/resolve_variables.zig:1565`)
...
### `Resolver.skipDeadCode` (`src/compiler/resolve_variables.zig:1589`)
...
### `Resolver.lowerScopeVar` (`src/compiler/resolve_variables.zig:1635`)
...
### `Resolver.lowerScopeRef` (`src/compiler/resolve_variables.zig:1703`)
...
### `Resolver.lowerScopeMakeRef` (`src/compiler/resolve_variables.zig:1766`)
...
### `Resolver.lowerPrivateField` (`src/compiler/resolve_variables.zig:1875`)
...
### `Resolver.run` (`src/compiler/resolve_variables.zig:1902`)
...
### `validateInput` (`src/compiler/resolve_variables.zig:2266`)
...
### `initializeLabels` (`src/compiler/resolve_variables.zig:2295`)
...
### `preallocateProductStreams` (`src/compiler/resolve_variables.zig:2324`)
...
### `buildBindIndex` (`src/compiler/resolve_variables.zig:2363`)
...
### `markReachableEvalCaptures` (`src/compiler/resolve_variables.zig:2391`)
...
### `run` (`src/compiler/resolve_variables.zig:2459`)
...
### `ResolveTestHarness.init` (`src/compiler/resolve_variables.zig:2543`)
...
### `ResolveTestHarness.deinit` (`src/compiler/resolve_variables.zig:2568`)
...
### `ResolveTestHarness.deinitInput` (`src/compiler/resolve_variables.zig:2574`)
...
### `ResolveTestHarness.input` (`src/compiler/resolve_variables.zig:2582`)
...
### `ResolveTestHarness.resolve` (`src/compiler/resolve_variables.zig:2586`)
...
### `expectProductCode` (`src/compiler/resolve_variables.zig:2591`)
...
### `expectProductLabel` (`src/compiler/resolve_variables.zig:2596`)
...
### `TestInputSnapshot.init` (`src/compiler/resolve_variables.zig:2622`)
...
### `TestInputSnapshot.deinit` (`src/compiler/resolve_variables.zig:2660`)
...
### `TestInputSnapshot.expectUnchanged` (`src/compiler/resolve_variables.zig:2669`)
...
### `expectOwnedAtomRelease` (`src/compiler/resolve_variables.zig:2697`)
...
### `expectOomInputUnchanged` (`src/compiler/resolve_variables.zig:3725`)
...
### `resolveVariablesOomScript` (`src/compiler/resolve_variables.zig:3740`)
