...
### `finalizingShape` (`src/core/object.zig:87`)
...
### `classHasExoticMethods` (`src/core/object.zig:294`)
...
### `classNeedsSlowPropertyAccess` (`src/core/object.zig:299`)
...
### `classOwnsIndexedElementStorage` (`src/core/object.zig:338`)
...
### `exoticMethodsForClassId` (`src/core/object.zig:349`)
...
### `ObjectStorage.initPayload` (`src/core/object.zig:397`)
...
### `unionArmBytes` (`src/core/object.zig:427`)
...
### `Object.objectBodyBytes` (`src/core/object.zig:509`)
...
### `Object.prospectiveAccountedBodyBytes` (`src/core/object.zig:515`)
...
### `Object.bodyBytes` (`src/core/object.zig:522`)
...
### `Object.accountedBodyBytesForPhysical` (`src/core/object.zig:529`)
...
### `Object.gcHeader` (`src/core/object.zig:534`)
...
### `Object.gcHeaderConst` (`src/core/object.zig:538`)
...
### `Object.fromHeader` (`src/core/object.zig:542`)
...
### `Object.fromHeaderConst` (`src/core/object.zig:550`)
...
### `Object.objectTailBytes` (`src/core/object.zig:563`)
...
### `prepareNonBlockObjectAllocation` (`src/core/object.zig:600`)
...
### `Object.allocCell` (`src/core/object.zig:574`)
...
### `Object.allocCellConst` (`src/core/object.zig:587`)
...
### `Object.freeRawCellConst` (`src/core/object.zig:605`)
...
### `Object.freeRawCell` (`src/core/object.zig:617`)
...
### `Object.armBase` (`src/core/object.zig:623`)
...
### `Object.assertArmReadable` (`src/core/object.zig:640`)
...
### `Object.payloadArm` (`src/core/object.zig:647`)
...
### `Object.asyncResumeArm` (`src/core/object.zig:652`)
...
### `Object.asyncResumeContinuation` (`src/core/object.zig:659`)
...
### `Object.setAsyncResumeContinuation` (`src/core/object.zig:663`)
...
### `Object.arrayArm` (`src/core/object.zig:668`)
...
### `Object.bytecodeArm` (`src/core/object.zig:673`)
...
### `Object.regexpArm` (`src/core/object.zig:678`)
...
### `Object.initArmPayload` (`src/core/object.zig:690`)
...
### `Object.traceShapeSummary` (`src/core/object.zig:736`)
...
### `Object.traceShapeSummaryIsExact` (`src/core/object.zig:740`)
...
### `Object.traceShapeSummaryCount` (`src/core/object.zig:744`)
...
### `Object.traceShapeSummaryFlagsAt` (`src/core/object.zig:749`)
...
### `Object.traceShapeSlotState` (`src/core/object.zig:763`)
...
### `Object.shapeSummaryFor` (`src/core/object.zig:770`)
...
### `Object.storeTraceShapeSummary` (`src/core/object.zig:781`)
...
### `Object.refreshTraceShapeSummary` (`src/core/object.zig:791`)
...
### `Object.traceShapeSummaryMatches` (`src/core/object.zig:795`)
...
### `Object.commitTraceShapeAppend` (`src/core/object.zig:808`)
...
### `Object.syncTraceShapePropertyFlags` (`src/core/object.zig:844`)
...
### `Object.updateShapePropertyFlags` (`src/core/object.zig:861`)
...
- 清单函数数（本文件分到）: 43（`src/core/object.zig` 全文件 879）
- 本文标题覆盖: 43
- 未覆盖: 无
