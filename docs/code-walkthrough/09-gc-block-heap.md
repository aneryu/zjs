...
### `ExtentIdentityAuthority.recordMut` (`src/core/gc_carrier.zig:124`)

- **签名**：`fn recordMut(self: *ExtentIdentityAuthority, base: usize) ?*ExtentIdentityRecord`。
- **作用**：按基址借用可变身份记录。
- **实现**：records.getPtr(base)，不存在则 null。
- **所有权 / 错误 / 调用**：不插入、不分配；借用不得跨表扩容或删除保存。

### `ExtentIdentityAuthority.handle` (`src/core/gc_carrier.zig:128`)
...
### `ExtentIdentityAuthority.resolve` (`src/core/gc_carrier.zig:133`)
...
### `ExtentIdentityAuthority.finishRawFree` (`src/core/gc_carrier.zig:145`)
...
### `ExtentIdentityAuthority.verify` (`src/core/gc_carrier.zig:149`)
...
### `ExtentLifecycleAuthority.deinit` (`src/core/gc_carrier.zig:177`)
...
### `ExtentLifecycleAuthority.prepare` (`src/core/gc_carrier.zig:182`)
...
### `ExtentLifecycleAuthority.commit` (`src/core/gc_carrier.zig:186`)
...
### `ExtentLifecycleAuthority.record` (`src/core/gc_carrier.zig:192`)
...
### `ExtentLifecycleAuthority.recordMut` (`src/core/gc_carrier.zig:196`)
...
### `ExtentLifecycleAuthority.transition` (`src/core/gc_carrier.zig:200`)
...
### `ExtentLifecycleAuthority.publish` (`src/core/gc_carrier.zig:205`)
...
### `ExtentLifecycleAuthority.resolve` (`src/core/gc_carrier.zig:211`)
...
### `ExtentLifecycleAuthority.finishRawFree` (`src/core/gc_carrier.zig:217`)
...
### `ExtentLifecycleAuthority.verify` (`src/core/gc_carrier.zig:222`)
...
### `HeapAccountingOracle.deinit` (`src/core/gc_carrier.zig:262`)
...
### `HeapAccountingOracle.prepareRawAlloc` (`src/core/gc_carrier.zig:267`)
...
### `HeapAccountingOracle.recordRawAlloc` (`src/core/gc_carrier.zig:271`)
...
### `HeapAccountingOracle.recordRawFree` (`src/core/gc_carrier.zig:281`)
...
### `HeapAccountingOracle.recordPublish` (`src/core/gc_carrier.zig:286`)
...
### `HeapAccountingOracle.recordUnpublish` (`src/core/gc_carrier.zig:296`)
...
hot_blocks_published/reopened、hot_blocks_k_rejected记录复用流程；hot_publish_rejected_*按empty/capacity/active/doomed/young/listed/decommitted/cached_k分支计数，分支顺序影响归因。bitmap_reclaimed_cells只记录批量bitmap释放分支。deferred_block_runs_completed是保留字段，当前此文件无更新逻辑，不能据名称宣称它追踪了所有完成block。统计混用普通与饱和加法，不能统称不会溢出。
...
### `Stats.currentDecommittedBytes` (`src/core/gc_block_heap.zig:253`)
...
### `canAllocCellSize` (`src/core/gc_block_heap.zig:304`)
...
### `cellClassForPayload` (`src/core/gc_block_heap.zig:312`)
...
### `accountedBodyBytesForRequest` (`src/core/gc_block_heap.zig:322`)
...
### `Block.fromAddr` (`src/core/gc_block_heap.zig:539`)
...
### `Block.bitmaps` (`src/core/gc_block_heap.zig:547`)
...
### `Block.finalizerBits` (`src/core/gc_block_heap.zig:561`)
...
### `Block.setFinalizerBit` (`src/core/gc_block_heap.zig:568`)
...
### `Block.clearFinalizerBit` (`src/core/gc_block_heap.zig:572`)
...
### `Block.cellNeedsFinalizer` (`src/core/gc_block_heap.zig:576`)
...
### `Block.cellPtr` (`src/core/gc_block_heap.zig:580`)
...
### `Block.cellIndex` (`src/core/gc_block_heap.zig:585`)
...
### `Block.cellIndexInterior` (`src/core/gc_block_heap.zig:599`)
...
### `Block.allocWords` (`src/core/gc_block_heap.zig:608`)
...
### `Block.doomedWords` (`src/core/gc_block_heap.zig:617`)
...
### `Block.deadWord` (`src/core/gc_block_heap.zig:624`)
...
### `Block.cellAllocated` (`src/core/gc_block_heap.zig:631`)
...
### `Block.cellBase` (`src/core/gc_block_heap.zig:635`)
...
### `Block.fromCellTrusted` (`src/core/gc_block_heap.zig:642`)
...
### `Block.clearMark` (`src/core/gc_block_heap.zig:648`)
...
### `Block.clearYoungMarksStw` (`src/core/gc_block_heap.zig:663`)
...
### `Block.isYoungListed` (`src/core/gc_block_heap.zig:688`)
...
### `Block.hasPendingDoomed` (`src/core/gc_block_heap.zig:692`)
...
### `Block.cellPendingDoomed` (`src/core/gc_block_heap.zig:700`)
...
### `Block.snapshotDoomed` (`src/core/gc_block_heap.zig:715`)
...
### `Block.forgetDoomedCell` (`src/core/gc_block_heap.zig:755`)
...
### `Block.takeDoomedFinalizerCell` (`src/core/gc_block_heap.zig:777`)
...
### `Block.reclaimDoomedIntoBitmap` (`src/core/gc_block_heap.zig:806`)
...
### `Block.takeDoomedCell` (`src/core/gc_block_heap.zig:827`)
...
### `Block.ensureMarkEpoch` (`src/core/gc_block_heap.zig:874`)
...
### `Block.isDoomed` (`src/core/gc_block_heap.zig:893`)
...
### `Block.isMarked` (`src/core/gc_block_heap.zig:897`)
...
### `Block.setMark` (`src/core/gc_block_heap.zig:902`)
...
### `blockGeometry` (`src/core/gc_block_heap.zig:925`)
...
### `Heap.init` (`src/core/gc_block_heap.zig:1061`)
...
### `Heap.deinit` (`src/core/gc_block_heap.zig:1065`)
...
### `Heap.beginMajor` (`src/core/gc_block_heap.zig:1091`)
...
### `Heap.alloc` (`src/core/gc_block_heap.zig:1102`)
...
### `Heap.allocCell` (`src/core/gc_block_heap.zig:1119`)
...
### `Heap.allocCellFixedPtr` (`src/core/gc_block_heap.zig:1132`)
...
### `Heap.allocSmallCell` (`src/core/gc_block_heap.zig:1136`)
...
### `Heap.free` (`src/core/gc_block_heap.zig:1163`)
...
### `Heap.ExtentKeyIterator.next` (`src/core/gc_block_heap.zig:1202`)
...
### `Heap.extentKeys` (`src/core/gc_block_heap.zig:1209`)
...
### `Heap.extentSetMark` (`src/core/gc_block_heap.zig:1213`)
...
### `Heap.extentSetNeedsFinalizer` (`src/core/gc_block_heap.zig:1228`)
...
### `Heap.extentNeedsFinalizer` (`src/core/gc_block_heap.zig:1236`)
...
### `Heap.extentIsMarked` (`src/core/gc_block_heap.zig:1242`)
...
### `Heap.extentContaining` (`src/core/gc_block_heap.zig:1270`)
...
### `Heap.extentsContaining` (`src/core/gc_block_heap.zig:1289`)
...
### `Heap.extentsContainingLinear` (`src/core/gc_block_heap.zig:1309`)
...
### `Heap.indexExtentPages` (`src/core/gc_block_heap.zig:1339`)
...
### `Heap.rollbackExtentPages` (`src/core/gc_block_heap.zig:1374`)
...
### `Heap.unindexExtentPages` (`src/core/gc_block_heap.zig:1382`)
...
### `Heap.compactExtentPagesIfTombstoned` (`src/core/gc_block_heap.zig:1402`)
...
### `Heap.verifyExtentPageIndex` (`src/core/gc_block_heap.zig:1419`)
...
### `Heap.verifyOneExtentIndexed` (`src/core/gc_block_heap.zig:1440`)
...
### `Heap.sweepExtents` (`src/core/gc_block_heap.zig:1472`)
...
### `Heap.containsExtent` (`src/core/gc_block_heap.zig:1503`)
...
### `Heap.extentUserBytes` (`src/core/gc_block_heap.zig:1507`)
...
### `Heap.sweepYoungExtents` (`src/core/gc_block_heap.zig:1523`)
...
### `Heap.retireYoungExtents` (`src/core/gc_block_heap.zig:1551`)
...
### `Heap.clearYoungExtentMarksStw` (`src/core/gc_block_heap.zig:1563`)
...
### `Heap.freeSmallCell` (`src/core/gc_block_heap.zig:1578`)
...
### `Heap.generationFor` (`src/core/gc_block_heap.zig:1588`)
...
### `Heap.generationForConst` (`src/core/gc_block_heap.zig:1597`)
...
### `Heap.lifecycleFor` (`src/core/gc_block_heap.zig:1606`)
...
### `Heap.lifecycleForConst` (`src/core/gc_block_heap.zig:1615`)
...
### `Heap.blockIncarnation` (`src/core/gc_block_heap.zig:1624`)
...
### `Heap.reserveCellGeneration` (`src/core/gc_block_heap.zig:1631`)
...
### `Heap.popTrackedCell` (`src/core/gc_block_heap.zig:1639`)
...
### `Heap.generationHandle` (`src/core/gc_block_heap.zig:1655`)
...
### `Heap.containsAllocatedCell` (`src/core/gc_block_heap.zig:1669`)
...
### `Heap.resolveExactHandle` (`src/core/gc_block_heap.zig:1684`)
...
### `Heap.transitionCell` (`src/core/gc_block_heap.zig:1705`)
...
### `Heap.publishCell` (`src/core/gc_block_heap.zig:1715`)
...
### `Heap.rawBytesForCell` (`src/core/gc_block_heap.zig:1724`)
...
### `Heap.setReuseSequenceForTest` (`src/core/gc_block_heap.zig:1731`)
...
### `Heap.forEachOwnedIdentity` (`src/core/gc_block_heap.zig:1739`)
...
### `Heap.verifyGenerationAuthority` (`src/core/gc_block_heap.zig:1765`)
...
### `Heap.verifyLifecycleAuthority` (`src/core/gc_block_heap.zig:1785`)
...
### `Heap.reclaimDoomedCells` (`src/core/gc_block_heap.zig:1816`)
...
### `Heap.censusBlocks` (`src/core/gc_block_heap.zig:1849`)
...
### `Heap.verifyBlockAllocCount` (`src/core/gc_block_heap.zig:1902`)
...
### `Heap.owns` (`src/core/gc_block_heap.zig:1908`)
...
### `Heap.noteYoungCell` (`src/core/gc_block_heap.zig:1917`)
...
### `Heap.clearYoungBlocks` (`src/core/gc_block_heap.zig:1925`)
...
### `Heap.clearYoungBlockMarksStw` (`src/core/gc_block_heap.zig:1942`)
...
### `Heap.noteNonemptyBlock` (`src/core/gc_block_heap.zig:1954`)
...
### `Heap.noteEmptyBlock` (`src/core/gc_block_heap.zig:1962`)
...
### `Heap.hasHotReuseCapacity` (`src/core/gc_block_heap.zig:1970`)
...
### `Heap.withdrawHotBlocks` (`src/core/gc_block_heap.zig:1978`)
...
### `Heap.findCellState` (`src/core/gc_block_heap.zig:2000`)
...
### `Heap.writeIntervalNode` (`src/core/gc_block_heap.zig:2022`)
...
### `Heap.rebuildFreeIntervals` (`src/core/gc_block_heap.zig:2034`)
...
### `Heap.publishHotBlock` (`src/core/gc_block_heap.zig:2079`)
...
### `Heap.publishCompletedHotBlocks` (`src/core/gc_block_heap.zig:2131`)
...
### `Heap.publishCompletedHotBlocksSlice` (`src/core/gc_block_heap.zig:2155`)
...
### `Heap.publishSuperblockHotBlocks` (`src/core/gc_block_heap.zig:2174`)
...
### `Heap.recordDoomedBlock` (`src/core/gc_block_heap.zig:2200`)
...
### `Heap.snapshotAllDoomed` (`src/core/gc_block_heap.zig:2241`)
...
### `Heap.snapshotYoungDoomed` (`src/core/gc_block_heap.zig:2267`)
...
### `Heap.decommitCellPages` (`src/core/gc_block_heap.zig:2295`)
...
### `Heap.releaseFreeBlockPages` (`src/core/gc_block_heap.zig:2312`)
...
### `Heap.trimProcessHeapAfterLargeShrink` (`src/core/gc_block_heap.zig:2355`)
...
### `Heap.verify` (`src/core/gc_block_heap.zig:2401`)
...
### `Heap.verifyPublishedCellsAllowing` (`src/core/gc_block_heap.zig:2794`)
...
### `Heap.verifyAccountingCellsAllowing` (`src/core/gc_block_heap.zig:2807`)
...
### `Heap.verifyCellsAllowing` (`src/core/gc_block_heap.zig:2816`)
...
### `Heap.blockOf` (`src/core/gc_block_heap.zig:2901`)
...
### `Heap.scanFilter` (`src/core/gc_block_heap.zig:2914`)
...
### `Heap.blockOfWithFilter` (`src/core/gc_block_heap.zig:2918`)
...
### `Heap.liveSmall` (`src/core/gc_block_heap.zig:2938`)
...
### `Heap.census` (`src/core/gc_block_heap.zig:2988`)
...
### `Heap.liveBytes` (`src/core/gc_block_heap.zig:3046`)
...
### `Heap.committedLiveMilli` (`src/core/gc_block_heap.zig:3055`)
...
### `Heap.containsBlock` (`src/core/gc_block_heap.zig:3061`)
...
### `Heap.containsInitializedBlock` (`src/core/gc_block_heap.zig:3065`)
...
### `Heap.blockFromListLink` (`src/core/gc_block_heap.zig:3069`)
...
### `Heap.blockFromFreeLink` (`src/core/gc_block_heap.zig:3079`)
...
### `Heap.allocSmall` (`src/core/gc_block_heap.zig:3085`)
...
### `Heap.freeSmall` (`src/core/gc_block_heap.zig:3091`)
...
### `Heap.openBlock` (`src/core/gc_block_heap.zig:3130`)
...
- **实现**：逐个摘hot链头，清hot_list并设active sweep_state，rebuildFreeIntervals；最大区间不足64 cell则记k_rejected并缓存hot_rejected，继续候选，满足则记reopened并返回。无hot时摘同class free链头，若decommitted先增加recommitted/committed账，再resetBlock(reused=true)，设active返回；再无则takeClassedBlock、resetBlock(reused=false)，将fresh转active返回。
...
### `Heap.takeClassedBlock` (`src/core/gc_block_heap.zig:3177`)
...
### `Heap.reserveSuperblock` (`src/core/gc_block_heap.zig:3258`)
...
### `Heap.unreserveSuperblock` (`src/core/gc_block_heap.zig:3303`)
...
### `Heap.whollyEmpty` (`src/core/gc_block_heap.zig:3351`)
...
### `Heap.releaseEmptyMediumSuperblocks` (`src/core/gc_block_heap.zig:3358`)
...
### `Heap.resetBlock` (`src/core/gc_block_heap.zig:3388`)
...
### `Heap.allocMedium` (`src/core/gc_block_heap.zig:3446`)
...
### `Heap.takeMediumSuperblock` (`src/core/gc_block_heap.zig:3491`)
...
### `Heap.freeMedium` (`src/core/gc_block_heap.zig:3502`)
...
### `Heap.rebucket` (`src/core/gc_block_heap.zig:3527`)
...
### `Heap.bucketUnlink` (`src/core/gc_block_heap.zig:3534`)
...
### `Heap.bucketLink` (`src/core/gc_block_heap.zig:3554`)
...
### `Heap.verifyMediumBuckets` (`src/core/gc_block_heap.zig:3580`)
...
### `Heap.allocLarge` (`src/core/gc_block_heap.zig:3616`)
...
### `Ctx.destroy` (`src/core/gc_block_heap.zig:3802`)
...
### `processHeapTrimNeeded` (`src/core/gc_block_heap.zig:3966`)
...
### `popCell` (`src/core/gc_block_heap.zig:3972`)
...
### `pushCell` (`src/core/gc_block_heap.zig:4029`)
...
### `bitMask` (`src/core/gc_block_heap.zig:4045`)
...
### `setBitPlain` (`src/core/gc_block_heap.zig:4064`)
...
### `clearBitPlain` (`src/core/gc_block_heap.zig:4068`)
...
### `testBitPlain` (`src/core/gc_block_heap.zig:4072`)
...
### `testBit` (`src/core/gc_block_heap.zig:4076`)
...
### `setBit` (`src/core/gc_block_heap.zig:4081`)
...
### `clearBit` (`src/core/gc_block_heap.zig:4085`)
...
### `scanFreeRuns` (`src/core/gc_block_heap.zig:4103`)
...
### `testPage` (`src/core/gc_block_heap.zig:4138`)
...
### `setPage` (`src/core/gc_block_heap.zig:4142`)
...
### `clearPage` (`src/core/gc_block_heap.zig:4146`)
...
- 清单函数数: 191（`src/core/gc_block_heap.zig` 153 + `src/core/gc_carrier.zig` 29 + `src/core/gc_space.zig` 9）
- 本文标题覆盖: 191
- 未覆盖: 无
