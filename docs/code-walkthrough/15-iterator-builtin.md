...
### `staticMethodId` (`src/exec/iterator_ops.zig:21`)
...
### `prototypeMethodId` (`src/exec/iterator_ops.zig:29`)
...
### `iteratorEntry` (`src/exec/iterator_ops.zig:83`)
...
### `iteratorCall` (`src/exec/iterator_ops.zig:100`)
