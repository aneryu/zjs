...
### `callWithThis` (`src/exec/call.zig:44`)
...
### `expectClosure` (`src/exec/call.zig:73`)
...
### `defineIntProperty` (`src/exec/call.zig:81`)
...
### `getIntProperty` (`src/exec/call.zig:86`)
...
### `setGlobalMapString` (`src/exec/call.zig:92`)
...
### `setGlobalWeakMapString` (`src/exec/call.zig:110`)
...
### `appendUnindexedCollectionEntryAndDefineSize` (`src/exec/call.zig:134`)
...
### `rollbackLastUnindexedCollectionEntry` (`src/exec/call.zig:148`)
...
### `getGlobalObjectProperty` (`src/exec/call.zig:121`)
...
### `getGlobalThisObject` (`src/exec/call.zig:127`)
