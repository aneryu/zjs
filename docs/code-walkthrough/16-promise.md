...
### `promiseThenableJob` (`src/exec/promise_ops.zig:1024`)

- **签名**：`pub fn promiseThenableJob( ctx: *core.JSContext, target_value: core.JSValue, thenable_value: core.JSValue, then_value: core.JSValue, ) !jobs_mod.Job`。
- **作用**：包装 `Job.initPromiseThenable`。
- **实现**：无失败。
- **所有权 / 错误 / 调用**：测试根 then-function bytecode。生产路径直接 `initPromiseThenable`。

### `PromiseJobOomProbe.thunk` (`src/exec/promise_ops.zig:1037`)
...
### `PromiseJobOomProbe.call` (`src/exec/promise_ops.zig:1047`)
...
### `promiseJobOomProbeFunction` (`src/exec/promise_ops.zig:1061`)
...
### `PromiseBareCapabilityErrorProbe.thunk` (`src/exec/promise_ops.zig:1080`)
...
### `promiseBareCapabilityErrorFunction` (`src/exec/promise_ops.zig:1091`)
...
### `appendDummyPromiseReaction` (`src/exec/promise_ops.zig:1106`)
...
### `TailJob.run` (`src/exec/promise_ops.zig:1229`)
...
### `promiseThenableJobCall` (`src/exec/promise_ops.zig:1446`)
...
### `promiseSettlementJobCall` (`src/exec/promise_ops.zig:1505`)
...
### `promiseReactionJobCall` (`src/exec/promise_ops.zig:1520`)
...
### `resetThenCapabilityTestMetrics` (`src/exec/promise_ops.zig:1668`)
...
### `thenCapabilityTestMetrics` (`src/exec/promise_ops.zig:1672`)
...
### `thenCapability` (`src/exec/promise_ops.zig:1686`)
...
### `thenReactionRecord` (`src/exec/promise_ops.zig:1707`)
...
### `promiseCapabilityExecutorCall` (`src/exec/promise_ops.zig:1722`)
...
### `promiseCombinatorElementCall` (`src/exec/promise_ops.zig:1738`)
...
### `promiseCapability` (`src/exec/promise_ops.zig:1813`)
...
### `promiseSetArrayIndex` (`src/exec/promise_ops.zig:1866`)
...
### `promiseKeyedResult` (`src/exec/promise_ops.zig:1871`)
...
### `promiseCombinatorState` (`src/exec/promise_ops.zig:1978`)
...
### `promiseKeyedCombinatorState` (`src/exec/promise_ops.zig:2035`)
...
### `promiseCombinatorCallback` (`src/exec/promise_ops.zig:2042`)
...
### `promiseRejectCapability` (`src/exec/promise_ops.zig:2059`)
...
### `promiseRejectCapabilityForError` (`src/exec/promise_ops.zig:2071`)
...
### `rejectCombinatorAndRelease` (`src/exec/promise_ops.zig:2089`)
...
### `promiseResolveIdentity` (`src/exec/promise_ops.zig:2102`)
...
### `promiseConstructorDataValueForFastPath` (`src/exec/promise_ops.zig:2126`)
...
### `promiseDefaultConstructor` (`src/exec/promise_ops.zig:2137`)
...
### `promiseSpeciesConstructor` (`src/exec/promise_ops.zig:2150`)
...
### `promiseConstructorRealmGlobal` (`src/exec/promise_ops.zig:2171`)
...
### `promiseCombinatorCall` (`src/exec/promise_ops.zig:2178`)
...
### `promiseKeyedCombinatorCall` (`src/exec/promise_ops.zig:2320`)
...
### `promiseResolveStaticCall` (`src/exec/promise_ops.zig:2420`)
...
### `promiseStaticCall` (`src/exec/promise_ops.zig:2448`)
...
### `PromiseRejectionReason.deinit` (`src/exec/promise_ops.zig:2509`)
...
### `PromiseRejectionReason.commit` (`src/exec/promise_ops.zig:2514`)
...
### `promiseRejectionReason` (`src/exec/promise_ops.zig:2519`)
...
### `closeForAwaitIteratorFromVm` (`src/exec/promise_ops.zig:2558`)
...
### `constructAsyncFunctionFromSource` (`src/exec/promise_ops.zig:2569`)
...
### `constructAsyncGeneratorFunctionFromSource` (`src/exec/promise_ops.zig:2581`)
...
### `asyncFunctionStart` (`src/exec/promise_ops.zig:2593`)
...
### `asyncFunctionRunState` (`src/exec/promise_ops.zig:2636`)
...
### `asyncFunctionRunAndSettle` (`src/exec/promise_ops.zig:2679`)
...
### `asyncFunctionAwaitOrReject` (`src/exec/promise_ops.zig:2707`)
...
### `clearHandledRejectionException` (`src/exec/promise_ops.zig:2725`)
...
### `asyncFunctionAwait` (`src/exec/promise_ops.zig:2729`)
...
### `asyncFunctionResumeCallback` (`src/exec/promise_ops.zig:2815`)
...
### `asyncResumeJobCall` (`src/exec/promise_ops.zig:2836`)
...
### `asyncFunctionResumeCallbackCall` (`src/exec/promise_ops.zig:2849`)
...
### `Probe.run` (`src/exec/promise_ops.zig:3016`)
...
### `settleAsyncPromise` (`src/exec/promise_ops.zig:2969`)
...
### `asyncFunctionSettle` (`src/exec/promise_ops.zig:2982`)
...
### `asyncFunctionClearPromise` (`src/exec/promise_ops.zig:3200`)
...
### `isAsyncGeneratorPrototypeMethod` (`src/exec/promise_ops.zig:3204`)
...
### `isAsyncGeneratorReceiver` (`src/exec/promise_ops.zig:3209`)
...
### `asyncGeneratorRejectedTypeError` (`src/exec/promise_ops.zig:3214`)
...
### `asyncFromSyncIteratorMethodCall` (`src/exec/promise_ops.zig:3218`)
...
### `asyncFromSyncIteratorThrow` (`src/exec/promise_ops.zig:3244`)
...
### `asyncFromSyncIteratorCloseWrap` (`src/exec/promise_ops.zig:3286`)
...
### `asyncFromSyncIteratorCloseWrapCall` (`src/exec/promise_ops.zig:3298`)
...
### `asyncFromSyncIteratorNext` (`src/exec/promise_ops.zig:3316`)
...
### `asyncFromSyncIteratorReturn` (`src/exec/promise_ops.zig:3344`)
...
### `asyncFromSyncIteratorContinuation` (`src/exec/promise_ops.zig:3372`)
...
### `asyncFromSyncIteratorUnwrap` (`src/exec/promise_ops.zig:3439`)
...
### `asyncFromSyncIteratorUnwrapCall` (`src/exec/promise_ops.zig:3451`)
...
### `promiseFinallyCallback` (`src/exec/promise_ops.zig:3471`)
...
### `promiseFinallyCallbackCall` (`src/exec/promise_ops.zig:3531`)
...
### `promiseFinally` (`src/exec/promise_ops.zig:3584`)
...
### `performPromiseThen` (`src/exec/promise_ops.zig:3611`)
...
### `promiseThen` (`src/exec/promise_ops.zig:3720`)
...
### `promiseCatchGeneric` (`src/exec/promise_ops.zig:3799`)
...
### `settlePendingPromiseReaction` (`src/exec/promise_ops.zig:3814`)
...
### `awaitPendingPromise` (`src/exec/promise_ops.zig:3911`)
...
### `drainPendingPromiseJobs` (`src/exec/promise_ops.zig:3931`)
...
### `promiseReactionInternalSettleCanRetry` (`src/exec/promise_ops.zig:3950`)
...
### `drainOnePendingJob` (`src/exec/promise_ops.zig:3968`)
...
### `enqueuePendingPromiseJob` (`src/exec/promise_ops.zig:4117`)
...
### `awaitThenableValue` (`src/exec/promise_ops.zig:4121`)
...
### `finishAwaitedPromise` (`src/exec/promise_ops.zig:4162`)
...
### `rejectModuleNamespaceSuperSet` (`src/exec/promise_ops.zig:4171`)
...
### `countPromiseJob` (`src/exec/promise_ops.zig:4184`)
...
- 清单函数数: 135（`src/exec/async_completion.zig` 5 + `src/exec/async_generator.zig` 15 + `src/exec/promise_builtin_ops.zig` 5 + `src/exec/promise_ops.zig` 110）
- 本文标题覆盖: 135
- 未覆盖: 无
