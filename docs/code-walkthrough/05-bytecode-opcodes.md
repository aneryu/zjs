...
### `opcode.dyn_env.Flags.encode` (`src/bytecode.zig:130`)
...
### `opcode.dyn_env.Flags.stackPop` (`src/bytecode.zig:137`)
...
### `opcode.dyn_env.Flags.stackPush` (`src/bytecode.zig:144`)
...
### `opcode.dyn_env.Flags.branchStackDelta` (`src/bytecode.zig:153`)
...
### `opcode.dyn_env.decode` (`src/bytecode.zig:165`)
...
### `opcode.ext0_sub.add` (`src/bytecode.zig:563`)
...
### `opcode.ext0_sub.isAdd` (`src/bytecode.zig:567`)
...
### `opcode.ext0_sub.addHint` (`src/bytecode.zig:571`)
...
### `opcode.ext0_sub.stackPop` (`src/bytecode.zig:575`)
...
### `opcode.ext0_sub.stackPush` (`src/bytecode.zig:599`)
...
### `opcode.formForId` (`src/bytecode.zig:664`)
...
### `opcode.generatedRow` (`src/bytecode.zig:673`)
...
### `opcode.finalInfo` (`src/bytecode.zig:742`)
...
### `opcode.finalCompactInfo` (`src/bytecode.zig:753`)
...
### `opcode.phase1Info` (`src/bytecode.zig:773`)
...
### `opcode.sizeOf` (`src/bytecode.zig:787`)
...
### `opcode.sizeOfPhase1` (`src/bytecode.zig:793`)
...
### `opcode.formatOf` (`src/bytecode.zig:799`)
...
### `opcode.carriesPropCacheIdx` (`src/bytecode.zig:825`)
...
### `opcode.carriesPropCacheIdxPhase1` (`src/bytecode.zig:832`)
...
### `opcode.formatOfPhase1` (`src/bytecode.zig:838`)
...
### `opcode.nameOf` (`src/bytecode.zig:844`)
...
### `opcode.nameOfPhase1` (`src/bytecode.zig:849`)
...
### `opcode.nPopOf` (`src/bytecode.zig:854`)
...
### `opcode.nPushOf` (`src/bytecode.zig:859`)
...
### `opcode.physical.isReclaimedName` (`src/bytecode.zig:892`)
...
### `opcode.physical.stateOf` (`src/bytecode.zig:915`)
...
### `opcode.physical.Ledger.free` (`src/bytecode.zig:928`)
...
### `opcode.physical.Ledger.total` (`src/bytecode.zig:932`)
...
### `planeOf` (`src/opcode_logical.zig:390`)
...
### `familyOf` (`src/opcode_logical.zig:609`)
...
### `operandTemplate` (`src/opcode_logical.zig:1016`)
...
### `operandsOf` (`src/opcode_logical.zig:1118`)
...
### `subForm` (`src/opcode_logical.zig:1271`)
...
### `traitsOf` (`src/opcode_logical.zig:1297`)
...
### `asyncSuspension` (`src/opcode_logical.zig:1637`)
