...
### `pipeline_pc2line.Encoded.deinit` (`src/bytecode.zig:6181`)
...
### `pipeline_pc2line.encode` (`src/bytecode.zig:6193`)
...
### `pipeline_pc2line.Encoder.putByte` (`src/bytecode.zig:6219`)
...
### `pipeline_pc2line.Encoder.putLeb128` (`src/bytecode.zig:6228`)
...
### `pipeline_pc2line.Encoder.putSleb128` (`src/bytecode.zig:6241`)
...
### `pipeline_pc2line.encodeInto` (`src/bytecode.zig:6250`)
...
### `pipeline_pc2line.decodeHeader` (`src/bytecode.zig:6302`)
...
### `pipeline_pc2line.decode` (`src/bytecode.zig:6319`)
...
### `pipeline_pc2line.findSourceLocation` (`src/bytecode.zig:6362`)
...
### `pipeline_pc2line.readLeb128` (`src/bytecode.zig:6403`)
...
### `pipeline_pc2line.readSleb128` (`src/bytecode.zig:6419`)
...
### `pipeline_stack_size.FinalArtifactValidator.validateKnownInstruction` (`src/bytecode.zig:9688`)
...
### `pipeline_stack_size.FinalArtifactValidator.validateBefore` (`src/bytecode.zig:9739`)
...
### `pipeline_stack_size.FinalArtifactValidator.finish` (`src/bytecode.zig:9751`)
...
### `pipeline_stack_size.compute` (`src/bytecode.zig:9763`)
...
### `pipeline_stack_size.seed` (`src/bytecode.zig:9958`)
...
### `pipeline_stack_size.maybePopCatchPos` (`src/bytecode.zig:9983`)
...
### `pipeline_finalize.isVarInArgumentScope` (`src/bytecode.zig:10403`)
...
### `pipeline_finalize.captureEvalParentLocal` (`src/bytecode.zig:10412`)
...
### `pipeline_finalize.captureEvalParentArg` (`src/bytecode.zig:10447`)
...
### `pipeline_finalize.addEvalVariables` (`src/bytecode.zig:10479`)
...
### `pipeline_finalize.addGlobalVariables` (`src/bytecode.zig:10605`)
...
### `pipeline_finalize.prepareCurrentBeforeChildren` (`src/bytecode.zig:10636`)
...
### `pipeline_finalize.validateOpenBindingIndices` (`src/bytecode.zig:10693`)
...
### `pipeline_finalize.createFunctionBytecode` (`src/bytecode.zig:10730`)
...
### `pipeline_finalize.createModuleFunctionBytecode` (`src/bytecode.zig:10741`)
...
### `pipeline_finalize.validateRuntimeIdentity` (`src/bytecode.zig:10754`)
...
### `pipeline_finalize.validatePreLoweringArtifactShape` (`src/bytecode.zig:10761`)
...
### `pipeline_finalize.validateFinalArtifactShape` (`src/bytecode.zig:10773`)
...
### `pipeline_finalize.createFunctionBytecodeAfterChildren` (`src/bytecode.zig:10800`)
...
### `pipeline_finalize.runWithFunctionDef` (`src/bytecode.zig:10998`)
...
### `pipeline_finalize.runWithFunctionDefRuntime` (`src/bytecode.zig:11012`)
...
### `pipeline_finalize.lowerAttachedBuilder` (`src/bytecode.zig:11032`)
...
### `pipeline_finalize.publishLoweredMetadata` (`src/bytecode.zig:11045`)
...
### `pipeline_finalize.computeStackSizeForCurrentBytecode` (`src/bytecode.zig:11140`)
...
### `pipeline_finalize.encodePc2Line` (`src/bytecode.zig:11162`)
...
### `pipeline_finalize.syncBytecodeVarNames` (`src/bytecode.zig:11172`)
...
### `pipeline_finalize.syncBytecodeArgDefs` (`src/bytecode.zig:11193`)
...
### `pipeline_finalize.syncBytecodeVarRefNames` (`src/bytecode.zig:11214`)
...
### `pipeline_finalize.installChildFunctionBytecodes` (`src/bytecode.zig:11245`)
...
### `pipeline_finalize.syncFunctionDefCpool` (`src/bytecode.zig:11360`)
...
- 清单函数数（本文件分组）: 41（`src/bytecode.zig` 全文件 538）
- 本文标题覆盖: 41
- 未覆盖: 无
