...
- **`DetachedSegment`**：从 builder 剪下的尾巴。拥有 code/atoms/relocs/binds/sources；偏移相对段起点。`LabelId` **不**进段——标签是函数全局的。
- **`Snapshot`**：六个标量：`code_len, atom_len, label_len, reloc_len, source_len, last_opcode_pos`。
...
### `reserve` (`src/compiler/builder.zig:70`)
...
### `reserveSlowBytes` (`src/compiler/builder.zig:106`)
...
### `Builder.init` (`src/compiler/builder.zig:172`)
...
### `Builder.deinit` (`src/compiler/builder.zig:178`)
...
### `Builder.newLabel` (`src/compiler/builder.zig:203`)
...
### `Builder.emitJump` (`src/compiler/builder.zig:224`)
...
### `Builder.bindLabel` (`src/compiler/builder.zig:264`)
...
### `Builder.bindLabelMatchBarrier` (`src/compiler/builder.zig:276`)
...
### `Builder.retargetLabelRefs` (`src/compiler/builder.zig:298`)
...
### `Builder.firstUnboundLabel` (`src/compiler/builder.zig:377`)
...
### `Builder.emitOp` (`src/compiler/builder.zig:385`)
...
### `Builder.emitOpU8` (`src/compiler/builder.zig:395`)
...
### `Builder.emitOpU16` (`src/compiler/builder.zig:407`)
...
### `Builder.emitOpU32` (`src/compiler/builder.zig:419`)
...
### `Builder.emitOpI32` (`src/compiler/builder.zig:431`)
...
### `Builder.emitAtomOpOwned` (`src/compiler/builder.zig:444`)
...
### `Builder.emitAtomOpU8Owned` (`src/compiler/builder.zig:479`)
...
### `Builder.emitAtomOpU16Owned` (`src/compiler/builder.zig:505`)
...
### `Builder.emitScopeRefOpOwned` (`src/compiler/builder.zig:535`)
...
### `Builder.takeLastAtomOwned` (`src/compiler/builder.zig:594`)
...
### `Builder.takeTrailingAtomOpcodeOwned` (`src/compiler/builder.zig:603`)
...
### `Builder.replaceAtomOperand` (`src/compiler/builder.zig:646`)
...
### `Builder.rewriteTrailingAtomOpAsPlain` (`src/compiler/builder.zig:678`)
...
### `Builder.addSourceMarker` (`src/compiler/builder.zig:703`)
...
### `Builder.snapshot` (`src/compiler/builder.zig:727`)
...
### `Builder.rollback` (`src/compiler/builder.zig:742`)
...
### `Builder.truncateLastOpcodePreserveSources` (`src/compiler/builder.zig:796`)
...
### `Builder.detachTail` (`src/compiler/builder.zig:831`)
...
### `Builder.spliceSegment` (`src/compiler/builder.zig:948`)
...
### `Builder.discardSegment` (`src/compiler/builder.zig:1063`)
...
### `Builder.invalidateLastOpcode` (`src/compiler/builder.zig:1069`)
...
### `Builder.freeSegmentBackings` (`src/compiler/builder.zig:1073`)
...
### `Builder.reserveCode` (`src/compiler/builder.zig:1082`)
...
### `expectRelocChain` (`src/compiler/builder.zig:1104`)
...
### `s2g4OomScript` (`src/compiler/builder.zig:1579`)
