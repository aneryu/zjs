...
### `RootedValueCopies.init` (`src/exec/array_ops.zig:29`)
...
### `RootedValueCopies.deinit` (`src/exec/array_ops.zig:43`)
...
### `staticMethodId` (`src/exec/array_ops.zig:53`)
...
### `prototypeMethodId` (`src/exec/array_ops.zig:61`)
...
### `arrayEntry` (`src/exec/array_ops.zig:192`)
...
### `arrayPushEntry` (`src/exec/array_ops.zig:196`)
...
### `arrayPopEntry` (`src/exec/array_ops.zig:205`)
...
### `arraySpliceEntry` (`src/exec/array_ops.zig:209`)
...
### `arrayEntryWithHandler` (`src/exec/array_ops.zig:215`)
...
### `arrayConstructorEntry` (`src/exec/array_ops.zig:269`)
...
### `arrayPrototypeFromGlobal` (`src/exec/array_ops.zig:284`)
...
### `arrayCall` (`src/exec/array_ops.zig:302`)
...
### `arrayPushCall` (`src/exec/array_ops.zig:363`)
...
### `arrayPushDirect` (`src/exec/array_ops.zig:383`)
...
### `arrayPushDirectHost` (`src/exec/array_ops.zig:415`)
...
### `arraySpliceCall` (`src/exec/array_ops.zig:435`)
...
### `arraySpliceDirect` (`src/exec/array_ops.zig:453`)
...
### `arraySpliceDirectHost` (`src/exec/array_ops.zig:478`)
...
### `arrayPopCall` (`src/exec/array_ops.zig:498`)
...
### `construct` (`src/exec/array_ops.zig:525`)
...
### `constructConstructorWithPrototype` (`src/exec/array_ops.zig:529`)
...
### `constructWithPrototype` (`src/exec/array_ops.zig:546`)
...
### `arrayLengthFromNumber` (`src/exec/array_ops.zig:574`)
...
### `methodCall` (`src/exec/array_ops.zig:591`)
...
- **所有权 / 错误 / 调用**：返回 owned 值，`receiver`/`args` 借用。error set 见 `methodCallWithRealm`（`error.TypeError` / `error.InvalidBuiltinRegistry`），bare-runtime API 不映射 JS 异常。**生产树内无调用方**（spec 路径走 `array_ops`）：只有 `src/tests/core.zig:3383`、`src/tests/core.zig:4560`（method 20 = 迭代器 next，用作 GC 重入夹具）与本文件测试在用；函数上的注释已写明它是 test-only 留存面。同批次里真正零调用的 `join` 已删。

### `methodCallInRealm` (`src/exec/array_ops.zig:599`)
...
### `methodCallWithRealm` (`src/exec/array_ops.zig:603`)
...
### `arrayIterator` (`src/exec/array_ops.zig:682`)
...
### `arrayIteratorNext` (`src/exec/array_ops.zig:717`)
...
### `arrayIteratorValue` (`src/exec/array_ops.zig:735`)
...
### `iteratorResult` (`src/exec/array_ops.zig:753`)
...
### `filterEven` (`src/exec/array_ops.zig:909`)
...
### `reduceSum` (`src/exec/array_ops.zig:927`)
...
### `someEven` (`src/exec/array_ops.zig:938`)
...
### `everyPositive` (`src/exec/array_ops.zig:949`)
...
### `indexSearch` (`src/exec/array_ops.zig:966`)
...
### `stringSearchValue` (`src/exec/array_ops.zig:1008`)
...
### `at` (`src/exec/array_ops.zig:1022`)
...
### `slice` (`src/exec/array_ops.zig:1030`)
...
### `splice` (`src/exec/array_ops.zig:1047`)
...
### `push` (`src/exec/array_ops.zig:1071`)
...
### `pop` (`src/exec/array_ops.zig:1079`)
...
### `rewriteReversedPair` (`src/exec/array_ops.zig:1090`)
...
### `reverse` (`src/exec/array_ops.zig:1110`)
...
### `sort` (`src/exec/array_ops.zig:1149`)
...
### `SortEntry.lessThan` (`src/exec/array_ops.zig:1184`)
...
### `rewriteSortedArray` (`src/exec/array_ops.zig:1201`)
...
### `rewriteSortedArrayRooted` (`src/exec/array_ops.zig:1211`)
...
### `concat` (`src/exec/array_ops.zig:1230`)
...
### `concatAppend` (`src/exec/array_ops.zig:1256`)
...
### `expectArrayIteratorTarget` (`src/exec/array_ops.zig:1284`)
...
### `arrayIteratorTargetLength` (`src/exec/array_ops.zig:1290`)
...
### `valuesEqual` (`src/exec/array_ops.zig:1297`)
...
### `compareBigIntValues` (`src/exec/array_ops.zig:1315`)
...
### `bigIntParts` (`src/exec/array_ops.zig:1328`)
...
### `compareStringValues` (`src/exec/array_ops.zig:1351`)
...
### `appendValueString` (`src/exec/array_ops.zig:1356`)
