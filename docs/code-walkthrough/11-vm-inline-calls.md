...
### `ReturnContinuation.takeAtom` (`src/exec/inline_calls.zig:335`)
...
### `ReturnContinuation.takeForOfDepth` (`src/exec/inline_calls.zig:343`)
...
### `Entry.takeContinuation` (`src/exec/inline_calls.zig:421`)
...
### `Entry.isEmptyLeaf` (`src/exec/inline_calls.zig:428`)
...
### `Entry.isExactArgsLeaf` (`src/exec/inline_calls.zig:432`)
...
### `Entry.isForwardedLeaf` (`src/exec/inline_calls.zig:436`)
...
### `Entry.hasSpecialReturn` (`src/exec/inline_calls.zig:440`)
...
### `Entry.isNativeBoundaryReturn` (`src/exec/inline_calls.zig:444`)
...
### `Entry.isLeanBoundaryReturn` (`src/exec/inline_calls.zig:453`)
...
### `Entry.completesConstructor` (`src/exec/inline_calls.zig:458`)
...
### `Entry.emptyLeafResumeWords` (`src/exec/inline_calls.zig:472`)
...
### `Entry.setEmptyLeafResume` (`src/exec/inline_calls.zig:477`)
...
### `Entry.emptyLeafResumePc` (`src/exec/inline_calls.zig:484`)
...
### `Entry.emptyLeafResumeSp` (`src/exec/inline_calls.zig:489`)
...
### `Entry.tailChainBudgetSlot` (`src/exec/inline_calls.zig:503`)
...
### `Entry.adoptContinuation` (`src/exec/inline_calls.zig:514`)
...
### `Entry.isOrdinaryReturn` (`src/exec/inline_calls.zig:587`)
...
### `Entry.canUseSimpleTeardown` (`src/exec/inline_calls.zig:594`)
...
### `Entry.deinit` (`src/exec/inline_calls.zig:604`)
...
### `Entry.deinitReturned` (`src/exec/inline_calls.zig:628`)
...
### `deinitEmptyLeaf` (`src/exec/inline_calls.zig:639`)
...
### `Entry.deinitEmptyLeafInline` (`src/exec/inline_calls.zig:658`)
...
### `Entry.deinitExactArgsLeafInline` (`src/exec/inline_calls.zig:680`)
...
### `Entry.deinitForwardedLeafInline` (`src/exec/inline_calls.zig:701`)
...
### `Entry.deinitSimple` (`src/exec/inline_calls.zig:722`)
...
### `Entry.deinitSimpleResources` (`src/exec/inline_calls.zig:731`)
...
### `Entry.deinitOrdinarySimpleResources` (`src/exec/inline_calls.zig:748`)
...
### `Entry.deinitOrdinaryReturned` (`src/exec/inline_calls.zig:764`)
...
### `Entry.deinitConstructorReturned` (`src/exec/inline_calls.zig:792`)
...
### `Entry.deinitGeneral` (`src/exec/inline_calls.zig:813`)
...
### `Entry.deinitGeneralResources` (`src/exec/inline_calls.zig:818`)
...
### `Entry.deinitForTailReplacement` (`src/exec/inline_calls.zig:828`)
...
### `ExecutionLevel.function` (`src/exec/inline_calls.zig:856`)
...
### `MachineBacktraceView.root` (`src/exec/inline_calls.zig:892`)
...
### `MachineBacktraceView.segment` (`src/exec/inline_calls.zig:899`)
...
### `MachineBacktraceView.freeze` (`src/exec/inline_calls.zig:911`)
...
### `MachineBacktraceView.thaw` (`src/exec/inline_calls.zig:917`)
...
### `resolveMachineBacktraceRange` (`src/exec/inline_calls.zig:924`)
...
### `consumeInlineThenPhysical` (`src/exec/inline_calls.zig:950`)
...
### `resolveMachineBacktraceView` (`src/exec/inline_calls.zig:963`)
...
### `nativeBacktraceSnapshot` (`src/exec/inline_calls.zig:975`)
...
### `Machine.isSimpleInlineFrame` (`src/exec/inline_calls.zig:1627`)
...
### `Machine.paddedSimpleInlineMode` (`src/exec/inline_calls.zig:1670`)
...
### `Machine.methodSimpleInlineMode` (`src/exec/inline_calls.zig:1688`)
...
### `Machine.isStrictSimpleInlineFrame` (`src/exec/inline_calls.zig:1718`)
...
### `setupFallbackInlineEntry` (`src/exec/inline_calls.zig:1738`)
...
### `Machine.simpleInlineSlabTotal` (`src/exec/inline_calls.zig:1760`)
...
### `setupSimpleInlineEntryWarm` (`src/exec/inline_calls.zig:1785`)
...
### `Machine.setupSimpleInlineEntryDispatch` (`src/exec/inline_calls.zig:1876`)
...
### `Machine.setupSimpleConstructorEntryDispatch` (`src/exec/inline_calls.zig:1898`)
...
### `setupSimpleInlineEntry` (`src/exec/inline_calls.zig:1940`)
...
### `setupSimpleConstructorEntry` (`src/exec/inline_calls.zig:1960`)
...
### `Machine.setupSimpleInlineEntryImpl` (`src/exec/inline_calls.zig:1964`)
...
### `pushExactSimpleFrame` (`src/exec/inline_calls.zig:2157`)
...
### `pushExactSimpleFrameSlow` (`src/exec/inline_calls.zig:2292`)
...
### `Machine.pushExactSimpleOrSlow` (`src/exec/inline_calls.zig:2304`)
...
### `Machine.pushExactSimpleFrameImpl` (`src/exec/inline_calls.zig:2326`)
...
### `pushEmptyLeafFrame` (`src/exec/inline_calls.zig:2388`)
...
### `pushExactArgsLeafFrame` (`src/exec/inline_calls.zig:2443`)
...
### `pushCaptureLeafFrame` (`src/exec/inline_calls.zig:2503`)
...
### `Machine.assertLeafEligible` (`src/exec/inline_calls.zig:2557`)
...
### `Machine.assertExactArgsLeafEligible` (`src/exec/inline_calls.zig:2571`)
...
### `Machine.assertCaptureLeafEligible` (`src/exec/inline_calls.zig:2586`)
...
### `Machine.finishEmptyLeafFrame` (`src/exec/inline_calls.zig:2612`)
...
### `Machine.finishExactArgsLeafFrame` (`src/exec/inline_calls.zig:2675`)
...
### `Machine.finishCaptureLeafFrame` (`src/exec/inline_calls.zig:2780`)
...
### `Machine.callerResumePc` (`src/exec/inline_calls.zig:2836`)
...
### `Machine.tryPushEmptyLeafCallFast` (`src/exec/inline_calls.zig:2849`)
...
### `Machine.tryPushExactArgsLeafCallFast` (`src/exec/inline_calls.zig:2905`)
...
### `Machine.tryPushForwardedExactArgsLeafFast` (`src/exec/inline_calls.zig:2963`)
...
### `Machine.tryPushCaptureLeafCallFast` (`src/exec/inline_calls.zig:3012`)
...
### `setupInlineEntry` (`src/exec/inline_calls.zig:3065`)
...
### `Machine.nativeBoundarySimpleEligible` (`src/exec/inline_calls.zig:3681`)
...
### `Machine.pushNativeBoundaryCopiedArgs` (`src/exec/inline_calls.zig:3693`)
...
### `Machine.pushNativeBoundaryMovedArgs` (`src/exec/inline_calls.zig:3705`)
...
### `Machine.pushLeanEntry` (`src/exec/inline_calls.zig:3719`)
...
### `Machine.tryPushNativeBoundaryCopiedArgsFast` (`src/exec/inline_calls.zig:3782`)
...
### `Machine.tryPushNativeBoundaryMovedArgsFast` (`src/exec/inline_calls.zig:3793`)
...
### `Machine.tryPushNativeBoundaryArgsFast` (`src/exec/inline_calls.zig:3802`)
...
### `Machine.tryPushNativeBoundaryEmptyFast` (`src/exec/inline_calls.zig:3838`)
...
### `Machine.tryPushNativeBoundaryLeafArgsFast` (`src/exec/inline_calls.zig:3909`)
...
### `Machine.tryPushNativeBoundarySimpleGeneralFast` (`src/exec/inline_calls.zig:4012`)
...
### `Machine.pushNativeBoundarySimple` (`src/exec/inline_calls.zig:4117`)
...
### `Machine.pushNativeBoundaryLeafArgs` (`src/exec/inline_calls.zig:4178`)
...
### `Machine.pushNativeBoundaryEmpty` (`src/exec/inline_calls.zig:4271`)
...
### `setupNativeBoundarySimpleEntry` (`src/exec/inline_calls.zig:4344`)
...
### `Machine.pushMovedCall` (`src/exec/inline_calls.zig:4458`)
...
### `Machine.pushAsyncMovedCall` (`src/exec/inline_calls.zig:4489`)
...
### `Machine.completeAsync` (`src/exec/inline_calls.zig:4498`)
...
### `Machine.catchAsyncBoundary` (`src/exec/inline_calls.zig:4507`)
...
### `Machine.pushBorrowedIteratorNext` (`src/exec/inline_calls.zig:4521`)
...
### `Machine.assertBorrowedIteratorWarmEligible` (`src/exec/inline_calls.zig:4545`)
...
### `Machine.readValueAsIntPair` (`src/exec/inline_calls.zig:4561`)
...
### `Machine.tryPushBorrowedIteratorNextFast` (`src/exec/inline_calls.zig:4589`)
...
### `Machine.finishBorrowedIteratorFrame` (`src/exec/inline_calls.zig:4641`)
...
### `Machine.tailCallReuse` (`src/exec/inline_calls.zig:4720`)
...
### `Machine.popFrameMode` (`src/exec/inline_calls.zig:4817`)
...
### `popTailChainFrameMode` (`src/exec/inline_calls.zig:4856`)
...
### `Machine.popOrdinaryFrame` (`src/exec/inline_calls.zig:4887`)
...
### `Machine.popFrame` (`src/exec/inline_calls.zig:4912`)
...
### `Machine.popReturnedFrame` (`src/exec/inline_calls.zig:4918`)
...
### `Machine.popReturnedNativeBoundary` (`src/exec/inline_calls.zig:4929`)
...
### `Machine.popReturnedLean` (`src/exec/inline_calls.zig:4974`)
...
### `Machine.popReturnedEmptyLeaf` (`src/exec/inline_calls.zig:4991`)
...
### `Machine.popReturnedExactArgsLeaf` (`src/exec/inline_calls.zig:5021`)
...
### `Machine.popReturnedForwardedLeaf` (`src/exec/inline_calls.zig:5050`)
...
### `Machine.popReturn` (`src/exec/inline_calls.zig:5074`)
...
### `popConstructorReturn` (`src/exec/inline_calls.zig:5125`)
...
### `Machine.unwindForErrorToDepth` (`src/exec/inline_calls.zig:5173`)
...
### `Machine.unwindForError` (`src/exec/inline_calls.zig:5211`)
...
### `clearPropSiteIndices` (`src/exec/small_inline.zig:696`)
...
### `emitGetField2` (`src/exec/small_inline.zig:708`)
...
### `emitGoto` (`src/exec/small_inline.zig:719`)
...
### `recordMap` (`src/exec/small_inline.zig:726`)
...
### `rewriteBody` (`src/exec/small_inline.zig:734`)
...
### `relTarget` (`src/exec/small_inline.zig:958`)
...
### `patchJump` (`src/exec/small_inline.zig:965`)
...
### `collectSameCalleeConstructorPcs` (`src/exec/small_inline.zig:986`)
...
### `cloneAndExpand` (`src/exec/small_inline.zig:1037`)
...
### `consumedArgSlots` (`src/exec/small_inline.zig:1330`)
...
### `windowFits` (`src/exec/small_inline.zig:1336`)
...
### `installInlineWindow` (`src/exec/small_inline.zig:1344`)
...
### `logicalInlineFrames` (`src/exec/small_inline.zig:1370`)
...
### `inlinedSnapshot` (`src/exec/small_inline.zig:1394`)
...
### `resolveCalleeLocation` (`src/exec/small_inline.zig:1407`)
...
### `sampleCtorCache` (`src/exec/small_inline.zig:1422`)
...
### `calleeMatches` (`src/exec/small_inline.zig:1435`)
...
### `realmFunctionApply` (`src/exec/small_inline.zig:1440`)
...
### `isFunctionApplyBuiltin` (`src/exec/small_inline.zig:1445`)
...
### `lookupProtoChainDataFunction` (`src/exec/small_inline.zig:1451`)
...
### `applyForwardGuardHolds` (`src/exec/small_inline.zig:1465`)
...
### `applyForwardTakeOk` (`src/exec/small_inline.zig:1480`)
...
### `applyForwardSiteAfterCall` (`src/exec/small_inline.zig:1497`)
...
### `realmApplyBuiltin` (`src/exec/small_inline.zig:1508`)
...
### `tryFusedConstructor` (`src/exec/small_inline.zig:1516`)
