...
### `Object.materializeAutoInit` (`src/core/object.zig:7775`)
...
### `Object.materializeModuleAutoInit` (`src/core/object.zig:7813`)
...
### `Object.autoInitSlotStillMatches` (`src/core/object.zig:7821`)
...
### `Object.commitAutoInitValue` (`src/core/object.zig:7828`)
...
### `Object.commitAutoInitVarRef` (`src/core/object.zig:7856`)
...
### `Object.materializeAutoInitEntryForMutation` (`src/core/object.zig:7864`)
...
### `Object.materializePropAutoInit` (`src/core/object.zig:7878`)
...
### `Object.materializeStringConstantAutoInit` (`src/core/object.zig:7896`)
...
### `Object.materializeEmptyArrayAutoInit` (`src/core/object.zig:7905`)
...
### `Object.materializeNativeFunctionAutoInit` (`src/core/object.zig:7911`)
...
### `Object.prepareAutoInitNativeFunction` (`src/core/object.zig:7926`)
...
### `Object.materializeArrayUnscopablesAutoInit` (`src/core/object.zig:7945`)
...
### `Object.applyAutoInitFunctionMarkers` (`src/core/object.zig:7982`)
...
### `Object.materializeHostFunctionAutoInit` (`src/core/object.zig:8005`)
...
### `Object.materializeBuiltinNamespaceAutoInit` (`src/core/object.zig:8025`)
...
### `Object.defineHostAutoInitDataPropertyByName` (`src/core/object.zig:8032`)
...
### `Object.materializeConsoleAutoInit` (`src/core/object.zig:8059`)
...
### `Object.materializeNavigatorAutoInit` (`src/core/object.zig:8073`)
...
### `Object.materializePerformanceAutoInit` (`src/core/object.zig:8102`)
...
### `Object.performanceAutoInitNowMs` (`src/core/object.zig:8132`)
...
### `Object.objectPrototypeValueForAutoInit` (`src/core/object.zig:8144`)
...
### `Object.materializeFunctionPrototypeAutoInit` (`src/core/object.zig:8164`)
...
### `Object.defineFunctionPrototypeAutoInit` (`src/core/object.zig:8185`)
...
### `Object.arrayPrototypeValueForAutoInit` (`src/core/object.zig:8232`)
...
### `Object.autoInitRealmForDefinition` (`src/core/object.zig:8500`)
...
### `Object.createPropAutoInitSlot` (`src/core/object.zig:8510`)
...
### `Object.createPropAutoInitSlotWork` (`src/core/object.zig:8529`)
...
### `Object.defineAutoInitPropertyFromDescriptor` (`src/core/object.zig:8543`)
...
### `Object.defineAutoInitPropertyFromDescriptorWithResolvedRealm` (`src/core/object.zig:8558`)
...
### `Object.defineModuleVarRefProperty` (`src/core/object.zig:8580`)

- **签名**：`pub fn defineModuleVarRefProperty( self: *Object, rt: *JSRuntime, atom_id: atom.Atom, cell: *var_ref_mod.VarRef, ) !void`。
...
- **所有权 / 错误 / 调用**：成功槽共享 supplied cell，不复制 binding 值；cell 仍归 exporter 模块记录所有，属性只是多一条被追踪的边，失败路径无需回滚（参数原名 owned_cell 与「每条返回路径都消耗该引用」的注释都是 RC 时代残留，已改实）。caller 负责 cell 的存活和模块链接合同。

### `Object.defineModuleAutoInitProperty` (`src/core/object.zig:8599`)
...
### `Object.defineModuleAutoInitPropertyForFixture` (`src/core/object.zig:8640`)
...
### `Object.defineAutoInitProperty` (`src/core/object.zig:8651`)
...
### `Object.defineAutoInitPropertyWithRealm` (`src/core/object.zig:8662`)
...
### `Object.defineAutoInitPropertyWithRealmAndNative` (`src/core/object.zig:8674`)
...
### `Object.replaceAutoInitPropertyWithRealmAndNative` (`src/core/object.zig:8700`)
...
### `Object.replaceAutoInitPropertyWithData` (`src/core/object.zig:8735`)
...
### `Object.defineNavigatorAutoInitProperty` (`src/core/object.zig:8758`)
...
### `Object.defineConsoleAutoInitProperty` (`src/core/object.zig:8775`)
...
### `Object.definePerformanceAutoInitProperty` (`src/core/object.zig:8796`)
...
### `Object.defineBuiltinNamespaceAutoInitProperty` (`src/core/object.zig:8813`)
...
### `Object.defineEmptyArrayAutoInitProperty` (`src/core/object.zig:8836`)
...
### `Object.defineEmptyArrayAutoInitPropertyMut` (`src/core/object.zig:8856`)
...
### `Object.defineHostAutoInitProperty` (`src/core/object.zig:8892`)
...
### `Object.defineHostAutoInitPropertyWithEntry` (`src/core/object.zig:8916`)
...
### `Object.materializeMappedArgumentsProperty` (`src/core/object.zig:10985`)
...
### `Object.materializeAllMappedArgumentsProperties` (`src/core/object.zig:10992`)
...
- 清单函数数（本文件分到）: 47（`src/core/object.zig` 全文件 873）
- 本文标题覆盖: 47
- 未覆盖: 无
