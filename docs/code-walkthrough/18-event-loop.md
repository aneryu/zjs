...
### `RunResult.hasPendingError` (`src/runtime/event_loop.zig:50`)
...
### `EventLoop.init` (`src/runtime/event_loop.zig:69`)
...
### `EventLoop.initCore` (`src/runtime/event_loop.zig:73`)
...
### `EventLoop.install` (`src/runtime/event_loop.zig:81`)
...
### `EventLoop.deinit` (`src/runtime/event_loop.zig:89`)
...
### `EventLoop.runUntilIdle` (`src/runtime/event_loop.zig:117`)
...
### `EventLoop.result` (`src/runtime/event_loop.zig:125`)
...
### `EventLoop.setExitCode` (`src/runtime/event_loop.zig:132`)
...
### `EventLoop.exitCode` (`src/runtime/event_loop.zig:136`)
...
### `EventLoop.traceRoots` (`src/runtime/event_loop.zig:140`)
...
### `EventLoop.takeNextTimerId` (`src/runtime/event_loop.zig:152`)
...
### `EventLoop.ensureTimerCapacity` (`src/runtime/event_loop.zig:159`)
...
### `EventLoop.enqueueTimer` (`src/runtime/event_loop.zig:176`)
...
### `EventLoop.clearTimer` (`src/runtime/event_loop.zig:184`)
...
### `EventLoop.removeTimerAt` (`src/runtime/event_loop.zig:194`)
...
### `EventLoop.runNextTimer` (`src/runtime/event_loop.zig:209`)
...
### `EventLoop.timerExists` (`src/runtime/event_loop.zig:264`)
...
### `EventLoop.ensureRwHandlerCapacity` (`src/runtime/event_loop.zig:271`)
...
### `EventLoop.setRwHandler` (`src/runtime/event_loop.zig:288`)
...
### `EventLoop.clearRwHandler` (`src/runtime/event_loop.zig:304`)
...
### `EventLoop.runNextRwHandler` (`src/runtime/event_loop.zig:331`)
...
### `EventLoop.runNextRwHandlerWindows` (`src/runtime/event_loop.zig:341`)
...
### `EventLoop.runNextRwHandlerPosix` (`src/runtime/event_loop.zig:376`)
...
### `EventLoop.ensureSignalHandlerCapacity` (`src/runtime/event_loop.zig:437`)
...
### `EventLoop.setSignalHandler` (`src/runtime/event_loop.zig:454`)
...
### `EventLoop.clearSignalHandler` (`src/runtime/event_loop.zig:469`)
...
### `EventLoop.removeSignalHandlerAt` (`src/runtime/event_loop.zig:482`)
...
### `EventLoop.runNextSignalHandler` (`src/runtime/event_loop.zig:497`)
...
### `runUntilIdle` (`src/runtime/event_loop.zig:512`)
...
### `Timer.traceRoots` (`src/runtime/event_loop.zig:536`)
...
### `RwHandler.setCallback` (`src/runtime/event_loop.zig:546`)
...
### `RwHandler.clearCallback` (`src/runtime/event_loop.zig:551`)
...
### `RwHandler.traceRoots` (`src/runtime/event_loop.zig:556`)
...
### `SignalHandler.init` (`src/runtime/event_loop.zig:566`)
...
### `SignalHandler.setCallback` (`src/runtime/event_loop.zig:573`)
...
### `SignalHandler.traceRoots` (`src/runtime/event_loop.zig:577`)
...
### `fromOpaque` (`src/runtime/event_loop.zig:598`)
...
### `traceRoots` (`src/runtime/event_loop.zig:602`)
...
### `setExitCode` (`src/runtime/event_loop.zig:606`)
...
### `exitCode` (`src/runtime/event_loop.zig:610`)
...
### `nextTimerId` (`src/runtime/event_loop.zig:614`)
...
### `enqueueTimer` (`src/runtime/event_loop.zig:618`)
...
### `clearTimer` (`src/runtime/event_loop.zig:624`)
...
### `runNextTimer` (`src/runtime/event_loop.zig:630`)
...
### `setRwHandler` (`src/runtime/event_loop.zig:636`)
...
### `clearRwHandler` (`src/runtime/event_loop.zig:642`)
...
### `runNextRwHandler` (`src/runtime/event_loop.zig:648`)
...
### `setSignalHandler` (`src/runtime/event_loop.zig:654`)
...
### `clearSignalHandler` (`src/runtime/event_loop.zig:660`)
...
### `runNextSignalHandler` (`src/runtime/event_loop.zig:666`)
...
### `osSignalHandler` (`src/runtime/event_loop.zig:674`)
...
### `nowMs` (`src/runtime/event_loop.zig:679`)
...
### `hostTimerIo` (`src/runtime/event_loop.zig:684`)
...
### `Counter.visitValue` (`src/runtime/event_loop.zig:899`)
...
### `Counter.visitObject` (`src/runtime/event_loop.zig:906`)
