...
### `SharedArrayBufferRef.retain` (`src/core/context.zig:221`)
...
### `SharedArrayBufferRef.release` (`src/core/context.zig:227`)
...
### `SharedArrayBufferRef.sharedStore` (`src/core/context.zig:234`)
...
### `HostEventLoop.traceRoots` (`src/core/context.zig:265`)
...
### `HostEventLoop.setExitCode` (`src/core/context.zig:269`)
...
### `HostEventLoop.exitCode` (`src/core/context.zig:273`)
...
### `HostEventLoop.nextTimerId` (`src/core/context.zig:277`)
...
### `HostEventLoop.enqueueTimer` (`src/core/context.zig:281`)
...
### `HostEventLoop.clearTimer` (`src/core/context.zig:285`)
...
### `HostEventLoop.runNextTimer` (`src/core/context.zig:289`)
...
### `HostEventLoop.setRwHandler` (`src/core/context.zig:293`)
...
### `HostEventLoop.clearRwHandler` (`src/core/context.zig:297`)
...
### `HostEventLoop.runNextRwHandler` (`src/core/context.zig:301`)
...
### `HostEventLoop.setSignalHandler` (`src/core/context.zig:305`)
...
### `HostEventLoop.clearSignalHandler` (`src/core/context.zig:309`)
...
### `HostEventLoop.runNextSignalHandler` (`src/core/context.zig:313`)
...
### `JSContext.traceListPreviousPtr` (`src/core/context.zig:443`)
...
### `JSContext.traceListPreviousPtrConst` (`src/core/context.zig:447`)
...
### `JSContext.create` (`src/core/context.zig:457`)

- **签名**：`pub fn create(rt: *JSRuntime, options: ContextOptions) !*JSContext`。
- **作用**：创建并立即完成core发布的realm。默认写 `create(rt, .{})`。
- **实现**：调用createWithPublication(rt,options,true)。
- **所有权 / 错误 / 调用**：会检查owner线程并可能分配失败；创建宿主create-ref根，调用方最终释放一次。选项stack_size作用于整个runtime，而非独立realm额度；无默认全局/内建安装。

### `JSContext.createConstructingWithOptions` (`src/core/context.zig:463`)
...
### `JSContext.createWithPublication` (`src/core/context.zig:467`)
...
### `JSContext.fillNullJsValues` (`src/core/context.zig:482`)
...
### `JSContext.initConstructing` (`src/core/context.zig:489`)
...
### `JSContext.publishLive` (`src/core/context.zig:524`)
...
### `JSContext.finishConstruction` (`src/core/context.zig:540`)
...
### `JSContext.finishConstructionChecked` (`src/core/context.zig:548`)
...
### `JSContext.publicationState` (`src/core/context.zig:553`)
...
### `JSContext.isLive` (`src/core/context.zig:557`)
...
### `JSContext.runtimePtr` (`src/core/context.zig:561`)
...
### `JSContext.setStackLimit` (`src/core/context.zig:565`)
...
### `JSContext.stackLimit` (`src/core/context.zig:569`)
...
### `JSContext.pollInterrupt` (`src/core/context.zig:578`)
...
### `JSContext.pollInterruptTick` (`src/core/context.zig:588`)
...
### `JSContext.pollInterruptSlowPublic` (`src/core/context.zig:594`)
...
### `JSContext.pollInterruptSlow` (`src/core/context.zig:598`)
...
### `JSContext.setTrackUnhandledRejections` (`src/core/context.zig:613`)
...
### `JSContext.tracksUnhandledRejections` (`src/core/context.zig:617`)
...
### `JSContext.setPreserveUncaughtException` (`src/core/context.zig:621`)
...
### `JSContext.preservesUncaughtException` (`src/core/context.zig:625`)
...
### `JSContext.setHostEventLoop` (`src/core/context.zig:629`)
...
### `JSContext.clearHostEventLoop` (`src/core/context.zig:633`)
...
### `JSContext.hostEventLoop` (`src/core/context.zig:639`)
...
### `JSContext.usingInlineClassPrototypes` (`src/core/context.zig:643`)
...
### `JSContext.deinitClassPrototypeSlots` (`src/core/context.zig:647`)
...
### `JSContext.ensureClassPrototypeSlot` (`src/core/context.zig:660`)
...
### `JSContext.setClassPrototype` (`src/core/context.zig:684`)
...
### `JSContext.clearClassPrototype` (`src/core/context.zig:695`)
...
### `JSContext.classPrototypeObject` (`src/core/context.zig:702`)
...
### `JSContext.setNativeErrorPrototype` (`src/core/context.zig:712`)
...
### `JSContext.nativeErrorPrototypeObject` (`src/core/context.zig:720`)
...
### `JSContext.initializeInitialShapes` (`src/core/context.zig:729`)
...
### `JSContext.releaseInitialShape` (`src/core/context.zig:795`)
...
### `JSContext.clearIntrinsicBootstrapValues` (`src/core/context.zig:802`)
...
### `JSContext.rollbackIntrinsicBootstrap` (`src/core/context.zig:825`)
...
### `JSContext.deinitResources` (`src/core/context.zig:838`)
...
### `JSContext.destroy` (`src/core/context.zig:869`)
...
### `JSContext.tryDestroy` (`src/core/context.zig:876`)
...
### `JSContext.consumeHostApiRelease` (`src/core/context.zig:881`)
...
### `JSContext.dropHostRootProvider` (`src/core/context.zig:892`)
...
### `JSContext.destroyFromHeader` (`src/core/context.zig:899`)
...
### `JSContext.createValueHandle` (`src/core/context.zig:907`)
...
### `JSContext.takeValueHandle` (`src/core/context.zig:911`)
...
### `JSContext.traceRoots` (`src/core/context.zig:915`)
...
### `JSContext.traceChildEdgesNoFail` (`src/core/context.zig:968`)
...
### `JSContext.arrayBuffer` (`src/core/context.zig:999`)
...
### `JSContext.rootProvider` (`src/core/context.zig:1003`)
...
### `JSContext.traceRootProvider` (`src/core/context.zig:1010`)
...
### `JSContext.throwValue` (`src/core/context.zig:1020`)
...
### `JSContext.setExceptionUncatchable` (`src/core/context.zig:1028`)
...
### `JSContext.exceptionIsUncatchable` (`src/core/context.zig:1033`)
...
### `JSContext.markExceptionOutOfMemory` (`src/core/context.zig:1040`)
...
### `JSContext.exceptionIsOutOfMemory` (`src/core/context.zig:1045`)
...
### `JSContext.hasException` (`src/core/context.zig:1049`)
...
### `JSContext.takeException` (`src/core/context.zig:1053`)
...
### `JSContext.clearException` (`src/core/context.zig:1062`)
...
### `JSContext.recordUnhandledRejection` (`src/core/context.zig:1068`)
...
### `JSContext.recordUnhandledPromiseRejection` (`src/core/context.zig:1078`)
...
### `JSContext.appendUnhandledRejection` (`src/core/context.zig:1090`)
...
### `JSContext.removeUnhandledPromiseRejection` (`src/core/context.zig:1114`)
...
### `JSContext.hasUnhandledRejection` (`src/core/context.zig:1127`)
...
### `JSContext.takeUnhandledRejection` (`src/core/context.zig:1134`)
...
### `JSContext.clearUnhandledRejection` (`src/core/context.zig:1145`)
...
### `JSContext.classPrototypeSlotCount` (`src/core/context.zig:1154`)
...
### `JSContext.pushBacktraceFrame` (`src/core/context.zig:1158`)
...
### `JSContext.pushBacktraceFrameWithResolver` (`src/core/context.zig:1168`)
...
### `JSContext.pushActiveBacktraceFrame` (`src/core/context.zig:1180`)
...
### `JSContext.popActiveBacktraceFrame` (`src/core/context.zig:1185`)
...
### `JSContext.snapshotBacktraceFrames` (`src/core/context.zig:1191`)
...
### `JSContext.freeBacktraceFrameSnapshot` (`src/core/context.zig:1236`)
...
### `JSContext.dupBacktraceFrame` (`src/core/context.zig:1240`)
...
### `JSContext.dupActiveBacktraceFrameFromSnapshot` (`src/core/context.zig:1254`)
...
### `JSContext.pushBacktraceFrameLazyName` (`src/core/context.zig:1271`)
...
### `JSContext.popBacktraceFrame` (`src/core/context.zig:1305`)
...
### `JSContext.updateBacktracePc` (`src/core/context.zig:1311`)
...
### `JSContext.borrowBacktracePc` (`src/core/context.zig:1318`)
...
### `JSContext.updateBacktraceLocation` (`src/core/context.zig:1323`)
...
### `JSContext.takePendingException` (`src/core/context.zig:1332`)
...
### `JSContext.globalObject` (`src/core/context.zig:1341`)
...
### `RealmRef.takeOwned` (`src/core/context.zig:1364`)
...
### `RealmRef.retain` (`src/core/context.zig:1372`)
...
### `RealmRef.clone` (`src/core/context.zig:1376`)
...
### `RealmRef.borrow` (`src/core/context.zig:1380`)
...
### `RealmRef.deinit` (`src/core/context.zig:1384`)
