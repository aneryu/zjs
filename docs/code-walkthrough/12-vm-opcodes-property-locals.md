...
### `loc` (`src/exec/vm_property.zig:20`)
...
### `arg` (`src/exec/vm_property.zig:66`)
...
### `checkedLocVm` (`src/exec/vm_property.zig:93`)
...
### `varRef` (`src/exec/vm_property.zig:184`)
...
### `varRefVm` (`src/exec/vm_property.zig:240`)
...
### `tryFastDirectVarRefGet` (`src/exec/vm_property.zig:256`)
...
### `closeLoc` (`src/exec/vm_property.zig:264`)
