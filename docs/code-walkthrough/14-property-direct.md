...
[`src/exec/property_ops.zig`](../../src/exec/property_ops.zig) 只做 **guarded probe**：在确认 class / shape / flags / atom 种类 / 非 exotic / 非 Proxy 之后，直接读或写 data 槽。命中失败必须落到 `property_ops` / `object_ops` / `vm_property.zig`。返回的 `JSValue` 默认 **borrowed**；名字带 `Owned` 的写路径在槽提交后才消费输入。
...
### `dataPropertyValueForFastPath` (`src/exec/property_ops.zig:61`)
...
### `functionOwnDataPropertyValueForFastPath` (`src/exec/property_ops.zig:82`)
...
### `functionOwnDataPropertyObject` (`src/exec/property_ops.zig:87`)
...
### `isFunctionLikeClassId` (`src/exec/property_ops.zig:94`)
...
### `cacheableNamedDataObject` (`src/exec/property_ops.zig:116`)
...
### `fastImmediatePrototypeDataPropertyLookupForObject` (`src/exec/property_ops.zig:131`)
...
### `fastOwnOrdinaryDataPropertyLookupForObject` (`src/exec/property_ops.zig:145`)
...
### `writableOwnDataPropertyLookup` (`src/exec/property_ops.zig:153`)
...
### `setOwnDataPropertyLookup` (`src/exec/property_ops.zig:158`)
...
### `setOwnDataPropertyAt` (`src/exec/property_ops.zig:162`)
...
### `ordinaryDataPropertyLookup` (`src/exec/property_ops.zig:172`)
...
### `ordinaryDataPropertyValueOrUndefinedForFastPath` (`src/exec/property_ops.zig:196`)
...
### `declaredGlobalVarDataBorrowedLookup` (`src/exec/property_ops.zig:204`)
...
### `globalOwnDataPropertyBorrowedLookup` (`src/exec/property_ops.zig:212`)
...
### `globalOwnDataPropertyValue` (`src/exec/property_ops.zig:224`)
...
### `globalOwnDataPropertyBorrowedAt` (`src/exec/property_ops.zig:229`)
...
### `globalOwnWritableDataPropertyLookup` (`src/exec/property_ops.zig:234`)
...
### `globalDataPropertyLookupForFastPath` (`src/exec/property_ops.zig:239`)
...
### `globalDataPropertyValueForFastPath` (`src/exec/property_ops.zig:249`)
...
### `globalDataPropertyLookupForFastPathNoProfile` (`src/exec/property_ops.zig:263`)
...
### `globalDataPropertyValueForFastPathNoProfile` (`src/exec/property_ops.zig:265`)
...
### `globalWritableDataStoreIndexForFastPath` (`src/exec/property_ops.zig:276`)
...
### `globalWritableDataStoreLookupForFastPath` (`src/exec/property_ops.zig:288`)
...
### `setGlobalWritableDataStoreForFastPathOwned` (`src/exec/property_ops.zig:308`)
...
### `setGlobalWritableDataStoreLookupOwned` (`src/exec/property_ops.zig:321`)
...
### `setGlobalDataPropertyLookup` (`src/exec/property_ops.zig:331`)
...
### `installableGlobalDataPropertyLookup` (`src/exec/property_ops.zig:341`)
...
### `setGlobalOwnWritableDataPropertyAt` (`src/exec/property_ops.zig:356`)
...
### `setGlobalOwnWritableDataPropertyAtOwned` (`src/exec/property_ops.zig:368`)
...
### `writableDataSlotAt` (`src/exec/property_ops.zig:370`)
...
### `globalWritableDataPropertyLookupAt` (`src/exec/property_ops.zig:376`)
...
### `dataSlotAt` (`src/exec/property_ops.zig:381`)
