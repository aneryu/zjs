...
### `InterruptTestState.run` (`src/tests/exec.zig:230`)
...
### `TailSetupOomArm.call` (`src/tests/exec.zig:241`)
...
### `HostBacktraceErrorProbe.call` (`src/tests/exec.zig:261`)
...
### `ExternalNamedErrorProbe.call` (`src/tests/exec.zig:267`)
...
### `NativeRecordStackProbe.call` (`src/tests/exec.zig:279`)
...
### `InterruptOomArm.call` (`src/tests/exec.zig:290`)
...
### `NativeFenceProbe.invoke` (`src/tests/exec.zig:314`)
...
### `NativeFenceProbe.cleanupObserved` (`src/tests/exec.zig:333`)
...
### `crossRealmNativeProbe` (`src/tests/exec.zig:3241`)
...
### `localIndexNamed` (`src/tests/exec.zig:3256`)
...
### `derivedThisLocalIndex` (`src/tests/exec.zig:3264`)
...
### `globalFunctionBytecode` (`src/tests/exec.zig:3271`)
...
### `fixtureFlagsFromFunction` (`src/tests/exec.zig:3280`)
...
### `createOversizedLeafFixture` (`src/tests/exec.zig:3297`)
...
### `finalOpcodeCount` (`src/tests/exec.zig:3310`)
...
### `finalSetVarRefStats` (`src/tests/exec.zig:3328`)
...
### `hasTailEvalReturn` (`src/tests/exec.zig:3350`)
...
### `expectSingleDerivedThisClosureCapture` (`src/tests/exec.zig:3368`)
...
### `JobQueueRootProvider.trace` (`src/tests/exec.zig:6050`)
...
### `JobQueueRootProvider.provider` (`src/tests/exec.zig:6055`)
...
### `expectEvalCycleReclaimed` (`src/tests/exec.zig:10250`)
...
### `ImportProbe.run` (`src/tests/exec.zig:11739`)
...
### `ImportProbe.run` (`src/tests/exec.zig:11791`)
...
### `LoaderProbe.load` (`src/tests/exec.zig:11837`)
...
### `ActiveProbe.run` (`src/tests/exec.zig:18106`)
...
### `Probe.run` (`src/tests/exec.zig:18206`)
...
### `retainedModuleExportCell` (`src/tests/exec.zig:19672`)
...
### `PromiseResult.get` (`src/tests/exec.zig:19908`)
...
### `ArmableOneShotAllocator.allocator` (`src/tests/exec.zig:20013`)
...
### `ArmableOneShotAllocator.arm` (`src/tests/exec.zig:20020`)
...
### `ArmableOneShotAllocator.disarm` (`src/tests/exec.zig:20025`)
...
### `ArmableOneShotAllocator.alloc` (`src/tests/exec.zig:20029`)
...
### `ArmableOneShotAllocator.resize` (`src/tests/exec.zig:20038`)
...
### `ArmableOneShotAllocator.remap` (`src/tests/exec.zig:20043`)
...
### `ArmableOneShotAllocator.free` (`src/tests/exec.zig:20048`)
...
### `HostFixture.findBySpecifierOrPath` (`src/tests/exec.zig:20254`)
...
### `HostFixture.findByPath` (`src/tests/exec.zig:20261`)
...
### `expectRejectedPromiseNamedError` (`src/tests/exec.zig:20269`)
...
### `hostHooks` (`src/tests/exec.zig:20288`)
...
### `resolveFixtureModule` (`src/tests/exec.zig:20296`)
...
### `loadFixtureModule` (`src/tests/exec.zig:20313`)
...
### `ReflectActiveRootSymbolProbe.trigger` (`src/tests/exec.zig:20372`)
...
### `reflectTestSetArrayIndex` (`src/tests/exec.zig:20392`)
...
### `ActiveInvocationRootProbe.call` (`src/tests/exec.zig:21977`)
...
### `ActiveInvocationRootProbe.Recorder.visitValue` (`src/tests/exec.zig:21989`)
...
### `ActiveInvocationRootProbe.Recorder.visitObject` (`src/tests/exec.zig:21998`)
...
### `assertLiveWindowsVisited` (`src/tests/exec.zig:22040`)
...
### `expectFrameVisited` (`src/tests/exec.zig:22062`)
...
### `expectValueVisitedSlice` (`src/tests/exec.zig:22096`)
...
### `expectValueVisited` (`src/tests/exec.zig:22100`)
...
### `S3MajorAtEveryAllocationProbe.trigger` (`src/tests/exec.zig:22331`)
...
### `Probe.trigger` (`src/tests/exec.zig:22475`)
...
### `PublishRootProbe.trigger` (`src/tests/exec.zig:22539`)
...
### `runUnderPublishProbe` (`src/tests/exec.zig:22558`)
...
### `Probe.call` (`src/tests/exec.zig:22944`)
...
### `Probe.call` (`src/tests/exec.zig:23013`)
...
### `Probe.call` (`src/tests/exec.zig:23190`)
...
### `Probe.call` (`src/tests/exec.zig:23240`)
...
### `Probe.tail` (`src/tests/exec.zig:23247`)
...
### `Probe.call` (`src/tests/exec.zig:23346`)
...
### `test "dense parameter arrays spread keeps contiguous storage for array and custom iterator"` (`src/tests/exec.zig:78`)
...
### `test "dense parameter arrays spread retains CreateDataProperty constraints"` (`src/tests/exec.zig:96`)
...
### `test "dense parameter arrays spread reserves one backing cell for a known dense range"` (`src/tests/exec.zig:120`)
...
### `test "dense parameter arrays spread reserve OOM preserves iterator progress and retries"` (`src/tests/exec.zig:136`)
...
### `test "dense parameter arrays spread observes iterator methods getters and abrupt completion"` (`src/tests/exec.zig:160`)
...
### `test "eval lazily materializes a bare core context global before root closure construction"` (`src/tests/exec.zig:339`)
...
### `test "object_slots2 literal allocation preserves data and accessor semantics"` (`src/tests/exec.zig:353`)
...
### `test "fused cmp_if_false8 interrupt poll stays uncatchable in a for loop"` (`src/tests/exec.zig:371`)
...
### `test "interrupt budget survives Machine replacement and bypasses catch markers"` (`src/tests/exec.zig:415`)
...
### `test "interrupt remains uncatchable when error construction runs out of memory"` (`src/tests/exec.zig:467`)
...
### `test "uncatchable interrupt skips outer inline for-of close and catch"` (`src/tests/exec.zig:559`)
...
### `test "synchronous native fence reuses one Machine and restores native cleanup order"` (`src/tests/exec.zig:625`)
...
### `test "synchronous native reentry crosses Entry chunk boundaries exactly"` (`src/tests/exec.zig:716`)
...
### `test "synchronous native fence restores every budget after interrupt"` (`src/tests/exec.zig:777`)
...
### `test "Function and Reflect apply opt into the active Machine explicitly"` (`src/tests/exec.zig:856`)
...
### `test "synchronous apply fallbacks restore the outer active invocation"` (`src/tests/exec.zig:906`)
...
### `test "ordinary spread calls enter eligible bytecode targets on the current Machine"` (`src/tests/exec.zig:950`)
...
### `test "publish-time simple-ctor gate keeps prototype-miss and non-simple fallbacks"` (`src/tests/exec.zig:1006`)
...
### `test "constructor allocation profile reserves capacity without skipping the body"` (`src/tests/exec.zig:1034`)
...
### `test "constructor return fusion and abrupt teardown each release the fallback exactly once"` (`src/tests/exec.zig:1078`)
...
### `test "constructor spread preserves new target on the current Machine"` (`src/tests/exec.zig:1116`)
...
### `test "Array and TypedArray synchronous callback cohort stays on one Machine"` (`src/tests/exec.zig:1236`)
...
### `test "Map and Set synchronous callback cohort stays on one Machine"` (`src/tests/exec.zig:1353`)
...
### `test "accessors Proxy traps and primitive coercion stay on the active Machine"` (`src/tests/exec.zig:1552`)
...
### `test "JSON synchronous callback cohort stays on one Machine"` (`src/tests/exec.zig:1894`)
...
### `test "string regexp iterator helpers and DisposableStack stay on one Machine"` (`src/tests/exec.zig:2092`)
...
### `test "Promise executor reuses the active Machine while reactions remain roots"` (`src/tests/exec.zig:2348`)
...
### `test "nested calls and generator resumes share one Realm interrupt cadence"` (`src/tests/exec.zig:2595`)
...
### `test "initial async resume rejects with the caller-Realm interrupt exception"` (`src/tests/exec.zig:2757`)
...
### `test "cross-Realm interrupt polls charge caller entry and callee body separately"` (`src/tests/exec.zig:2831`)
...
### `test "tail-frame reuse charges planned stack bytes and fully restores both budgets"` (`src/tests/exec.zig:2971`)
...
### `test "tail target setup OOM remains catchable in the retiring caller"` (`src/tests/exec.zig:3070`)
...
### `test "js_function_set_properties publishes configurable length then name"` (`src/tests/exec.zig:3407`)
...
### `test "get_var_ref reuses the open cell on a second capture of the same local"` (`src/tests/exec.zig:3428`)
...
### `test "js_closure2 attach roots captures through the function object"` (`src/tests/exec.zig:3460`)
...
### `test "var-ref growth promotes borrowed captures to owned cells"` (`src/tests/exec.zig:3490`)
...
### `test "global declaration construction rebinds duplicate carriers one slot at a time"` (`src/tests/exec.zig:3515`)
...
### `test "ordinary global closure selector preserves QuickJS cell waterfall and owner metadata"` (`src/tests/exec.zig:3572`)
...
### `test "hidden uninitialized globals compact at the QuickJS sawtooth bound"` (`src/tests/exec.zig:3645`)
...
### `test "W1 two own layouts keep the VM property site active"` (`src/tests/exec.zig:3700`)
...
### `test "W1 property sites stay correct across every shape mutation that invalidates them"` (`src/tests/exec.zig:3757`)
...
### `test "W1 native-getter sites re-resolve the accessor out of the guarded slot"` (`src/tests/exec.zig:3857`)
...
### `test "runtime-strict script still constructs its global function declaration"` (`src/tests/exec.zig:3890`)
...
### `test "var-ref growth rejects an owned composite frame slab"` (`src/tests/exec.zig:3905`)
...
### `test "local growth rejects an owned composite frame slab"` (`src/tests/exec.zig:3932`)
...
### `test "arg aliases reject missing open-ref storage without cellifying the slot"` (`src/tests/exec.zig:3957`)
...
### `test "local growth rejects moving storage after an open binding is published"` (`src/tests/exec.zig:4020`)
...
### `test "call-binding OOM leaves input references with the caller"` (`src/tests/exec.zig:4050`)
...
### `test "original-args cold-state OOM does not retain copied references"` (`src/tests/exec.zig:4079`)
...
### `test "strict generator resident frame supports qjs argument counts beyond u16 storage"` (`src/tests/exec.zig:4112`)
...
### `test "a dynamic function outlives its teardown when its object held the last bytecode reference"` (`src/tests/exec.zig:4131`)
...
### `test "string leftover ToIntegerOrInfinity matches value_ops including bigint TypeError"` (`src/tests/exec.zig:4153`)
...
### `test "vm executes push constants arithmetic comparisons and return"` (`src/tests/exec.zig:4169`)
...
### `test "Engine executes both paths of a threaded with atom-label destructuring probe"` (`src/tests/exec.zig:4187`)
...
### `test "signed bigint-i32 neg preserves inline and generic BigInt semantics"` (`src/tests/exec.zig:4204`)
...
### `test "heap bigint multiplication still compacts a short-representable product"` (`src/tests/exec.zig:4222`)
...
### `test "numeric discarded immediates preserve comma control and completion semantics"` (`src/tests/exec.zig:4251`)
...
### `test "vm executes stack constants source locations and return_undef"` (`src/tests/exec.zig:4285`)
...
### `test "frame setLocal handles self-assignment without dropping object"` (`src/tests/exec.zig:4301`)
...
### `test "lookupFrameVarRef tolerates synthetic var-ref name mirrors"` (`src/tests/exec.zig:4321`)
...
### `test "derived constructor without nested this references has no owner cell"` (`src/tests/exec.zig:4347`)
...
### `test "derived constructor arrow creates exactly one owner this cell"` (`src/tests/exec.zig:4366`)
...
### `test "derived constructor parameter default arrow captures this by binding identity"` (`src/tests/exec.zig:4380`)
...
### `test "direct eval captures derived this while indirect eval does not"` (`src/tests/exec.zig:4394`)
...
### `test "ordinary calls to the current superclass do not initialize derived this"` (`src/tests/exec.zig:4423`)
...
### `test "class entry and construction use bytecode gates without a class behavior flag"` (`src/tests/exec.zig:4443`)
...
### `test "ordinary constructor Machine completion preserves bindings eval recursion and abrupt teardown"` (`src/tests/exec.zig:4510`)
...
### `test "derived constructor Machine completion preserves inherited new target and teardown"` (`src/tests/exec.zig:4573`)
...
### `test "Reflect.construct keeps a fresh prototype getter result alive through instance allocation"` (`src/tests/exec.zig:4655`)
...
### `test "Proxy wrapping a class named Array never enters the native Array construct record"` (`src/tests/exec.zig:4684`)
...
### `test "Proxy native constructor forwarding resolves new target prototype before coercion"` (`src/tests/exec.zig:4712`)
...
### `test "default derived constructor follows the live constructor prototype"` (`src/tests/exec.zig:4745`)
...
### `test "class constructor opcode errors preserve QuickJS messages and realms"` (`src/tests/exec.zig:4781`)
...
### `test "direct spread and arrow super follow the live derived constructor prototype"` (`src/tests/exec.zig:4818`)
...
### `test "super call paths reject null live parents and do not authorize ordinary class calls"` (`src/tests/exec.zig:4867`)
...
### `test "derived constructor arrow and direct eval observe the same this value"` (`src/tests/exec.zig:4944`)
...
### `test "derived constructor direct eval this shortcut preserves TDZ"` (`src/tests/exec.zig:4963`)
...
### `test "bound function call skips zero-length combined args allocation"` (`src/tests/exec.zig:4985`)
...
### `test "constant pool execution retains returned constants"` (`src/tests/exec.zig:5005`)
...
### `test "property ops use shared object semantics"` (`src/tests/exec.zig:5023`)
...
### `test "value ops own primitive VM semantics"` (`src/tests/exec.zig:5048`)
...
### `test "closure helper stores closure state outside the VM"` (`src/tests/exec.zig:5116`)
...
### `test "M1.3: returned closure can update and return captured counter"` (`src/tests/exec.zig:5128`)
...
### `test "resident set_var_ref preserves assignment results and refcounted self-assignment"` (`src/tests/exec.zig:5147`)
...
### `test "resident stack permutations preserve assignment values and ownership"` (`src/tests/exec.zig:5212`)
...
### `test "empty object named field miss is undefined and own hit stores"` (`src/tests/exec.zig:5247`)
...
### `test "mapped arguments named field skips binding alias; computed index stays aliased"` (`src/tests/exec.zig:5261`)
...
### `test "mapped arguments rest-style 0-formal length and index (sc_list)"` (`src/tests/exec.zig:5281`)
...
### `test "typed array integer get uses class-id arm and qjs tag shape"` (`src/tests/exec.zig:5313`)
...
### `test "typed array prototype chain get reads canonical numeric indices"` (`src/tests/exec.zig:5346`)
...
### `test "typed array integer put uses class-id arm"` (`src/tests/exec.zig:5369`)
...
### `test "typed array int32 store fast arm preserves conversion and assignment semantics"` (`src/tests/exec.zig:5401`)
...
### `test "checked local replacement preserves int fast moves and refcounted fallbacks"` (`src/tests/exec.zig:5449`)
...
### `test "an expression helper emits an explicit return after a bytecode call"` (`src/tests/exec.zig:5468`)
...
### `test "TDZ: closure update and return of captured const throws TypeError"` (`src/tests/exec.zig:5480`)
...
### `test "forward-ref top-level lexical captured through a nested closure resolves after init"` (`src/tests/exec.zig:5493`)
...
### `test "forward-ref lexical captured through nested closure still honors TDZ before init"` (`src/tests/exec.zig:5512`)
...
### `test "global closure get before top-level lexical initialization honors TDZ"` (`src/tests/exec.zig:5533`)
...
### `test "global closure set before top-level lexical initialization honors TDZ"` (`src/tests/exec.zig:5559`)
...
### `test "global closure update before top-level lexical initialization honors TDZ"` (`src/tests/exec.zig:5575`)
...
### `test "Annex B block function updates existing global function binding"` (`src/tests/exec.zig:5591`)
...
### `test "block function declarations instantiate at scope entry"` (`src/tests/exec.zig:5612`)
...
### `test "Annex B eval block function updates global function binding mirrors"` (`src/tests/exec.zig:5640`)
...
### `test "Annex B direct eval global function does not block later script lexical declaration"` (`src/tests/exec.zig:5666`)
...
### `test "sloppy global assignment creates deletable object property"` (`src/tests/exec.zig:5690`)
...
### `test "forward-ref top-level lexical threads through three closure levels"` (`src/tests/exec.zig:5716`)
...
### `test "top-level function declarations use wide closure operands past 255 constants"` (`src/tests/exec.zig:5732`)
...
### `test "function expressions execute wide closure operands past 255 constants"` (`src/tests/exec.zig:5751`)
...
### `test "test262 helpers own SameValue assertions"` (`src/tests/exec.zig:5772`)
...
### `test "call subsystem installs and invokes host globals"` (`src/tests/exec.zig:5779`)
...
### `test "native builtin record dispatch is independent from dispatch-name strings"` (`src/tests/exec.zig:5864`)
...
### `test "bytecode calls execute directly from the shared function bytecode"` (`src/tests/exec.zig:5925`)
...
### `test "Math cproto dispatch preserves observable ToNumber semantics"` (`src/tests/exec.zig:5986`)
...
### `test "local add_loc retains string snapshots after accumulator tail removal"` (`src/tests/exec.zig:6006`)
...
### `test "add_loc string+object goes through slow add after toPrimitive (qjs OP_add_loc)"` (`src/tests/exec.zig:6060`)
...
### `test "checked lexical string accumulation keeps rope depth bounded"` (`src/tests/exec.zig:6160`)
...
### `test "computed reads with cached string atoms preserve exotic and prototype semantics"` (`src/tests/exec.zig:6198`)
...
### `test "native dispatch metadata is internal and ignores user properties"` (`src/tests/exec.zig:6246`)
...
### `test "scope resolver skips popped lexical shadow for destructured parameter"` (`src/tests/exec.zig:6272`)
...
### `test "__zjs-prefixed user properties are ordinary own properties"` (`src/tests/exec.zig:6290`)
...
### `test "array species fast path markers are internal"` (`src/tests/exec.zig:6312`)
...
### `test "auto-init builtin markers are internal and ignore user properties"` (`src/tests/exec.zig:6338`)
...
### `test "immutable prototype marker is internal"` (`src/tests/exec.zig:6452`)
...
### `test "builtin dispatch function markers are internal"` (`src/tests/exec.zig:6472`)
...
### `test "proxy revocation target is internal"` (`src/tests/exec.zig:6513`)
...
### `test "regexp accessor realm TypeError constructor is internal"` (`src/tests/exec.zig:6554`)
...
### `test "throw type error intrinsic marker is internal"` (`src/tests/exec.zig:6588`)
...
### `test "async generator prototype method marker is internal"` (`src/tests/exec.zig:6640`)
...
### `test "generator instances inherit shared prototype methods"` (`src/tests/exec.zig:6662`)
...
### `test "generator object uses the prototype selected after parameter initialization"` (`src/tests/exec.zig:6760`)
...
### `test "closure-env var_ref hitting rc zero during remove_cycles stays a batch no-op"` (`src/tests/exec.zig:6777`)
...
### `test "parked generator open cell death path reclaims cell and generator together"` (`src/tests/exec.zig:6815`)
...
### `test "cycle drain frees leftover-rc rings under repeated forceGC"` (`src/tests/exec.zig:6860`)
...
### `test "major tracing keeps a heap BigInt reachable through an object"` (`src/tests/exec.zig:6895`)
...
### `test "generator continuation keeps its FunctionBytecode alive after every source binding is dropped"` (`src/tests/exec.zig:6906`)
...
### `test "initial_yield keeps sync generators in suspended-start after parameter initialization"` (`src/tests/exec.zig:6936`)
...
### `test "initial_yield keeps async generators in suspended-start"` (`src/tests/exec.zig:6969`)
...
### `test "initial_yield executes exported generator bytecode in module mode"` (`src/tests/exec.zig:6999`)
...
### `test "generator completion resumes keep the original function home object"` (`src/tests/exec.zig:7022`)
...
### `test "resident generator resumes preserve nested catch and finally targets"` (`src/tests/exec.zig:7069`)
...
### `test "surviving var references keep resident local slots bare"` (`src/tests/exec.zig:7135`)
...
### `test "direct eval captures only bindings visible at its call scope"` (`src/tests/exec.zig:7180`)
...
### `test "suspended generators retain one resident execution owner across resumes"` (`src/tests/exec.zig:7211`)
...
### `test "completed generators eagerly release their resident execution state"` (`src/tests/exec.zig:7267`)
...
### `test "iterator helper method marker is internal"` (`src/tests/exec.zig:7319`)
...
### `test "Iterator.from follows QuickJS wrapper selection"` (`src/tests/exec.zig:7367`)
...
### `test "number native builtin records cover static and prototype dispatch"` (`src/tests/exec.zig:7433`)
...
### `test "class extends Number ToPrimitive matches JS_ToNumeric"` (`src/tests/exec.zig:7497`)
...
### `test "Number.prototype.toString saturates out-of-i32 radix before intFromFloat"` (`src/tests/exec.zig:7526`)
...
### `test "string static native builtin records ignore dispatch names"` (`src/tests/exec.zig:7553`)
...
### `test "string prototype native builtin records ignore dispatch names"` (`src/tests/exec.zig:7596`)
...
### `test "String case conversion records preserve coercion and Unicode semantics"` (`src/tests/exec.zig:7642`)
...
### `test "date static native builtin records ignore dispatch names"` (`src/tests/exec.zig:7678`)
...
### `test "date constructor native builtin records ignore dispatch names"` (`src/tests/exec.zig:7720`)
...
### `test "constructValue AggregateError releases copied errors array owner"` (`src/tests/exec.zig:7776`)
...
### `test "date prototype native builtin records ignore dispatch names"` (`src/tests/exec.zig:7815`)
...
### `test "array static native builtin records ignore dispatch names"` (`src/tests/exec.zig:7860`)
...
### `test "array prototype native builtin records ignore dispatch names"` (`src/tests/exec.zig:7921`)
...
### `test "collection native builtin records ignore dispatch names"` (`src/tests/exec.zig:8001`)
...
### `test "buffer native builtin records ignore dispatch names"` (`src/tests/exec.zig:8094`)
...
### `test "typed array accessor native builtin records ignore dispatch names"` (`src/tests/exec.zig:8219`)
...
### `test "regexp static native builtin records ignore dispatch names"` (`src/tests/exec.zig:8293`)
...
### `test "regexp prototype native builtin records ignore dispatch names"` (`src/tests/exec.zig:8338`)
...
### `test "regexp symbol native builtin records ignore dispatch names"` (`src/tests/exec.zig:8428`)
...
### `test "regexp accessor native builtin records ignore dispatch names"` (`src/tests/exec.zig:8540`)
...
### `test "vm host native builtin records dispatch by id before name fallback"` (`src/tests/exec.zig:8607`)
...
### `test "vm collection constructors use registered prototype methods"` (`src/tests/exec.zig:8646`)
...
### `test "finite number formatting keeps simple decimal fast path semantics"` (`src/tests/exec.zig:8680`)
...
### `test "qjs alignment C1 for-head lexical self-reference observes TDZ"` (`src/tests/exec.zig:8692`)
...
### `test "qjs alignment C2 string for-of observes patched iterator"` (`src/tests/exec.zig:8723`)
...
### `test "qjs alignment C3 in operator respects null prototype"` (`src/tests/exec.zig:8757`)
...
### `test "qjs alignment X-02 Array length Set redirects when Receiver differs"` (`src/tests/exec.zig:8772`)
...
### `test "qjs alignment X-08 eval var writable false syncs VARREF is_const"` (`src/tests/exec.zig:8804`)
...
### `test "qjs alignment X-09 VARREF to GETSET detaches the stale cell"` (`src/tests/exec.zig:8834`)
...
### `test "qjs alignment X-07 integer-key Set breaks on first proto hit"` (`src/tests/exec.zig:8856`)
...
### `test "qjs alignment X-10 Get miss does not fall back to globalThis constructor prototype"` (`src/tests/exec.zig:8892`)
...
### `test "qjs alignment X-10 tagged template objects keep Array.prototype"` (`src/tests/exec.zig:8932`)
...
### `test "qjs alignment C4 Array instanceof follows prototype chain"` (`src/tests/exec.zig:8942`)
...
### `test "instanceof resident dispatch preserves GetMethod and result coercion semantics"` (`src/tests/exec.zig:8964`)
...
### `test "default Function hasInstance uses Ordinary; other native records still Call"` (`src/tests/exec.zig:9080`)
...
### `test "local reference-tail lowering preserves binding semantics"` (`src/tests/exec.zig:9119`)
...
### `test "qjs alignment const local writes throw from resolved bytecode"` (`src/tests/exec.zig:9163`)
...
### `test "qjs alignment named function self-binding ignores every sloppy write form"` (`src/tests/exec.zig:9207`)
...
### `test "Engine eval executes test262 helpers through generic call paths"` (`src/tests/exec.zig:9331`)
...
### `test "shared test engine reset rebuilds global shape hash buckets"` (`src/tests/exec.zig:9341`)
...
### `test "Engine eval strips TypeScript source kind before execution"` (`src/tests/exec.zig:9362`)
...
### `test "Engine eval strips TypeScript method annotations"` (`src/tests/exec.zig:9376`)
...
### `test "Engine eval preserves as and satisfies runtime property names in TypeScript files"` (`src/tests/exec.zig:9389`)
...
### `test "Engine eval supports TypeScript parameter properties"` (`src/tests/exec.zig:9400`)
...
### `test "Engine eval strips TypeScript automatically for ts filenames"` (`src/tests/exec.zig:9414`)
...
### `test "CallSite metadata is internal"` (`src/tests/exec.zig:9425`)
...
### `test "pc2line stack locations match QuickJS return and throw matrix"` (`src/tests/exec.zig:9464`)
...
### `test "X-89 sloppy and method tails keep the caller like QuickJS; strict tail_call reuses"` (`src/tests/exec.zig:9484`)
...
### `test "strict plain tail_call recursion stays in constant stack"` (`src/tests/exec.zig:9509`)
...
### `test "X-89 frame disasm: return call and method emit tail opcodes"` (`src/tests/exec.zig:9525`)
...
### `test "pc2line malformed transition reports zero location instead of header fallback"` (`src/tests/exec.zig:9579`)
...
### `test "Error stack uses object method runtime names"` (`src/tests/exec.zig:9606`)
...
### `test "native builtin errors capture a native callsite"` (`src/tests/exec.zig:9623`)
...
### `test "external host errors capture the native host callsite"` (`src/tests/exec.zig:9769`)
...
### `test "native record calls preflight the native stack and recover"` (`src/tests/exec.zig:9812`)
...
### `test "external C function preflight uses caller realm and callback errors use callee realm"` (`src/tests/exec.zig:9850`)
...
### `test "Error stack preserves construction frames across delayed access"` (`src/tests/exec.zig:9935`)
...
### `test "eval SyntaxError carries construction stack"` (`src/tests/exec.zig:9956`)
...
### `test "TypeError thrown via message helper carries stack exactly once"` (`src/tests/exec.zig:9979`)
...
### `test "Error prepareStackTrace formats captured frames lazily"` (`src/tests/exec.zig:10003`)
...
### `test "Error stack setter rejects non-string stack values"` (`src/tests/exec.zig:10033`)
...
### `test "Error stack copied accessor setter writes without recursion"` (`src/tests/exec.zig:10051`)
...
### `test "Error stack copied accessor setter writes through proxy without recursion"` (`src/tests/exec.zig:10070`)
...
### `test "Error stack reentrant formatting is capped to captured frames"` (`src/tests/exec.zig:10086`)
...
### `test "Array fill respects proxy prototypes"` (`src/tests/exec.zig:10112`)
...
### `test "Error.prepareStackTrace exceptions produce null stack"` (`src/tests/exec.zig:10132`)
...
### `test "Engine runtime-strict file eval matches QuickJS CLI script surface"` (`src/tests/exec.zig:10146`)
...
### `test "runtime-strict eval overrides parse-time mapped arguments subtype"` (`src/tests/exec.zig:10176`)
...
### `test "Engine strict script top-level this remains the global object"` (`src/tests/exec.zig:10198`)
...
### `test "Engine direct eval publishes Annex B block functions"` (`src/tests/exec.zig:10207`)
...
### `test "Engine direct eval Annex B block function updates same-name parameter"` (`src/tests/exec.zig:10230`)
...
### `test "Engine eval exit leaves closed var-ref cycles for explicit collection"` (`src/tests/exec.zig:10269`)
...
### `test "Promise result cycle is released by runtime cycle removal"` (`src/tests/exec.zig:10306`)
...
### `test "Promise reaction cycle is released by runtime cycle removal"` (`src/tests/exec.zig:10318`)
...
### `test "proxy revoke FunctionRare cycle is released by runtime cycle removal"` (`src/tests/exec.zig:10330`)
...
### `test "Promise finally FunctionRare cycle is released by runtime cycle removal"` (`src/tests/exec.zig:10342`)
...
### `test "DisposableStack resource self-cycle is released by runtime cycle removal"` (`src/tests/exec.zig:10354`)
...
### `test "module import-meta and eval-exception cycles are released by runtime cycle removal"` (`src/tests/exec.zig:10366`)
...
### `test "Engine eval supports Annex B escape and unescape code-unit semantics"` (`src/tests/exec.zig:10398`)
...
### `test "Engine eval supports Annex B Date setYear ordering"` (`src/tests/exec.zig:10413`)
...
### `test "Engine eval supports Annex B String HTML wrappers and trim aliases"` (`src/tests/exec.zig:10431`)
...
### `test "html wrap leftover optional attribute preserves Annex B wrap and attr"` (`src/tests/exec.zig:10451`)
...
### `test "disposable stack extras leftover runtime metadata preserves dispose aliases and disposed"` (`src/tests/exec.zig:10467`)
...
### `test "buffer constructor extras leftover runtime tables preserve ArrayBuffer SharedArrayBuffer and DataView"` (`src/tests/exec.zig:10498`)
...
### `test "iterator step leftover post-next decode preserves for-of and helper results"` (`src/tests/exec.zig:10535`)
...
### `test "class field initializer leftover runtime static preserves instance static private and computed fields"` (`src/tests/exec.zig:10585`)
...
### `test "leftover instance-computed public field initializer through shared emit"` (`src/tests/exec.zig:10628`)
...
### `test "leftover do while parse through one runtime flag"` (`src/tests/exec.zig:10662`)
...
### `test "leftover error stack at-line format through one runtime kind"` (`src/tests/exec.zig:10697`)
...
### `test "leftover array-from array-like through one runtime destination"` (`src/tests/exec.zig:10752`)
...
### `test "leftover proxy set trap through one runtime kind"` (`src/tests/exec.zig:10777`)
...
### `test "leftover proxy extensible trap through one runtime kind"` (`src/tests/exec.zig:10806`)
...
### `test "leftover proxy has trap through one outlined walk"` (`src/tests/exec.zig:10856`)
...
### `test "leftover proxy getPrototypeOf through one outlined walk"` (`src/tests/exec.zig:10893`)
...
### `test "leftover Object.isExtensible builtin through outlined extensible op"` (`src/tests/exec.zig:10931`)
...
### `test "leftover Object.getOwnPropertyNames through outlined enumerable own properties"` (`src/tests/exec.zig:10964`)
...
### `test "leftover Array.shift index-move through outlined arrayMoveIndex"` (`src/tests/exec.zig:10997`)
...
### `test "leftover Array.slice present-index through outlined arrayCopyPresentIndex"` (`src/tests/exec.zig:11033`)
...
### `test "leftover integer binary through live bitwise and number arms"` (`src/tests/exec.zig:11064`)
...
### `test "leftover Array.map generic get through one runtime tail"` (`src/tests/exec.zig:11092`)
...
### `test "leftover Array.toReversed get-define through outlined arrayCopyIndex"` (`src/tests/exec.zig:11116`)
...
### `test "leftover Array.sort generic set through one runtime tail"` (`src/tests/exec.zig:11141`)
...
### `test "leftover Array.fill generic set through one runtime tail"` (`src/tests/exec.zig:11172`)
...
### `test "leftover Array.indexOf direction through one runtime walk"` (`src/tests/exec.zig:11198`)
...
### `test "leftover Array.reduce direction through one runtime walk"` (`src/tests/exec.zig:11226`)
...
### `test "leftover iterator wrap next return through one runtime kind"` (`src/tests/exec.zig:11253`)
...
### `test "stamped native data-method leftover runtime stamp preserves async generator and iterator helpers"` (`src/tests/exec.zig:11281`)
...
### `test "fast prototype method leftover runtime domain preserves regexp and collection lookups"` (`src/tests/exec.zig:11314`)
...
### `test "data view extras leftover optional species preserves accessors and omits species"` (`src/tests/exec.zig:11366`)
...
### `test "defineNativeDataMethod leftover optional native id preserves iterator methods"` (`src/tests/exec.zig:11394`)
...
### `test "createStringValue leftover noinline preserves empty flags and ascii strings"` (`src/tests/exec.zig:11416`)
...
### `test "Engine eval TypeError with evaluated arguments does not double free constants"` (`src/tests/exec.zig:11429`)
...
### `test "vm call handler accepts allocator-backed argument lists"` (`src/tests/exec.zig:11442`)
...
### `test "Engine API eval and job queue are wired"` (`src/tests/exec.zig:11494`)
...
### `test "job queue enqueue propagates allocator failure"` (`src/tests/exec.zig:11543`)
...
### `test "prepared Promise reactions reserve storage without claiming FIFO order"` (`src/tests/exec.zig:11557`)
...
### `test "waitAsync completions enter one typed cross-realm FIFO after facade release"` (`src/tests/exec.zig:11603`)
...
### `test "public property key coercion accepts a Symbol.toPrimitive key"` (`src/tests/exec.zig:11665`)
...
### `test "waitAsync completion OOM stays at FIFO head for same-runtime retry"` (`src/tests/exec.zig:11684`)
...
### `test "dynamic import job OOM retains its FIFO position for retry"` (`src/tests/exec.zig:11731`)
...
### `test "dynamic import job keeps its enqueue Realm after creator facade release"` (`src/tests/exec.zig:11778`)
...
### `test "dynamic import loader mutates only the enqueue Realm registry after public owner release"` (`src/tests/exec.zig:11820`)
...
### `test "thenable job reservation OOM leaves resolving function retryable"` (`src/tests/exec.zig:11886`)
...
### `test "published Promise resolution survives resolver collection through typed FIFO owner"` (`src/tests/exec.zig:11941`)
...
### `test "Promise reaction retains callable Proxy classification after revocation"` (`src/tests/exec.zig:11995`)
...
### `test "job queue keeps symbol arguments rooted until release"` (`src/tests/exec.zig:12020`)
...
### `test "job queue symbol roots preserve weak map values"` (`src/tests/exec.zig:12046`)
...
### `test "ordinary script entry points do not run full-heap cycle collection on exit"` (`src/tests/exec.zig:12089`)
...
### `test "IC-R1: delete then get_field is undefined after a prior hit"` (`src/tests/exec.zig:12151`)
...
### `test "IC-P1: OrdinarySet forwards to a Proxy proto [[Set]] trap"` (`src/tests/exec.zig:12164`)
...
### `test "Engine eval executes simple variable assignment and print"` (`src/tests/exec.zig:12175`)
...
### `test "String.prototype.match invokes a custom matcher before coercing the receiver"` (`src/tests/exec.zig:12179`)
...
### `test "RegExp Symbol.split preserves captures returned by custom exec"` (`src/tests/exec.zig:12190`)
...
### `test "RegExp Symbol.split propagates invalid species exec TypeError"` (`src/tests/exec.zig:12208`)
...
### `test "RegExp Symbol.split appends sticky flag without narrowing wide species flags"` (`src/tests/exec.zig:12217`)
...
### `test "flagless RegExp flags accessor reuses the runtime empty string"` (`src/tests/exec.zig:12230`)
...
### `test "RegExp exec result template preserves metadata groups and indices"` (`src/tests/exec.zig:12244`)
...
### `test "RegExp compiler stack overflow is a catchable SyntaxError"` (`src/tests/exec.zig:12254`)
...
### `test "RegExp accepts literal astral group names in non-unicode mode"` (`src/tests/exec.zig:12266`)
...
### `test "RegExp literals reuse parse-time bytecode and the intrinsic realm shape"` (`src/tests/exec.zig:12278`)
...
### `test "RegExp legacy statics preserve the realm snapshot across constructor replacement"` (`src/tests/exec.zig:12302`)
...
### `test "regexp split and global match arrays use the realm Array prototype"` (`src/tests/exec.zig:12325`)
...
### `test "RegExp Symbol.split uses the realm intrinsic default species"` (`src/tests/exec.zig:12333`)
...
### `test "Engine eval preserves global lexical write fast path semantics"` (`src/tests/exec.zig:12346`)
...
### `test "Engine nested functions retain ancestor with environments during finalization"` (`src/tests/exec.zig:12364`)
...
### `test "Engine eval preserves selected with references during updates"` (`src/tests/exec.zig:12381`)
...
### `test "with compound assignment rechecks proxy binding before get and set"` (`src/tests/exec.zig:12404`)
...
### `test "Engine destructuring snapshots with binding references before property reads"` (`src/tests/exec.zig:12420`)
...
### `test "Engine with destructuring assignment reaches const fallback at runtime"` (`src/tests/exec.zig:12452`)
...
### `test "Engine eval assignments capture the target before dynamic var insertion"` (`src/tests/exec.zig:12478`)
...
### `test "Engine arrow eval assignments capture the target before dynamic var insertion"` (`src/tests/exec.zig:12519`)
...
### `test "Engine direct eval captures the caller arguments binding"` (`src/tests/exec.zig:12553`)
...
### `test "Engine arguments writes prefer the current function binding over outer lexical bindings"` (`src/tests/exec.zig:12604`)
...
### `test "Engine direct eval shares top-level lexical cells across nested closures"` (`src/tests/exec.zig:12635`)
...
### `test "Engine constructor parameter defaults use the initialized this binding"` (`src/tests/exec.zig:12673`)
...
### `test "Engine heritage closures retain the initialized inner class-name binding"` (`src/tests/exec.zig:12692`)
...
### `test "Engine inferred class names precede static initialization across named-evaluation sites"` (`src/tests/exec.zig:12716`)
...
### `test "Engine eval assigns contextual await bindings in sloppy scripts"` (`src/tests/exec.zig:12754`)
...
### `test "Engine eval creates non-configurable enumerable global var bindings"` (`src/tests/exec.zig:12762`)
...
### `test "Engine eval executes object property assignment through quick parser"` (`src/tests/exec.zig:12776`)
...
### `test "Engine eval executes parenthesized literal postfix through quick parser"` (`src/tests/exec.zig:12780`)
...
### `test "Engine eval balances refcounts for refcounted duplicate-key object literals"` (`src/tests/exec.zig:12791`)
...
### `test "Engine eval executes compound assignment and update statements through quick parser"` (`src/tests/exec.zig:12821`)
...
### `test "Engine eval executes console.log with many arguments"` (`src/tests/exec.zig:12825`)
...
### `test "Engine eval routes host output through global function calls"` (`src/tests/exec.zig:12829`)
...
### `test "using early exit before await using keeps sync disposal synchronous"` (`src/tests/exec.zig:12842`)
...
### `test "Engine eval preserves local numeric add host output semantics"` (`src/tests/exec.zig:12878`)
...
### `test "get_array_el2 dense indexed call keeps the receiver"` (`src/tests/exec.zig:12893`)
...
### `test "get_array_el dense direct arm preserves hits and indexed fallback"` (`src/tests/exec.zig:12910`)
...
### `test "int32 add sub mul overflow stays a number on the generic binary"` (`src/tests/exec.zig:12926`)
...
### `test "Engine eval preserves collection read host output semantics"` (`src/tests/exec.zig:12943`)
...
### `test "runtime teardown preserves closure capture metadata until objects are destroyed"` (`src/tests/exec.zig:12971`)
...
### `test "cycle teardown preserves restored strong counts for weakly referenced keys"` (`src/tests/exec.zig:12993`)
...
### `test "Engine eval preserves regexp UTF-16 test host output semantics"` (`src/tests/exec.zig:13015`)
...
### `test "Engine eval prepared RegExp call observes same-site property changes"` (`src/tests/exec.zig:13043`)
...
### `test "Engine eval preserves dense array join host output semantics"` (`src/tests/exec.zig:13065`)
...
### `test "Engine eval preserves dense array pop host output semantics"` (`src/tests/exec.zig:13083`)
...
### `test "Engine eval preserves ordinary array pop fast path semantics"` (`src/tests/exec.zig:13103`)
...
### `test "empty native array pop fast arm preserves observable length writes"` (`src/tests/exec.zig:13128`)
...
### `test "array pop length write removes elements added by the last-element getter"` (`src/tests/exec.zig:13174`)
...
### `test "array pop reports read-only length after deleting a configurable last element"` (`src/tests/exec.zig:13197`)
...
### `test "Engine eval preserves simple closure call host output semantics"` (`src/tests/exec.zig:13215`)
...
### `test "Engine eval preserves one-shot array literal host output semantics"` (`src/tests/exec.zig:13229`)
...
### `test "Engine eval preserves one-shot array named property host output semantics"` (`src/tests/exec.zig:13252`)
...
### `test "Engine eval preserves typed array constructor length host output semantics"` (`src/tests/exec.zig:13276`)
...
### `test "Engine eval preserves Int32Array indexed read fast path semantics"` (`src/tests/exec.zig:13297`)
...
### `test "Engine eval executes simple template interpolation"` (`src/tests/exec.zig:13313`)
...
### `test "Engine eval template interpolation calls object toString"` (`src/tests/exec.zig:13317`)
...
### `test "Engine eval executes simple arrays and map"` (`src/tests/exec.zig:13321`)
...
### `test "Engine eval executes simple functions and arrows"` (`src/tests/exec.zig:13325`)
...
### `test "strict plain calls preserve this arguments eval captures and backtraces"` (`src/tests/exec.zig:13340`)
...
### `test "strict arguments preserve qjs intrinsic metadata and dense element semantics"` (`src/tests/exec.zig:13382`)
...
### `test "mapped arguments use var-ref indexed storage and detach on descriptor changes"` (`src/tests/exec.zig:13447`)
...
### `test "apply resolves arguments length and preserves observable fallback"` (`src/tests/exec.zig:13534`)
...
### `test "resident generators preserve mapped arguments parameter aliases"` (`src/tests/exec.zig:13579`)
...
### `test "implicit arguments resolution preserves mapped aliases"` (`src/tests/exec.zig:13603`)
...
### `test "body function named arguments does not create a synthetic lexical collision"` (`src/tests/exec.zig:13648`)
...
### `test "resident mapped arguments share one open bare arg slot"` (`src/tests/exec.zig:13655`)
...
### `test "generic arg opcodes preserve mapped aliases in a bare resident slot"` (`src/tests/exec.zig:13704`)
...
### `test "generator mapped arguments closures and direct eval share one alias across resumes"` (`src/tests/exec.zig:13746`)
...
### `test "async mapped arguments and closures retain one alias across await"` (`src/tests/exec.zig:13782`)
...
### `test "escaped generator arg aliases retain resident backing across cycle collection"` (`src/tests/exec.zig:13811`)
...
### `test "generator completion closes escaped arg aliases before releasing resident backing"` (`src/tests/exec.zig:13859`)
...
### `test "get_length preserves qjs own-property-before-exotic ordering and actions"` (`src/tests/exec.zig:13900`)
...
### `test "missing-argument plain calls preserve parameter and arguments ownership"` (`src/tests/exec.zig:14062`)
...
### `test "inline calls release lazily materialized arguments state"` (`src/tests/exec.zig:14131`)
...
### `test "inline empty leaf abrupt teardown releases pending operands"` (`src/tests/exec.zig:14158`)
...
### `test "exact-args leaf abrupt teardown releases borrowed args exactly once"` (`src/tests/exec.zig:14182`)
...
### `test "leaf returns with leftover operands route through general teardown"` (`src/tests/exec.zig:14220`)
...
### `test "missing-argument calls read undefined across every entry arm"` (`src/tests/exec.zig:14255`)
...
### `test "missing-argument calls on leaf-excluded shapes keep generic-path outcomes"` (`src/tests/exec.zig:14361`)
...
### `test "missing-argument leftover-carrying returns route through general teardown"` (`src/tests/exec.zig:14411`)
...
### `test "zero-arg leaf leftover bodies are refused publication and balance rc"` (`src/tests/exec.zig:14443`)
...
### `test "capture leaf abrupt teardown releases operands and keeps borrowed cells"` (`src/tests/exec.zig:14516`)
...
### `test "capture leaf returns with leftover operands route through general teardown"` (`src/tests/exec.zig:14557`)
...
### `test "capture leaf shares live cells with its closure across calls"` (`src/tests/exec.zig:14595`)
...
### `test "inline empty leaf warm constructor preserves miss fallback and ownership"` (`src/tests/exec.zig:14627`)
...
### `test "forwarded leaf call semantics keep exclusions on the authoritative path"` (`src/tests/exec.zig:14728`)
...
### `test "forwarded leaf abrupt completion balances and keeps the native frame"` (`src/tests/exec.zig:14758`)
...
### `test "forwarded leaf returns with leftover operands route through general teardown"` (`src/tests/exec.zig:14798`)
...
### `test "method call empty leaf binds receiver as this and balances refcounts"` (`src/tests/exec.zig:14830`)
...
### `test "method call empty leaf abrupt teardown releases receiver"` (`src/tests/exec.zig:14864`)
...
### `test "method empty leaf warm constructor moves receiver ownership"` (`src/tests/exec.zig:14886`)
...
### `test "strict empty leaf preserves undefined this across call forms"` (`src/tests/exec.zig:14987`)
...
### `test "strict method empty leaf passes primitive receiver uncoerced"` (`src/tests/exec.zig:15029`)
...
### `test "strict empty leaf frame preserves undefined this and borrowed ownership"` (`src/tests/exec.zig:15066`)
...
### `test "inline call teardown releases every escaped storage shape"` (`src/tests/exec.zig:15132`)
...
### `test "inline operand Stack keeps limit and ownership flags in one word"` (`src/tests/exec.zig:15214`)
...
### `test "ordinary root bytecode call carves one operand window"` (`src/tests/exec.zig:15224`)
...
### `test "method calls preserve receiver arguments eval captures and abrupt ownership"` (`src/tests/exec.zig:15260`)
...
### `test "primitive prototype lookup preserves raw receiver and exotic prototype semantics"` (`src/tests/exec.zig:15354`)
...
### `test "computed named reads preserve prototype accessors proxies and operand ownership"` (`src/tests/exec.zig:15464`)
...
### `test "computed integer write misses preserve generic set semantics"` (`src/tests/exec.zig:15532`)
...
### `test "dense write leaf consumes reserved appends only inside the qjs capacity window"` (`src/tests/exec.zig:15602`)
...
### `test "static named getter and proxy fast paths preserve receivers throws and invariants"` (`src/tests/exec.zig:15656`)
...
### `test "proxy bytecode get continuation does not require spare operand capacity"` (`src/tests/exec.zig:15759`)
...
### `test "for-of bytecode next continuation preserves result and abrupt semantics"` (`src/tests/exec.zig:15776`)
...
### `test "IteratorNext bound proxy and native throws do not close the iterator"` (`src/tests/exec.zig:15905`)
...
### `test "destructuring abrupt completion closes every live outer iterator"` (`src/tests/exec.zig:15930`)
...
### `test "array destructuring rest roots direct symbol values while creating its result"` (`src/tests/exec.zig:15958`)
...
### `test "computed object-rest keys perform observable ToPropertyKey once"` (`src/tests/exec.zig:15977`)
...
### `test "object destructuring does not turn its source into a with environment"` (`src/tests/exec.zig:16000`)
...
### `test "object destructuring ToObject uses the current realm primitive prototypes"` (`src/tests/exec.zig:16016`)
...
### `test "for-in-of generic lvalues use QuickJS bottom-stack evaluation order"` (`src/tests/exec.zig:16035`)
...
### `test "computed proxy bytecode trap continuations preserve nested calls throws and invariants"` (`src/tests/exec.zig:16084`)
...
### `test "native tail calls preserve iterator and proxy continuation success and throws"` (`src/tests/exec.zig:16310`)
...
### `test "return conditional followed by newline comma keeps the comma expression"` (`src/tests/exec.zig:16379`)
...
### `test "Phase 7: inlined arrow keeps lexical this and ignores any receiver"` (`src/tests/exec.zig:16394`)
...
### `test "arrow direct eval reads captured this and new.target"` (`src/tests/exec.zig:16414`)
...
### `test "direct eval inherits QuickJS entry capabilities and var environment"` (`src/tests/exec.zig:16434`)
...
### `test "class field direct eval keeps QuickJS field initializer capabilities"` (`src/tests/exec.zig:16468`)
...
### `test "public instance fields initialize once in constructor order on every path"` (`src/tests/exec.zig:16484`)
...
### `test "arrow super property call keeps the enclosing method receiver"` (`src/tests/exec.zig:16602`)
...
### `test "super property assignment respects strictness when inherited descriptors reject writes"` (`src/tests/exec.zig:16634`)
...
### `test "bytecode constructability follows canonical function shape"` (`src/tests/exec.zig:16678`)
...
### `test "forwarded call releases ignored arrow thisArg"` (`src/tests/exec.zig:16706`)
...
### `test "function inherited data lookup preserves own and exotic semantics"` (`src/tests/exec.zig:16741`)
...
### `test "function caller and arguments restrictions follow immutable function shape"` (`src/tests/exec.zig:16796`)
...
### `test "Engine eval Function.prototype.toString returns source or native text"` (`src/tests/exec.zig:16820`)
...
### `test "Engine eval Function.prototype.toString emits syntactic native names"` (`src/tests/exec.zig:16839`)
...
### `test "Engine eval Function.prototype.toString returns method and class source"` (`src/tests/exec.zig:16857`)
...
### `test "Engine eval releases arrow destructuring iterator closures cleanly"` (`src/tests/exec.zig:16874`)
...
### `test "Engine eval preserves one-shot object missing field host output semantics"` (`src/tests/exec.zig:16897`)
...
### `test "Engine eval preserves local string substring host output semantics"` (`src/tests/exec.zig:16916`)
...
### `test "String prim_self leaf arms (lane K) agree with the legacy bodies on every miss shape"` (`src/tests/exec.zig:16931`)
...
### `test "String index-read native records preserve primitive fast paths and observable coercion"` (`src/tests/exec.zig:16972`)
...
### `test "mod cold handler preserves fmod and ToNumeric fallbacks"` (`src/tests/exec.zig:16994`)
...
### `test "Engine eval preserves ASCII string integer literal concat semantics"` (`src/tests/exec.zig:17014`)
...
### `test "Engine eval preserves resolve-label peephole semantics"` (`src/tests/exec.zig:17022`)
...
### `test "resident is_null preserves qjs true and refcounted false legs"` (`src/tests/exec.zig:17041`)
...
### `test "Engine generator return keeps finally rethrow control marker"` (`src/tests/exec.zig:17058`)
...
### `test "generator return runs nested finally before closing its for-of iterator"` (`src/tests/exec.zig:17079`)
...
### `test "return cleanup restores outer catch targets before finally and IteratorClose throws"` (`src/tests/exec.zig:17113`)
...
### `test "generator return crosses catch markers before closing its for-of iterator"` (`src/tests/exec.zig:17172`)
...
### `test "generator return closes an inner for-of iterator before its enclosing finally"` (`src/tests/exec.zig:17212`)
...
### `test "destructuring rest parameter defaults use the parameter environment"` (`src/tests/exec.zig:17261`)
...
### `test "caught destructuring error preserves IteratorClose output"` (`src/tests/exec.zig:17282`)
...
### `test "generator parameter eval cells close before body resume"` (`src/tests/exec.zig:17294`)
...
### `test "generator return executes an add_loc-terminated shared finally before completing"` (`src/tests/exec.zig:17313`)
...
### `test "generator default argument stores release refcounted stack values"` (`src/tests/exec.zig:17334`)
...
### `test "spread super brands derived instances before class field initializers"` (`src/tests/exec.zig:17346`)
...
### `test "computed class keys close over runtime private field identity"` (`src/tests/exec.zig:17370`)
...
### `test "nested same-name private fields isolate repeated class evaluations"` (`src/tests/exec.zig:17388`)
...
### `test "private fields isolate class evaluations and preserve lexical call and eval semantics"` (`src/tests/exec.zig:17432`)
...
### `test "private method brands use lexical initializers on every constructor path"` (`src/tests/exec.zig:17558`)
...
### `test "private methods and accessors preserve brands captures and readonly semantics"` (`src/tests/exec.zig:17616`)
...
### `test "started generator resumes preserve unmapped arguments from parked locals"` (`src/tests/exec.zig:17835`)
...
### `test "array named proto field uses ordinary lookup; length and index stay exotic"` (`src/tests/exec.zig:17890`)
...
### `test "iterator results use ordinary transitions without a sixth realm shape"` (`src/tests/exec.zig:17911`)
...
### `test "bytecode closures reuse the final function-prototype shape"` (`src/tests/exec.zig:17935`)
...
### `test "escaped closure keeps its compile realm after facade destruction"` (`src/tests/exec.zig:17958`)
...
### `test "standard constructors publish realm class prototype slots"` (`src/tests/exec.zig:18000`)
...
### `test "FunctionRealm query separates owned carriers from caller-semantics classes"` (`src/tests/exec.zig:18035`)
...
### `test "async resume callbacks remain callable and nonconstructible to all consumers"` (`src/tests/exec.zig:18078`)
...
### `test "fulfilled await queues a direct resume and retains suspended values"` (`src/tests/exec.zig:18100`)
...
### `test "fulfilled await checks state after the constructor getter settles its input"` (`src/tests/exec.zig:18172`)
...
### `test "fulfilled await roots its continuation through constructor getter GC"` (`src/tests/exec.zig:18201`)
...
### `test "pending and rejected await retain both callbacks and execute rejection recovery"` (`src/tests/exec.zig:18263`)
...
### `test "async direct settlement preserves adoption self resolution and once guards"` (`src/tests/exec.zig:18303`)
...
### `test "async resume callbacks preserve thenable metadata microtasks and realms"` (`src/tests/exec.zig:18347`)
...
### `test "generator async and wrapper noncarriers derive cross-realm state across GC"` (`src/tests/exec.zig:18404`)
...
### `test "FinalizationRegistry cleanup job keeps registry realm before invoking callback realm"` (`src/tests/exec.zig:18495`)
...
### `test "event-loop caller reaches external C function with one callee realm view"` (`src/tests/exec.zig:18571`)
...
### `test "true C function without its RealmRef fails the final-arm invariant"` (`src/tests/exec.zig:18648`)
...
### `test "legacy output writer failure is a catchable named Error"` (`src/tests/exec.zig:18674`)
...
### `test "native host error sentinel always has a pending named JS exception"` (`src/tests/exec.zig:18700`)
...
### `test "generator creation avoids a second payload copy of rooted input slices"` (`src/tests/exec.zig:18721`)
...
### `test "Engine generator return propagates an explicit finally throw"` (`src/tests/exec.zig:18841`)
...
### `test "async generator return awaits for-await iterator close before completing"` (`src/tests/exec.zig:18873`)
...
### `test "async generator return closes an inner iterator before its enclosing finally"` (`src/tests/exec.zig:18901`)
...
### `test "async generator return awaits its value once before a yielding finalizer"` (`src/tests/exec.zig:18928`)
...
### `test "Engine eval preserves simple for-in mutation semantics"` (`src/tests/exec.zig:18948`)
...
### `test "Engine runJobs preserves pending JS exceptions for callers"` (`src/tests/exec.zig:18970`)
...
### `test "external host arbitrary errors retain their Zig error name"` (`src/tests/exec.zig:18989`)
...
### `test "dynamic import failures preserve unsupported not-found and host I/O mappings"` (`src/tests/exec.zig:19010`)
...
### `test "static module read failures are named JS exceptions"` (`src/tests/exec.zig:19079`)
...
### `test "stalled module host progress is a named InternalError"` (`src/tests/exec.zig:19114`)
...
### `test "host module graph syntax diagnostics do not write to program output"` (`src/tests/exec.zig:19141`)
...
### `test "host commonjs wrapper passes directory dirname"` (`src/tests/exec.zig:19171`)
...
### `test "module graph evaluates block var declarations as module bindings"` (`src/tests/exec.zig:19207`)
...
### `test "module evaluation does not skip a body-leading function expression"` (`src/tests/exec.zig:19233`)
...
### `test "module evaluation does not mistake a body-leading this branch for a hoist prologue"` (`src/tests/exec.zig:19254`)
...
### `test "module cycles initialize wide function declaration closures before evaluation"` (`src/tests/exec.zig:19276`)
...
### `test "module cycles do not hoist a body-leading named function expression"` (`src/tests/exec.zig:19333`)
...
### `test "W1e: module namespace exposes sorted immutable live export properties"` (`src/tests/exec.zig:19380`)
...
### `test "module namespace has and super set preserve uninitialized export semantics"` (`src/tests/exec.zig:19448`)
...
### `test "W1e: named aliases and namespace reexports share live canonical bindings"` (`src/tests/exec.zig:19504`)
...
### `test "W1e: missing indirect export precedes bad import wiring"` (`src/tests/exec.zig:19561`)
...
### `test "W1e: one host source load spans declaration body TLA resume and dynamic import"` (`src/tests/exec.zig:19613`)
...
### `test "same module specifier keeps record cells namespace import meta and error state per Realm"` (`src/tests/exec.zig:19684`)
...
### `test "context module eval does not rerun evaluated or errored records"` (`src/tests/exec.zig:19751`)
...
### `test "context module eval resumes TLA from its reaction FIFO position"` (`src/tests/exec.zig:19806`)
...
### `test "Runtime loader keeps same-path TLA continuations and waiters in parent and child Realms"` (`src/tests/exec.zig:19841`)
...
### `test "module top-level await resumes in Promise reaction FIFO order"` (`src/tests/exec.zig:19938`)
...
### `test "module await reaction keeps its position on the awaited Promise"` (`src/tests/exec.zig:19976`)
...
### `test "module TLA continuation OOM retains FIFO node for retry"` (`src/tests/exec.zig:20007`)
...
### `test "async module dependency does not preempt an independent sibling"` (`src/tests/exec.zig:20150`)
...
### `test "import bytes module creates immutable ArrayBuffer backing store"` (`src/tests/exec.zig:20206`)
...
### `test "host global bootstrap installs and tears down builtin plus host domains"` (`src/tests/exec.zig:20334`)
...
### `test "engine eval host globals and throw intrinsic tear down cleanly"` (`src/tests/exec.zig:20346`)
...
### `test "reflect construct roots argument list while resolving prototype"` (`src/tests/exec.zig:20397`)
...
### `test "short conditional branches preserve immediate and full ToBoolean semantics"` (`src/tests/exec.zig:20468`)
...
### `test "if-throw fall-off form returns undefined (if_false8 branch-to-end)"` (`src/tests/exec.zig:20496`)
...
### `test "if-return fall-off form returns undefined on the fall-through leg"` (`src/tests/exec.zig:20510`)
...
### `test "else-return goto-to-end form returns undefined on the taken if leg"` (`src/tests/exec.zig:20522`)
...
### `test "nested-block branch-to-end survives trailing scope cleanup lowering"` (`src/tests/exec.zig:20534`)
...
### `test "arrow block body branch-to-end returns undefined"` (`src/tests/exec.zig:20551`)
...
### `test "generator branch-to-end completes with undefined value"` (`src/tests/exec.zig:20565`)
...
### `test "eval and script completion end in an explicit value return"` (`src/tests/exec.zig:20584`)
...
### `test "eval preserves completion through nested shared finalizers"` (`src/tests/exec.zig:20605`)
...
### `test "module top-level branch-to-end gets a terminator (no fall-off)"` (`src/tests/exec.zig:20617`)
...
### `test "W1d: module import.meta identity survives methods and nested closures"` (`src/tests/exec.zig:20626`)
...
### `test "module function declaration cells do not leak onto the global object"` (`src/tests/exec.zig:20648`)
...
### `test "call consumers derive receiver and direct-eval provenance from the final opcode"` (`src/tests/exec.zig:20665`)
...
### `test "optional chains use one unbounded shared label and preserve closed-chain calls"` (`src/tests/exec.zig:20718`)
...
### `test "direct eval inside a module function forwards module live bindings"` (`src/tests/exec.zig:20742`)
...
### `test "dynamic global put keeps cell and global-object legs semantically separate"` (`src/tests/exec.zig:20755`)
...
### `test "get_var uninitialized-cell inline global-object leg preserves the cold waterfall semantics"` (`src/tests/exec.zig:20865`)
...
### `test "named function expression self-binding materializes lazily with pinned QuickJS semantics"` (`src/tests/exec.zig:20932`)
...
### `test "K2 warm leaf miss retreat keeps call accounting balanced across chunk and carve misses"` (`src/tests/exec.zig:21012`)
...
### `test "latin1 high bytes survive raw-string byte bridges (qjs JS_ToCStringLen2 mirror)"` (`src/tests/exec.zig:21070`)
...
### `test "ToNumber latin1 high bytes are code points not UTF-8 whitespace"` (`src/tests/exec.zig:21117`)
...
### `test "JSON.rawJSON latin1 payload survives the simple stringify byte buffer"` (`src/tests/exec.zig:21183`)
...
### `test "native function toString keeps non-ASCII identifier names (qjs js_function_toString)"` (`src/tests/exec.zig:21198`)
...
### `test "switch dispatch trampoline shapes keep their identity and semantics"` (`src/tests/exec.zig:21214`)
...
### `test "Annex B if/else function declarations update the shared function binding"` (`src/tests/exec.zig:21298`)
...
### `test "sloppy CallExpression assignment targets throw after evaluating only the call"` (`src/tests/exec.zig:21312`)
...
### `test "async context-keyword arrow binding identifier is a function"` (`src/tests/exec.zig:21338`)
...
### `test "get/set object shorthand serializes like a named property"` (`src/tests/exec.zig:21345`)
...
### `test "top-level direct eval does not break private-name eval resolution"` (`src/tests/exec.zig:21352`)
...
### `test "switch fallthrough after while-family tails reaches the next case"` (`src/tests/exec.zig:21380`)
...
### `test "long numeric literals parse without a 128-byte cap"` (`src/tests/exec.zig:21409`)
...
### `test "small-function-inlining: sc_Pair constructor is eligible and arguments ctor is not"` (`src/tests/exec.zig:21416`)
...
### `test "small-function-inlining: setter throw stack is setter, ctor, caller"` (`src/tests/exec.zig:21442`)
...
### `test "small-function-inlining: redefinition takes the new function"` (`src/tests/exec.zig:21467`)
...
### `test "small-function-inlining: new C field write is visible"` (`src/tests/exec.zig:21483`)
...
### `test "small-function-inlining: polymorphic site is not specialized"` (`src/tests/exec.zig:21496`)
...
### `test "small-function-inlining: R-2 getter on callee is invoked once per new"` (`src/tests/exec.zig:21527`)
...
### `test "small-function-inlining: inner throw stack and caller catch"` (`src/tests/exec.zig:21547`)
...
### `test "small-function-inlining: primitive ctor return keeps instance"` (`src/tests/exec.zig:21566`)
...
### `test "small-function-inlining: Reflect.construct with foreign NewTarget is not expanded"` (`src/tests/exec.zig:21580`)
...
### `test "small-function-inlining: derived class constructor is not eligible"` (`src/tests/exec.zig:21596`)
...
### `test "small-function-inlining: next-entry specialize is installed on the caller"` (`src/tests/exec.zig:21610`)
...
### `test "small-function-inlining: spec copy keeps simple_inline bits after extra TAKE locals"` (`src/tests/exec.zig:21635`)
...
### `test "small-function-inlining: sibling constructor sites both specialize"` (`src/tests/exec.zig:21669`)
...
### `test "small-function-inlining: proto replacement after specialize is observed"` (`src/tests/exec.zig:21695`)
...
### `test "small-function-inlining: call_constructor callers keep published frame geometry"` (`src/tests/exec.zig:21715`)
...
### `test "small-function-inlining: leftover-operand bodies are not small-inline eligible"` (`src/tests/exec.zig:21733`)
...
### `test "small-function-inlining: leftover ctor is not specialized and does not overflow"` (`src/tests/exec.zig:21757`)
...
### `test "small-function-inlining: extra ctor args do not overwrite callee fields"` (`src/tests/exec.zig:21781`)
...
### `test "small-function-inlining: monomorphic method is expanded"` (`src/tests/exec.zig:21804`)
...
### `test "small-function-inlining L1: apply-arguments ctor specializes"` (`src/tests/exec.zig:21818`)
...
### `test "small-function-inlining L1: next-entry take does not leak initialize return"` (`src/tests/exec.zig:21844`)
...
### `test "small-function-inlining L1: forwarded argc is the site argc"` (`src/tests/exec.zig:21861`)
...
### `test "small-function-inlining L1: Error.stack is initialize, apply native, ctor"` (`src/tests/exec.zig:21876`)
...
### `test "small-function-inlining L1: own apply misses take"` (`src/tests/exec.zig:21899`)
...
### `test "small-function-inlining L1: replaced Function.prototype.apply misses take"` (`src/tests/exec.zig:21918`)
...
### `test "flat string strict-eq matches content across distinct objects"` (`src/tests/exec.zig:21943`)
...
### `test "active invocation Adapter traces live VM windows and not unused stack capacity"` (`src/tests/exec.zig:22105`)
...
### `test "C0: final artifacts carry the carrier encoding and no direct to_propkey"` (`src/tests/exec.zig:22138`)
...
### `test "C0: ToPropertyKey semantics across every parser surface (D7 fixtures)"` (`src/tests/exec.zig:22162`)
...
### `test "C0: a throw inside key coercion attributes the frame to the carrier's source pc"` (`src/tests/exec.zig:22213`)
...
### `test "C0 closed: the carrier encoding executes and the quarantined direct id is rejected"` (`src/tests/exec.zig:22230`)
...
### `test "C0/D7: an unknown carrier tag is rejected by the artifact proof and by dispatch"` (`src/tests/exec.zig:22254`)
...
### `test "C1-1: computed-name function naming rides the carrier encoding"` (`src/tests/exec.zig:22275`)
...
### `test "TGC S3: JSON.parse object keys stay reachable across majors taken mid-parse"` (`src/tests/exec.zig:22349`)
...
### `test "TGC S3-c: operand-stack strings stay rooted while a later push materializes its atom"` (`src/tests/exec.zig:22408`)
...
### `test "TGC S3-d: an inline call's argument region stays rooted while the callee frame is pushed"` (`src/tests/exec.zig:22588`)
...
### `test "TGC S3-d: op_put_array_el's cold arm publishes before the dense grow allocates"` (`src/tests/exec.zig:22664`)
...
### `test "TGC S3-d: the string-primitive get_field2 arm publishes before the auto-init resolver allocates"` (`src/tests/exec.zig:22718`)
...
### `test "an unresolved binding names its identifier in the ReferenceError message (qjs JS_ThrowReferenceErrorNotDefined)"` (`src/tests/exec.zig:22766`)
...
### `test "print / console.log dump objects like QuickJS JS_PrintValue (qjs-generated expectations, 36 shapes)"` (`src/tests/exec.zig:22789`)
...
### `test "no-suspend async uses a same-Machine completion boundary"` (`src/tests/exec.zig:22878`)
...
### `test "no-suspend async preserves parameter exceptions finally aliases and nested boundaries"` (`src/tests/exec.zig:22892`)
...
### `test "no-suspend async leaves suspension eval host-observed cadence and wrappers on fallback"` (`src/tests/exec.zig:22921`)
...
### `test "no-suspend async completion roots survive declared-only GC before and after frame pop"` (`src/tests/exec.zig:22940`)
...
### `test "no-suspend async final code policy includes hidden suspension and excludes nested bodies"` (`src/tests/exec.zig:22984`)
...
### `test "no-suspend async transfers post-body OOM to FIFO without replay"` (`src/tests/exec.zig:23010`)
...
### `test "P-Cap intrinsic then preserves independent results and pending handlers"` (`src/tests/exec.zig:23070`)
...
### `test "P-Cap species observation keeps custom capability handshake"` (`src/tests/exec.zig:23090`)
...
### `test "P-Cap intrinsic prototype survives species replacing global Promise"` (`src/tests/exec.zig:23114`)
...
### `test "P-Cap thenable resolution identity thrower and FIFO preserve single observation"` (`src/tests/exec.zig:23137`)
...
### `test "P-Cap foreign species falls back and delayed foreign settlement keeps self error realm"` (`src/tests/exec.zig:23163`)
...
### `test "P-Cap post-handler and post-getter OOM retain FIFO completion without replay"` (`src/tests/exec.zig:23187`)
...
### `test "P-Cap retries reserved reaction phase before then getter without replaying handler"` (`src/tests/exec.zig:23237`)
...
### `test "fulfilled await preserves FIFO and bypasses an overridden then"` (`src/tests/exec.zig:23294`)
...
### `test "fulfilled await preserves the registration and body realms"` (`src/tests/exec.zig:23314`)
...
### `test "fulfilled await does not replay a resumed body after allocation failure"` (`src/tests/exec.zig:23343`)
...
### `test "print writes top-level strings raw including latin1 high bytes"` (`src/tests/exec.zig:23382`)
