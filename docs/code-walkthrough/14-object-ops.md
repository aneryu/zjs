...
- **实现**：忽略 `rt`。两层 `getOwnDataObjectBorrowed`。
- **所有权 / 错误 / 调用**：不跑 getter。替换 `globalThis.String` 在标准装箱上不可观察。

### `functionPrototypeFromGlobal` (`src/exec/object_ops.zig:153`)
...
### `cachedRealmObject` (`src/exec/object_ops.zig:157`)
...
### `primitivePrototypeFromRealmOrGlobal` (`src/exec/object_ops.zig:162`)
...
### `primitivePrototypeForAccess` (`src/exec/object_ops.zig:178`)
...
### `materializeFrameThisBinding` (`src/exec/object_ops.zig:208`)
...
### `generatorPrototypeFromGlobal` (`src/exec/object_ops.zig:223`)
...
### `installGeneratorPrototypeProperties` (`src/exec/object_ops.zig:235`)
...
### `generatorFunctionPrototypeFromGlobal` (`src/exec/object_ops.zig:251`)
...
### `createGlobalClosureVarRef` (`src/exec/object_ops.zig:278`)
...
### `bytecodeFunctionClassId` (`src/exec/object_ops.zig:285`)
...
### `createModuleBytecodeFunctionShell` (`src/exec/object_ops.zig:297`)
...
### `bytecodeFunctionPrototypeForRealm` (`src/exec/object_ops.zig:322`)
...
### `ownedClosureCell` (`src/exec/object_ops.zig:358`)
...
### `createRootGlobalClosureCell` (`src/exec/object_ops.zig:368`)
...
### `resolveNestedClosureCell` (`src/exec/object_ops.zig:396`)
...
### `attachFunctionCaptures` (`src/exec/object_ops.zig:431`)
...
### `createBytecodeFunctionObjectInternal` (`src/exec/object_ops.zig:467`)
...
### `jsFunctionSetProperties` (`src/exec/object_ops.zig:520`)
...
### `installOrdinaryFunctionPrototype` (`src/exec/object_ops.zig:547`)
...
### `createBytecodeFunctionObject` (`src/exec/object_ops.zig:588`)
...
### `createClassBytecodeFunctionObject` (`src/exec/object_ops.zig:605`)
...
### `createRootBytecodeFunctionObject` (`src/exec/object_ops.zig:623`)
...
### `constructPrimitiveWrapperWithPrototype` (`src/exec/object_ops.zig:644`)
...
### `aggregateErrorConstructWithPrototype` (`src/exec/object_ops.zig:682`)
...
### `suppressedErrorConstructWithPrototype` (`src/exec/object_ops.zig:792`)
...
### `disposableStackConstructWithPrototype` (`src/exec/object_ops.zig:872`)
...
- **实现**：忽略 `global`。`Object.create(disposable_stack, prototype)`。
- **所有权 / 错误 / 调用**：`class_init`。async 变体在 `promise_ops`。

### `errorConstructWithPrototype` (`src/exec/object_ops.zig:882`)
...
### `createCallSiteObject` (`src/exec/object_ops.zig:975`)
...
### `callSitePrototypeFromGlobal` (`src/exec/object_ops.zig:996`)
...
### `defineDataPropertyByAtom` (`src/exec/object_ops.zig:1030`)
...
### `regExpPrototypeMethodIsDefault` (`src/exec/object_ops.zig:1042`)
...
### `regExpPrototypeGetterIsDefault` (`src/exec/object_ops.zig:1067`)
...
### `regExpIsStandard` (`src/exec/object_ops.zig:1087`)
...
### `setValuePropertyStrict` (`src/exec/object_ops.zig:1106`)
...
### `regExpPrototypeFromGlobal` (`src/exec/object_ops.zig:1142`)
...
### `datePrototypeMethod` (`src/exec/object_ops.zig:1149`)
...
### `defineFreshNonIndexDataProperty` (`src/exec/object_ops.zig:1184`)
...
### `defineRegExpIndicesGroupsProperty` (`src/exec/object_ops.zig:1188`)
...
### `populateRegExpGroupsFromCaptureValues` (`src/exec/object_ops.zig:1230`)
...
### `primitivePrototypeMethod` (`src/exec/object_ops.zig:1259`)
...
### `symbolConstructorCall` (`src/exec/object_ops.zig:1322`)
...
### `symbolDescriptionValue` (`src/exec/object_ops.zig:1346`)
...
### `symbolPrimitiveValue` (`src/exec/object_ops.zig:1355`)
...
### `throwPrimitivePrototypeTypeError` (`src/exec/object_ops.zig:1368`)
...
### `getNumberPrototypeMethodId` (`src/exec/object_ops.zig:1387`)
...
- **实现**：忽略 rt。decode builtin；domain 须 `.number`。
- **所有权 / 错误 / 调用**：快调识别。

### `numberPrototypeMethod` (`src/exec/object_ops.zig:1402`)
...
### `primitivePrototypeThisValue` (`src/exec/object_ops.zig:1431`)
...
- **实现**：tag 1..5 分别 number/bool/bigint/symbol/string。对象须 class 匹配，然后 `objectData()`。忽略 rt。
- **所有权 / 错误 / 调用**：失败 TypeError，由调用方换成带消息版本。

### `defineErrorStackDataProperty` (`src/exec/object_ops.zig:1453`)
...
### `dataViewConstructWithPrototype` (`src/exec/object_ops.zig:1475`)
...
### `defineClassFieldDataProperty` (`src/exec/object_ops.zig:1493`)
...
### `constructWeakRefWithPrototype` (`src/exec/object_ops.zig:1508`)
...
### `constructFinalizationRegistryWithPrototype` (`src/exec/object_ops.zig:1512`)
...
### `constructCollectionWithPrototypeFromVm` (`src/exec/object_ops.zig:1534`)
...
### `OwnedPrototype.fromObject` (`src/exec/object_ops.zig:1578`)
...
### `OwnedPrototype.object` (`src/exec/object_ops.zig:1582`)
...
### `OwnedPrototype.deinit` (`src/exec/object_ops.zig:1586`)
...
### `constructorPrototypeObject` (`src/exec/object_ops.zig:1591`)
...
### `dynamicFunctionNewTargetPrototype` (`src/exec/object_ops.zig:1601`)
...
### `constructorClassPrototypeId` (`src/exec/object_ops.zig:1626`)
...
### `nativeErrorKindFromConstructorName` (`src/exec/object_ops.zig:1672`)
...
### `objectRealmGlobal` (`src/exec/object_ops.zig:1686`)
...
### `propertyIndexFromLengthKey` (`src/exec/object_ops.zig:1709`)
...
### `propertyAtomFromLengthIndex` (`src/exec/object_ops.zig:1720`)
...
### `createDataPropertyOrThrow` (`src/exec/object_ops.zig:1730`)
...
- **实现**：有 proxy target → `proxyCreateDataPropertyOrThrow`。否则 `createArrayDataOrTypedArrayElement`。
