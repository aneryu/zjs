...
### `privateFieldAtom` (`src/exec/vm_property.zig:16`)
...
### `getPrivateField` (`src/exec/vm_property.zig:36`)
...
### `getPrivateFieldVm` (`src/exec/vm_property.zig:51`)
...
### `putPrivateField` (`src/exec/vm_property.zig:67`)
...
### `putPrivateFieldVm` (`src/exec/vm_property.zig:82`)
...
### `definePrivateField` (`src/exec/vm_property.zig:98`)
...
### `definePrivateFieldVm` (`src/exec/vm_property.zig:114`)
