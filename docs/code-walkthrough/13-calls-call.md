...
### `hostFunctionCanDispatchFromVmWithoutGlobals` (`src/exec/call.zig:332`)
...
### `definePredefinedHostEntryFunction` (`src/exec/call.zig:336`)
...
### `predefinedStringAtom` (`src/exec/call.zig:356`)
...
### `defineObjectProperty` (`src/exec/call.zig:360`)
...
### `defineGlobalThisProperty` (`src/exec/call.zig:364`)
...
### `defineConstantPropertyAssumingNew` (`src/exec/call.zig:368`)
...
### `defineNumberConstantPropertyAssumingNew` (`src/exec/call.zig:373`)
...
### `hasOwnPropertyProxyAware` (`src/exec/call.zig:667`)
...
### `callHostGlobalNativeFunctionRecord` (`src/exec/call.zig:861`)
...
### `objectAssignGet` (`src/exec/call.zig:1179`)
...
### `objectIsSealed` (`src/exec/call.zig:1245`)
...
### `objectIsFrozen` (`src/exec/call.zig:1256`)
...
### `objectPrototypeValueOf` (`src/exec/call.zig:1312`)
...
### `objectPrototypeHasOwn` (`src/exec/call.zig:1316`)
...
### `objectPrototypePropertyIsEnumerable` (`src/exec/call.zig:1326`)
...
### `objectPrototypeIsPrototypeOf` (`src/exec/call.zig:1336`)
...
### `objectPrototypeDefineAccessor` (`src/exec/call.zig:1348`)
...
### `objectPrototypeLookupAccessor` (`src/exec/call.zig:1368`)
...
### `isCallableObjectValue` (`src/exec/call.zig:1383`)
...
### `primitiveWrapper` (`src/exec/call.zig:1393`)
...
### `primitivePrototypeFromGlobal` (`src/exec/call.zig:1436`)
...
### `boundFunctionNameValue` (`src/exec/call.zig:1452`)
...
### `boundFunctionLengthValue` (`src/exec/call.zig:1462`)
...
### `Trigger.trigger` (`src/exec/call.zig:1696`)
...
### `defaultObjectTag` (`src/exec/call.zig:1799`)
...
### `nativeFunctionName` (`src/exec/call.zig:1828`)
...
### `nativeFunctionNameForVm` (`src/exec/call.zig:1836`)
...
### `VmDispatchName.deinit` (`src/exec/call.zig:1854`)
...
### `nativeFunctionNameForVmBorrowed` (`src/exec/call.zig:1875`)
...
### `nativeFunctionNameForVmEquals` (`src/exec/call.zig:1887`)
...
### `functionToStringValue` (`src/exec/call.zig:1897`)
...
### `nativeFunctionDispatchNameRef` (`src/exec/call.zig:1936`)
...
### `stringLatin1BytesRef` (`src/exec/call.zig:1959`)
...
### `nativeFunctionDispatchName` (`src/exec/call.zig:1967`)
...
### `nativeFunctionNameValue` (`src/exec/call.zig:1981`)
...
### `functionBytecodeToStringValue` (`src/exec/call.zig:1992`)
...
### `nativeFunctionSourceValue` (`src/exec/call.zig:2005`)
...
### `appendNativeFunctionSourceName` (`src/exec/call.zig:2019`)
...
### `nativeFunctionSourceName` (`src/exec/call.zig:2029`)
...
### `isNativeFunctionPropertyName` (`src/exec/call.zig:2042`)
...
### `isUnicodeIdentifierName` (`src/exec/call.zig:2052`)
...
### `isNativeFunctionComputedPropertyName` (`src/exec/call.zig:2068`)
...
### `isFunctionToStringCallable` (`src/exec/call.zig:2103`)
...
### `thisObject` (`src/exec/call.zig:2112`)
...
### `hostCallOutput` (`src/exec/call.zig:2149`)
...
### `runNextOsSignalHandler` (`src/exec/call.zig:2153`)
...
### `globalBtoa` (`src/exec/call.zig:2160`)
...
### `globalAtob` (`src/exec/call.zig:2173`)
...
### `stringToLatin1Bytes` (`src/exec/call.zig:2192`)
...
### `throwInvalidCharacter` (`src/exec/call.zig:2214`)
...
### `createDOMExceptionValue` (`src/exec/call.zig:2221`)
...
### `globalQueueMicrotask` (`src/exec/call.zig:2234`)
...
### `globalGc` (`src/exec/call.zig:2242`)
...
### `materializeMappedArgumentsDescriptorValue` (`src/exec/call.zig:2247`)
...
### `materializeMappedArgumentsDescriptorValueForVm` (`src/exec/call.zig:2263`)
...
### `descriptorObject` (`src/exec/call.zig:2304`)
...
### `optionalBoolProperty` (`src/exec/call.zig:2359`)
...
### `definePropertiesFromObject` (`src/exec/call.zig:2365`)
...
### `atomFromPropertyKey` (`src/exec/call.zig:2382`)
...
### `defineBoolProperty` (`src/exec/call.zig:2386`)
...
### `errorNameMatchesConstructor` (`src/exec/call.zig:2392`)
...
### `isFunctionClass` (`src/exec/call.zig:2401`)
