...
### `FrameSlab.carve` (`src/exec/frame.zig:81`)
...
### `FrameSlab.allocHeap` (`src/exec/frame.zig:87`)
...
### `argumentsNeedsOriginalSnapshot` (`src/exec/frame.zig:171`)
...
### `frameArgCount` (`src/exec/frame.zig:178`)
...
### `originalArgCount` (`src/exec/frame.zig:182`)
...
### `frameVarRefStorageCount` (`src/exec/frame.zig:186`)
...
### `frameOpenVarRefStorageCount` (`src/exec/frame.zig:191`)
...
### `Frame.ensureCold` (`src/exec/frame.zig:243`)
...
### `Frame.freeCold` (`src/exec/frame.zig:252`)
...
### `Frame.releaseColdStorage` (`src/exec/frame.zig:260`)
...
### `Frame.newTargetValue` (`src/exec/frame.zig:269`)
...
### `Frame.originalArgs` (`src/exec/frame.zig:287`)
...
### `Frame.initResidentExecution` (`src/exec/frame.zig:299`)
...
### `Frame.isEmptyResidentExecutionShell` (`src/exec/frame.zig:317`)
...
### `Frame.initCallBindings` (`src/exec/frame.zig:327`)
...
### `Frame.initArguments` (`src/exec/frame.zig:337`)
...
### `Frame.initArgumentsMoved` (`src/exec/frame.zig:363`)
...
### `Frame.initArgumentsBorrowedSlots` (`src/exec/frame.zig:390`)
...
### `Frame.allocArgsSlice` (`src/exec/frame.zig:405`)
...
### `Frame.initOriginalArgsSnapshot` (`src/exec/frame.zig:422`)
...
### `Frame.installOwnedStorage` (`src/exec/frame.zig:444`)
...
### `Frame.installResidentStorage` (`src/exec/frame.zig:450`)
...
### `Frame.allocOwnedStorage` (`src/exec/frame.zig:455`)
...
### `Frame.deinitInlineCall` (`src/exec/frame.zig:478`)
...
### `Frame.releaseOwnedStorage` (`src/exec/frame.zig:484`)
...
### `Frame.captureLocal` (`src/exec/frame.zig:514`)
...
### `Frame.captureArg` (`src/exec/frame.zig:542`)
...
### `Frame.closeLocalBinding` (`src/exec/frame.zig:563`)
...
### `Frame.installOpenVarRefSlots` (`src/exec/frame.zig:580`)
...
### `Frame.ensureOpenVarRefSlots` (`src/exec/frame.zig:586`)
...
### `Frame.setLocal` (`src/exec/frame.zig:614`)
...
### `ensureVarRefsCapacity` (`src/exec/frame.zig:641`)
...
### `growLocalsCapacity` (`src/exec/frame.zig:686`)
...
### `ownedStorageContainsOnlyLocals` (`src/exec/frame.zig:714`)
...
### `ownedStorageContainsOnlyVarRefs` (`src/exec/frame.zig:725`)
...
### `sliceOverlapsStorage` (`src/exec/frame.zig:738`)
...
### `Stack.push` (`src/exec/stack.zig:224`)
...
### `Stack.pop` (`src/exec/stack.zig:244`)
...
### `Stack.reserveFrameCapacity` (`src/exec/stack.zig:266`)
...
### `Stack.reserveCapacityUpTo` (`src/exec/stack.zig:271`)
