...
### `assertThrows` (`src/exec/call_runtime.zig:2673`)
...
### `callAssertThrowsCallback` (`src/exec/call_runtime.zig:2701`)
...
### `collectIteratorValues` (`src/exec/call_runtime.zig:2712`)
...
### `getIteratorMethod` (`src/exec/call_runtime.zig:2755`)
...
### `cacheIteratorNextMethod` (`src/exec/call_runtime.zig:2765`)
...
### `appendIteratorValues` (`src/exec/call_runtime.zig:2779`)
...
### `appendSpreadValuesEnumerate` (`src/exec/call_runtime.zig:2827`)
...
### `isCallableValue` (`src/exec/call_runtime.zig:2927`)
...
### `isIteratorIdentityFunction` (`src/exec/call_runtime.zig:2934`)
...
### `globalLexicalEnv` (`src/exec/call_runtime.zig:2939`)
...
### `existingGlobalLexicalEnv` (`src/exec/call_runtime.zig:2952`)
...
### `existingGlobalLexicalEnvForGlobal` (`src/exec/call_runtime.zig:2958`)
...
### `globalLexicalHasForGlobal` (`src/exec/call_runtime.zig:2967`)
...
### `globalLexicalCell` (`src/exec/call_runtime.zig:2976`)
...
### `selectOrdinaryGlobalClosureCell` (`src/exec/call_runtime.zig:2993`)
...
### `globalUninitializedVarsEnv` (`src/exec/call_runtime.zig:3025`)
...
### `globalObjectGetUninitializedVar` (`src/exec/call_runtime.zig:3037`)
...
### `globalObjectFindUninitializedVar` (`src/exec/call_runtime.zig:3056`)
...
### `ensureGlobalObjectVarRefCell` (`src/exec/call_runtime.zig:3074`)
...
### `defineGlobalDeclVarCell` (`src/exec/call_runtime.zig:3138`)
...
- **实现**：类型/名字不符 false。`ensureGlobalObjectVarRefCell`；扩 var_refs；同名 `varDefIsEvalHoistedVar` 的 local 写成细胞值（兼容直接 eval lookup）。
- **所有权 / 错误 / 调用**：`vm_property_globals` 的 global_decl 安装循环非词法臂（词法臂走 `defineGlobalDeclLexicalCell`）。

### `ensureGlobalLexicalCell` (`src/exec/call_runtime.zig:3179`)
...
### `globalLexicalValueForGlobal` (`src/exec/call_runtime.zig:3248`)
...
### `defineGlobalLexicalValue` (`src/exec/call_runtime.zig:3256`)
...
### `defineGlobalDeclLexicalCell` (`src/exec/call_runtime.zig:3269`)
...
### `setGlobalLexicalValueForGlobal` (`src/exec/call_runtime.zig:3290`)
...
### `setGlobalLexicalValueForFastPathOwned` (`src/exec/call_runtime.zig:3303`)
...
### `initializeGlobalLexicalValue` (`src/exec/call_runtime.zig:3309`)
...
### `varDefIsEvalHoistedVar` (`src/exec/call_runtime.zig:3336`)
...
### `indirectEval` (`src/exec/call_runtime.zig:3343`)
...
### `isSimpleIdentifierName` (`src/exec/call_runtime.zig:3426`)
...
### `ActiveRootValueProbe.trigger` (`src/exec/call_runtime.zig:3441`)
...
### `freeArgs` (`src/exec/call_runtime.zig:3456`)
...
### `Probe.trigger` (`src/exec/call_runtime.zig:3488`)
...
### `callFunctionBytecodeConstruct` (`src/exec/call_runtime.zig:3531`)
...
### `callFunctionBytecodeModeState` (`src/exec/call_runtime.zig:3561`)
...
### `callFunctionBytecodeModeStateAfterInterruptPoll` (`src/exec/call_runtime.zig:3622`)
...
### `runGeneratorParameterInit` (`src/exec/call_runtime.zig:3742`)
...
### `generatorNext` (`src/exec/call_runtime.zig:3810`)
...
### `generatorFunctionBytecodeFromExecution` (`src/exec/call_runtime.zig:3870`)
...
### `generatorHasYieldStarResult` (`src/exec/call_runtime.zig:3878`)
...
### `syncGeneratorStep` (`src/exec/call_runtime.zig:3893`)
...
### `generatorYieldStarSuspended` (`src/exec/call_runtime.zig:3945`)
...
### `setGeneratorYieldStarSuspended` (`src/exec/call_runtime.zig:3950`)
...
### `generatorResumeCompletionType` (`src/exec/call_runtime.zig:3955`)
...
### `setGeneratorResumeCompletionType` (`src/exec/call_runtime.zig:3960`)
...
### `resumeGeneratorYieldStarCompletion` (`src/exec/call_runtime.zig:3965`)
...
### `generatorReturn` (`src/exec/call_runtime.zig:4003`)
...
### `resumeGeneratorCatchForRuntimeError` (`src/exec/call_runtime.zig:4074`)
...
### `generatorYieldStarReturnStep` (`src/exec/call_runtime.zig:4125`)
...
### `generatorYieldStarThrowStep` (`src/exec/call_runtime.zig:4160`)
...
### `generatorYieldStarCloseForMissingThrow` (`src/exec/call_runtime.zig:4196`)
...
### `generatorThrow` (`src/exec/call_runtime.zig:4210`)
...
### `generatorCatchResumeResultValue` (`src/exec/call_runtime.zig:4304`)
...
### `generatorPcAfterYieldStar` (`src/exec/call_runtime.zig:4308`)
...
### `wrapIteratorFromIterator` (`src/exec/call_runtime.zig:4317`)
...
### `pollGCSafePoint` (`src/exec/call_runtime.zig:4383`)
...
### `runNextOsTimer` (`src/exec/call_runtime.zig:4390`)
...
### `runNextOsRwHandler` (`src/exec/call_runtime.zig:4397`)
...
### `enqueuePendingMicrotask` (`src/exec/call_runtime.zig:4404`)
...
### `throwTypeErrorIntrinsicForGlobal` (`src/exec/call_runtime.zig:4447`)
...
### `throwTypeErrorIntrinsic` (`src/exec/call_runtime.zig:4468`)
...
### `currentFrameFunctionIsStrict` (`src/exec/call_runtime.zig:4474`)
...
### `functionBytecodeFromValue` (`src/exec/call_runtime.zig:4486`)
...
### `isFunctionLikeClass` (`src/exec/call_runtime.zig:4491`)
...
### `throwPrivateBrandTypeError` (`src/exec/call_runtime.zig:4633`)
...
### `throwSetFailureTypeError` (`src/exec/call_runtime.zig:4661`)
...
### `setFailureShouldThrow` (`src/exec/call_runtime.zig:4677`)
...
### `functionRuntimeStrict` (`src/exec/call_runtime.zig:4682`)
...
### `ordinarySetWithReceiver` (`src/exec/call_runtime.zig:4686`)
...
### `definePropertiesCall` (`src/exec/call_runtime.zig:4717`)
...
### `PendingDescriptorRoots.traceRoots` (`src/exec/call_runtime.zig:4745`)
...
### `PendingDescriptorRoots.provider` (`src/exec/call_runtime.zig:4755`)
...
### `PendingDescriptorRoots.activate` (`src/exec/call_runtime.zig:4759`)
...
### `PendingDescriptorRoots.deactivate` (`src/exec/call_runtime.zig:4765`)
...
### `definePropertiesOnTarget` (`src/exec/call_runtime.zig:4773`)
...
### `callAccessorSetter` (`src/exec/call_runtime.zig:4845`)
...
### `inOp` (`src/exec/call_runtime.zig:4870`)
...
### `instanceofOp` (`src/exec/call_runtime.zig:4892`)
...
### `instanceofValue` (`src/exec/call_runtime.zig:4909`)
...
### `instanceofMethod` (`src/exec/call_runtime.zig:4929`)
...
### `instanceofMethodSlow` (`src/exec/call_runtime.zig:4944`)
...
### `instanceofValueWithMethod` (`src/exec/call_runtime.zig:4956`)
...
### `constructorNameEqlLocal` (`src/exec/call_runtime.zig:4993`)
...
### `nativeFunctionNameValueLocal` (`src/exec/call_runtime.zig:5001`)
...
### `isBlockedByUnscopables` (`src/exec/call_runtime.zig:5014`)
...
### `lookupFrameVarRef` (`src/exec/call_runtime.zig:5030`)
...
### `closureVarIsNonLexicalGlobalSentinel` (`src/exec/call_runtime.zig:5056`)
...
### `atomIdOrNameEql` (`src/exec/call_runtime.zig:5066`)
...
### `functionNameValueFromAtom` (`src/exec/call_runtime.zig:5073`)
...
### `mappedArgumentsValue` (`src/exec/call_runtime.zig:5108`)
...
### `setMappedArgumentsValue` (`src/exec/call_runtime.zig:5118`)
...
### `readInt` (`src/exec/call_runtime.zig:5132`)
