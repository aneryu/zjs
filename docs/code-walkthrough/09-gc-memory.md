...
### `oomCoverageDistinctSiteCount` (`src/core/memory.zig:150`)
...
### `SmallObjectSlab.forEachArena` (`src/core/memory.zig:193`)
...
### `SmallObjectSlab.blockSize` (`src/core/memory.zig:251`)
...
### `SmallObjectSlab.canUse` (`src/core/memory.zig:267`)
...
### `SmallObjectSlab.setArenaBacking` (`src/core/memory.zig:271`)
...
### `SmallObjectSlab.eligibleSize` (`src/core/memory.zig:280`)
...
### `SmallObjectSlab.headerClassIndex` (`src/core/memory.zig:289`)
...
### `SmallObjectSlab.usablePayloadFromClass` (`src/core/memory.zig:294`)
...
### `SmallObjectSlab.allocAtIndex` (`src/core/memory.zig:303`)
...
### `SmallObjectSlab.popFreeBlock` (`src/core/memory.zig:311`)
...
### `SmallObjectSlab.freeAtIndex` (`src/core/memory.zig:346`)
...
### `SmallObjectSlab.releaseEmptyArena` (`src/core/memory.zig:391`)
...
### `SmallObjectSlab.deinit` (`src/core/memory.zig:410`)
...
### `SmallObjectSlab.addArena` (`src/core/memory.zig:426`)
...
### `SmallObjectSlab.classIndex` (`src/core/memory.zig:459`)
...
### `SmallObjectSlab.blockSizeIndex` (`src/core/memory.zig:474`)
...
### `SmallObjectSlab.totalBlockSize` (`src/core/memory.zig:502`)
...
### `SmallObjectSlab.arenaBlocks` (`src/core/memory.zig:510`)
...
### `SmallObjectSlab.userPtrWithinArena` (`src/core/memory.zig:528`)
...
### `SmallObjectSlab.forEachArenaBlock` (`src/core/memory.zig:548`)
...
### `SmallObjectSlab.blockHeaderAt` (`src/core/memory.zig:572`)
...
### `SmallObjectSlab.blockHeaderFromUser` (`src/core/memory.zig:576`)
...
### `SmallObjectSlab.userData` (`src/core/memory.zig:580`)
...
### `SmallObjectSlab.arenaFromBlock` (`src/core/memory.zig:584`)
...
### `SmallObjectSlab.arenaAllocation` (`src/core/memory.zig:589`)
...
### `SmallObjectSlab.arenaBacking` (`src/core/memory.zig:595`)
...
### `SmallObjectSlab.addArenaList` (`src/core/memory.zig:599`)
...
### `SmallObjectSlab.removeArena` (`src/core/memory.zig:606`)
...
### `SmallObjectSlab.addFreeArena` (`src/core/memory.zig:618`)
...
### `SmallObjectSlab.removeFreeArena` (`src/core/memory.zig:638`)
...
### `MemoryAccount.init` (`src/core/memory.zig:715`)
...
### `MemoryAccount.accountedMallocSize` (`src/core/memory.zig:728`)
...
### `MemoryAccount.accountedSizeForRequest` (`src/core/memory.zig:737`)
...
### `MemoryAccount.creditAlloc` (`src/core/memory.zig:741`)
...
### `MemoryAccount.debitAlloc` (`src/core/memory.zig:746`)
...
### `MemoryAccount.initWithTrace` (`src/core/memory.zig:750`)
...
### `MemoryAccount.activateRuntimeAccounting` (`src/core/memory.zig:758`)
...
### `MemoryAccount.accountedAllocator` (`src/core/memory.zig:769`)
...
### `MemoryAccount.accountedAllocatorAlloc` (`src/core/memory.zig:783`)
...
### `MemoryAccount.accountedAllocatorResize` (`src/core/memory.zig:797`)
...
### `MemoryAccount.accountedAllocatorRemap` (`src/core/memory.zig:820`)
...
### `MemoryAccount.accountedAllocatorFree` (`src/core/memory.zig:849`)
...
### `MemoryAccount.recordAccountedResize` (`src/core/memory.zig:860`)
...
### `MemoryAccount.alloc` (`src/core/memory.zig:871`)
...
### `MemoryAccount.allocElements` (`src/core/memory.zig:880`)
...
### `MemoryAccount.reallocElements` (`src/core/memory.zig:906`)
...
### `MemoryAccount.allocNoTrigger` (`src/core/memory.zig:924`)
...
### `MemoryAccount.slabPopHot` (`src/core/memory.zig:932`)
...
### `MemoryAccount.noteAllocDiagnostics` (`src/core/memory.zig:937`)
...
### `MemoryAccount.noteFreeDiagnostics` (`src/core/memory.zig:957`)
...
### `MemoryAccount.allocInternal` (`src/core/memory.zig:968`)
...
### `MemoryAccount.allocInternalSlow` (`src/core/memory.zig:1037`)
...
### `MemoryAccount.allocSlowErased` (`src/core/memory.zig:1059`)
...
### `MemoryAccount.free` (`src/core/memory.zig:1094`)
...
### `MemoryAccount.freeGc` (`src/core/memory.zig:1108`)
...
### `MemoryAccount.remap` (`src/core/memory.zig:1136`)
...
### `MemoryAccount.allocAlignedBytesNoTrigger` (`src/core/memory.zig:1173`)
...
### `MemoryAccount.allocAlignedBytesInternal` (`src/core/memory.zig:1177`)
...
### `MemoryAccount.allocAlignedBytesSlow` (`src/core/memory.zig:1201`)
...
### `MemoryAccount.freeAlignedBytes` (`src/core/memory.zig:1217`)
...
### `MemoryAccount.create` (`src/core/memory.zig:1236`)
...
### `MemoryAccount.createNoTrigger` (`src/core/memory.zig:1242`)
...
### `MemoryAccount.createObjectConstFamNoTrigger` (`src/core/memory.zig:1250`)
...
### `MemoryAccount.gcPrefixSize` (`src/core/memory.zig:1270`)
...
### `MemoryAccount.gcAlignment` (`src/core/memory.zig:1274`)
...
### `MemoryAccount.gcSlabClassIndex` (`src/core/memory.zig:1278`)
...
### `MemoryAccount.rawAllocForGc` (`src/core/memory.zig:1283`)
...
### `MemoryAccount.prepareGcRawAudit` (`src/core/memory.zig:1288`)
...
### `MemoryAccount.reserveGcExtent` (`src/core/memory.zig:1294`)
...
### `MemoryAccount.commitGcExtent` (`src/core/memory.zig:1306`)
...
### `MemoryAccount.recordBlockGcAllocation` (`src/core/memory.zig:1341`)
...
### `MemoryAccount.carrierGenerationHandle` (`src/core/memory.zig:1360`)
...
### `MemoryAccount.carrierTransition` (`src/core/memory.zig:1368`)
...
### `MemoryAccount.carrierPublish` (`src/core/memory.zig:1378`)
...
### `MemoryAccount.beginGcRawFree` (`src/core/memory.zig:1388`)

- **签名**：`pub fn beginGcRawFree(self: *MemoryAccount, base: usize) void`。
- **作用**：把审计生命周期转为raw_free_in_progress。
- **实现**：编译期要求block或extent tracking；lifecycle启用时carrierTransition，错误转panic（原先那段 test-only 空壳 if 已删）。
- **所有权 / 错误 / 调用**：不释放存储或删除身份，不清Registry成员；若仅oracle追踪无lifecycle则没有此状态写入。

### `MemoryAccount.finishExtentGcRawFree` (`src/core/memory.zig:1396`)
...
### `MemoryAccount.finishBlockGcRawFree` (`src/core/memory.zig:1411`)
...
### `MemoryAccount.deinitGcCarrier` (`src/core/memory.zig:1418`)
...
### `MemoryAccount.gcAllocInfoByte` (`src/core/memory.zig:1446`)
...
### `MemoryAccount.initGcPrefixBlockCell` (`src/core/memory.zig:1452`)
...
### `MemoryAccount.initGcPrefix` (`src/core/memory.zig:1469`)
...
### `MemoryAccount.initGcPrefixTagged` (`src/core/memory.zig:1478`)
...
### `MemoryAccount.createInternal` (`src/core/memory.zig:1494`)
...
### `MemoryAccount.createInternalSlow` (`src/core/memory.zig:1576`)
...
### `MemoryAccount.destroy` (`src/core/memory.zig:1592`)
...
### `MemoryAccount.destroyConstFam` (`src/core/memory.zig:1601`)
...
### `MemoryAccount.destroyErased` (`src/core/memory.zig:1634`)
...
### `MemoryAccount.createWithFam` (`src/core/memory.zig:1680`)
...
### `MemoryAccount.createWithFamComptime` (`src/core/memory.zig:1686`)
...
### `MemoryAccount.createObjectWithFamNoTrigger` (`src/core/memory.zig:1718`)
...
### `MemoryAccount.createWithFamInternal` (`src/core/memory.zig:1729`)
...
### `MemoryAccount.createWithFamInternalSlow` (`src/core/memory.zig:1804`)
...
### `MemoryAccount.gcSlabAccountedPayload` (`src/core/memory.zig:1823`)
...
### `MemoryAccount.destroyWithFam` (`src/core/memory.zig:1835`)
...
### `MemoryAccount.createStringCell` (`src/core/memory.zig:1895`)
...
### `MemoryAccount.destroyStringCell` (`src/core/memory.zig:1917`)
...
### `MemoryAccount.createStringExtent` (`src/core/memory.zig:1941`)
...
### `MemoryAccount.createExtent` (`src/core/memory.zig:1948`)
...
### `MemoryAccount.destroyStringExtent` (`src/core/memory.zig:1983`)
...
### `MemoryAccount.createStorageCell` (`src/core/memory.zig:2009`)
...
### `MemoryAccount.noteBlockCellBitmapReclaim` (`src/core/memory.zig:2032`)
...
### `MemoryAccount.debitBlockBytes` (`src/core/memory.zig:2047`)
...
### `MemoryAccount.hasOutstandingAllocations` (`src/core/memory.zig:2052`)
...
### `MemoryAccount.enableSmallObjectSlab` (`src/core/memory.zig:2059`)
...
### `MemoryAccount.useIndependentSmallObjectSlabArenaBacking` (`src/core/memory.zig:2078`)
...
### `MemoryAccount.deinitSmallObjectSlab` (`src/core/memory.zig:2083`)
...
### `MemoryAccount.setLimit` (`src/core/memory.zig:2088`)
...
### `MemoryAccount.getLimit` (`src/core/memory.zig:2092`)
...
### `MemoryAccount.checkAllocation` (`src/core/memory.zig:2096`)
...
### `MemoryAccount.triggerGCBeforeAllocation` (`src/core/memory.zig:2110`)
...
### `MemoryAccount.samplePeakAtCollection` (`src/core/memory.zig:2133`)
...
### `MemoryAccount.updatePeak` (`src/core/memory.zig:2137`)
...
### `MemoryAccount.beginCyclePeakTracking` (`src/core/memory.zig:2144`)
...
### `MemoryAccount.endCyclePeakTracking` (`src/core/memory.zig:2150`)
...
### `MemoryAccount.noteCyclePeak` (`src/core/memory.zig:2154`)
...
### `MemoryAccount.rawSlabClass` (`src/core/memory.zig:2169`)
...
### `MemoryAccount.rawAlloc` (`src/core/memory.zig:2176`)
...
### `MemoryAccount.rawFree` (`src/core/memory.zig:2185`)
...
### `MemoryAccount.traceAlloc` (`src/core/memory.zig:2199`)
...
### `MemoryAccount.traceFree` (`src/core/memory.zig:2208`)
