...
### `LexerImpl.init` (`src/lexer.zig:73`)
...
### `LexerImpl.deinit` (`src/lexer.zig:86`)
...
### `LexerImpl.enableTypeScript` (`src/lexer.zig:90`)
...
### `LexerImpl.getSkippedIntervalAtPos` (`src/lexer.zig:95`)
...
### `LexerImpl.skipRange` (`src/lexer.zig:103`)
...
### `LexerImpl.releaseTokenPayload` (`src/lexer.zig:127`)
...
### `LexerImpl.freeToken` (`src/lexer.zig:142`)
...
### `LexerImpl.nextIntoReplacing` (`src/lexer.zig:153`)
...
### `LexerImpl.dupToken` (`src/lexer.zig:164`)
...
### `LexerImpl.isSourceSlice` (`src/lexer.zig:186`)
...
### `LexerImpl.gotLineTerminator` (`src/lexer.zig:196`)
...
### `LexerImpl.next` (`src/lexer.zig:201`)
...
### `LexerImpl.nextInto` (`src/lexer.zig:210`)
...
### `LexerImpl.nextTemplatePart` (`src/lexer.zig:251`)
...
### `LexerImpl.nextTemplatePartInto` (`src/lexer.zig:257`)
...
### `LexerImpl.nextTemplatePartAfterBrace` (`src/lexer.zig:266`)
...
### `LexerImpl.nextTemplatePartAfterBraceInto` (`src/lexer.zig:272`)
...
### `LexerImpl.rescanRegexp` (`src/lexer.zig:282`)
...
### `LexerImpl.rescanRegexpInto` (`src/lexer.zig:288`)
...
### `LexerImpl.peek` (`src/lexer.zig:300`)
...
### `LexerImpl.peekAt` (`src/lexer.zig:304`)
...
### `LexerImpl.remaining` (`src/lexer.zig:308`)
...
### `LexerImpl.simpleNextIsArrowNoLineTerminator` (`src/lexer.zig:316`)
...
### `LexerImpl.simpleCurrentParenIsArrowHead` (`src/lexer.zig:329`)
...
### `LexerImpl.bump` (`src/lexer.zig:334`)
...
### `LexerImpl.mark` (`src/lexer.zig:345`)
...
### `LexerImpl.emitInto` (`src/lexer.zig:351`)
...
### `LexerImpl.skipTrivia` (`src/lexer.zig:365`)
...
### `LexerImpl.skipLineComment` (`src/lexer.zig:434`)
...
### `LexerImpl.skipNonAsciiWhiteSpace` (`src/lexer.zig:443`)
...
### `LexerImpl.isUtf8LineSeparator` (`src/lexer.zig:495`)
...
### `LexerImpl.skipBlockComment` (`src/lexer.zig:500`)
...
### `LexerImpl.startsWithBytes` (`src/lexer.zig:524`)
...
### `LexerImpl.startsUnicodeEscape` (`src/lexer.zig:529`)
...
### `LexerImpl.lexIdentifier` (`src/lexer.zig:535`)
...
### `LexerImpl.lexAsciiIdentifierNoEscape` (`src/lexer.zig:581`)
...
### `LexerImpl.emitIdentifierOrKeyword` (`src/lexer.zig:608`)
...
### `LexerImpl.isNonAsciiTriviaStart` (`src/lexer.zig:636`)
...
### `LexerImpl.consumeIdentCodePoint` (`src/lexer.zig:650`)
...
### `LexerImpl.lexPrivateName` (`src/lexer.zig:666`)
...
### `LexerImpl.lexDotOrNumber` (`src/lexer.zig:716`)
...
### `LexerImpl.lexNumber` (`src/lexer.zig:731`)
...
### `LexerImpl.finishNumber` (`src/lexer.zig:793`)
...
### `LexerImpl.lexString` (`src/lexer.zig:824`)
...
### `LexerImpl.decodeStringEscape` (`src/lexer.zig:878`)
...
### `LexerImpl.consumeLegacyOctalEscape` (`src/lexer.zig:970`)
...
### `LexerImpl.consumeUnicodeEscapeAfterBackslash` (`src/lexer.zig:988`)
...
### `LexerImpl.consumeUnicodeEscape` (`src/lexer.zig:1032`)
...
### `LexerImpl.consumeFourHex` (`src/lexer.zig:1038`)
...
### `LexerImpl.lexTemplate` (`src/lexer.zig:1055`)
...
### `LexerImpl.lexTemplateBody` (`src/lexer.zig:1059`)
...
### `appendNormalizedTemplateRaw` (`src/lexer.zig:1143`)
...
### `LexerImpl.lexRegexp` (`src/lexer.zig:1164`)
...
### `LexerImpl.lexPunctuator` (`src/lexer.zig:1215`)
...
### `LexerImpl.lexPlus` (`src/lexer.zig:1242`)
...
### `LexerImpl.lexMinus` (`src/lexer.zig:1259`)
...
### `LexerImpl.lexStar` (`src/lexer.zig:1276`)
...
### `LexerImpl.lexSlash` (`src/lexer.zig:1298`)
...
### `LexerImpl.lexPercent` (`src/lexer.zig:1308`)
...
### `LexerImpl.lexEquals` (`src/lexer.zig:1318`)
...
### `LexerImpl.lexBang` (`src/lexer.zig:1340`)
...
### `LexerImpl.lexLt` (`src/lexer.zig:1355`)
...
### `LexerImpl.lexGt` (`src/lexer.zig:1377`)
...
### `LexerImpl.lexAmp` (`src/lexer.zig:1409`)
...
### `LexerImpl.lexPipe` (`src/lexer.zig:1431`)
...
### `LexerImpl.lexCaret` (`src/lexer.zig:1453`)
...
### `LexerImpl.lexQuestion` (`src/lexer.zig:1463`)
...
### `LexerImpl.decodeUtf8` (`src/lexer.zig:1487`)
...
### `LexerImpl.startsUtf8Trivia` (`src/lexer.zig:1501`)
...
### `LexerImpl.startsUtf8LineTerminator` (`src/lexer.zig:1516`)
...
### `isAsciiIdentStart` (`src/lexer.zig:1525`)
...
### `isAsciiIdentContinue` (`src/lexer.zig:1529`)
...
### `isOctalDigit` (`src/lexer.zig:1557`)
...
### `isBinaryDigit` (`src/lexer.zig:1561`)
...
### `isDecimalDigit` (`src/lexer.zig:1565`)
...
### `consumeDigitRun` (`src/lexer.zig:1569`)
...
### `consumeHexDigits` (`src/lexer.zig:1587`)
...
### `consumeOctalDigits` (`src/lexer.zig:1591`)
...
### `consumeBinaryDigits` (`src/lexer.zig:1595`)
...
### `consumeDecDigits` (`src/lexer.zig:1599`)
...
### `consumeDecDigitsRequired` (`src/lexer.zig:1603`)
...
### `consumeOptionalFractionDigits` (`src/lexer.zig:1607`)
...
### `decimalBigIntHasInvalidLeadingZero` (`src/lexer.zig:1615`)
...
### `legacyOrNonOctalDecimalValue` (`src/lexer.zig:1627`)
...
### `parseNumber` (`src/lexer.zig:1656`)

- **签名**：`fn parseNumber(allocator: std.mem.Allocator, lexeme: []const u8, base: u8) !f64`。
- **作用**：把数字 lexeme 解析成 `f64`；有 `_` 则先剥掉（对齐 `js_atof` 无长度帽，`quickjs.c:12876-12883`）。
- **实现**：无 `_` 直接 `parseNumberDigits`。有则 `ArrayList` 去掉 `_` 再解析。
- **所有权 / 错误 / 调用**：临时缓冲 defer deinit。`InvalidNumber` / OOM。

### `parseNumberDigits` (`src/lexer.zig:1679`)

- **签名**：`fn parseNumberDigits(s: []const u8, base: u8) !f64`。
- **作用**：无分隔符的数字文本 → `f64`。
- **实现**：base 10 用 `parseFloat`。其它 `len<3` → `InvalidNumber`，跳过两字节前缀（不校验前缀字母）后先 `parseUnsigned(u128)`；溢出则按 digit 在 `f64` 里累乘（`js_atod` / `parseRadixPrefixedDigits`）。
- **所有权 / 错误 / 调用**：不分配。非法 digit → `InvalidNumber`。

### `keywordLookup` (`src/lexer.zig:1703`)
...
### `isReservedKeyword` (`src/lexer.zig:1783`)
