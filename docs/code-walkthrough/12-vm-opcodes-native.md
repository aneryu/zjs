...
### `dispatch` (`src/exec/vm_opcodes.zig:32`)
...
### `managedInlineEligible` (`src/exec/vm_opcodes.zig:90`)
...
### `getterInlineEligible` (`src/exec/vm_opcodes.zig:97`)
...
### `methodManagedInlineEligible` (`src/exec/vm_opcodes.zig:103`)
...
### `failure` (`src/exec/vm_opcodes.zig:110`)
