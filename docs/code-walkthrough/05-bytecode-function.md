...
### `BytecodeVarDef.init` (`src/bytecode.zig:3322`)
...
### `BytecodeVarDef.fromCompile` (`src/bytecode.zig:3335`)
...
### `BytecodeVarDef.isConst` (`src/bytecode.zig:3351`)
...
### `BytecodeVarDef.isLexical` (`src/bytecode.zig:3355`)
...
### `BytecodeVarDef.isCaptured` (`src/bytecode.zig:3359`)
...
### `BytecodeVarDef.hasScope` (`src/bytecode.zig:3363`)
...
### `BytecodeVarDef.varKind` (`src/bytecode.zig:3367`)
...
### `ClosureVar.init` (`src/bytecode.zig:3395`)
...
### `ClosureVar.closureType` (`src/bytecode.zig:3406`)
...
### `ClosureVar.isLexical` (`src/bytecode.zig:3410`)
...
### `ClosureVar.isConst` (`src/bytecode.zig:3414`)
...
### `ClosureVar.varKind` (`src/bytecode.zig:3418`)
...
### `ClosureVar.toInit` (`src/bytecode.zig:3422`)
...
### `FunctionBytecode.bit` (`src/bytecode.zig:3840`)
...
### `FunctionBytecode.assignBit` (`src/bytecode.zig:3844`)
...
### `FunctionBytecode.hasDebug` (`src/bytecode.zig:3848`)
...
### `FunctionBytecode.hasExtension` (`src/bytecode.zig:3852`)
...
### `FunctionBytecode.layout` (`src/bytecode.zig:3856`)
...
### `FunctionBytecode.famBytes` (`src/bytecode.zig:3860`)
...
### `FunctionBytecode.debugInfo` (`src/bytecode.zig:3864`)
...
### `FunctionBytecode.debugInfoMut` (`src/bytecode.zig:3870`)
...
### `FunctionBytecode.hotExtension` (`src/bytecode.zig:3876`)
...
### `FunctionBytecode.hotExtensionCanonical` (`src/bytecode.zig:3891`)
...
### `FunctionBytecode.hotExtensionMut` (`src/bytecode.zig:3897`)
...
### `FunctionBytecode.canonicalHotAddress` (`src/bytecode.zig:3905`)
...
### `FunctionBytecode.canonicalHotExtension` (`src/bytecode.zig:3913`)
...
### `FunctionBytecode.hotExtensionSlow` (`src/bytecode.zig:3920`)
...
### `FunctionBytecode.hotExtensionMutSlow` (`src/bytecode.zig:3929`)
...
### `FunctionBytecode.hotExtensionRequiredMut` (`src/bytecode.zig:3938`)
...
### `FunctionBytecode.canonicalCallFacts` (`src/bytecode.zig:3946`)
...
### `FunctionBytecode.applyFlags` (`src/bytecode.zig:3969`)
...
### `FunctionBytecode.functionKind` (`src/bytecode.zig:3985`)
...
### `FunctionBytecode.hasPrototype` (`src/bytecode.zig:3988`)
...
### `FunctionBytecode.hasSimpleParameterList` (`src/bytecode.zig:3991`)
...
### `FunctionBytecode.isDerivedClassConstructor` (`src/bytecode.zig:3994`)
...
### `FunctionBytecode.needHomeObject` (`src/bytecode.zig:3997`)
...
### `FunctionBytecode.newTargetAllowed` (`src/bytecode.zig:4000`)
...
### `FunctionBytecode.superCallAllowed` (`src/bytecode.zig:4003`)
...
### `FunctionBytecode.superAllowed` (`src/bytecode.zig:4006`)
...
### `FunctionBytecode.argumentsAllowed` (`src/bytecode.zig:4009`)
...
### `FunctionBytecode.isDirectOrIndirectEval` (`src/bytecode.zig:4012`)
...
### `FunctionBytecode.callFacts` (`src/bytecode.zig:4015`)
...
### `FunctionBytecode.ctorAllocProfile` (`src/bytecode.zig:4019`)
...
### `FunctionBytecode.ctorAllocProfileMut` (`src/bytecode.zig:4023`)
...
### `FunctionBytecode.legacyBytecodeAdapter` (`src/bytecode.zig:4027`)
...
### `FunctionBytecode.setLegacyBytecodeAdapter` (`src/bytecode.zig:4040`)
...
### `FunctionBytecode.openVarRefCount` (`src/bytecode.zig:4049`)
...
### `FunctionBytecode.closureVarCount` (`src/bytecode.zig:4052`)
...
### `FunctionBytecode.filenameAtom` (`src/bytecode.zig:4056`)
...
### `FunctionBytecode.byteCodeAssumeMaterialized` (`src/bytecode.zig:4070`)
...
### `FunctionBytecode.byteCode` (`src/bytecode.zig:4075`)
...
### `FunctionBytecode.byteCodeSlow` (`src/bytecode.zig:4094`)
...
### `FunctionBytecode.allVarDefs` (`src/bytecode.zig:4103`)
...
### `FunctionBytecode.argVarDefs` (`src/bytecode.zig:4115`)
...
### `FunctionBytecode.localVarDefs` (`src/bytecode.zig:4119`)
...
### `FunctionBytecode.varDefs` (`src/bytecode.zig:4124`)
...
### `FunctionBytecode.closureVar` (`src/bytecode.zig:4127`)
...
### `FunctionBytecode.cpoolSlice` (`src/bytecode.zig:4136`)
...
### `FunctionBytecode.constantAt` (`src/bytecode.zig:4146`)
...
### `FunctionBytecode.funcName` (`src/bytecode.zig:4151`)
...
### `FunctionBytecode.varRefIsLexicalAt` (`src/bytecode.zig:4154`)
...
### `FunctionBytecode.varRefIsConstAt` (`src/bytecode.zig:4159`)
...
### `FunctionBytecode.varRefIsGlobalDeclAt` (`src/bytecode.zig:4164`)
...
### `FunctionBytecode.varRefNamesLen` (`src/bytecode.zig:4169`)
...
### `FunctionBytecode.varRefName` (`src/bytecode.zig:4173`)
...
### `FunctionBytecode.localOpenBindingIndex` (`src/bytecode.zig:4177`)
...
### `FunctionBytecode.argOpenBindingIndex` (`src/bytecode.zig:4182`)
...
### `FunctionBytecode.isGlobalVar` (`src/bytecode.zig:4187`)
...
### `FunctionBytecode.isModule` (`src/bytecode.zig:4194`)
...
### `FunctionBytecode.isAsync` (`src/bytecode.zig:4197`)
...
### `FunctionBytecode.isGenerator` (`src/bytecode.zig:4200`)
...
### `FunctionBytecode.entryContract` (`src/bytecode.zig:4203`)
...
### `FunctionBytecode.isStrictMode` (`src/bytecode.zig:4212`)
...
### `FunctionBytecode.runtimeStrictMode` (`src/bytecode.zig:4218`)
...
### `FunctionBytecode.executionFlags` (`src/bytecode.zig:4223`)
...
### `FunctionBytecode.setExecutionFlags` (`src/bytecode.zig:4226`)
...
### `FunctionBytecode.hasMappedArguments` (`src/bytecode.zig:4235`)
...
### `FunctionBytecode.simpleInlineEligible` (`src/bytecode.zig:4238`)
...
### `FunctionBytecode.strictSimpleInlineEligible` (`src/bytecode.zig:4241`)
...
### `FunctionBytecode.strictSimpleSnapshotInlineEligible` (`src/bytecode.zig:4244`)
...
### `FunctionBytecode.simpleInlineEmptyLeaf` (`src/bytecode.zig:4247`)
...
### `FunctionBytecode.rawThisInlineEmptyLeaf` (`src/bytecode.zig:4250`)
...
### `FunctionBytecode.simpleInlineExactArgsLeaf` (`src/bytecode.zig:4253`)
...
### `FunctionBytecode.rawThisInlineExactArgsLeaf` (`src/bytecode.zig:4256`)
...
### `FunctionBytecode.exactArgsLeafKind` (`src/bytecode.zig:4259`)
...
### `FunctionBytecode.captureLeafKind` (`src/bytecode.zig:4262`)
...
### `FunctionBytecode.smallInlineEligible` (`src/bytecode.zig:4265`)
...
### `FunctionBytecode.applyForwardInlined` (`src/bytecode.zig:4268`)
...
### `FunctionBytecode.pc2lineBuf` (`src/bytecode.zig:4271`)
...
### `FunctionBytecode.pc2lineLen` (`src/bytecode.zig:4283`)

- **签名**：`pub inline fn pc2lineLen(self: *const FunctionBytecodeImpl) i32`。
- **作用**：缓冲长度或 0。
- **实现**：debug.pc2line_len。
- **所有权 / 错误 / 调用**：借用读、不分配、无 error set；无 debug 尾返回 0。生产树内没有调用方——行列号解码走 `pc2lineBuf()`，本名只被 `src/tests/bytecode.zig:1678` 用来断言 debug 尾非空。


### `FunctionBytecode.lineNum` (`src/bytecode.zig:4289`)
...
### `FunctionBytecode.colNum` (`src/bytecode.zig:4301`)
...
### `FunctionBytecode.sourceText` (`src/bytecode.zig:4313`)
...
### `FunctionBytecode.scriptOrModule` (`src/bytecode.zig:4321`)
...
### `FunctionBytecode.callSiteCount` (`src/bytecode.zig:4331`)
...
### `FunctionBytecode.callSiteCache` (`src/bytecode.zig:4339`)
...
### `FunctionBytecode.propSiteCount` (`src/bytecode.zig:4348`)
...
### `FunctionBytecode.propSiteCache` (`src/bytecode.zig:4359`)
...
### `FunctionBytecode.createRaw` (`src/bytecode.zig:4367`)
...
### `FunctionBytecode.createProductionShell` (`src/bytecode.zig:4390`)
...
### `FunctionBytecode.createFixture` (`src/bytecode.zig:4423`)
...
- **实现**：`defined_arg_count > arg_count` 直接 `error.BytecodeOverflow`；`script_or_module != null_atom` 会强制 has_extension；算 layout；createRaw；memcpy 代码；applyFlags 与 defined_arg_count/stack_size/var_ref_count 回填；func_name（及 has_debug 时的 filename）经 `noteHolderStore`；可选 realm retain；`dupBytecodeAtoms`。
- **所有权 / 错误 / 调用**：返回未发布对象；失败走 destroyWithFam。随后 `publishFixtureNoFail` 或 `destroyUnpublishedFixture`。


### `FunctionBytecode.destroyUnpublishedFixture` (`src/bytecode.zig:4464`)
...
### `FunctionBytecode.publishFixtureNoFail` (`src/bytecode.zig:4472`)
...
### `FunctionBytecode.realmContext` (`src/bytecode.zig:4476`)
...
### `FunctionBytecode.realmContextSlow` (`src/bytecode.zig:4485`)
...
### `FunctionBytecode.dupBytecodeAtoms` (`src/bytecode.zig:4505`)

- **签名**：`pub fn dupBytecodeAtoms(byte_code: []const u8, _: *atom.AtomTable) void`。
- **作用**：夹具工具：走最终字节码，对每个 atom 操作数「重复」所有权。
- **实现**：按 sizeOf 步进；atom 总在 pc+1。tracing 下函数体把 atom_id 读出后丢弃（`_ = atom_id`）——atom 所有权已不靠 rc。
- **所有权 / 错误 / 调用**：生产 finalize 是 move，不走这里。


### `FunctionBytecode.freeBytecodeAtoms` (`src/bytecode.zig:4522`)

- **签名**：`pub fn freeBytecodeAtoms(byte_code: []const u8, _: *atom.AtomTable) void`。
- **作用**：对称地走一遍 atom 操作数。
- **实现**：与 dup 同一拓扑。
- **所有权 / 错误 / 调用**：deinit 在释放代码缓冲前调用。


### `FunctionBytecode.hasAtomOperandFmt` (`src/bytecode.zig:4539`)
...
### `FunctionBytecode.BytecodeAtomIterator.next` (`src/bytecode.zig:4554`)
...
### `FunctionBytecode.atomOperandIterator` (`src/bytecode.zig:4572`)
...
### `FunctionBytecode.deinit` (`src/bytecode.zig:4576`)
...
### `FunctionBytecode.deinitWithLayout` (`src/bytecode.zig:4580`)

- **签名**：`fn deinitWithLayout( self: *FunctionBytecodeImpl, rt: anytype, layout_value: function_bytecode.FunctionLayout, ) void`。
- **作用**：按 QuickJS `free_function_bytecode` 顺序释放：small-inline 回调、代码里的 atom、vardefs、cpool、closure、realm、func_name、debug 的 pc2line/source、hot.script_or_module。
- **实现**：先捕获 layout 视图再清指针。GC deinit 阶段 `restoreSizing` 以便 Pass B 重建 FAM 长度。
- **所有权 / 错误 / 调用**：不释放主 FAM 本身。


### `FunctionBytecode.heapByteSize` (`src/bytecode.zig:4667`)
...
### `FunctionBytecode.heapByteSizeWithLayout` (`src/bytecode.zig:4671`)
...
### `FunctionLayout.init` (`src/bytecode.zig:4717`)
...
### `FunctionLayout.fromFunction` (`src/bytecode.zig:4799`)
...
### `FunctionLayout.famBytes` (`src/bytecode.zig:4834`)
...
### `FunctionLayout.mainPayloadBytes` (`src/bytecode.zig:4838`)
...
### `FunctionLayout.cpoolSliceMut` (`src/bytecode.zig:4842`)
...
### `FunctionLayout.vardefsSliceMut` (`src/bytecode.zig:4846`)
...
### `FunctionLayout.closureVarSliceMut` (`src/bytecode.zig:4850`)
...
### `FunctionLayout.byteCodeSliceMut` (`src/bytecode.zig:4854`)
...
### `FunctionLayout.callSitesSliceMut` (`src/bytecode.zig:4858`)
...
### `FunctionLayout.propSitesSliceMut` (`src/bytecode.zig:4863`)
...
### `FunctionLayout.hotExtensionPtrMut` (`src/bytecode.zig:4868`)
...
### `FunctionLayout.seedHeader` (`src/bytecode.zig:4874`)
...
### `FunctionLayout.restoreSizing` (`src/bytecode.zig:4898`)
...
### `function_bytecode.packedSlice` (`src/bytecode.zig:4907`)
...
### `function_bytecode.addSliceBytes` (`src/bytecode.zig:4922`)
...
### `function_bytecode.addSaturating` (`src/bytecode.zig:4927`)
...
### `function_bytecode.destroyFunctionBytecode` (`src/bytecode.zig:4931`)

- **签名**：`pub fn destroyFunctionBytecode(header: *gc.ObjectHeader, destroy_ctx: ?*anyopaque) void`。
- **作用**：GC 对象析构入口：destroy_ctx 是 JSRuntime。
- **实现**：ctx 空则 return；否则 destroyFromHeader。
- **所有权 / 错误 / 调用**：当前树里没有调用方，只在 `src/bytecode.zig:12245` 再导出；GC 清扫与 teardown 直接调 `destroyFromHeader`（`src/core/gc_trace_stw.zig:1699`、`src/core/gc.zig:1665`）。


### `function_bytecode.destroyFromHeader` (`src/bytecode.zig:4936`)
...
- 清单函数数（本文件分组）: 132（`src/bytecode.zig` 全文件 538）
- 本文标题覆盖: 132
- 未覆盖: 无
