...
（2026-09-20 起没有栈上适配器：每个可执行的 FunctionBytecode 都是 GC 拥有的 packed 记录；下文若仍提到 `legacy_byte_code_len_sentinel`/`LegacyExecutionAdapter` 均已删除。）针），禁止逃逸、禁止当 GC 对象析构。
...
### `BytecodeVarDef.init` (`src/bytecode/function_bytecode.zig:1338`)
...
### `BytecodeVarDef.isConst` (`src/bytecode/function_bytecode.zig:213`)
...
### `BytecodeVarDef.hasScope` (`src/bytecode/function_bytecode.zig:162`)
...
### `ClosureVar.closureType` (`src/bytecode/function_bytecode.zig:205`)
...
### `FunctionBytecode.bit` (`src/bytecode/function_bytecode.zig:594`)
...
### `FunctionBytecode.assignBit` (`src/bytecode/function_bytecode.zig:598`)
...
### `FunctionBytecode.hasDebug` (`src/bytecode/function_bytecode.zig:602`)
...
### `FunctionBytecode.hasExtension` (`src/bytecode/function_bytecode.zig:606`)
...
### `FunctionBytecode.layout` (`src/bytecode/function_bytecode.zig:610`)
...
### `FunctionBytecode.famBytes` (`src/bytecode/function_bytecode.zig:1440`)
...
### `FunctionBytecode.debugInfo` (`src/bytecode/function_bytecode.zig:618`)
...
### `FunctionBytecode.debugInfoMut` (`src/bytecode/function_bytecode.zig:624`)
...
### `FunctionBytecode.hotExtension` (`src/bytecode/function_bytecode.zig:630`)
...
### `FunctionBytecode.hotExtensionCanonical` (`src/bytecode/function_bytecode.zig:645`)
...
### `FunctionBytecode.hotExtensionMut` (`src/bytecode/function_bytecode.zig:651`)
...
### `FunctionBytecode.canonicalHotAddress` (`src/bytecode/function_bytecode.zig:659`)
...
### `FunctionBytecode.canonicalHotExtension` (`src/bytecode/function_bytecode.zig:667`)
...
### `FunctionBytecode.hotExtensionSlow` (`src/bytecode/function_bytecode.zig:674`)

- **签名**：`noinline fn hotExtensionSlow(self: *const FunctionBytecodeImpl) *align(1) const FunctionBytecodeHotExtension`。
- **作用**：`hotExtension` 在没有自有 code 指针时的 outlined 定位：用 layout 的 `hot_off`。
- **实现**：`layout().hot_off orelse unreachable`。热路径 `hotExtension` 有 code 指针时走 `canonicalHotExtension`，不进这里。
- **所有权 / 错误 / 调用**：返回的是 FAM 内指针，不拥有。只有空码指针的夹具才进来。


### `FunctionBytecode.hotExtensionMutSlow` (`src/bytecode/function_bytecode.zig:680`)
...
### `FunctionBytecode.hotExtensionRequiredMut` (`src/bytecode/function_bytecode.zig:686`)
...
### `FunctionBytecode.canonicalCallFacts` (`src/bytecode/function_bytecode.zig:694`)
...
### `FunctionBytecode.applyFlags` (`src/bytecode/function_bytecode.zig:717`)
...
### `FunctionBytecode.functionKind` (`src/bytecode/function_bytecode.zig:733`)
...
### `FunctionBytecode.hasPrototype` (`src/bytecode/function_bytecode.zig:736`)
...
### `FunctionBytecode.hasSimpleParameterList` (`src/bytecode/function_bytecode.zig:739`)
...
### `FunctionBytecode.isDerivedClassConstructor` (`src/bytecode/function_bytecode.zig:742`)
...
### `FunctionBytecode.newTargetAllowed` (`src/bytecode/function_bytecode.zig:748`)
...
### `FunctionBytecode.superCallAllowed` (`src/bytecode/function_bytecode.zig:751`)
...
### `FunctionBytecode.superAllowed` (`src/bytecode/function_bytecode.zig:754`)
...
### `FunctionBytecode.argumentsAllowed` (`src/bytecode/function_bytecode.zig:757`)
...
### `FunctionBytecode.isDirectOrIndirectEval` (`src/bytecode/function_bytecode.zig:760`)
...
### `FunctionBytecode.callFacts` (`src/bytecode/function_bytecode.zig:763`)
...
### `FunctionBytecode.ctorAllocProfile` (`src/bytecode/function_bytecode.zig:767`)
...
### `FunctionBytecode.ctorAllocProfileMut` (`src/bytecode/function_bytecode.zig:771`)
...
### `FunctionBytecode.openVarRefCount` (`src/bytecode/function_bytecode.zig:775`)
...
### `FunctionBytecode.closureVarCount` (`src/bytecode/function_bytecode.zig:778`)
...
### `FunctionBytecode.filenameAtom` (`src/bytecode/function_bytecode.zig:782`)
...
### `FunctionBytecode.byteCodeAssumeMaterialized` (`src/bytecode/function_bytecode.zig:795`)
...
### `FunctionBytecode.byteCode` (`src/bytecode/function_bytecode.zig:800`)
...
### `FunctionBytecode.byteCodeSlow` (`src/bytecode/function_bytecode.zig:819`)

- **签名**：`noinline fn byteCodeSlow(self: *const FunctionBytecodeImpl) []u8`。
- **作用**：`byteCode` 的空码臂：core 指针为空时返回空切片。
- **实现**：断言 `byte_code_len >= 0`；len=0 返回空切片；非空且无指针是 bug（unreachable）。outlined 是为了让 Debug 每条 opcode 的 `byteCode()` 不把 optional-extension 走法实例化进 threaded handler。
- **所有权 / 错误 / 调用**：返回空切片。生产编译产物不进这里。


### `FunctionBytecode.allVarDefs` (`src/bytecode/function_bytecode.zig:827`)
...
### `FunctionBytecode.argVarDefs` (`src/bytecode/function_bytecode.zig:835`)
...
### `FunctionBytecode.varDefs` (`src/bytecode/function_bytecode.zig:842`)
...
### `FunctionBytecode.constantAt` (`src/bytecode/function_bytecode.zig:862`)
...
### `FunctionBytecode.varRefIsLexicalAt` (`src/bytecode/function_bytecode.zig:870`)
...
### `FunctionBytecode.varRefIsConstAt` (`src/bytecode/function_bytecode.zig:874`)
...
### `FunctionBytecode.localOpenBindingIndex` (`src/bytecode/function_bytecode.zig:888`)
...
### `FunctionBytecode.argOpenBindingIndex` (`src/bytecode/function_bytecode.zig:893`)
...
### `FunctionBytecode.isModule` (`src/bytecode/function_bytecode.zig:898`)
...
### `FunctionBytecode.entryContract` (`src/bytecode/function_bytecode.zig:907`)
...
### `FunctionBytecode.isStrictMode` (`src/bytecode/function_bytecode.zig:915`)
...
### `FunctionBytecode.setExecutionFlags` (`src/bytecode/function_bytecode.zig:926`)
...
### `FunctionBytecode.hasMappedArguments` (`src/bytecode/function_bytecode.zig:935`)
...
### `FunctionBytecode.simpleInlineEligible` (`src/bytecode/function_bytecode.zig:938`)
...
### `FunctionBytecode.strictSimpleInlineEligible` (`src/bytecode/function_bytecode.zig:941`)
...
### `FunctionBytecode.strictSimpleSnapshotInlineEligible` (`src/bytecode/function_bytecode.zig:944`)
...
### `FunctionBytecode.simpleInlineEmptyLeaf` (`src/bytecode/function_bytecode.zig:947`)
...
### `FunctionBytecode.rawThisInlineEmptyLeaf` (`src/bytecode/function_bytecode.zig:950`)
...
### `FunctionBytecode.simpleInlineExactArgsLeaf` (`src/bytecode/function_bytecode.zig:953`)
...
### `FunctionBytecode.rawThisInlineExactArgsLeaf` (`src/bytecode/function_bytecode.zig:956`)
...
### `FunctionBytecode.exactArgsLeafKind` (`src/bytecode/function_bytecode.zig:959`)
...
### `FunctionBytecode.captureLeafKind` (`src/bytecode/function_bytecode.zig:962`)
...
### `FunctionBytecode.smallInlineEligible` (`src/bytecode/function_bytecode.zig:965`)
...
### `FunctionBytecode.applyForwardInlined` (`src/bytecode/function_bytecode.zig:968`)
...
### `FunctionBytecode.pc2lineBuf` (`src/bytecode/function_bytecode.zig:971`)
...
### `FunctionBytecode.lineNum` (`src/bytecode/function_bytecode.zig:982`)
...
### `FunctionBytecode.colNum` (`src/bytecode/function_bytecode.zig:990`)
...
### `FunctionBytecode.sourceText` (`src/bytecode/function_bytecode.zig:999`)
...
### `FunctionBytecode.scriptOrModule` (`src/bytecode/function_bytecode.zig:1006`)
...
### `FunctionBytecode.propSiteCount` (`src/bytecode/function_bytecode.zig:1015`)
...
### `FunctionBytecode.propSiteCache` (`src/bytecode/function_bytecode.zig:1026`)
...
### `FunctionBytecode.createRaw` (`src/bytecode/function_bytecode.zig:1034`)
...
### `FunctionBytecode.createProductionShell` (`src/bytecode/function_bytecode.zig:1057`)
...
### `FunctionBytecode.createFixture` (`src/bytecode/function_bytecode.zig:1088`)
...
### `FunctionBytecode.destroyUnpublishedFixture` (`src/bytecode/function_bytecode.zig:1137`)
...
### `FunctionBytecode.publishFixtureNoFail` (`src/bytecode/function_bytecode.zig:1145`)
...
### `FunctionBytecode.realmContext` (`src/bytecode/function_bytecode.zig:1149`)
...
### `FunctionBytecode.realmContextSlow` (`src/bytecode/function_bytecode.zig:1157`)
...
### `FunctionBytecode.hasAtomOperandFmt` (`src/bytecode/function_bytecode.zig:1172`)
...
### `FunctionBytecode.BytecodeAtomIterator.next` (`src/bytecode/function_bytecode.zig:1187`)
...
### `FunctionBytecode.atomOperandIterator` (`src/bytecode/function_bytecode.zig:1205`)
...
### `FunctionBytecode.deinit` (`src/bytecode/function_bytecode.zig:1209`)
...
### `FunctionBytecode.deinitWithLayout` (`src/bytecode/function_bytecode.zig:1213`)
...
### `FunctionBytecode.heapByteSize` (`src/bytecode/function_bytecode.zig:1292`)
...
### `FunctionBytecode.heapByteSizeWithLayout` (`src/bytecode/function_bytecode.zig:1296`)
...
### `FunctionLayout.init` (`src/bytecode/function_bytecode.zig:1338`)
...
### `FunctionLayout.fromFunction` (`src/bytecode/function_bytecode.zig:1407`)
...
### `FunctionLayout.famBytes` (`src/bytecode/function_bytecode.zig:1440`)
...
### `FunctionLayout.mainPayloadBytes` (`src/bytecode/function_bytecode.zig:1444`)
...
### `FunctionLayout.cpoolSliceMut` (`src/bytecode/function_bytecode.zig:1448`)
...
### `FunctionLayout.vardefsSliceMut` (`src/bytecode/function_bytecode.zig:1452`)
...
### `FunctionLayout.closureVarSliceMut` (`src/bytecode/function_bytecode.zig:1456`)
...
### `FunctionLayout.byteCodeSliceMut` (`src/bytecode/function_bytecode.zig:1460`)
...
### `FunctionLayout.propSitesSliceMut` (`src/bytecode/function_bytecode.zig:1464`)
...
### `FunctionLayout.hotExtensionPtrMut` (`src/bytecode/function_bytecode.zig:1469`)
...
### `FunctionLayout.seedHeader` (`src/bytecode/function_bytecode.zig:1475`)
...
### `FunctionLayout.restoreSizing` (`src/bytecode/function_bytecode.zig:1496`)
...
### `function_bytecode.packedSlice` (`src/bytecode/function_bytecode.zig:1505`)
...
### `function_bytecode.addSliceBytes` (`src/bytecode/function_bytecode.zig:1520`)
...
### `function_bytecode.addSaturating` (`src/bytecode/function_bytecode.zig:1525`)
...
### `function_bytecode.destroyFromHeader` (`src/bytecode/function_bytecode.zig:1529`)
