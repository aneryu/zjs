...
### `args` (`src/exec/builtin_dispatch.zig:70`)
...
### `managedGeneric` (`src/exec/builtin_dispatch.zig:75`)
...
### `managedGeneric.thunk` (`src/exec/builtin_dispatch.zig:77`)
...
### `managedGenericMagic` (`src/exec/builtin_dispatch.zig:85`)
...
### `managedGenericMagic.thunk` (`src/exec/builtin_dispatch.zig:87`)
...
### `getterThunk` (`src/exec/builtin_dispatch.zig:94`)
...
### `getterThunk.thunk` (`src/exec/builtin_dispatch.zig:96`)
...
### `getterMagicThunk` (`src/exec/builtin_dispatch.zig:103`)
...
### `getterMagicThunk.thunk` (`src/exec/builtin_dispatch.zig:105`)
...
### `setterThunk` (`src/exec/builtin_dispatch.zig:111`)
...
### `setterThunk.thunk` (`src/exec/builtin_dispatch.zig:113`)
...
### `setterMagicThunk` (`src/exec/builtin_dispatch.zig:120`)
...
### `setterMagicThunk.thunk` (`src/exec/builtin_dispatch.zig:122`)
...
### `leafF64` (`src/exec/builtin_dispatch.zig:128`)
...
### `leafF64.thunk` (`src/exec/builtin_dispatch.zig:130`)
...
### `leafF64F64` (`src/exec/builtin_dispatch.zig:136`)
...
### `leafF64F64.thunk` (`src/exec/builtin_dispatch.zig:138`)
...
### `entryFromInternal` (`src/exec/builtin_dispatch.zig:147`)
...
### `primLeafOrManaged` (`src/exec/builtin_dispatch.zig:233`)
...
### `genericEntry` (`src/exec/builtin_dispatch.zig:255`)
