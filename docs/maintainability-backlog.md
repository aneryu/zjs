...
|---|---|---|---|
| H1 | Rehome overflow content out of `call_runtime.zig` (7568 lines, 202 pub fns after H5) | Atomics `:3544-3781`, Reflect `:3475`, iterator protocol `:3196-3468`, Error.stack `:1694-1781`, dynamic Function construction `:2883-2922` all have dedicated owning files | Move in batches; one bench-v8 A/B per batch |
...
| H9 | Narrow the public `JSValue` surface (88 leaked internal pub decls, e.g. `freeObjectAssumeObjectDuringActiveBytecode`) via an opaque public value type | Public-api audit A3; `public-api-contract.md` promises the opposite | Design jointly with the fun port |
