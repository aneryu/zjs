...
- `src/libs/`: Irregexp (V8 C++ compiler + Zig bytecode interpreter)
  compile/exec, QuickJS-style regexp helpers, unicode, bigint, number
  formatting. Vendor sources and the C ABI live under `vendor/irregexp/`.
