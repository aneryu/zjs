...
- [QCP-1 Switch Decision](qcp1_switch_decision.md): the compiler configuration
  that ships and the evidence it rests on. §8 records the original split
  ruling; §9 records the deletion bisection, compiler-stage boundary fix,
  current validation, and amended **QCP-1B ACCEPT** verdict.
