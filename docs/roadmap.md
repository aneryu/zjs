...
**Now(遵守 §4 WIP)**
```
owner-decision: PERF-OPCODE-SPACE(driver 会话;FN-M0D 已闭合——
                FNABI v0.7 六项裁决 owner 批复 2026-08-26,FN-M0F
                只剩等 FN-M0I 会合)
...
```
now        PERF-OPCODE-SPACE GC-P3 FN-M0I
ready      G1-LIGHT-PROCESS-WORKLOAD PERF-T-SPIKE PERF-DYN-SPIKE PERF-N-SPIKE PERF-VMABI PERF-SIDECAR SER-CORE SER-TRANSFER HR-P1 DBG-W2 RT-LIFECYCLE GC-MULTIRT-GATE VM-WEAK-REGISTRY PROC-D5A
...
done       BASE-DOC-NORM BASE-ROADMAP-LINT BASE-G0 G1-GC GC-GAP FN-M0D
```
