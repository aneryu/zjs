...
| 2026-04-27 | semantic-followups | `./zig-out/bin/run-test262 -v -t 1 -c quickjs/test262.conf -d quickjs/test262/test/built-ins/Map 0 60` | 1 | Wider Map tranche remains a blocker: prepared 61/204 tests, `Result: 27/61 errors, passed 34`; remaining failures are iterator closing/custom adder/prototype descriptor/clear receiver semantics | targeted-test262 |
