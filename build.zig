...
pub fn build(b: *std.Build) void {
    ...
    // PERF-T-SPIKE (branch spike/perf-t-main, never main): off | u64 | ptr.
    // Non-off compiles the guarded direct-slot opcode's guard arm; the arm is
    // baked per build so neither arm pays a runtime branch. Default off.
