...
// README). Shapes are ordered: lhs has 29 limbs of 64 bits, rhs has 29, so the
// product's flexible array member is 58 limbs. That is the allocator boundary
// P6-03b pinned: a 56-byte wrapper plus 58 limbs is 520 bytes of payload, and
...
const a = (1n << 29n * 64n - 1n) | 1n;
const b = (1n << 29n * 64n - 1n) | 1n;
function run() {
    let r = 0n;
