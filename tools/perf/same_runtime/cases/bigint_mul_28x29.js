...
// README). Shapes are ordered: lhs has 28 limbs of 64 bits, rhs has 29, so the
// product's flexible array member is 57 limbs. That is the allocator boundary
// P6-03b pinned: a 56-byte wrapper plus 57 limbs is 512 bytes of payload, and
